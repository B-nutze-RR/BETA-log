...
# 44 "./src/main/drivers/camera_control.c"
...
# 45 "./src/main/drivers/camera_control.c" 2
...
void cameraControlInit(void)
{
    ...
    if (CAMERA_CONTROL_MODE_HARDWARE_PWM == cameraControlConfig()->mode) {
        ...
        pwmOutConfig(&cameraControlRuntime.channel, timerHardware, timerClock(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1000))), 128, 0, cameraControlRuntime.inverted);
...
# 142 "./src/main/drivers/camera_control.c"
        ...
        cameraControlRuntime.enabled = 
# 151 "./src/main/drivers/camera_control.c" 3 4
                                      1
# 151 "./src/main/drivers/camera_control.c"
                                          ;
