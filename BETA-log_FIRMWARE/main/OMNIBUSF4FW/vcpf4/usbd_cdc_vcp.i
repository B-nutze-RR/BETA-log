...
# 1 "<command-line>"
# 1 "./src/main/vcpf4/usbd_cdc_vcp.c"
# 24 "./src/main/vcpf4/usbd_cdc_vcp.c"
...
# 153 "./src/main/platform.h" 2
# 25 "./src/main/vcpf4/usbd_cdc_vcp.c" 2
...
# 81 "./src/main/vcpf4/usbd_cdc_vcp.c"
static uint16_t VCP_Init(void)
{
    bDeviceState = CONFIGURED;
    ctrlLineStateCb = 
# 84 "./src/main/vcpf4/usbd_cdc_vcp.c" 3 4
                     ((void *)0)
# 84 "./src/main/vcpf4/usbd_cdc_vcp.c"
                         ;
    baudRateCb = 
# 85 "./src/main/vcpf4/usbd_cdc_vcp.c" 3 4
                ((void *)0)
# 85 "./src/main/vcpf4/usbd_cdc_vcp.c"
                    ;
    return USBD_OK;
}
...
# 117 "./src/main/vcpf4/usbd_cdc_vcp.c"
static uint16_t VCP_Ctrl(uint32_t Cmd, uint8_t* Buf, uint32_t Len)
{
...
# 182 "./src/main/vcpf4/usbd_cdc_vcp.c"
uint32_t CDC_Send_DATA(const uint8_t *ptrBuffer, uint32_t sendLength)
{
...
# 207 "./src/main/vcpf4/usbd_cdc_vcp.c"
static uint16_t VCP_DataTx(const uint8_t* Buf, uint32_t Len)
{
...
# 235 "./src/main/vcpf4/usbd_cdc_vcp.c"
uint32_t CDC_Receive_DATA(uint8_t* recvBuf, uint32_t len)
{
    uint32_t count = 0;
...
# 268 "./src/main/vcpf4/usbd_cdc_vcp.c"
static uint16_t VCP_DataRx(uint8_t* Buf, uint32_t Len)
{
...
# 289 "./src/main/vcpf4/usbd_cdc_vcp.c"
uint8_t usbIsConfigured(void)
{
    return (bDeviceState == CONFIGURED);
}
# 301 "./src/main/vcpf4/usbd_cdc_vcp.c"
uint8_t usbIsConnected(void)
{
    return (bDeviceState != UNCONNECTED);
}
# 313 "./src/main/vcpf4/usbd_cdc_vcp.c"
uint32_t CDC_BaudRate(void)
{
    return g_lc.bitrate;
}
# 325 "./src/main/vcpf4/usbd_cdc_vcp.c"
void CDC_SetBaudRateCb(void (*cb)(void *context, uint32_t baud), void *context)
{
    baudRateCbContext = context;
    baudRateCb = cb;
}
# 338 "./src/main/vcpf4/usbd_cdc_vcp.c"
void CDC_SetCtrlLineStateCb(void (*cb)(void *context, uint16_t ctrlLineState), void *context)
{
