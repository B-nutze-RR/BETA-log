...
extern const usbDev_t pgResetTemplate_usbDevConfig; usbDev_t usbDevConfig_System; usbDev_t usbDevConfig_Copy; extern const pgRegistry_t usbDevConfig_Registry; const pgRegistry_t usbDevConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 531 | (0 << 12), .length = 1, .size = sizeof(usbDev_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&usbDevConfig_System, .copy = (uint8_t*)&usbDevConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_usbDevConfig}, };
