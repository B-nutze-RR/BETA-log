...
# 33 "./src/main/drivers/rx/rx_spi.c" 2
...
# 35 "./src/main/drivers/rx/rx_spi.c" 2
...
# 36 "./src/main/drivers/rx/rx_spi.c" 2
...
# 37 "./src/main/drivers/rx/rx_spi.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 38 "./src/main/drivers/rx/rx_spi.c" 2
...
# 39 "./src/main/drivers/rx/rx_spi.c" 2
...
# 40 "./src/main/drivers/rx/rx_spi.c" 2
...
# 41 "./src/main/drivers/rx/rx_spi.c" 2
...
# 43 "./src/main/drivers/rx/rx_spi.c" 2
...
# 45 "./src/main/drivers/rx/rx_spi.c" 2
...
static IO_t extiPin = ((IO_t)0);
static extiCallbackRec_t rxSpiExtiCallbackRec;
static 
# 57 "./src/main/drivers/rx/rx_spi.c" 3 4
      _Bool 
# 57 "./src/main/drivers/rx/rx_spi.c"
           extiLevel = 
# 57 "./src/main/drivers/rx/rx_spi.c" 3 4
                       1
# 57 "./src/main/drivers/rx/rx_spi.c"
...
static volatile 
# 59 "./src/main/drivers/rx/rx_spi.c" 3 4
               _Bool 
# 59 "./src/main/drivers/rx/rx_spi.c"
                    extiHasOccurred = 
# 59 "./src/main/drivers/rx/rx_spi.c" 3 4
                                      0
# 59 "./src/main/drivers/rx/rx_spi.c"
...
{
    spiPreinitRegister(rxSpiConfig->csnTag, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_UP) << 5)), 1);
}
...
void rxSpiExtiHandler(extiCallbackRec_t* callback)
{
    ...
    if (IORead(extiPin) == extiLevel) {
        ...
        extiHasOccurred = 
# 75 "./src/main/drivers/rx/rx_spi.c" 3 4
                         1
# 75 "./src/main/drivers/rx/rx_spi.c"
                             ;
    }
}


# 79 "./src/main/drivers/rx/rx_spi.c" 3 4
_Bool 
# 79 "./src/main/drivers/rx/rx_spi.c"
    rxSpiDeviceInit(const rxSpiConfig_t *rxSpiConfig)
{
    SPI_TypeDef *instance = spiInstanceByDevice(((rxSpiConfig->spibus) - 1));

    if (!instance) {
        return 
# 84 "./src/main/drivers/rx/rx_spi.c" 3 4
              0
# 84 "./src/main/drivers/rx/rx_spi.c"
                   ;
    }
    ...
    IOConfigGPIO(rxCsPin, ((GPIO_Mode_OUT) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
    ...
    return 
# 107 "./src/main/drivers/rx/rx_spi.c" 3 4
          1
# 107 "./src/main/drivers/rx/rx_spi.c"
              ;
}
...
void rxSpiExtiInit(ioConfig_t rxSpiExtiPinConfig, extiTrigger_t rxSpiExtiPinTrigger)
{
    if (extiPin) {
        if (rxSpiExtiPinTrigger == BETAFLIGHT_EXTI_TRIGGER_FALLING) {
            extiLevel = 
# 114 "./src/main/drivers/rx/rx_spi.c" 3 4
                       0
# 114 "./src/main/drivers/rx/rx_spi.c"
                            ;
        }
        EXTIHandlerInit(&rxSpiExtiCallbackRec, rxSpiExtiHandler);
        EXTIConfig(extiPin, &rxSpiExtiCallbackRec, (((((0x0f)<<(4-(7-(((uint32_t)0x500)>>8))))|((0x0f)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), rxSpiExtiPinConfig, rxSpiExtiPinTrigger);
        EXTIEnable(extiPin, 
# 118 "./src/main/drivers/rx/rx_spi.c" 3 4
                           1
# 118 "./src/main/drivers/rx/rx_spi.c"
                               );
    }
}
...
# 155 "./src/main/drivers/rx/rx_spi.c" 3 4
_Bool 
# 155 "./src/main/drivers/rx/rx_spi.c"
    rxSpiExtiConfigured(void)
{
    return extiPin != ((IO_t)0);
}


# 160 "./src/main/drivers/rx/rx_spi.c" 3 4
_Bool 
# 160 "./src/main/drivers/rx/rx_spi.c"
    rxSpiGetExtiState(void)
{
...
# 165 "./src/main/drivers/rx/rx_spi.c" 3 4
_Bool 
# 165 "./src/main/drivers/rx/rx_spi.c"
    rxSpiPollExti(void)
{
...
{
    extiHasOccurred = 
# 172 "./src/main/drivers/rx/rx_spi.c" 3 4
                     0
# 172 "./src/main/drivers/rx/rx_spi.c"
                          ;
}
