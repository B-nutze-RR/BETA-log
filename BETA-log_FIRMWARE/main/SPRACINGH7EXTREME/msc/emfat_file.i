...
static const emfat_entry_t entriesPredefined[] =
{
    ...
    { "", 
# 261 "./src/main/msc/emfat_file.c" 3 4
                     1
# 261 "./src/main/msc/emfat_file.c"
...
# 261 "./src/main/msc/emfat_file.c"
    ...
    { "autorun.inf", 
# 263 "./src/main/msc/emfat_file.c" 3 4
                     0
# 263 "./src/main/msc/emfat_file.c"
                          , 0x02, 1, 0, (sizeof(autorun_file) - 1), (sizeof(autorun_file) - 1), (long)autorun_file, { ((((((2018)-1980) << 9) | ((1) << 5) | (1)) << 16) | (((13) << 11) | ((0) << 5) | (0 >> 1))), ((((((2018)-1980) << 9) | ((1) << 5) | (1)) << 16) | (((13) << 11) | ((0) << 5) | (0 >> 1))), ((((((2018)-1980) << 9) | ((1) << 5) | (1)) << 16) | (((13) << 11) | ((0) << 5) | (0 >> 1))) }, memory_read_proc, 
# 263 "./src/main/msc/emfat_file.c" 3 4
                                                                                                                                   ((void *)0)
# 263 "./src/main/msc/emfat_file.c"
                                                                                                                                       , { 0 } },
    ...
    { "icon.ico", 
# 266 "./src/main/msc/emfat_file.c" 3 4
                     0
# 266 "./src/main/msc/emfat_file.c"
                          , 0x02, 1, 0, (sizeof(icon_file)), (sizeof(icon_file)), (long)icon_file, { ((((((2018)-1980) << 9) | ((1) << 5) | (1)) << 16) | (((13) << 11) | ((0) << 5) | (0 >> 1))), ((((((2018)-1980) << 9) | ((1) << 5) | (1)) << 16) | (((13) << 11) | ((0) << 5) | (0 >> 1))), ((((((2018)-1980) << 9) | ((1) << 5) | (1)) << 16) | (((13) << 11) | ((0) << 5) | (0 >> 1))) }, memory_read_proc, 
# 266 "./src/main/msc/emfat_file.c" 3 4
                                                                                                                                   ((void *)0)
# 266 "./src/main/msc/emfat_file.c"
                                                                                                                                       , { 0 } },
...
# 271 "./src/main/msc/emfat_file.c" 3 4
                                                                                                                                                      ((void *)0)
# 271 "./src/main/msc/emfat_file.c"
                                                                                                                                                          , { 0 } },
...
# 272 "./src/main/msc/emfat_file.c" 3 4
                                                                                                                ((void *)0)
# 272 "./src/main/msc/emfat_file.c"
                                                                                                                    , 
# 272 "./src/main/msc/emfat_file.c" 3 4
                                                                                                                                   ((void *)0)
# 272 "./src/main/msc/emfat_file.c"
...
static emfat_entry_t entries[((1 + 1 + 1 + 0) + 100 + 2)];
...
static int emfat_find_log(emfat_entry_t *entry, int maxCount, int flashfsUsedSpace)
{
    ...
    for ( ; currOffset < flashfsUsedSpace ; currOffset += 2048) {
        ...
        while (
# 355 "./src/main/msc/emfat_file.c" 3 4
              1
# 355 "./src/main/msc/emfat_file.c"
                  ) {
...
# 369 "./src/main/msc/emfat_file.c" 3 4
                                                  ((void *)0)
# 369 "./src/main/msc/emfat_file.c"
                                                      , 10);
...
void emfat_init_files(void)
{
    ...
    flashfsInit();
    ledSet(0, 
# 438 "./src/main/msc/emfat_file.c" 3 4
   0
# 438 "./src/main/msc/emfat_file.c"
   );

    flashfsUsedSpace = flashfsIdentifyStartOfFreeSpace();


    const int logCount = emfat_find_log(&entries[(1 + 1 + 1 + 0)], 100, flashfsUsedSpace);
    ...
    if (logCount > 0) {
        ...
        entries[entryIndex] = entriesPredefined[(1 + 1 + 1 + 0)];
    ...
    if (flashfsUsedSpace * 2 < 256 * 1024 * 1024) {
        entries[entryIndex] = entriesPredefined[(1 + 1 + 1 + 0) + 1];
        entry = &entries[entryIndex];
    ...
    ledSet(0, 
# 472 "./src/main/msc/emfat_file.c" 3 4
   0
# 472 "./src/main/msc/emfat_file.c"
   );
}
