...
static void calculateThrottleAndCurrentMotorEndpoints(timeUs_t currentTimeUs)
{
    ...
    if (mixerRuntime.feature3dEnabled) {
        ...
        if (mixerRuntime.vbatSagCompensationFactor > 0.0f) {
            ...
            {if (debugMode == (DEBUG_BATTERY)) {debug[(2)] = (batteryGoodness * 100);}};
            {if (debugMode == (DEBUG_BATTERY)) {debug[(3)] = (motorRangeAttenuationFactor * 1000);}};
        }
...
# 428 "./src/main/flight/mixer.c" 3 4
                                                             _Bool 
# 428 "./src/main/flight/mixer.c"
                                                                  airmodeEnabled) {
...
# 444 "./src/main/flight/mixer.c" 3 4
                                                                                                         _Bool 
 ...
 void mixTable(timeUs_t currentTimeUs)
{
    ...
    const 
# 484 "./src/main/flight/mixer.c" 3 4
         _Bool 
...
# 502 "./src/main/flight/mixer.c"
    ...
    const 
# 572 "./src/main/flight/mixer.c" 3 4
         _Bool 
