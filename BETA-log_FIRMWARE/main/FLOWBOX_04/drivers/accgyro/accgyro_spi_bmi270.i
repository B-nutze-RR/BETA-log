# 1 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
# 21 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
# 1 "c:\\dev\\9 2020-q2-update\\lib\\gcc\\arm-none-eabi\\9.3.1\\include\\stdbool.h" 1 3 4
# 22 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 2
...
# 23 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 2
...
# 153 "./src/main/platform.h" 2
# 25 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 2
...
#pragma GCC diagnostic pop
# 29 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 2
...
# 30 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 2
...
# 31 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 2
...
# 33 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 2
...
# 34 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 35 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 2
...
# 37 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 2
# 46 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
...
typedef enum {
    ...
    BMI270_VAL_PWR_CTRL = 0x0E,
    BMI270_VAL_PWR_CONF = 0x02,
    BMI270_VAL_ACC_CONF_ODR800 = 0x0B,
    BMI270_VAL_ACC_CONF_ODR1600 = 0x0C,
    BMI270_VAL_ACC_CONF_BWP = 0x02,
    BMI270_VAL_ACC_CONF_HP = 0x01,
    BMI270_VAL_ACC_RANGE_8G = 0x02,
    BMI270_VAL_ACC_RANGE_16G = 0x03,
    BMI270_VAL_GYRO_CONF_ODR3200 = 0x0D,
    BMI270_VAL_GYRO_CONF_BWP = 0x02,
    BMI270_VAL_GYRO_CONF_NOISE_PERF = 0x01,
    BMI270_VAL_GYRO_CONF_FILTER_PERF = 0x01,

    BMI270_VAL_GYRO_RANGE_2000DPS = 0x08,



    BMI270_VAL_INT_MAP_DATA_DRDY_INT1 = 0x04,
    BMI270_VAL_INT_MAP_FIFO_WM_INT1 = 0x02,
    BMI270_VAL_INT1_IO_CTRL_PINMODE = 0x0A,
    BMI270_VAL_FIFO_CONFIG_0 = 0x00,
    BMI270_VAL_FIFO_CONFIG_1 = 0x80,
    BMI270_VAL_FIFO_DOWNS = 0x00,
    BMI270_VAL_FIFO_WTM_0 = 0x06,
    BMI270_VAL_FIFO_WTM_1 = 0x00,
...
uint8_t bmi270Detect(const busDevice_t *bus)
{
    spiSetDivisor(bus->busdev_u.spi.instance, spiCalculateDivider(10000000));
    bmi270EnableSPI(bus);

    if (bmi270RegisterRead(bus, BMI270_REG_CHIP_ID) == 0x24) {
        return BMI_270_SPI;
    }
...
static void bmi270UploadConfig(const busDevice_t *bus)
{
    ...
    spiTransfer(bus->busdev_u.spi.instance, bmi270_config_file, 
# 177 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
                                                               ((void *)0)
# 177 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
...
static void bmi270Config(const gyroDev_t *gyro)
{
    ...
    const 
# 191 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
         _Bool 
# 191 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
              fifoMode = (gyro->hardware_lpf == GYRO_HARDWARE_LPF_EXPERIMENTAL);
...
# 255 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
                     __builtin_offsetof (
# 255 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
                     gyroDev_t
# 255 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
                     , 
# 255 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
...
# 255 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
    ...
    gyro->dataReady = 
# 256 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
                     1
# 256 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
                         ;
}
...
static void bmi270IntExtiInit(gyroDev_t *gyro)
{
    ...
    EXTIEnable(mpuIntIO, 
# 270 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
                        1
# 270 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
                            );
}


static 
# 274 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
      _Bool 
# 274 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
           bmi270AccRead(accDev_t *acc)
{
    enum {
        IDX_REG = 0,
        IDX_SKIP,
    ...
    spiTransfer(acc->bus.busdev_u.spi.instance, bmi270_tx_buf, bmi270_rx_buf, BUFFER_SIZE);
    ...
    return 
# 299 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
          1
# 299 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
              ;
}

static 
# 302 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
      _Bool 
# 302 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
           bmi270GyroReadRegister(gyroDev_t *gyro)
{
    enum {
        IDX_REG = 0,
        IDX_SKIP,
    ...
    spiTransfer(gyro->bus.busdev_u.spi.instance, bmi270_tx_buf, bmi270_rx_buf, BUFFER_SIZE);
    ...
    return 
# 327 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
          1
# 327 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
              ;
}


static 
# 331 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
      _Bool 
# 331 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
           bmi270GyroReadFifo(gyroDev_t *gyro)
{
    enum {
        IDX_REG = 0,
        IDX_SKIP,
...
# 347 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
   _Bool 
# 347 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
        dataRead = 
# 347 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
                   0
# 347 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
    ...
    if (fifoLength >= 6) {
        ...
        if ((gyroX != 
# 370 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
                     (-0x7fff - 1)
# 370 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
                              ) || (gyroY != 
# 370 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
                                             (-0x7fff - 1)
# 370 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
...
# 370 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
            ...
            dataRead = 
# 374 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
                      1
# 374 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
                          ;
        }
        fifoLength -= 6;
    }
# 386 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
    if (fifoLength > 0) {
...
static 
# 395 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
      _Bool 
# 395 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
           bmi270GyroRead(gyroDev_t *gyro)
{
...
# 424 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
_Bool 
# 424 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
    bmi270SpiAccDetect(accDev_t *acc)
{
    if (acc->mpuDetectionResult.sensor != BMI_270_SPI) {
        return 
# 427 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
              0
# 427 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
                   ;
    }
    ...
    return 
# 433 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
          1
# 433 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
              ;
}



# 437 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
_Bool 
# 437 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
    bmi270SpiGyroDetect(gyroDev_t *gyro)
{
    if (gyro->mpuDetectionResult.sensor != BMI_270_SPI) {
        return 
# 440 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
              0
# 440 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
                   ;
    }
    ...
    return 
# 447 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c" 3 4
          1
# 447 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
              ;
}
# 457 "./src/main/drivers/accgyro/accgyro_spi_bmi270.c"
uint8_t bmi270InterruptStatus(gyroDev_t *gyro)
{
