...
void pgResetFn_gyroDeviceConfig(gyroDeviceConfig_t *devconf)
{
    ...
    gyroResetSpiDeviceConfig(&devconf[0], ((SPI_TypeDef *) ((0x40000000UL) + 0x3C00UL)), ((ioTag_t)((((0) + 1) << 4) | (15))), ((ioTag_t)((((3) + 1) << 4) | (4))), CW180_DEG, customAlignment1);

    devconf[1].index = 1;
    sensorAlignment_t customAlignment2 = ((sensorAlignment_t){ .roll = ((0) * 10), .pitch = ((0) * 10), .yaw = ((0) * 10), });

    customAlignment2 = ((sensorAlignment_t){ .roll = ((0) * 10), .pitch = ((0) * 10), .yaw = ((225) * 10), });



    gyroResetSpiDeviceConfig(&devconf[1], ((SPI_TypeDef *) ((0x40000000UL) + 0x3800UL)), ((ioTag_t)((((1) + 1) << 4) | (12))), ((ioTag_t)((((4) + 1) << 4) | (15))), ALIGN_CUSTOM, customAlignment2);
