...
static 
# 42 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 42 "./src/main/drivers/barometer/barometer_bmp085.c"
...
# 42 "./src/main/drivers/barometer/barometer_bmp085.c"
                                       ;
static 
# 43 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 43 "./src/main/drivers/barometer/barometer_bmp085.c"
           isEOCConnected = 
# 43 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                            0
# 43 "./src/main/drivers/barometer/barometer_bmp085.c"
...
static void bmp085ExtiHandler(extiCallbackRec_t* cb)
{
    (void)(cb);
    isConversionComplete = 
# 56 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                          1
...
# 118 "./src/main/drivers/barometer/barometer_bmp085.c"
...
static 
# 123 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 123 "./src/main/drivers/barometer/barometer_bmp085.c"
           bmp085InitDone = 
# 123 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                            0
# 123 "./src/main/drivers/barometer/barometer_bmp085.c"
...
static 
# 129 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 129 "./src/main/drivers/barometer/barometer_bmp085.c"
           bmp085ReadUT(baroDev_t *baro);
static 
# 130 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 130 "./src/main/drivers/barometer/barometer_bmp085.c"
           bmp085GetUT(baroDev_t *baro);
static void bmp085StartUP(baroDev_t *baro);
static 
# 132 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 132 "./src/main/drivers/barometer/barometer_bmp085.c"
           bmp085ReadUP(baroDev_t *baro);
static 
# 133 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 133 "./src/main/drivers/barometer/barometer_bmp085.c"
           bmp085GetUP(baroDev_t *baro);
static int32_t bmp085GetTemperature(uint32_t ut);
static int32_t bmp085GetPressure(uint32_t up);
static void bmp085Calculate(int32_t *pressure, int32_t *temperature);

static 
# 138 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 138 "./src/main/drivers/barometer/barometer_bmp085.c"
           bmp085TestEOCConnected(baroDev_t *baro, const bmp085Config_t *config);

static IO_t xclrIO = ((IO_t)0);
...
# 151 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
_Bool 
# 151 "./src/main/drivers/barometer/barometer_bmp085.c"
    bmp085Detect(const bmp085Config_t *config, baroDev_t *baro)
{
    uint8_t data;
    
# 154 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
   _Bool 
# 154 "./src/main/drivers/barometer/barometer_bmp085.c"
        ack;
    
# 155 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
   _Bool 
# 155 "./src/main/drivers/barometer/barometer_bmp085.c"
...
# 158 "./src/main/drivers/barometer/barometer_bmp085.c"
    ...
    EXTIConfig(eocIO, &exti, (((((0x0f)<<(4-(7-(((uint32_t)0x500)>>8))))|((0x0f)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)), BETAFLIGHT_EXTI_TRIGGER_RISING);
    EXTIEnable(eocIO, 
...
# 171 "./src/main/drivers/barometer/barometer_bmp085.c"
    ...
    if ((busdev->bustype == BUSTYPE_I2C) && (busdev->busdev_u.i2c.address == 0)) {
        ...
        defaultAddressApplied = 
# 183 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                               1
# 183 "./src/main/drivers/barometer/barometer_bmp085.c"
                                   ;
    }
    ...
    if (ack) {
        ...
        if (bmp085.chip_id == 0x55) {
            ...
            bmp085ReadCalibrarionParameters(busdev);
            baro->ut_delay = 6000;
            baro->up_delay = 27000;
            ...
            bmp085InitDone = 
# 210 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                            1
# 210 "./src/main/drivers/barometer/barometer_bmp085.c"
                                ;
            return 
# 211 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                  1
# 211 "./src/main/drivers/barometer/barometer_bmp085.c"
                      ;
        }
    }
...
{
    isConversionComplete = 
# 286 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                          0
# 286 "./src/main/drivers/barometer/barometer_bmp085.c"
                               ;

    busWriteRegisterStart(&baro->busdev, 0xF4, 0x2E);
}

static 
# 291 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 291 "./src/main/drivers/barometer/barometer_bmp085.c"
           bmp085ReadUT(baroDev_t *baro)
{
    if (busBusy(&baro->busdev, 
# 293 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                              ((void *)0)
# 293 "./src/main/drivers/barometer/barometer_bmp085.c"
                                  )) {
        return 
# 294 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
              0
# 294 "./src/main/drivers/barometer/barometer_bmp085.c"
                   ;
    }
    ...
    if (isEOCConnected && !isConversionComplete) {
        return 
# 299 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
              0
# 299 "./src/main/drivers/barometer/barometer_bmp085.c"
                   ;
    }

    busReadRegisterBufferStart(&baro->busdev, 0xF6, sensor_data, 2);

    return 
# 304 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
          1
# 304 "./src/main/drivers/barometer/barometer_bmp085.c"
              ;
}

static 
# 307 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 307 "./src/main/drivers/barometer/barometer_bmp085.c"
           bmp085GetUT(baroDev_t *baro)
{
    if (busBusy(&baro->busdev, 
# 309 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                              ((void *)0)
# 309 "./src/main/drivers/barometer/barometer_bmp085.c"
                                  )) {
        return 
# 310 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
              0
# 310 "./src/main/drivers/barometer/barometer_bmp085.c"
                   ;
    }
    ...
    return 
# 315 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
          1
# 315 "./src/main/drivers/barometer/barometer_bmp085.c"
              ;
}
...
static void bmp085StartUP(baroDev_t *baro)
{
    ...
    isConversionComplete = 
# 324 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                          0
# 324 "./src/main/drivers/barometer/barometer_bmp085.c"
                               ;

    busWriteRegisterStart(&baro->busdev, 0xF4, ctrl_reg_data);
}

static 
# 329 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 329 "./src/main/drivers/barometer/barometer_bmp085.c"
           bmp085ReadUP(baroDev_t *baro)
{
    if (busBusy(&baro->busdev, 
# 331 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                              ((void *)0)
# 331 "./src/main/drivers/barometer/barometer_bmp085.c"
                                  )) {
        return 
# 332 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
              0
# 332 "./src/main/drivers/barometer/barometer_bmp085.c"
                   ;
    }
    ...
    if (isEOCConnected && !isConversionComplete) {
        return 
# 337 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
              0
# 337 "./src/main/drivers/barometer/barometer_bmp085.c"
                   ;
    }

    busReadRegisterBufferStart(&baro->busdev, 0xF6, sensor_data, 3);

    return 
# 342 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
          1
# 342 "./src/main/drivers/barometer/barometer_bmp085.c"
              ;
}
...
static 
# 349 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 349 "./src/main/drivers/barometer/barometer_bmp085.c"
           bmp085GetUP(baroDev_t *baro)
{
    if (busBusy(&baro->busdev, 
# 351 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                              ((void *)0)
# 351 "./src/main/drivers/barometer/barometer_bmp085.c"
                                  )) {
        return 
# 352 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
              0
# 352 "./src/main/drivers/barometer/barometer_bmp085.c"
                   ;
    }
    ...
    return 
# 358 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
          1
# 358 "./src/main/drivers/barometer/barometer_bmp085.c"
              ;
}
...
static 
# 396 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 396 "./src/main/drivers/barometer/barometer_bmp085.c"
           bmp085TestEOCConnected(baroDev_t *baro, const bmp085Config_t *config)
{
    (void)(config);
    ...
    if (!bmp085InitDone && eocIO) {
        ...
        if (IORead(eocIO)) {
            return 
# 404 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                  0
# 404 "./src/main/drivers/barometer/barometer_bmp085.c"
                       ;
        }
        ...
        if (status) {
            return 
# 413 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                  1
# 413 "./src/main/drivers/barometer/barometer_bmp085.c"
                      ;
        }
    }
    ...
    return 
# 420 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
          0
# 420 "./src/main/drivers/barometer/barometer_bmp085.c"
               ;
}
