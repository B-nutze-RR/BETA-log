...
{
    adcConfig->device = ((adcDeviceByInstance(((ADC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL)))) + 1);
    adcConfig->dmaopt[ADCDEV_1] = 8;


    adcConfig->dmaopt[ADCDEV_2] = ((-1));
    adcConfig->dmaopt[ADCDEV_3] = 9;
...
# 62 "./src/main/pg/adc.c" 3 4
                                  1
# 62 "./src/main/pg/adc.c"
                                      ;
    adcConfig->external1.ioTag = ((ioTag_t)((((2) + 1) << 4) | (5)));
...
# 67 "./src/main/pg/adc.c"
                                    ;
    adcConfig->current.ioTag = ((ioTag_t)((((2) + 1) << 4) | (0)));
...
# 72 "./src/main/pg/adc.c"
                                 ;
    adcConfig->rssi.ioTag = ((ioTag_t)((((2) + 1) << 4) | (4)));
