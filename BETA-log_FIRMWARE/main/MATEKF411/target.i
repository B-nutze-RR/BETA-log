# 1 "./src/main/target/MATEKF411/target.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/target/MATEKF411/target.c"
# 21 "./src/main/target/MATEKF411/target.c"
...
# 22 "./src/main/target/MATEKF411/target.c" 2
...
# 153 "./src/main/platform.h" 2
# 24 "./src/main/target/MATEKF411/target.c" 2
...
# 25 "./src/main/target/MATEKF411/target.c" 2
...
# 27 "./src/main/target/MATEKF411/target.c" 2
...
# 28 "./src/main/target/MATEKF411/target.c" 2


const timerHardware_t timerHardware[10] = {
    { ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4000)), ((ioTag_t)((((0) + 1) << 4) | (3))), ((uint16_t)0x0004), TIM_USE_PPM, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x03) , 
# 31 "./src/main/target/MATEKF411/target.c" 3 4
   ((void *)0)
# 31 "./src/main/target/MATEKF411/target.c"
   , ((uint32_t)0x00000000) , 
# 31 "./src/main/target/MATEKF411/target.c" 3 4
   ((void *)0)
# 31 "./src/main/target/MATEKF411/target.c"
   , ((uint32_t)0x00000000), 0 },
    ...
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)), ((ioTag_t)((((1) + 1) << 4) | (6))), ((uint16_t)0x0000), TIM_USE_MOTOR, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x02) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x010)), ((uint32_t)0x04000000) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0A0)), ((uint32_t)0x04000000), DMA1_ST6_HANDLER },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)), ((ioTag_t)((((1) + 1) << 4) | (7))), ((uint16_t)0x0004), TIM_USE_MOTOR, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x02) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058)), ((uint32_t)0x04000000) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0A0)), ((uint32_t)0x04000000), DMA1_ST6_HANDLER },

    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((ioTag_t)((((1) + 1) << 4) | (3))), ((uint16_t)0x0004), TIM_USE_MOTOR, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x01) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0A0)), ((uint32_t)0x06000000) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8)), ((uint32_t)0x06000000), DMA1_ST7_HANDLER },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((ioTag_t)((((1) + 1) << 4) | (10))), ((uint16_t)0x0008), TIM_USE_MOTOR, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x01) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x028)), ((uint32_t)0x06000000) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8)), ((uint32_t)0x06000000), DMA1_ST7_HANDLER },
    ...
    { ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)), ((ioTag_t)((((0) + 1) << 4) | (8))), ((uint16_t)0x0000), TIM_USE_LED, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x01) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0A0)), ((uint32_t)0x00000000) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088)), ((uint32_t)0x0C000000), DMA2_ST5_HANDLER },
};
