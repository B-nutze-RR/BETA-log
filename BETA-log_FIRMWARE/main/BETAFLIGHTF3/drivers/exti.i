...
void EXTIRelease(IO_t io)
{
    ...
    EXTIEnable(io, 
# 189 "./src/main/drivers/exti.c" 3 4
                  0
# 189 "./src/main/drivers/exti.c"
    ...
    extiChannelRec_t *rec = &extiChannelRecs[chIdx];
    rec->handler = 
# 198 "./src/main/drivers/exti.c" 3 4
                  ((void *)0)
# 198 "./src/main/drivers/exti.c"
                      ;
}

void EXTIEnable(IO_t io, 
# 201 "./src/main/drivers/exti.c" 3 4
                        _Bool 
# 201 "./src/main/drivers/exti.c"
                             enable)
{
# 217 "./src/main/drivers/exti.c"
...
{
    uint32_t exti_active = ((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->IMR) & (((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00000400))->PR)) & 0xFFFF;
