...
# 29 "./src/main/pg/sdio.c" 2

extern const sdioConfig_t pgResetTemplate_sdioConfig; sdioConfig_t sdioConfig_System; sdioConfig_t sdioConfig_Copy; extern const pgRegistry_t sdioConfig_Registry; const pgRegistry_t sdioConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 532 | (0 << 12), .length = 1, .size = sizeof(sdioConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&sdioConfig_System, .copy = (uint8_t*)&sdioConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_sdioConfig}, };

const sdioConfig_t pgResetTemplate_sdioConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .clockBypass = 0, .useCache = 0, .use4BitWidth = 
# 32 "./src/main/pg/sdio.c" 3 4
1
# 32 "./src/main/pg/sdio.c"
, .dmaopt = ((-1)), .device = ((SDIODEV_1) + 1), }
...
extern const sdioPinConfig_t pgResetTemplate_sdioPinConfig; sdioPinConfig_t sdioPinConfig_System; sdioPinConfig_t sdioPinConfig_Copy; extern const pgRegistry_t sdioPinConfig_Registry; const pgRegistry_t sdioPinConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 550 | (0 << 12), .length = 1, .size = sizeof(sdioPinConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&sdioPinConfig_System, .copy = (uint8_t*)&sdioPinConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_sdioPinConfig}, };

const sdioPinConfig_t pgResetTemplate_sdioPinConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .CKPin = ((ioTag_t)((((2) + 1) << 4) | (12))), .CMDPin = ((ioTag_t)((((3) + 1) << 4) | (2))), .D0Pin = ((ioTag_t)((((2) + 1) << 4) | (8))), .D1Pin = ((ioTag_t)((((2) + 1) << 4) | (9))), .D2Pin = ((ioTag_t)((((2) + 1) << 4) | (10))), .D3Pin = ((ioTag_t)((((2) + 1) << 4) | (11))), }
