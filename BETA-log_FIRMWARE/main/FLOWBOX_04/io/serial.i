...
static serialPortUsage_t serialPortUsageList[3];

const serialPortIdentifier_e serialPortIdentifiers[3] = {
...
void pgResetFn_serialConfig(serialConfig_t *serialConfig)
{
    ...
    serialPortConfig_t *serialRxUartConfig = serialFindPortConfigurationMutable(SERIAL_PORT_USART1);
...
const serialPortConfig_t *findNextSerialPortConfig(serialPortFunction_e function)
{
    while (findSerialPortConfigState.lastIndex < 3) {
