...
# 32 "./src/main/drivers/bus_quadspi.c" 2
...
# 33 "./src/main/drivers/bus_quadspi.c" 2
...
# 45 "./src/main/drivers/exti.h"
                             enable);
# 34 "./src/main/drivers/bus_quadspi.c" 2
...
# 35 "./src/main/drivers/bus_quadspi.c" 2
...
# 36 "./src/main/drivers/bus_quadspi.c" 2
...
# 38 "./src/main/drivers/bus_quadspi.c" 2

quadSpiDevice_t quadSpiDevice[1] = { 0 };

QUADSPIDevice quadSpiDeviceByInstance(QUADSPI_TypeDef *instance)
{

    if (instance == ((QUADSPI_TypeDef *) (((0x40000000UL) + 0x12000000UL) + 0x5000UL))) {
        return QUADSPIDEV_1;
    }
...
QUADSPI_TypeDef *quadSpiInstanceByDevice(QUADSPIDevice device)
{
    if (device == QUADSPIINVALID || device >= 1) {
        return 
# 55 "./src/main/drivers/bus_quadspi.c" 3 4
              ((void *)0)
# 55 "./src/main/drivers/bus_quadspi.c"
                  ;
    }
...
# 61 "./src/main/drivers/bus_quadspi.c" 3 4
_Bool 
# 61 "./src/main/drivers/bus_quadspi.c"
    quadSpiInit(QUADSPIDevice device)
{
    switch (device) {
    case QUADSPIINVALID:
        return 
# 65 "./src/main/drivers/bus_quadspi.c" 3 4
              0
# 65 "./src/main/drivers/bus_quadspi.c"
                   ;
    case QUADSPIDEV_1:

        quadSpiInitDevice(device);
        return 
# 69 "./src/main/drivers/bus_quadspi.c" 3 4
              1
# 69 "./src/main/drivers/bus_quadspi.c"
                  ;
    ...
    return 
# 74 "./src/main/drivers/bus_quadspi.c" 3 4
          0
# 74 "./src/main/drivers/bus_quadspi.c"
               ;
}
...
const quadSpiHardware_t quadSpiHardware[] = {
    ...
    {
        .device = QUADSPIDEV_1,
        .reg = ((QUADSPI_TypeDef *) (((0x40000000UL) + 0x12000000UL) + 0x5000UL)),
        .clkPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (2))), ((uint8_t)0x09) },
        },
        .bk1IO0Pins = {
            { ((ioTag_t)((((2) + 1) << 4) | (9))), ((uint8_t)0x09) },
            { ((ioTag_t)((((3) + 1) << 4) | (11))), ((uint8_t)0x09) },
            { ((ioTag_t)((((5) + 1) << 4) | (8))), ((uint8_t)0x0A) },
        },
        .bk1IO1Pins = {
            { ((ioTag_t)((((2) + 1) << 4) | (10))), ((uint8_t)0x09) },
            { ((ioTag_t)((((3) + 1) << 4) | (12))), ((uint8_t)0x09) },
            { ((ioTag_t)((((5) + 1) << 4) | (9))), ((uint8_t)0x0A) },
        },
        .bk1IO2Pins = {
            { ((ioTag_t)((((4) + 1) << 4) | (2))), ((uint8_t)0x09) },
            { ((ioTag_t)((((5) + 1) << 4) | (7))), ((uint8_t)0x09) },
        },
        .bk1IO3Pins = {
            { ((ioTag_t)((((0) + 1) << 4) | (1))), ((uint8_t)0x09) },
            { ((ioTag_t)((((3) + 1) << 4) | (13))), ((uint8_t)0x09) },
            { ((ioTag_t)((((5) + 1) << 4) | (6))), ((uint8_t)0x09) },
        },
        .bk1CSPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (6))), ((uint8_t)0x0A) },
            { ((ioTag_t)((((1) + 1) << 4) | (10))), ((uint8_t)0x09) },
            { ((ioTag_t)((((6) + 1) << 4) | (6))), ((uint8_t)0x0A) },
        },
        .bk2IO0Pins = {
            { ((ioTag_t)((((4) + 1) << 4) | (7))), ((uint8_t)0x0A) },

        },
        .bk2IO1Pins = {
            { ((ioTag_t)((((4) + 1) << 4) | (8))), ((uint8_t)0x0A) },

        },
        .bk2IO2Pins = {
            { ((ioTag_t)((((4) + 1) << 4) | (9))), ((uint8_t)0x0A) },
            { ((ioTag_t)((((6) + 1) << 4) | (9))), ((uint8_t)0x09) },
        },
        .bk2IO3Pins = {
            { ((ioTag_t)((((4) + 1) << 4) | (10))), ((uint8_t)0x0A) },
            { ((ioTag_t)((((6) + 1) << 4) | (14))), ((uint8_t)0x09) },
        },
        .bk2CSPins = {
            { ((ioTag_t)((((2) + 1) << 4) | (11))), ((uint8_t)0x09) },
        },
        .rcc = (((RCC_AHB3) << 5) | (16*(((0x1UL << (14U)))>65535L) + (8*((((0x1UL << (14U)))*1L >>16*(((0x1UL << (14U)))>65535L))>255) + (8 - 90/((((((0x1UL << (14U)))*1L >>16*(((0x1UL << (14U)))>65535L)) >>8*((((0x1UL << (14U)))*1L >>16*(((0x1UL << (14U)))>65535L))>255))/4+14)|1) - 2/(((((0x1UL << (14U)))*1L >>16*(((0x1UL << (14U)))>65535L)) >>8*((((0x1UL << (14U)))*1L >>16*(((0x1UL << (14U)))>65535L))>255))/2+1))))),
    },
...
{
    for (size_t hwindex = 0; hwindex < (sizeof(quadSpiHardware) / sizeof((quadSpiHardware)[0])); hwindex++) {
...
# 231 "./src/main/drivers/bus_quadspi.c" 3 4
       _Bool 
# 231 "./src/main/drivers/bus_quadspi.c"
            haveResources = 
# 231 "./src/main/drivers/bus_quadspi.c" 3 4
                            1
# 231 "./src/main/drivers/bus_quadspi.c"
...
# 239 "./src/main/drivers/bus_quadspi.c" 3 4
       _Bool 
# 239 "./src/main/drivers/bus_quadspi.c"
            needBK1 = (pConfig[device].mode == QUADSPI_MODE_DUAL_FLASH) || (pConfig[device].mode == QUADSPI_MODE_BK1_ONLY);
        if (needBK1) {
            
# 241 "./src/main/drivers/bus_quadspi.c" 3 4
           _Bool 
# 241 "./src/main/drivers/bus_quadspi.c"
                haveBK1Resources = pDev->bk1IO0 && pDev->bk1IO1 && pDev->bk1IO2 && pDev->bk1IO3 && pDev->bk1CS;
            haveResources = haveResources && haveBK1Resources;
        }

        
# 245 "./src/main/drivers/bus_quadspi.c" 3 4
       _Bool 
# 245 "./src/main/drivers/bus_quadspi.c"
            needBK2 = (pConfig[device].mode == QUADSPI_MODE_DUAL_FLASH) || (pConfig[device].mode == QUADSPI_MODE_BK2_ONLY);
        if (needBK2) {
            
# 247 "./src/main/drivers/bus_quadspi.c" 3 4
           _Bool 
# 247 "./src/main/drivers/bus_quadspi.c"
                haveBK2Resources = pDev->bk2IO0 && pDev->bk2IO1 && pDev->bk2IO2 && pDev->bk2IO3;
...
# 257 "./src/main/drivers/bus_quadspi.c" 3 4
       _Bool 
# 257 "./src/main/drivers/bus_quadspi.c"
            needBK2CS =
            (pConfig[device].mode == QUADSPI_MODE_DUAL_FLASH && (pConfig[device].csFlags & (1 << 4)) == (0 << 4)) ||
