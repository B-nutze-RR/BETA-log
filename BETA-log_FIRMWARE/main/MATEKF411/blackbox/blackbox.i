...
const blackboxConfig_t pgResetTemplate_blackboxConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .sample_rate = BLACKBOX_RATE_QUARTER, .device = BLACKBOX_DEVICE_SERIAL, .fields_disabled_mask = 0, .mode = BLACKBOX_MODE_NORMAL }
...
# 422 "./src/main/blackbox/blackbox.c"
    ...
    case FLIGHT_LOG_FIELD_CONDITION_MAG:
        ...
        return 
# 455 "./src/main/blackbox/blackbox.c" 3 4
              0
# 455 "./src/main/blackbox/blackbox.c"
                   ;
...
# 611 "./src/main/blackbox/blackbox.c"
...
# 759 "./src/main/blackbox/blackbox.c"
    if (testBlackboxCondition(FLIGHT_LOG_FIELD_CONDITION_BARO)) {
...
# 1436 "./src/main/blackbox/blackbox.c"
        ...
        case 73: blackboxPrintfHeaderLine("baro_hardware", "%d", barometerConfig()->baro_hardware); break;;




        case 74: blackboxPrintfHeaderLine("gyro_cal_on_first_arm", "%d", armingConfig()->gyro_cal_on_first_arm); break;;
        case 75: blackboxPrintfHeaderLine("rc_interpolation", "%d", rxConfig()->rcInterpolation); break;;
        case 76: blackboxPrintfHeaderLine("rc_interpolation_interval", "%d", rxConfig()->rcInterpolationInterval); break;;
        case 77: blackboxPrintfHeaderLine("rc_interpolation_channels", "%d", rxConfig()->rcInterpolationChannels); break;;
        case 78: blackboxPrintfHeaderLine("airmode_activate_throttle", "%d", rxConfig()->airModeActivateThreshold); break;;
        case 79: blackboxPrintfHeaderLine("serialrx_provider", "%d", rxConfig()->serialrx_provider); break;;
        case 80: blackboxPrintfHeaderLine("use_unsynced_pwm", "%d", motorConfig()->dev.useUnsyncedPwm); break;;
        case 81: blackboxPrintfHeaderLine("motor_pwm_protocol", "%d", motorConfig()->dev.motorPwmProtocol); break;;
        case 82: blackboxPrintfHeaderLine("motor_pwm_rate", "%d", motorConfig()->dev.motorPwmRate); break;;
        case 83: blackboxPrintfHeaderLine("dshot_idle_value", "%d", motorConfig()->digitalIdleOffsetValue); break;;
        case 84: blackboxPrintfHeaderLine("debug_mode", "%d", debugMode); break;;
        case 85: blackboxPrintfHeaderLine("features", "%d", featureConfig()->enabledFeatures); break;;
# 1470 "./src/main/blackbox/blackbox.c"
        case 86: blackboxPrintfHeaderLine("rates_type", "%d", currentControlRateProfile->rates_type); break;;

        case 87: blackboxPrintfHeaderLine("fields_disabled_mask", "%d", blackboxConfig()->fields_disabled_mask); break;;
...
# 1734 "./src/main/blackbox/blackbox.c"
    ...
    case BLACKBOX_STATE_SHUTTING_DOWN:
        ...
        break;
# 1819 "./src/main/blackbox/blackbox.c"
    default:
        break;
    }
