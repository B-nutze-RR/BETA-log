# 1 "./src/main/drivers/memprot_stm32h7xx.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/memprot_stm32h7xx.c"
# 21 "./src/main/drivers/memprot_stm32h7xx.c"
...
# 153 "./src/main/platform.h" 2
# 22 "./src/main/drivers/memprot_stm32h7xx.c" 2
...
# 24 "./src/main/drivers/memprot_stm32h7xx.c" 2
...
mpuRegion_t mpuRegions[] = {

    {
        ...
        .perm = ((uint8_t)0x06),
        .exec = ((uint8_t)0x00),
        .shareable = ((uint8_t)0x00),
        .cacheable = ((uint8_t)0x00),
        .bufferable = ((uint8_t)0x01),
    },

    {
        ...
        .perm = ((uint8_t)0x03),
        .exec = ((uint8_t)0x00),
        .shareable = ((uint8_t)0x01),
        .cacheable = ((uint8_t)0x01),
        .bufferable = ((uint8_t)0x00),
    },
...
unsigned mpuRegionCount = (sizeof(mpuRegions) / sizeof((mpuRegions)[0]));

_Static_assert(((sizeof(mpuRegions) / sizeof((mpuRegions)[0])) <= 8), "MPU_region_count_exceeds_limit");
