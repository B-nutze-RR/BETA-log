# 1 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c"
# 64 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c"
...
# 65 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c" 2
# 115 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c"
HAL_StatusTypeDef HAL_DACEx_DualStart(DAC_HandleTypeDef *hdac)
{
  ...
  if ((hdac->Instance->CR & ((0x1UL << (17U)) | (0xFUL << (18U)))) == (0x1UL << (17U)))
  {
    tmp_swtrig |= (0x1UL << (1U));
  }
...
# 189 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c"
HAL_StatusTypeDef HAL_DACEx_DualStart_DMA(DAC_HandleTypeDef *hdac, uint32_t Channel, uint32_t *pData, uint32_t Length,
                                          uint32_t Alignment)
{
...
# 298 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c"
HAL_StatusTypeDef HAL_DACEx_DualStop_DMA(DAC_HandleTypeDef *hdac, uint32_t Channel)
{
  HAL_StatusTypeDef status;
  ...
  ((hdac->Instance->CR) &= ~((0x1UL << (28U)) | (0x1UL << (12U))));
...
# 370 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c"
HAL_StatusTypeDef HAL_DACEx_TriangleWaveGenerate(DAC_HandleTypeDef *hdac, uint32_t Channel, uint32_t Amplitude)
{
...
# 419 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c"
HAL_StatusTypeDef HAL_DACEx_NoiseWaveGenerate(DAC_HandleTypeDef *hdac, uint32_t Channel, uint32_t Amplitude)
{
...
# 459 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c"
HAL_StatusTypeDef HAL_DACEx_DualSetValue(DAC_HandleTypeDef *hdac, uint32_t Alignment, uint32_t Data1, uint32_t Data2)
{
  uint32_t data;
  uint32_t tmp;
...
# 566 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c"
HAL_StatusTypeDef HAL_DACEx_SelfCalibrate(DAC_HandleTypeDef *hdac, DAC_ChannelConfTypeDef *sConfig, uint32_t Channel)
{
  ...
  if (hdac == 
# 582 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c" 3 4
             ((void *)0)
# 582 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c"
                 )
  {
    status = HAL_ERROR;
  }
  ...
  else
  {
    ...
    oldmodeconfiguration = (hdac->Instance->MCR & ((0x7UL << (0U)) << (Channel & 0x10UL)));


    (((hdac->Instance->CR)) &= ~(((0x1UL << (0U)) << (Channel & 0x10UL))));


    (((hdac->Instance->MCR)) = ((((((hdac->Instance->MCR))) & (~(((0x7UL << (0U)) << (Channel & 0x10UL))))) | (0U))));
    ...
    if (Channel == 0x00000000U)
    {
      tmp += (0x00000008UL + (0x00000000U));
    }
    else
    {
      tmp += (0x00000014UL + (0x00000000U));
    }

    *(volatile uint32_t *) tmp = 0x0800UL;
    ...
    while (delta != 0UL)
    {
      ...
      (((hdac->Instance->CCR)) = ((((((hdac->Instance->CCR))) & (~(((0x1FUL << (0U)) << (Channel & 0x10UL))))) | ((trimmingvalue << (Channel & 0x10UL))))));



      HAL_Delay(1);

      if ((hdac->Instance->SR & ((0x1UL << (14U)) << (Channel & 0x10UL))) == ((0x1UL << (14U)) << (Channel & 0x10UL)))
      {
    ...
    if ((hdac->Instance->SR & ((0x1UL << (14U)) << (Channel & 0x10UL))) == 0UL)
    {
    ...
    sConfig->DAC_UserTrimming = (0x00000001UL);


    (((hdac->Instance->MCR)) = ((((((hdac->Instance->MCR))) & (~(((0x7UL << (0U)) << (Channel & 0x10UL))))) | (oldmodeconfiguration))));
...
# 694 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c"
HAL_StatusTypeDef HAL_DACEx_SetUserTrimming(DAC_HandleTypeDef *hdac, DAC_ChannelConfTypeDef *sConfig, uint32_t Channel,
                                            uint32_t NewTrimmingValue)
{
  HAL_StatusTypeDef status = HAL_OK;
  ...
  if (hdac == 
# 704 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c" 3 4
             ((void *)0)
# 704 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c"
                 )
  {
    status = HAL_ERROR;
  }
  else
  {
    ...
    (((hdac->Instance->CCR)) = ((((((hdac->Instance->CCR))) & (~(((0x1FUL << (0U)) << (Channel & 0x10UL))))) | ((NewTrimmingValue << (Channel & 0x10UL))))));
...
# 736 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c"
uint32_t HAL_DACEx_GetTrimOffset(DAC_HandleTypeDef *hdac, uint32_t Channel)
{
  ...
  return ((hdac->Instance->CCR & ((0x1FUL << (0U)) << (Channel & 0x10UL))) >> (Channel & 0x10UL));
}
# 769 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c"
uint32_t HAL_DACEx_DualGetValue(DAC_HandleTypeDef *hdac)
{
  uint32_t tmp = 0UL;
...
# 801 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac_ex.c"
void DAC_DMAConvCpltCh2(DMA_HandleTypeDef *hdma)
{
