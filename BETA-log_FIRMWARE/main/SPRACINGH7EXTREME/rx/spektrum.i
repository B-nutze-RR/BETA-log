...
static uint8_t spektrumFrameStatus(rxRuntimeState_t *rxRuntimeState)
{
    ...
    if (rcFrameComplete) {
        rcFrameComplete = 
# 124 "./src/main/rx/spektrum.c" 3 4
                         0
# 124 "./src/main/rx/spektrum.c"
                              ;
...
# 195 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 195 "./src/main/rx/spektrum.c"
    spekShouldBind(uint8_t spektrum_sat_bind)
{
    ...
    if (BindPlug) {
        ...
        IOConfigGPIO(BindPlug, (((0x00000000U)) | (((0x00000000U)) << 2) | (((0x00000001U)) << 5)));


        delayMicroseconds(10);
        if (IORead(BindPlug)) {
            return 
# 207 "./src/main/rx/spektrum.c" 3 4
                  0
# 207 "./src/main/rx/spektrum.c"
                       ;
        }
    }
...
void spektrumBind(rxConfig_t *rxConfig)
{
    ...
    IOConfigGPIO(bindIO, (((0x00000001U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)));

    ledSet(1, 
# 270 "./src/main/rx/spektrum.c" 3 4
   1
# 270 "./src/main/rx/spektrum.c"
   );


    IOWrite(bindIO, 
# 273 "./src/main/rx/spektrum.c" 3 4
                   1
# 273 "./src/main/rx/spektrum.c"
                       );
...
# 280 "./src/main/rx/spektrum.c"
        ...
        ledSet(2, 
# 281 "./src/main/rx/spektrum.c" 3 4
       0
# 281 "./src/main/rx/spektrum.c"
       );

        IOWrite(bindIO, 
# 283 "./src/main/rx/spektrum.c" 3 4
                       0
# 283 "./src/main/rx/spektrum.c"
                            );
...
# 287 "./src/main/rx/spektrum.c"
        ...
        IOWrite(bindIO, 
# 289 "./src/main/rx/spektrum.c" 3 4
                       1
# 289 "./src/main/rx/spektrum.c"
                           );
        delayMicroseconds(120);
    ...
    if (rxConfig->spektrum_bind_pin_override_ioTag) {
        delay(50);
        IOConfigGPIO(bindIO, (((0x00000000U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)));
    }
    ...
    spektrumInit(const rxConfig_t *rxConfig, rxRuntimeState_t *rxRuntimeState)
{
    ...
    if (!portConfig) {
        return 
# 357 "./src/main/rx/spektrum.c" 3 4
              0
# 357 "./src/main/rx/spektrum.c"
                   ;
    }

    srxlEnabled = 
# 360 "./src/main/rx/spektrum.c" 3 4
                 0
...
# 364 "./src/main/rx/spektrum.c"
    ...
    case SERIALRX_SPEKTRUM2048:
        ...
        spek_chan_mask = 0x07;
        spekHiRes = 
# 380 "./src/main/rx/spektrum.c" 3 4
                   1
# 380 "./src/main/rx/spektrum.c"
                       ;
        resolution = 2048;
    ...
    case SERIALRX_SPEKTRUM1024:
        ...
        spek_chan_mask = 0x03;
        spekHiRes = 
# 389 "./src/main/rx/spektrum.c" 3 4
                   0
# 389 "./src/main/rx/spektrum.c"
                        ;
        resolution = 1024;
...
# 406 "./src/main/rx/spektrum.c" 3 4
       ((void *)0)
# 406 "./src/main/rx/spektrum.c"
           ,
        115200,
    ...
    return serialPort != 
# 424 "./src/main/rx/spektrum.c" 3 4
                        ((void *)0)
# 424 "./src/main/rx/spektrum.c"
                            ;
}


# 427 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 427 "./src/main/rx/spektrum.c"
    srxlRxIsActive(void)
{
    return serialPort != 
# 429 "./src/main/rx/spektrum.c" 3 4
                        ((void *)0)
# 429 "./src/main/rx/spektrum.c"
                            ;
}
