...
static 
# 101 "./src/main/flight/imu.c" 3 4
                  _Bool 
# 101 "./src/main/flight/imu.c"
...
# 206 "./src/main/flight/imu.c" 3 4
                               _Bool 
# 206 "./src/main/flight/imu.c"
                                    useAcc, float ax, float ay, float az,
                                
# 207 "./src/main/flight/imu.c" 3 4
                               _Bool 
# 207 "./src/main/flight/imu.c"
                                    useMag,
                                    ...
                                    useCOG, float courseOverGround, const float dcmKpGain)
{
    ...
    attitudeIsEstablished = 
# 328 "./src/main/flight/imu.c" 3 4
                           1
# 328 "./src/main/flight/imu.c"
                               ;
}
...
static 
# 352 "./src/main/flight/imu.c" 3 4
      _Bool 
# 352 "./src/main/flight/imu.c"
...
# 372 "./src/main/flight/imu.c" 3 4
                                                  _Bool 
# 372 "./src/main/flight/imu.c"
...
# 482 "./src/main/flight/imu.c" 3 4
   _Bool 
# 482 "./src/main/flight/imu.c"
        useMag = 
# 482 "./src/main/flight/imu.c" 3 4
                 0
# 482 "./src/main/flight/imu.c"
...
# 483 "./src/main/flight/imu.c"
    ...
    if (sensors(SENSOR_MAG) && compassIsHealthy()
        ...
        useMag = 
# 495 "./src/main/flight/imu.c" 3 4
                1
# 495 "./src/main/flight/imu.c"
                    ;
    }
...
# 598 "./src/main/flight/imu.c" 3 4
_Bool 
# 598 "./src/main/flight/imu.c"
    shouldInitializeGPSHeading()
{
    static 
# 600 "./src/main/flight/imu.c" 3 4
          _Bool 
# 600 "./src/main/flight/imu.c"
               initialized = 
# 600 "./src/main/flight/imu.c" 3 4
                             0
# 600 "./src/main/flight/imu.c"
...
# 603 "./src/main/flight/imu.c"
        ...
        return 
# 605 "./src/main/flight/imu.c" 3 4
              1
# 605 "./src/main/flight/imu.c"
                  ;
    }
...
# 666 "./src/main/flight/imu.c"

# 666 "./src/main/flight/imu.c" 3 4
_Bool 
# 666 "./src/main/flight/imu.c"
    imuQuaternionHeadfreeOffsetSet(void)
{
    if ((__extension__ ({ __typeof__ (attitude.values.roll) _x = (attitude.values.roll); _x > 0 ? _x : -_x; }) < 450) && (__extension__ ({ __typeof__ (attitude.values.pitch) _x = (attitude.values.pitch); _x > 0 ? _x : -_x; }) < 450)) {
        ...
        return 
# 676 "./src/main/flight/imu.c" 3 4
              1
# 676 "./src/main/flight/imu.c"
                  ;
    } else {
        return 
# 678 "./src/main/flight/imu.c" 3 4
              0
# 678 "./src/main/flight/imu.c"
                   ;
    }
}
...
# 715 "./src/main/flight/imu.c" 3 4
_Bool 
# 715 "./src/main/flight/imu.c"
    isUpright(void)
{
