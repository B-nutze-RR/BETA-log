# 1 "./src/main/drivers/serial_uart_stdperiph.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_uart_stdperiph.c"
# 32 "./src/main/drivers/serial_uart_stdperiph.c"
# 1 "c:\\dev\\9 2020-q2-update\\lib\\gcc\\arm-none-eabi\\9.3.1\\include\\stdbool.h" 1 3 4
# 33 "./src/main/drivers/serial_uart_stdperiph.c" 2
...
# 34 "./src/main/drivers/serial_uart_stdperiph.c" 2
...
# 153 "./src/main/platform.h" 2
# 36 "./src/main/drivers/serial_uart_stdperiph.c" 2
...
# 40 "./src/main/drivers/serial_uart_stdperiph.c" 2
...
# 41 "./src/main/drivers/serial_uart_stdperiph.c" 2
...
# 27 "./src/main/drivers/inverter.h"
                                               on);
# 44 "./src/main/drivers/serial_uart_stdperiph.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 45 "./src/main/drivers/serial_uart_stdperiph.c" 2
...
# 46 "./src/main/drivers/serial_uart_stdperiph.c" 2
...
# 49 "./src/main/drivers/serial_uart_stdperiph.c" 2
...
# 50 "./src/main/drivers/serial_uart_stdperiph.c" 2
...
# 55 "./src/main/drivers/serial_uart_stdperiph.c" 3 4
   _Bool 
# 55 "./src/main/drivers/serial_uart_stdperiph.c"
        inverted = uartPort->port.options & SERIAL_INVERTED;
# 65 "./src/main/drivers/serial_uart_stdperiph.c"
...
# 143 "./src/main/drivers/serial_uart_stdperiph.c"
            ...
            DMA_Init((DMA_Channel_TypeDef *)(uartPort->rxDMAResource), &DMA_InitStructure);
            DMA_Cmd((DMA_Channel_TypeDef *)(uartPort->rxDMAResource), ENABLE);
            USART_DMACmd(uartPort->USARTx, ((uint32_t)0x00000040), ENABLE);
            uartPort->rxDMAPos = DMA_GetCurrDataCounter((DMA_Channel_TypeDef *)(uartPort->rxDMAResource));
        } else {
            USART_ClearITPendingBit(uartPort->USARTx, ((uint32_t)0x00050105));
            USART_ITConfig(uartPort->USARTx, ((uint32_t)0x00050105), ENABLE);
            USART_ITConfig(uartPort->USARTx, ((uint32_t)0x00040104), ENABLE);
        }
    }
...
# 182 "./src/main/drivers/serial_uart_stdperiph.c"
            DMA_InitStructure.DMA_M2M = ((uint32_t)0x00000000);
            DMA_InitStructure.DMA_DIR = ((uint32_t)0x00000010);


            DMA_DeInit((DMA_Channel_TypeDef *)(uartPort->txDMAResource));
            DMA_Init((DMA_Channel_TypeDef *)(uartPort->txDMAResource), &DMA_InitStructure);




            DMA_ITConfig((DMA_Channel_TypeDef *)(uartPort->txDMAResource), ((uint32_t)0x00000002), ENABLE);


            DMA_SetCurrDataCounter((DMA_Channel_TypeDef *)(uartPort->txDMAResource), 0);
            USART_DMACmd(uartPort->USARTx, ((uint32_t)0x00000080), ENABLE);
        } else {
            USART_ITConfig(uartPort->USARTx, ((uint32_t)0x00070107), ENABLE);
        }
    }
...
void uartTryStartTxDMA(uartPort_t *s)
{
    ...
    for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        if ((((DMA_Channel_TypeDef *)(s->txDMAResource))->CCR & ((uint32_t)0x00000001))) {
        ...
        if (s->port.txBufferHead == s->port.txBufferTail) {
            ...
            s->txDMAEmpty = 
# 228 "./src/main/drivers/serial_uart_stdperiph.c" 3 4
                           1
# 228 "./src/main/drivers/serial_uart_stdperiph.c"
                               ;
            return;
        }
        ...
        ((DMA_Channel_TypeDef *)(s->txDMAResource))->CMAR = (uint32_t)&s->port.txBuffer[s->port.txBufferTail];


        if (s->port.txBufferHead > s->port.txBufferTail) {
            DMA_SetCurrDataCounter((DMA_Channel_TypeDef *)(s->txDMAResource), s->port.txBufferHead - s->port.txBufferTail);
            s->port.txBufferTail = s->port.txBufferHead;
        } else {
            DMA_SetCurrDataCounter((DMA_Channel_TypeDef *)(s->txDMAResource), s->port.txBufferSize - s->port.txBufferTail);
            s->port.txBufferTail = 0;
        }
        s->txDMAEmpty = 
# 247 "./src/main/drivers/serial_uart_stdperiph.c" 3 4
                       0
# 247 "./src/main/drivers/serial_uart_stdperiph.c"
                            ;
