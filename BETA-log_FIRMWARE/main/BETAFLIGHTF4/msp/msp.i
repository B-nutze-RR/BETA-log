...
# 63 "./src/main/osd/osd_elements.h" 3 4
_Bool 
# 63 "./src/main/osd/osd_elements.h"
    osdElementsNeedAccelerometer(void);
# 115 "./src/main/msp/msp.c" 2
...
# 28 "./src/main/osd/osd_warnings.h" 3 4
                                        _Bool 
# 28 "./src/main/osd/osd_warnings.h"
...
static 
# 227 "./src/main/msp/msp.c" 3 4
      _Bool 
# 227 "./src/main/msp/msp.c"
...
# 246 "./src/main/msp/msp.c" 3 4
                                  ((void *)0)
# 246 "./src/main/msp/msp.c"
                                      ;
...
# 263 "./src/main/msp/msp.c" 3 4
                                              ((void *)0)
# 263 "./src/main/msp/msp.c"
                                                  ;
}
...
# 270 "./src/main/msp/msp.c" 3 4
                                                      ((void *)0)
# 270 "./src/main/msp/msp.c"
                                                          , 
# 270 "./src/main/msp/msp.c" 3 4
                                                            ((void *)0)
# 270 "./src/main/msp/msp.c"
...
static void mspFcSetPassthroughCommand(sbuf_t *dst, sbuf_t *src, mspPostProcessFnPtr *mspPostProcessFn)
{
    ...
    case MSP_PASSTHROUGH_ESC_CASTLE:
        if (mspPassthroughArgument < getMotorCount() || (mspPassthroughMode == MSP_PASSTHROUGH_ESC_KISS && mspPassthroughArgument == 255)) {
            sbufWriteU8(dst, 1);
...
static void mspRebootFn(serialPort_t *serialPort)
{
    ...
    while (
# 382 "./src/main/msp/msp.c" 3 4
          1
# 382 "./src/main/msp/msp.c"
              ) ;
}
...
# 471 "./src/main/msp/msp.c" 3 4
                                                                                           _Bool 
# 471 "./src/main/msp/msp.c"
                                                                                                useLegacyFormat, 
# 471 "./src/main/msp/msp.c" 3 4
                                                                                                                 _Bool 
# 471 "./src/main/msp/msp.c"
...
static 
# 568 "./src/main/msp/msp.c" 3 4
      _Bool 
# 568 "./src/main/msp/msp.c"
           mspCommonProcessOutCommand(int16_t cmdMSP, sbuf_t *dst, mspPostProcessFnPtr *mspPostProcessFn)
{
    ...
    case 4:
    {
        ...
        sbufWriteU8(dst, 2);
# 612 "./src/main/msp/msp.c"
        uint8_t targetCapabilities = 0;

        targetCapabilities |= (1 << (0));


        targetCapabilities |= (1 << (1));
# 632 "./src/main/msp/msp.c"
...
# 687 "./src/main/msp/msp.c" 3 4
                                                           ((void *)0)
# 687 "./src/main/msp/msp.c"
                                                               )) {
...
# 940 "./src/main/msp/msp.c"
    ...
    default:
        return 
# 1004 "./src/main/msp/msp.c" 3 4
              0
# 1004 "./src/main/msp/msp.c"
                   ;
    }
    return 
# 1006 "./src/main/msp/msp.c" 3 4
          1
# 1006 "./src/main/msp/msp.c"
              ;
}

static 
# 1009 "./src/main/msp/msp.c" 3 4
      _Bool 
# 1009 "./src/main/msp/msp.c"
           mspProcessOutCommand(int16_t cmdMSP, sbuf_t *dst)
{
    
# 1011 "./src/main/msp/msp.c" 3 4
   _Bool 
# 1011 "./src/main/msp/msp.c"
        unsupportedCommand = 
# 1011 "./src/main/msp/msp.c" 3 4
                             0
# 1011 "./src/main/msp/msp.c"
...
# 1962 "./src/main/msp/msp.c"
    ...
    default:
        unsupportedCommand = 
# 1994 "./src/main/msp/msp.c" 3 4
                            1
# 1994 "./src/main/msp/msp.c"
                                ;
    }
...
# 2063 "./src/main/msp/msp.c"
            ...
            for (int i = 0; i < maxMSPs; i++) {
                ...
                mspFcProcessCommand(srcDesc, &packetIn, &packetOut, 
# 2077 "./src/main/msp/msp.c" 3 4
                                                                   ((void *)0)
# 2077 "./src/main/msp/msp.c"
                                                                       );
...
# 2159 "./src/main/msp/msp.c" 3 4
           _Bool 
# 2159 "./src/main/msp/msp.c"
                success = 
# 2159 "./src/main/msp/msp.c" 3 4
                          0
# 2159 "./src/main/msp/msp.c"
            ...
            if (!(armingFlags & (ARMED))) {
                ...
                success = resetEEPROM(
# 2164 "./src/main/msp/msp.c" 3 4
                                     0
# 2164 "./src/main/msp/msp.c"
                                          );
...
# 2190 "./src/main/msp/msp.c" 3 4
   _Bool 
# 2190 "./src/main/msp/msp.c"
        allowCompression = 
# 2190 "./src/main/msp/msp.c" 3 4
                           0
# 2190 "./src/main/msp/msp.c"
...
# 2191 "./src/main/msp/msp.c" 3 4
   _Bool 
# 2191 "./src/main/msp/msp.c"
        useLegacyFormat;
    if (dataSize >= sizeof(uint32_t) + sizeof(uint16_t)) {
        ...
        useLegacyFormat = 
# 2197 "./src/main/msp/msp.c" 3 4
                         0
# 2197 "./src/main/msp/msp.c"
                              ;
    } else {
        readLength = 128;
        useLegacyFormat = 
# 2200 "./src/main/msp/msp.c" 3 4
                         1
# 2200 "./src/main/msp/msp.c"
                             ;
    }
