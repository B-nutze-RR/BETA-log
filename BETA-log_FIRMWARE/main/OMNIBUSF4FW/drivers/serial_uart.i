...
# 69 "./src/main/drivers/serial_uart.c"
 volatile uint8_t uart1TxBuffer[1280]; volatile uint8_t uart1RxBuffer[128]; struct dummy_s;



 volatile uint8_t uart2TxBuffer[1280]; volatile uint8_t uart2RxBuffer[128]; struct dummy_s;



 volatile uint8_t uart3TxBuffer[1280]; volatile uint8_t uart3RxBuffer[128]; struct dummy_s;



 volatile uint8_t uart4TxBuffer[1280]; volatile uint8_t uart4RxBuffer[128]; struct dummy_s;
 ...
 volatile uint8_t uart6TxBuffer[1280]; volatile uint8_t uart6RxBuffer[128]; struct dummy_s;
...
static uint32_t uartTotalRxBytesWaiting(const serialPort_t *instance)
{
    ...
    if (s->rxDMAResource) {
        ...
        uint32_t rxDMAHead = DMA_GetCurrDataCounter((DMA_Stream_TypeDef *)(s->rxDMAResource));
...
static uint32_t uartTotalTxBytesFree(const serialPort_t *instance)
{
    ...
    if (s->txDMAResource) {
        ...
        bytesUsed += DMA_GetCurrDataCounter((DMA_Stream_TypeDef *)(s->txDMAResource));
