...
# 747 "./src/main/fc/core.c"
    ...
    {if (debugMode == (DEBUG_RX_TIMING)) {debug[(0)] = (__extension__ ({ __typeof__ (frameDeltaUs / 10) _a = (frameDeltaUs / 10); __typeof__ (
# 755 "./src/main/fc/core.c" 3 4
   (0x7fff)
# 755 "./src/main/fc/core.c"
   ) _b = (
# 755 "./src/main/fc/core.c" 3 4
   (0x7fff)
# 755 "./src/main/fc/core.c"
   ); _a < _b ? _a : _b; }));}};
    {if (debugMode == (DEBUG_RX_TIMING)) {debug[(1)] = (__extension__ ({ __typeof__ (frameAgeUs / 10) _a = (frameAgeUs / 10); __typeof__ (
# 756 "./src/main/fc/core.c" 3 4
   (0x7fff)
# 756 "./src/main/fc/core.c"
   ) _b = (
# 756 "./src/main/fc/core.c" 3 4
   (0x7fff)
# 756 "./src/main/fc/core.c"
    ...
    if (!calculateRxChannelsAndUpdateFailsafe(currentTimeUs)) {
        return 
# 759 "./src/main/fc/core.c" 3 4
              0
# 759 "./src/main/fc/core.c"
                   ;
    }
...
# 787 "./src/main/fc/core.c"
    ...
    if (throttleStatus == THROTTLE_LOW && !airmodeIsActivated && !launchControlActive) {
        pidSetItermReset(
# 793 "./src/main/fc/core.c" 3 4
                        1
# 793 "./src/main/fc/core.c"
                            );
        ...
        if (isUsingSticksForArming()) {
            if (throttleStatus == THROTTLE_LOW) {
                if ((autoDisarmDelayUs > 0) && (currentTimeUs > disarmAt)) {
                    ...
                    armedBeeperOn = 
# 910 "./src/main/fc/core.c" 3 4
                                   0
# 910 "./src/main/fc/core.c"
                                        ;
                } else {

                    beeper(BEEPER_ARMED);
                    armedBeeperOn = 
# 914 "./src/main/fc/core.c" 3 4
                                   1
# 914 "./src/main/fc/core.c"
                                       ;
                }
            } else {
                ...
                if (armedBeeperOn) {
                    beeperSilence();
                    armedBeeperOn = 
# 922 "./src/main/fc/core.c" 3 4
                                   0
# 922 "./src/main/fc/core.c"
                                        ;
                }
            }
        } else {
            ...
            if (throttleStatus == THROTTLE_LOW) {
                beeper(BEEPER_ARMED);
                armedBeeperOn = 
# 929 "./src/main/fc/core.c" 3 4
                               1
# 929 "./src/main/fc/core.c"
                                   ;
            } else if (armedBeeperOn) {
                beeperSilence();
                armedBeeperOn = 
# 932 "./src/main/fc/core.c" 3 4
                               0
# 932 "./src/main/fc/core.c"
                                    ;
            }
        }
    } else {
...
# 964 "./src/main/fc/core.c" 3 4
   _Bool 
# 964 "./src/main/fc/core.c"
        canUseHorizonMode = 
# 964 "./src/main/fc/core.c" 3 4
                            1
# 964 "./src/main/fc/core.c"
    ...
    if ((IS_RC_MODE_ACTIVE(BOXANGLE) || failsafeIsActive()) && (sensors(SENSOR_ACC))) {
        ...
        canUseHorizonMode = 
# 968 "./src/main/fc/core.c" 3 4
                           0
# 968 "./src/main/fc/core.c"
                                ;
...
# 999 "./src/main/fc/core.c" 3 4
       1
# 999 "./src/main/fc/core.c"
       );

        rescheduleTask(TASK_ATTITUDE, (1000000 / (500)));
    } else {
        ledSet(1, 
# 1003 "./src/main/fc/core.c" 3 4
       0
# 1003 "./src/main/fc/core.c"
       );
...
# 1084 "./src/main/fc/core.c"
    ...
    return 
# 1086 "./src/main/fc/core.c" 3 4
          1
# 1086 "./src/main/fc/core.c"
              ;
}

static __attribute__((section(".tcm_code"))) void subTaskPidController(timeUs_t currentTimeUs)
{
...
__attribute__((section(".tcm_code"))) void taskGyroSample(timeUs_t currentTimeUs)
{
    ((void)(currentTimeUs));
    gyroUpdate();
              ...
              gyroFilterReady(void)
{
    if (pidUpdateCounter % activePidLoopDenom == 0) {
        return 
# 1254 "./src/main/fc/core.c" 3 4
              1
# 1254 "./src/main/fc/core.c"
                  ;
    } else {
        return 
# 1256 "./src/main/fc/core.c" 3 4
              0
# 1256 "./src/main/fc/core.c"
                   ;
    }
}
              ...
              pidLoopReady(void)
{
    if ((pidUpdateCounter % activePidLoopDenom) == (activePidLoopDenom / 2)) {
        return 
# 1263 "./src/main/fc/core.c" 3 4
              1
# 1263 "./src/main/fc/core.c"
                  ;
    }
    return 
# 1265 "./src/main/fc/core.c" 3 4
          0
# 1265 "./src/main/fc/core.c"
               ;
}

__attribute__((section(".tcm_code"))) void taskFiltering(timeUs_t currentTimeUs)
{
...
__attribute__((section(".tcm_code"))) void taskMainPidLoop(timeUs_t currentTimeUs)
{
# 1287 "./src/main/fc/core.c"
    ...
    if (debugMode == DEBUG_CYCLETIME) {
        {if (debugMode == (DEBUG_CYCLETIME)) {debug[(0)] = (getTaskDeltaTimeUs(TASK_SELF));}};
        {if (debugMode == (DEBUG_CYCLETIME)) {debug[(1)] = (getAverageSystemLoadPercent());}};
    }
}


# 1300 "./src/main/fc/core.c" 3 4
_Bool 
# 1300 "./src/main/fc/core.c"
    isFlipOverAfterCrashActive(void)
{
...
# 1310 "./src/main/fc/core.c" 3 4
_Bool 
# 1310 "./src/main/fc/core.c"
    isTryingToArm()
{
...
# 1320 "./src/main/fc/core.c" 3 4
_Bool 
# 1320 "./src/main/fc/core.c"
    isLaunchControlActive(void)
{
