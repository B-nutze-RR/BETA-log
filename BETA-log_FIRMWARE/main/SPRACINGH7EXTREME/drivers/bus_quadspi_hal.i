# 1 "./src/main/drivers/bus_quadspi_hal.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/bus_quadspi_hal.c"
# 23 "./src/main/drivers/bus_quadspi_hal.c"
# 1 "c:\\dev\\9 2020-q2-update\\lib\\gcc\\arm-none-eabi\\9.3.1\\include\\stdbool.h" 1 3 4
# 24 "./src/main/drivers/bus_quadspi_hal.c" 2
...
# 25 "./src/main/drivers/bus_quadspi_hal.c" 2
...
# 153 "./src/main/platform.h" 2
# 27 "./src/main/drivers/bus_quadspi_hal.c" 2
...
# 26 "./src/main/drivers/bus_quadspi.h" 2
...
# 27 "./src/main/drivers/bus_quadspi.h" 2
...
# 29 "./src/main/drivers/bus_quadspi.h" 2
...
# 31 "./src/main/drivers/bus_quadspi_hal.c" 2
# 1 "./src/main/drivers/bus_quadspi_impl.h" 1
# 23 "./src/main/drivers/bus_quadspi_impl.h"
...
typedef struct quadSpiHardware_s {
    ...
    QUADSPI_TypeDef *reg;
    quadSpiPinDef_t clkPins[3];
    quadSpiPinDef_t bk1IO0Pins[3];
    quadSpiPinDef_t bk1IO1Pins[3];
    quadSpiPinDef_t bk1IO2Pins[3];
    quadSpiPinDef_t bk1IO3Pins[3];
    quadSpiPinDef_t bk1CSPins[3];
    quadSpiPinDef_t bk2IO0Pins[3];
    quadSpiPinDef_t bk2IO1Pins[3];
    quadSpiPinDef_t bk2IO2Pins[3];
    quadSpiPinDef_t bk2IO3Pins[3];
    quadSpiPinDef_t bk2CSPins[3];
...
# 33 "./src/main/drivers/bus_quadspi_hal.c" 2
...
# 34 "./src/main/drivers/bus_quadspi_hal.c" 2
...
# 35 "./src/main/drivers/bus_quadspi_hal.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 36 "./src/main/drivers/bus_quadspi_hal.c" 2
...
# 37 "./src/main/drivers/bus_quadspi_hal.c" 2
...
# 39 "./src/main/drivers/bus_quadspi_hal.c" 2
...
void quadSpiInitDevice(QUADSPIDevice device)
{
    ...
    IOInit(IOGetByTag(quadSpi->clk), OWNER_QUADSPI_CLK, (device + 1));
    IOInit(IOGetByTag(quadSpi->bk1IO0), OWNER_QUADSPI_BK1IO0, (device + 1));
    IOInit(IOGetByTag(quadSpi->bk1IO1), OWNER_QUADSPI_BK1IO1, (device + 1));
    IOInit(IOGetByTag(quadSpi->bk1IO2), OWNER_QUADSPI_BK1IO2, (device + 1));
    IOInit(IOGetByTag(quadSpi->bk1IO3), OWNER_QUADSPI_BK1IO3, (device + 1));
    IOInit(IOGetByTag(quadSpi->bk1CS), OWNER_QUADSPI_BK1CS, (device + 1));

    IOInit(IOGetByTag(quadSpi->bk2IO0), OWNER_QUADSPI_BK2IO0, (device + 1));
    IOInit(IOGetByTag(quadSpi->bk2IO1), OWNER_QUADSPI_BK2IO1, (device + 1));
    IOInit(IOGetByTag(quadSpi->bk2IO2), OWNER_QUADSPI_BK2IO2, (device + 1));
    IOInit(IOGetByTag(quadSpi->bk2IO3), OWNER_QUADSPI_BK2IO3, (device + 1));
    IOInit(IOGetByTag(quadSpi->bk2CS), OWNER_QUADSPI_BK2CS, (device + 1));




    IOConfigGPIOAF(IOGetByTag(quadSpi->clk), (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)), ((uint8_t)0x09));
    IOConfigGPIOAF(IOGetByTag(quadSpi->bk1IO0), (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)), quadSpi->bk1IO0AF);
    IOConfigGPIOAF(IOGetByTag(quadSpi->bk1IO1), (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)), quadSpi->bk1IO1AF);
    IOConfigGPIOAF(IOGetByTag(quadSpi->bk1IO2), (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)), quadSpi->bk1IO2AF);
    IOConfigGPIOAF(IOGetByTag(quadSpi->bk1IO3), (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)), quadSpi->bk1IO3AF);
    IOConfigGPIOAF(IOGetByTag(quadSpi->bk2IO0), (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)), quadSpi->bk2IO0AF);
    IOConfigGPIOAF(IOGetByTag(quadSpi->bk2IO1), (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)), quadSpi->bk2IO1AF);
    IOConfigGPIOAF(IOGetByTag(quadSpi->bk2IO2), (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)), quadSpi->bk2IO2AF);
    IOConfigGPIOAF(IOGetByTag(quadSpi->bk2IO3), (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)), quadSpi->bk2IO3AF);

    if ((quadSpiConfig(device)->csFlags & ((1 << 1) | (1 << 0))) == ((0 << 1) | (1 << 0))) {
        IOConfigGPIOAF(IOGetByTag(quadSpi->bk1CS), (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000001U)) << 5)), quadSpi->bk1CSAF);
    } else {
        IOConfigGPIO(IOGetByTag(quadSpi->bk1CS), (((0x00000001U)) | (((0x00000002U)) << 2) | (((0x00000001U)) << 5)));
    }

    if ((quadSpiConfig(device)->csFlags & ((1 << 3) | (1 << 2))) == ((0 << 3) | (1 << 2))) {
        IOConfigGPIOAF(IOGetByTag(quadSpi->bk2CS), (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000001U)) << 5)), quadSpi->bk2CSAF);
    } else {
        IOConfigGPIO(IOGetByTag(quadSpi->bk2CS), (((0x00000001U)) | (((0x00000002U)) << 2) | (((0x00000001U)) << 5)));
    }
    ...
    quadSpi->hquadSpi.Init.SampleShifting = 0x00000000U;
    quadSpi->hquadSpi.Init.FlashSize = 23;
    quadSpi->hquadSpi.Init.ChipSelectHighTime = 0x00000000U;
    quadSpi->hquadSpi.Init.ClockMode = 0x00000000U;

    switch (quadSpiConfig(device)->mode) {
    case QUADSPI_MODE_BK1_ONLY:
        quadSpi->hquadSpi.Init.FlashID = 0x00000000U;
        quadSpi->hquadSpi.Init.DualFlash = 0x00000000U;
        break;
    case QUADSPI_MODE_BK2_ONLY:
        quadSpi->hquadSpi.Init.FlashID = ((uint32_t)(0x1UL << (7U)));
        quadSpi->hquadSpi.Init.DualFlash = 0x00000000U;
        break;
    case QUADSPI_MODE_DUAL_FLASH:
        quadSpi->hquadSpi.Init.DualFlash = ((uint32_t)(0x1UL << (6U)));
        break;
    }
...
# 136 "./src/main/drivers/bus_quadspi_hal.c" 3 4
_Bool 
# 136 "./src/main/drivers/bus_quadspi_hal.c"
    quadSpiIsBusBusy(QUADSPI_TypeDef *instance)
{
    QUADSPIDevice device = quadSpiDeviceByInstance(instance);
    if(quadSpiDevice[device].hquadSpi.State == HAL_QSPI_STATE_BUSY)
        return 
# 140 "./src/main/drivers/bus_quadspi_hal.c" 3 4
              1
# 140 "./src/main/drivers/bus_quadspi_hal.c"
                  ;
    else
        return 
# 142 "./src/main/drivers/bus_quadspi_hal.c" 3 4
              0
# 142 "./src/main/drivers/bus_quadspi_hal.c"
                   ;
}
...
void quadSpiSelectDevice(QUADSPI_TypeDef *instance)
{
    ...
    switch(quadSpiConfig(device)->mode) {
    case QUADSPI_MODE_DUAL_FLASH:
        if ((quadSpiConfig(device)->csFlags & ((1 << 1) | (1 << 0))) == ((1 << 1) | (0 << 0))) {
            IOLo(bk1CS);
        }
        if ((quadSpiConfig(device)->csFlags & ((1 << 3) | (1 << 2))) == ((1 << 3) | (0 << 2))) {
            IOLo(bk2CS);
        }
        break;
    case QUADSPI_MODE_BK1_ONLY:
...
# 207 "./src/main/drivers/bus_quadspi_hal.c" 3 4
_Bool 
# 207 "./src/main/drivers/bus_quadspi_hal.c"
    quadSpiTransmit1LINE(QUADSPI_TypeDef *instance, uint8_t instruction, uint8_t dummyCycles, const uint8_t *out, int length)
{
    QUADSPIDevice device = quadSpiDeviceByInstance(instance);
    ...
    status = HAL_QSPI_Command(&quadSpiDevice[device].hquadSpi, &cmd, 10);
    
# 233 "./src/main/drivers/bus_quadspi_hal.c" 3 4
   _Bool 
# 233 "./src/main/drivers/bus_quadspi_hal.c"
        timeout = (status != HAL_OK);
    if (!timeout) {
        if (out && length > 0) {
            status = HAL_QSPI_Transmit(&quadSpiDevice[device].hquadSpi, (uint8_t *)out, 10);
            timeout = (status != HAL_OK);
        }
    }
    ...
    if (timeout) {
        ...
        return 
# 245 "./src/main/drivers/bus_quadspi_hal.c" 3 4
              0
# 245 "./src/main/drivers/bus_quadspi_hal.c"
                   ;
    }

    return 
# 248 "./src/main/drivers/bus_quadspi_hal.c" 3 4
          1
# 248 "./src/main/drivers/bus_quadspi_hal.c"
              ;
}


# 251 "./src/main/drivers/bus_quadspi_hal.c" 3 4
_Bool 
# 251 "./src/main/drivers/bus_quadspi_hal.c"
    quadSpiReceive1LINE(QUADSPI_TypeDef *instance, uint8_t instruction, uint8_t dummyCycles, uint8_t *in, int length)
{
    QUADSPIDevice device = quadSpiDeviceByInstance(instance);
    HAL_StatusTypeDef status;
...
# 272 "./src/main/drivers/bus_quadspi_hal.c" 3 4
   _Bool 
# 272 "./src/main/drivers/bus_quadspi_hal.c"
        timeout = (status != HAL_OK);
    if (!timeout) {
        status = HAL_QSPI_Receive(&quadSpiDevice[device].hquadSpi, in, 10);
    ...
    if (timeout) {
        quadSpiTimeoutUserCallback(instance);
        return 
# 283 "./src/main/drivers/bus_quadspi_hal.c" 3 4
              0
# 283 "./src/main/drivers/bus_quadspi_hal.c"
                   ;
    }

    return 
# 286 "./src/main/drivers/bus_quadspi_hal.c" 3 4
          1
# 286 "./src/main/drivers/bus_quadspi_hal.c"
              ;
}


# 289 "./src/main/drivers/bus_quadspi_hal.c" 3 4
_Bool 
# 289 "./src/main/drivers/bus_quadspi_hal.c"
    quadSpiReceiveWithAddress1LINE(QUADSPI_TypeDef *instance, uint8_t instruction, uint8_t dummyCycles, uint32_t address, uint8_t addressSize, uint8_t *in, int length)
{
    QUADSPIDevice device = quadSpiDeviceByInstance(instance);
    HAL_StatusTypeDef status;
...
# 312 "./src/main/drivers/bus_quadspi_hal.c" 3 4
   _Bool 
# 312 "./src/main/drivers/bus_quadspi_hal.c"
        timeout = (status != HAL_OK);
    if (!timeout) {
        status = HAL_QSPI_Receive(&quadSpiDevice[device].hquadSpi, in, 10);
        timeout = (status != HAL_OK);
    ...
    if (timeout) {
        quadSpiTimeoutUserCallback(instance);
        return 
# 322 "./src/main/drivers/bus_quadspi_hal.c" 3 4
              0
# 322 "./src/main/drivers/bus_quadspi_hal.c"
                   ;
    }

    return 
# 325 "./src/main/drivers/bus_quadspi_hal.c" 3 4
          1
# 325 "./src/main/drivers/bus_quadspi_hal.c"
              ;
}



# 329 "./src/main/drivers/bus_quadspi_hal.c" 3 4
_Bool 
# 329 "./src/main/drivers/bus_quadspi_hal.c"
    quadSpiReceiveWithAddress4LINES(QUADSPI_TypeDef *instance, uint8_t instruction, uint8_t dummyCycles, uint32_t address, uint8_t addressSize, uint8_t *in, int length)
{
    QUADSPIDevice device = quadSpiDeviceByInstance(instance);
    HAL_StatusTypeDef status;
...
# 352 "./src/main/drivers/bus_quadspi_hal.c" 3 4
   _Bool 
# 352 "./src/main/drivers/bus_quadspi_hal.c"
        timeout = (status != HAL_OK);
    if (!timeout) {
        status = HAL_QSPI_Receive(&quadSpiDevice[device].hquadSpi, in, 10);
        timeout = (status != HAL_OK);
    ...
    if (timeout) {
        quadSpiTimeoutUserCallback(instance);
        return 
# 362 "./src/main/drivers/bus_quadspi_hal.c" 3 4
              0
# 362 "./src/main/drivers/bus_quadspi_hal.c"
                   ;
    }

    return 
# 365 "./src/main/drivers/bus_quadspi_hal.c" 3 4
          1
# 365 "./src/main/drivers/bus_quadspi_hal.c"
              ;
}

# 367 "./src/main/drivers/bus_quadspi_hal.c" 3 4
_Bool 
# 367 "./src/main/drivers/bus_quadspi_hal.c"
    quadSpiTransmitWithAddress1LINE(QUADSPI_TypeDef *instance, uint8_t instruction, uint8_t dummyCycles, uint32_t address, uint8_t addressSize, const uint8_t *out, int length)
{
    QUADSPIDevice device = quadSpiDeviceByInstance(instance);
    HAL_StatusTypeDef status;
...
# 390 "./src/main/drivers/bus_quadspi_hal.c" 3 4
   _Bool 
# 390 "./src/main/drivers/bus_quadspi_hal.c"
        timeout = (status != HAL_OK);
    ...
    if (timeout) {
        quadSpiTimeoutUserCallback(instance);
        return 
# 401 "./src/main/drivers/bus_quadspi_hal.c" 3 4
              0
# 401 "./src/main/drivers/bus_quadspi_hal.c"
                   ;
    }

    return 
# 404 "./src/main/drivers/bus_quadspi_hal.c" 3 4
          1
# 404 "./src/main/drivers/bus_quadspi_hal.c"
              ;
}


# 407 "./src/main/drivers/bus_quadspi_hal.c" 3 4
_Bool 
# 407 "./src/main/drivers/bus_quadspi_hal.c"
    quadSpiInstructionWithAddress1LINE(QUADSPI_TypeDef *instance, uint8_t instruction, uint8_t dummyCycles, uint32_t address, uint8_t addressSize)
{
    QUADSPIDevice device = quadSpiDeviceByInstance(instance);
    HAL_StatusTypeDef status;
...
# 430 "./src/main/drivers/bus_quadspi_hal.c" 3 4
   _Bool 
# 430 "./src/main/drivers/bus_quadspi_hal.c"
        timeout = (status != HAL_OK);
    ...
    if (timeout) {
        quadSpiTimeoutUserCallback(instance);
        return 
# 436 "./src/main/drivers/bus_quadspi_hal.c" 3 4
              0
# 436 "./src/main/drivers/bus_quadspi_hal.c"
                   ;
    }


    return 
# 440 "./src/main/drivers/bus_quadspi_hal.c" 3 4
          1
# 440 "./src/main/drivers/bus_quadspi_hal.c"
              ;
}


# 443 "./src/main/drivers/bus_quadspi_hal.c" 3 4
_Bool 
# 443 "./src/main/drivers/bus_quadspi_hal.c"
    quadSpiInstructionWithData1LINE(QUADSPI_TypeDef *instance, uint8_t instruction, uint8_t dummyCycles, const uint8_t *out, int length)
{
    QUADSPIDevice device = quadSpiDeviceByInstance(instance);
    HAL_StatusTypeDef status;
...
# 464 "./src/main/drivers/bus_quadspi_hal.c" 3 4
   _Bool 
# 464 "./src/main/drivers/bus_quadspi_hal.c"
        timeout =(status != HAL_OK);
    ...
    if (timeout) {
        quadSpiTimeoutUserCallback(instance);
        return 
# 475 "./src/main/drivers/bus_quadspi_hal.c" 3 4
              0
# 475 "./src/main/drivers/bus_quadspi_hal.c"
                   ;
    }

    return 
# 478 "./src/main/drivers/bus_quadspi_hal.c" 3 4
          1
# 478 "./src/main/drivers/bus_quadspi_hal.c"
              ;
}
