...
const spiDefaultConfig_t spiDefaultConfig[] = {
    ...
    { SPIDEV_1, ((ioTag_t)((((1) + 1) << 4) | (3))), ((ioTag_t)((((1) + 1) << 4) | (4))), ((ioTag_t)((((1) + 1) << 4) | (5))), ((-1)), ((-1)) },
...
extern void pgResetFn_spiPinConfig(spiPinConfig_t *); spiPinConfig_t spiPinConfig_SystemArray[3]; spiPinConfig_t spiPinConfig_CopyArray[3]; extern const pgRegistry_t spiPinConfig_Registry; const pgRegistry_t spiPinConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 520 | (1 << 12), .length = 3, .size = (sizeof(spiPinConfig_t) * 3) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&spiPinConfig_SystemArray, .copy = (uint8_t*)&spiPinConfig_CopyArray, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_spiPinConfig}, };
