# 1 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
# 25 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
...
# 26 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c" 2
# 63 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
static HAL_StatusTypeDef RCCEx_PLL2_Config(RCC_PLL2InitTypeDef *pll2, uint32_t Divider);
static HAL_StatusTypeDef RCCEx_PLL3_Config(RCC_PLL3InitTypeDef *pll3, uint32_t Divider);
# 107 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit)
{
  uint32_t tmpreg;
  uint32_t tickstart;
  ...
  if(((PeriphClkInit->PeriphClockSelection) & (0x08000000U)) == (0x08000000U))
  {
...
# 391 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
  if(((PeriphClkInit->PeriphClockSelection) & (0x00000400U)) == (0x00000400U))
  {
    ...
    case (0x4UL << (21U)):
      ...
      break;
# 432 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
    default:
      ret = HAL_ERROR;
      break;
    }
  ...
  if(((PeriphClkInit->PeriphClockSelection) & (0x00000800U)) == (0x00000800U))
  {
    ...
    case (0x4UL << (24U)):
      ...
      break;
# 490 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
    default:
      ret = HAL_ERROR;
      break;
    }
...
# 605 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
...
# 804 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
...
# 1292 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
  ...
  if(((PeriphClkInit->PeriphClockSelection) & (0x20000000U)) == (0x20000000U))
  {
    if(RCCEx_PLL3_Config(&(PeriphClkInit->PLL3),2U)!=HAL_OK)
    {
      status=HAL_ERROR;
  ...
  if(((PeriphClkInit->PeriphClockSelection) & (0x10000000U)) == (0x10000000U))
  {
...
# 1550 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
  if(((PeriphClkInit->PeriphClockSelection) & (0x40000000U)) == (0x40000000U))
  {
  ...
  if(((PeriphClkInit->PeriphClockSelection) & (0x80000000U)) == (0x80000000U))
  {
...
# 1587 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit)
{
  ...
  PeriphClkInit->PeriphClockSelection =
                 ...
                 (0x00000100U) | (0x00001000U) | (0x00002000U) | (0x00004000U) |
          (0x00008000U) | (0x00010000U) | (0x00020000U) | (0x00040000U) |
          (0x00080000U) | (0x00100000U) | (0x00200000U) | (0x00400000U) |
          (0x00800000U) | (0x01000000U) | (0x08000000U) | (0x40000000U) |
          (0x80000000U);




PeriphClkInit->PeriphClockSelection |= (0x00000008U);
# 1611 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
  PeriphClkInit->PeriphClockSelection |= (0x00000200U);


  PeriphClkInit->PeriphClockSelection |= (0x00000400U);
  ...
  PeriphClkInit->PeriphClockSelection |= (0x02000000U);





  PeriphClkInit->PeriphClockSelection |= (0x10000000U);


  PeriphClkInit->PeriphClockSelection |= (0x20000000U);
...
# 1689 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
...
# 1744 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
...
# 1776 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
uint32_t HAL_RCCEx_GetPeriphCLKFreq(uint32_t PeriphClk)
{
      ...
      case (0x4UL << (0U)):
        {
          ...
          if(ckpclocksource== (0x00000000U))
          {

            frequency = ((uint32_t)64000000);
          }

          else if(ckpclocksource== (0x1UL << (28U)))
          {

            frequency = ((uint32_t)4000000);
          }

          else if (ckpclocksource== (0x2UL << (28U)))
          {
...
# 2086 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
  else if (PeriphClk == (0x00000400U))
    {
...
# 2457 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
uint32_t HAL_RCCEx_GetD1PCLK1Freq(void)
{
...
# 2498 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
void HAL_RCCEx_GetPLL2ClockFreq(PLL2_ClocksTypeDef* PLL2_Clocks)
{
  ...
  if (pll2m != 0U)
  {
    ...
    case (0x00000000U):
      ...
      {
        hsivalue = (((uint32_t)64000000) >> (((uint32_t)(((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->CR) & ((0x3UL << (3U))))))>> 3));
      ...
      {
        pll2vco = ((float_t)((uint32_t)64000000) / (float_t)pll2m) * ((float_t)(uint32_t)(((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->PLL2DIVR & (0x1FFUL << (0U))) + (fracn2/(float_t)0x2000) +(float_t)1 );
      }
      break;

    case (0x00000001U):
      pll2vco = ((float_t)((uint32_t)4000000) / (float_t)pll2m) * ((float_t)(uint32_t)(((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->PLL2DIVR & (0x1FFUL << (0U))) + (fracn2/(float_t)0x2000) +(float_t)1 );
      break;

    case (0x00000002U):
      pll2vco = ((float_t)8000000 / (float_t)pll2m) * ((float_t)(uint32_t)(((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->PLL2DIVR & (0x1FFUL << (0U))) + (fracn2/(float_t)0x2000) +(float_t)1 );
      break;
...
# 2567 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
void HAL_RCCEx_GetPLL3ClockFreq(PLL3_ClocksTypeDef* PLL3_Clocks)
{
  ...
  if (pll3m != 0U)
  {
    ...
    case (0x00000000U):
      ...
      {
        pll3vco = ((float_t)((uint32_t)64000000) / (float_t)pll3m) * ((float_t)(uint32_t)(((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->PLL3DIVR & (0x1FFUL << (0U))) + (fracn3/(float_t)0x2000) +(float_t)1 );
      }
      break;
    case (0x00000001U):
      pll3vco = ((float_t)((uint32_t)4000000) / (float_t)pll3m) * ((float_t)(uint32_t)(((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->PLL3DIVR & (0x1FFUL << (0U))) + (fracn3/(float_t)0x2000) +(float_t)1 );
      break;

    case (0x00000002U):
      pll3vco = ((float_t)8000000 / (float_t)pll3m) * ((float_t)(uint32_t)(((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->PLL3DIVR & (0x1FFUL << (0U))) + (fracn3/(float_t)0x2000) +(float_t)1 );
      break;
...
# 2635 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
void HAL_RCCEx_GetPLL1ClockFreq(PLL1_ClocksTypeDef* PLL1_Clocks)
{
  ...
  if (pll1m != 0U)
  {
    ...
    case (0x00000000U):
      ...
      {
        pll1vco = ((float_t)((uint32_t)64000000) / (float_t)pll1m) * ((float_t)(uint32_t)(((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->PLL1DIVR & (0x1FFUL << (0U))) + (fracn1/(float_t)0x2000) +(float_t)1 );
      }
      break;
    case (0x00000001U):
      pll1vco = ((float_t)((uint32_t)4000000) / (float_t)pll1m) * ((float_t)(uint32_t)(((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->PLL1DIVR & (0x1FFUL << (0U))) + (fracn1/(float_t)0x2000) +(float_t)1 );
      break;

    case (0x00000002U):
      pll1vco = ((float_t)8000000 / (float_t)pll1m) * ((float_t)(uint32_t)(((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->PLL1DIVR & (0x1FFUL << (0U))) + (fracn1/(float_t)0x2000) +(float_t)1 );
      break;
...
# 2696 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
uint32_t HAL_RCCEx_GetD1SysClockFreq(void)
{
...
# 2736 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
void HAL_RCCEx_EnableLSECSS(void)
{
...
# 2785 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
void HAL_RCCEx_WakeUpStopCLKConfig(uint32_t WakeUpClk)
{
  ((void)0);
...
# 2800 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
void HAL_RCCEx_KerWakeUpStopCLKConfig(uint32_t WakeUpClk)
{
  ((void)0);
...
# 2854 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
void HAL_RCCEx_WWDGxSysResetConfig(uint32_t RCC_WWDGx)
{
  ((void)0);
  ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->GCR) |= (RCC_WWDGx)) ;
}
# 2935 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
void HAL_RCCEx_CRSConfig(RCC_CRSInitTypeDef *pInit)
{
  uint32_t value;
...
# 3028 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
uint32_t HAL_RCCEx_CRSWaitSynchronization(uint32_t Timeout)
{
...
# 3214 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
...
# 3245 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
static HAL_StatusTypeDef RCCEx_PLL2_Config(RCC_PLL2InitTypeDef *pll2, uint32_t Divider)
{
...
# 3350 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c"
static HAL_StatusTypeDef RCCEx_PLL3_Config(RCC_PLL3InitTypeDef *pll3, uint32_t Divider)
{
  uint32_t tickstart;
  HAL_StatusTypeDef status = HAL_OK;
