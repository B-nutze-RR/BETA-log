# 1 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
# 301 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
...
# 302 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c" 2
# 358 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_Init(DAC_HandleTypeDef *hdac)
{

  if (hdac == 
# 361 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c" 3 4
             ((void *)0)
# 361 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
                 )
  {
    return HAL_ERROR;
  }
  ...
  {
# 389 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
...
HAL_StatusTypeDef HAL_DAC_DeInit(DAC_HandleTypeDef *hdac)
{
  ...
  if (hdac == 
# 422 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c" 3 4
             ((void *)0)
# 422 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
                 )
  {
    return HAL_ERROR;
  }
  ...
  hdac->State = HAL_DAC_STATE_BUSY;
# 442 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
...
# 522 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_Start(DAC_HandleTypeDef *hdac, uint32_t Channel)
{
  ...
  if (Channel == 0x00000000U)
  {
    ...
    if ((hdac->Instance->CR & ((0x1UL << (1U)) | (0xFUL << (2U)))) == ( (0x1UL << (1U))))
    {
  ...
  else
  {
    ...
    if ((hdac->Instance->CR & ((0x1UL << (17U)) | (0xFUL << (18U)))) == (( (0x1UL << (1U))) << (Channel & 0x10UL)))
    {
...
# 575 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_Stop(DAC_HandleTypeDef *hdac, uint32_t Channel)
{
...
# 607 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_Start_DMA(DAC_HandleTypeDef *hdac, uint32_t Channel, uint32_t *pData, uint32_t Length,
                                    uint32_t Alignment)
{
...
# 735 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_Stop_DMA(DAC_HandleTypeDef *hdac, uint32_t Channel)
{
  HAL_StatusTypeDef status;
...
# 792 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
void HAL_DAC_IRQHandler(DAC_HandleTypeDef *hdac)
{
...
# 863 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_SetValue(DAC_HandleTypeDef *hdac, uint32_t Channel, uint32_t Alignment, uint32_t Data)
{
...
# 982 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
uint32_t HAL_DAC_GetValue(DAC_HandleTypeDef *hdac, uint32_t Channel)
{
...
# 1009 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
HAL_StatusTypeDef HAL_DAC_ConfigChannel(DAC_HandleTypeDef *hdac, DAC_ChannelConfTypeDef *sConfig, uint32_t Channel)
{
  uint32_t tmpreg1;
  uint32_t tmpreg2;
  ...
  ((void)0);
  ((void)0);
  if ((sConfig->DAC_UserTrimming) == (0x00000001UL))
  {
    ((void)0);
  }
  ((void)0);
  if ((sConfig->DAC_SampleAndHold) == ((0x4UL << (0U))))
  {
    ((void)0);
    ((void)0);
    ((void)0);
  ...
  if (sConfig->DAC_SampleAndHold == ((0x4UL << (0U))))
  {
    ...
    if (Channel == 0x00000000U)
    {
      ...
      while (((hdac->Instance->SR) & (0x4001UL << (15U))) != 0UL)
      {

        if ((HAL_GetTick() - tickstart) > 1U)
        {

          ((hdac->ErrorCode) |= (0x08U));
    ...
    else
    {
      ...
      while (((hdac->Instance->SR) & (0x1UL << (31U))) != 0UL)
      {
    ...
    (((hdac->Instance->SHHR)) = ((((((hdac->Instance->SHHR))) & (~((0x3FFUL << (0U)) << (Channel & 0x10UL)))) | ((sConfig->DAC_SampleAndHoldConfig.DAC_HoldTime) << (Channel & 0x10UL)))));

    (((hdac->Instance->SHRR)) = ((((((hdac->Instance->SHRR))) & (~((0xFFUL << (0U)) << (Channel & 0x10UL)))) | ((sConfig->DAC_SampleAndHoldConfig.DAC_RefreshTime) << (Channel & 0x10UL)))));
  }
...

  {
    ...
    tmpreg1 &= ~(((uint32_t)((0x1FUL << (0U)))) << (Channel & 0x10UL));
  ...
  tmpreg1 &= ~(((uint32_t)((0x7UL << (0U)))) << (Channel & 0x10UL));

  if (sConfig->DAC_ConnectOnChipPeripheral == (1UL << 0))
  {
    connectOnChip = 0x00000000UL;
  }
  else if (sConfig->DAC_ConnectOnChipPeripheral == (1UL << 1))
  {
    connectOnChip = (0x1UL << (0U));
  }
  else
  {
    if (sConfig->DAC_OutputBuffer == 0x00000000U)
    {
      connectOnChip = (0x1UL << (0U));
    }
    else
  ...
  ((hdac->Instance->CR) &= ~((0x1UL << (14U)) << (Channel & 0x10UL)));


  tmpreg1 = hdac->Instance->CR;

  tmpreg1 &= ~(((uint32_t)((0xFUL << (8U)) | (0x3UL << (6U)) | (0xFUL << (2U)) | (0x1UL << (1U)))) << (Channel & 0x10UL));
...
# 1193 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
HAL_DAC_StateTypeDef HAL_DAC_GetState(DAC_HandleTypeDef *hdac)
{

  return hdac->State;
}
# 1206 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
uint32_t HAL_DAC_GetError(DAC_HandleTypeDef *hdac)
{
  return hdac->ErrorCode;
}
# 1466 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dac.c"
void DAC_DMAConvCpltCh1(DMA_HandleTypeDef *hdma)
{
