...
# 77 "./src/main/drivers/bus_i2c_impl.h"
...
# 49 "./src/main/drivers/bus_i2c_hal_init.c"
...
# 104 "./src/main/drivers/bus_i2c_hal_init.c"
    {
        .device = I2CDEV_1,
        .reg = ((I2C_TypeDef *) ((0x40000000UL) + 0x5400UL)),
        .sclPins = { { ((ioTag_t)((((1) + 1) << 4) | (6))), ((uint8_t)0x04) }, { ((ioTag_t)((((1) + 1) << 4) | (8))), ((uint8_t)0x04) } },
        .sdaPins = { { ((ioTag_t)((((1) + 1) << 4) | (7))), ((uint8_t)0x04) }, { ((ioTag_t)((((1) + 1) << 4) | (9))), ((uint8_t)0x04) } },
        .rcc = (((RCC_APB1L) << 5) | (16*(((0x1UL << (21U)))>65535L) + (8*((((0x1UL << (21U)))*1L >>16*(((0x1UL << (21U)))>65535L))>255) + (8 - 90/((((((0x1UL << (21U)))*1L >>16*(((0x1UL << (21U)))>65535L)) >>8*((((0x1UL << (21U)))*1L >>16*(((0x1UL << (21U)))>65535L))>255))/4+14)|1) - 2/(((((0x1UL << (21U)))*1L >>16*(((0x1UL << (21U)))>65535L)) >>8*((((0x1UL << (21U)))*1L >>16*(((0x1UL << (21U)))>65535L))>255))/2+1))))),
        .ev_irq = I2C1_EV_IRQn,
        .er_irq = I2C1_ER_IRQn,
    },
# 201 "./src/main/drivers/bus_i2c_hal_init.c"
};

i2cDevice_t i2cDevice[4];


static uint16_t trmax;
static uint16_t tfmax;
static uint8_t tsuDATmin;
static uint8_t thdDATmin;


static uint8_t tAFmin;
static uint8_t tAFmax;


static uint16_t tr = 100;
static uint16_t tf = 100;
static uint8_t tAF = 70;
...
void i2cInit(I2CDevice device)
{
    ...
    IOConfigGPIOAF(scl, pDev->pullUp ? (((0x00000012U)) | (((0x00000003U)) << 2) | (((0x00000001U)) << 5)) : (((0x00000012U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)), pDev->sclAF);
    IOConfigGPIOAF(sda, pDev->pullUp ? (((0x00000012U)) | (((0x00000003U)) << 2) | (((0x00000001U)) << 5)) : (((0x00000012U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)), pDev->sdaAF);
    ...
    uint32_t i2cPclk;
# 347 "./src/main/drivers/bus_i2c_hal_init.c"
    i2cPclk = (pHandle->Instance == ((I2C_TypeDef *) (((0x40000000UL) + 0x18000000UL) + 0x1C00UL))) ? HAL_RCCEx_GetD3PCLK1Freq() : HAL_RCC_GetPCLK1Freq();
    ...
    HAL_NVIC_SetPriority(hardware->er_irq, ((((((((0)<<(4-(7-(((uint32_t)0x00000005)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0))>>(4-(7-(((uint32_t)0x00000005)))))>>4), ((((((((0)<<(4-(7-(((uint32_t)0x00000005)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0))&(0x0f>>(7-(((uint32_t)0x00000005)))))>>4));
    HAL_NVIC_EnableIRQ(hardware->er_irq);
    HAL_NVIC_SetPriority(hardware->ev_irq, ((((((((0)<<(4-(7-(((uint32_t)0x00000005)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0))>>(4-(7-(((uint32_t)0x00000005)))))>>4), ((((((((0)<<(4-(7-(((uint32_t)0x00000005)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0))&(0x0f>>(7-(((uint32_t)0x00000005)))))>>4));
...
static void i2cUnstick(IO_t scl, IO_t sda)
{
    ...
    IOConfigGPIO(scl, (((0x00000011U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)));
    IOConfigGPIO(sda, (((0x00000011U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)));
