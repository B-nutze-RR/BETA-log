...
__attribute__((noinline)) float interpolatedSpApply(int axis, 
...
__attribute__((noinline)) float applyFfLimit(int axis, float value, float Kp, float currentPidSetpoint) {
    switch (axis) {
    case FD_ROLL:
