# 1 "./src/main/msc/usbd_storage_sdio.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/msc/usbd_storage_sdio.c"
# 30 "./src/main/msc/usbd_storage_sdio.c"
# 1 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\stdio.h" 1 3
# 29 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\stdio.h" 3
...
# 30 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\stdio.h" 2 3
...
# 45 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\sys\\cdefs.h" 3
...
# 46 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\sys\\cdefs.h" 2 3
...
# 36 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\stdio.h" 2 3
# 1 "c:\\dev\\9 2020-q2-update\\lib\\gcc\\arm-none-eabi\\9.3.1\\include\\stddef.h" 1 3 4
...
# 60 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\stdio.h" 3
...
# 61 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\stdio.h" 2 3
...
# 1 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\sys\\_stdint.h" 1 3
# 20 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\sys\\_stdint.h" 3
...
# 47 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\sys\\types.h" 2 3
...
# 21 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\stdint.h" 3 4
...
# 153 "./src/main/platform.h" 2
# 34 "./src/main/msc/usbd_storage_sdio.c" 2
...
# 40 "./src/main/msc/usbd_storage_sdio.c" 2
...
# 41 "./src/main/msc/usbd_storage_sdio.c" 2
...
# 67 "./src/main/drivers/light_led.h"
                         state);
# 43 "./src/main/msc/usbd_storage_sdio.c" 2
...
# 44 "./src/main/msc/usbd_storage_sdio.c" 2
...
# 45 "./src/main/msc/usbd_storage_sdio.c" 2
...
# 46 "./src/main/msc/usbd_storage_sdio.c" 2
...
# 50 "./src/main/msc/usbd_storage_sdio.c" 2
...
# 53 "./src/main/msc/usbd_storage_sdio.c" 2
...
# 32 "./src/main/msc/usbd_storage.h"
...
# 59 "./src/main/msc/usbd_storage_sdio.c" 2
# 76 "./src/main/msc/usbd_storage_sdio.c"
...
# 159 "./src/main/msc/usbd_storage_sdio.c"
static int8_t STORAGE_Init (uint8_t lun)
{

    const IO_t sd_det = IOGetByTag(sdcardConfig()->cardDetectTag);
    IOInit(sd_det, OWNER_SDCARD_DETECT, 0);
    IOConfigGPIO(sd_det, (((0x00000000U)) | (((0x00000000U)) << 2) | (((0x00000001U)) << 5)));

    ((void)(lun));
    ledSet(0, 
# 167 "./src/main/msc/usbd_storage_sdio.c" 3 4
   0
# 167 "./src/main/msc/usbd_storage_sdio.c"
   );
    ...
    SD_Initialize_LL((DMA_Stream_TypeDef *)dmaChannelSpec->ref);
...
# 201 "./src/main/msc/usbd_storage_sdio.c"
...
# 224 "./src/main/msc/usbd_storage_sdio.c"
static int8_t STORAGE_IsReady (uint8_t lun)
{
    ((void)(lun));
    int8_t ret = -1;
    if (SD_GetState() == 
# 228 "./src/main/msc/usbd_storage_sdio.c" 3 4
                        1 
# 228 "./src/main/msc/usbd_storage_sdio.c"
                             && sdcard_isInserted()) {
        ret = 0;
    }
    return ret;
}
# 241 "./src/main/msc/usbd_storage_sdio.c"
static int8_t STORAGE_IsWriteProtected (uint8_t lun)
{
    ((void)(lun));
    return 0;
}
# 254 "./src/main/msc/usbd_storage_sdio.c"
static int8_t STORAGE_Read (uint8_t lun,
                 uint8_t *buf,
                 uint32_t blk_addr,
                 uint16_t blk_len)
{
    ...
    if (SD_ReadBlocks_DMA(blk_addr, (uint32_t*) buf, 512, blk_len) == 0) {
        while (SD_CheckRead());
        while(SD_GetState() == 
# 266 "./src/main/msc/usbd_storage_sdio.c" 3 4
                              0
# 266 "./src/main/msc/usbd_storage_sdio.c"
                                   );
        mscSetActive();
        return 0;
    }
                  ...
                  uint16_t blk_len)
{
    ...
    if (SD_WriteBlocks_DMA(blk_addr, (uint32_t*) buf, 512, blk_len) == 0) {
        while (SD_CheckWrite());
        while(SD_GetState() == 
# 291 "./src/main/msc/usbd_storage_sdio.c" 3 4
                              0
# 291 "./src/main/msc/usbd_storage_sdio.c"
                                   );
        mscSetActive();
        return 0;
    }
