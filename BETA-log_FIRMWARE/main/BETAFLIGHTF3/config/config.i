...
# 94 "./src/main/config/config.c" 2

static 
# 95 "./src/main/config/config.c" 3 4
      _Bool 
# 95 "./src/main/config/config.c"
           configIsDirty;

static 
# 97 "./src/main/config/config.c" 3 4
      _Bool 
...
extern const systemConfig_t pgResetTemplate_systemConfig; systemConfig_t systemConfig_System; systemConfig_t systemConfig_Copy; extern const pgRegistry_t systemConfig_Registry; const pgRegistry_t systemConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 18 | (2 << 12), .length = 1, .size = sizeof(systemConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&systemConfig_System, .copy = (uint8_t*)&systemConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_systemConfig}, };
...
# 116 "./src/main/config/config.c" 3 4
1
...
0
# 116 "./src/main/config/config.c"
, .cpu_overclock = 0, .powerOnArmingGraceTime = 5, .boardIdentifier = "BFF3", .hseMhz = 0, .configurationState = CONFIGURATION_STATE_DEFAULTS_BARE, .schedulerOptimizeRate = SCHEDULER_OPTIMIZE_RATE_AUTO, .enableStickArming = 
# 116 "./src/main/config/config.c" 3 4
0
# 116 "./src/main/config/config.c"
, }
...
# 218 "./src/main/config/config.c" 3 4
                                                                      ((void *)0)
# 218 "./src/main/config/config.c"
                                                                          )
...
# 241 "./src/main/config/config.c"
    ...
    for (unsigned i = 0; i < 1; i++) {
        ...
        adjustFilterLimit(&pidProfilesMutable(i)->dterm_lowpass2_hz, 4000);
        adjustFilterLimit(&pidProfilesMutable(i)->dterm_notch_hz, 4000);
...
# 346 "./src/main/config/config.c" 3 4
                                                  0
# 346 "./src/main/config/config.c"
                                                       ;
    } else
    ...
    if (rxConfigMutable()->rssi_channel
        ...
        rxConfigMutable()->rssi_src_frame_errors = 
# 354 "./src/main/config/config.c" 3 4
                                                  0
# 354 "./src/main/config/config.c"
                                                       ;
    }
...
void validateAndFixGyroConfig(void)
{
    ...
    adjustFilterLimit(&gyroConfigMutable()->gyro_lowpass_hz, 4000);
    adjustFilterLimit(&gyroConfigMutable()->gyro_lowpass2_hz, 4000);
    adjustFilterLimit(&gyroConfigMutable()->gyro_soft_notch_hz_1, 4000);
    adjustFilterLimit(&gyroConfigMutable()->gyro_soft_notch_cutoff_1, 0);
    adjustFilterLimit(&gyroConfigMutable()->gyro_soft_notch_hz_2, 4000);
...
# 674 "./src/main/config/config.c" 3 4
           _Bool 
# 674 "./src/main/config/config.c"
                configuredMotorProtocolDshot = 
# 674 "./src/main/config/config.c" 3 4
                                               0
# 674 "./src/main/config/config.c"
    ...
    if (configuredLooptime > (1000000 / (2000))) {
...
# 734 "./src/main/config/config.c" 3 4
_Bool 
# 734 "./src/main/config/config.c"
    readEEPROM(void)
{
...
# 739 "./src/main/config/config.c" 3 4
   _Bool 
# 739 "./src/main/config/config.c"
        success = loadEEPROM();
...
void writeUnmodifiedConfigToEEPROM(void)
{
    ...
    resumeRxPwmPpmSignal();
    configIsDirty = 
# 761 "./src/main/config/config.c" 3 4
                   0
# 761 "./src/main/config/config.c"
                        ;
}
...
# 771 "./src/main/config/config.c" 3 4
_Bool 
# 771 "./src/main/config/config.c"
    resetEEPROM(
# 771 "./src/main/config/config.c" 3 4
                _Bool 
# 771 "./src/main/config/config.c"
                     useCustomDefaults)
{
    ...
    return 
# 788 "./src/main/config/config.c" 3 4
          1
# 788 "./src/main/config/config.c"
              ;
}
...
void ensureEEPROMStructureIsValid(void)
{
    ...
    resetEEPROM(
# 796 "./src/main/config/config.c" 3 4
               0
# 796 "./src/main/config/config.c"
                    );
}
...
# 811 "./src/main/config/config.c" 3 4
_Bool 
# 811 "./src/main/config/config.c"
    isConfigDirty(void)
{
