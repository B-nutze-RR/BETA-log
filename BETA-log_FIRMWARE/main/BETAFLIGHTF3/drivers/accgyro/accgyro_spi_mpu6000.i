...
void mpu6000SpiGyroInit(gyroDev_t *gyro)
{
    ...
    spiSetDivisor(gyro->bus.busdev_u.spi.instance, spiCalculateDivider(1000000));


    spiBusWriteRegister(&gyro->bus, 0x1A, mpuGyroDLPF(gyro));
    delayMicroseconds(1);

    spiSetDivisor(gyro->bus.busdev_u.spi.instance, spiCalculateDivider(20000000));
...
uint8_t mpu6000SpiDetect(const busDevice_t *bus)
{
    ...
    spiSetDivisor(bus->busdev_u.spi.instance, spiCalculateDivider(1000000));
    ...
    spiBusWriteRegister(bus, 0x68, 0x04 | 0x02 | 0x01);
    delay(100);
    ...
    spiSetDivisor(bus->busdev_u.spi.instance, spiCalculateDivider(20000000));
...
# 216 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 3 4
_Bool 
# 216 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c"
    mpu6000SpiAccDetect(accDev_t *acc)
{
    if (acc->mpuDetectionResult.sensor != MPU_60x0_SPI) {
        return 
# 219 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 3 4
              0
# 219 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c"
                   ;
    }
    ...
    return 
# 225 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 3 4
          1
# 225 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c"
              ;
}


# 228 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 3 4
_Bool 
# 228 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c"
    mpu6000SpiGyroDetect(gyroDev_t *gyro)
{
    if (gyro->mpuDetectionResult.sensor != MPU_60x0_SPI) {
        return 
# 231 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c" 3 4
              0
# 231 "./src/main/drivers/accgyro/accgyro_spi_mpu6000.c"
                   ;
    }
