...
{
    spiPreinitRegister(max7456Config->csTag, max7456Config->preInitOPU ? (((0x00000001U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)) : (((0x00000000U)) | (((0x00000000U)) << 2) | (((0x00000001U)) << 5)), 1);
}
...
# 487 "./src/main/drivers/max7456.c"
    ...
    if (osdm != 0x1B) {
        IOConfigGPIO(busdev->busdev_u.spi.csnPin, (((0x00000000U)) | (((0x00000000U)) << 2) | (((0x00000001U)) << 5)));
