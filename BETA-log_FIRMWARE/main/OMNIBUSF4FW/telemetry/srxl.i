...
# 56 "./src/main/rx/spektrum.h"
    srxlRxIsActive(void);
# 57 "./src/main/telemetry/srxl.c" 2
...
# 69 "./src/main/telemetry/srxl.c" 2
...
# 71 "./src/main/telemetry/srxl.c" 2
...
# 72 "./src/main/telemetry/srxl.c" 2
# 86 "./src/main/telemetry/srxl.c"
static 
# 86 "./src/main/telemetry/srxl.c" 3 4
      _Bool 
# 86 "./src/main/telemetry/srxl.c"
           srxlTelemetryEnabled;
static 
# 87 "./src/main/telemetry/srxl.c" 3 4
      _Bool 
# 87 "./src/main/telemetry/srxl.c"
           srxl2 = 
# 87 "./src/main/telemetry/srxl.c" 3 4
                   0
# 87 "./src/main/telemetry/srxl.c"
...
# 144 "./src/main/telemetry/srxl.c"

# 144 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 144 "./src/main/telemetry/srxl.c"
    srxlFrameQos(sbuf_t *dst, timeUs_t currentTimeUs)
{
    ...
    return 
# 154 "./src/main/telemetry/srxl.c" 3 4
          1
# 154 "./src/main/telemetry/srxl.c"
              ;
}
# 183 "./src/main/telemetry/srxl.c"
uint16_t getMotorAveragePeriod(void)
{
    ...
    if (escData != 
# 192 "./src/main/telemetry/srxl.c" 3 4
                  ((void *)0)
# 192 "./src/main/telemetry/srxl.c"
                      ) {
        rpm = escData->rpm;
    }
...
# 223 "./src/main/telemetry/srxl.c" 3 4
_Bool 
...
# 299 "./src/main/telemetry/srxl.c"

# 299 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 299 "./src/main/telemetry/srxl.c"
    srxlFrameGpsLoc(sbuf_t *dst, timeUs_t currentTimeUs)
{
    ...
    if (!featureIsEnabled(FEATURE_GPS) || !(stateFlags & (GPS_FIX)) || gpsSol.numSat < 6) {
        return 
# 308 "./src/main/telemetry/srxl.c" 3 4
              0
# 308 "./src/main/telemetry/srxl.c"
                   ;
    }
...
# 367 "./src/main/telemetry/srxl.c"

# 367 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 367 "./src/main/telemetry/srxl.c"
...
# 373 "./src/main/telemetry/srxl.c" 3 4
   _Bool 
# 373 "./src/main/telemetry/srxl.c"
        timeProvided = 
# 373 "./src/main/telemetry/srxl.c" 3 4
                       0
# 373 "./src/main/telemetry/srxl.c"
    ...
    if (!featureIsEnabled(FEATURE_GPS) || !(stateFlags & (GPS_FIX)) || gpsSol.numSat < 6) {
        return 
# 376 "./src/main/telemetry/srxl.c" 3 4
              0
# 376 "./src/main/telemetry/srxl.c"
                   ;
    }
    ...
    if (rtcHasTime()) {
        ...
        timeProvided = 
# 399 "./src/main/telemetry/srxl.c" 3 4
                      1
# 399 "./src/main/telemetry/srxl.c"
                          ;
    }
    ...
    return 
# 413 "./src/main/telemetry/srxl.c" 3 4
          1
# 413 "./src/main/telemetry/srxl.c"
              ;
}
# 440 "./src/main/telemetry/srxl.c"

# 440 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 440 "./src/main/telemetry/srxl.c"
...
# 468 "./src/main/telemetry/srxl.c"
    ...
    return 
# 470 "./src/main/telemetry/srxl.c" 3 4
          0
# 470 "./src/main/telemetry/srxl.c"
               ;
}
# 495 "./src/main/telemetry/srxl.c"
static char srxlTextBuff[(9)][(13)];
static 
# 496 "./src/main/telemetry/srxl.c" 3 4
      _Bool 
# 496 "./src/main/telemetry/srxl.c"
           lineSent[(9)];
...
int spektrumTmTextGenPutChar(uint8_t col, uint8_t row, char c)
{
    if (row < 9 && col < 12) {
        ...
        if (srxlTextBuff[row][col] != c) {
          ...
          lineSent[row] = 
# 507 "./src/main/telemetry/srxl.c" 3 4
                         0
# 507 "./src/main/telemetry/srxl.c"
                              ;
        }
    }
    return 0;
...
# 514 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 514 "./src/main/telemetry/srxl.c"
    srxlFrameText(sbuf_t *dst, timeUs_t currentTimeUs)
{
    ...
    lineSent[lineNo] = 
# 532 "./src/main/telemetry/srxl.c" 3 4
                      1
# 532 "./src/main/telemetry/srxl.c"
                          ;
    lineNo = (lineNo + 1) % (9);
    ...
    return 
# 538 "./src/main/telemetry/srxl.c" 3 4
          1
# 538 "./src/main/telemetry/srxl.c"
              ;
}
...
static void collectVtxTmData(spektrumVtx_t * vtx)
{
    ...
    unsigned vtxStatus;
    if (vtxDevice == 
# 553 "./src/main/telemetry/srxl.c" 3 4
                    ((void *)0) 
# 553 "./src/main/telemetry/srxl.c"
...
# 576 "./src/main/telemetry/srxl.c" 3 4
                                         ((void *)0)
# 576 "./src/main/telemetry/srxl.c"
                                             ;
        ...
        if (powerIndexTable != 
# 604 "./src/main/telemetry/srxl.c" 3 4
                              ((void *)0)
# 604 "./src/main/telemetry/srxl.c"
                                  ) {
            for (int i = 0; i < 8; i++)
...
# 650 "./src/main/telemetry/srxl.c"
static 
# 650 "./src/main/telemetry/srxl.c" 3 4
      _Bool 
# 650 "./src/main/telemetry/srxl.c"
           srxlFrameVTX(sbuf_t *dst, timeUs_t currentTimeUs)
{
    ...
    if ((vtxDeviceType != VTXDEV_UNKNOWN) && vtxDeviceType != VTXDEV_UNSUPPORTED) {
        ...
        if ((memcmp(&vtxSent, &vtx, sizeof(spektrumVtx_t)) != 0) ||
            ...
            return 
# 677 "./src/main/telemetry/srxl.c" 3 4
                  1
# 677 "./src/main/telemetry/srxl.c"
                      ;
        }
    }
    return 
# 680 "./src/main/telemetry/srxl.c" 3 4
          0
# 680 "./src/main/telemetry/srxl.c"
               ;
}
# 718 "./src/main/telemetry/srxl.c"
typedef 
# 718 "./src/main/telemetry/srxl.c" 3 4
       _Bool 
# 718 "./src/main/telemetry/srxl.c"
...
void initSrxlTelemetry(void)
{
  ...
  if (srxlRxIsActive()) {
    srxlTelemetryEnabled = 
# 778 "./src/main/telemetry/srxl.c" 3 4
                          1
# 778 "./src/main/telemetry/srxl.c"
                              ;
    srxl2 = 
# 779 "./src/main/telemetry/srxl.c" 3 4
           0
# 779 "./src/main/telemetry/srxl.c"
                ;

  } else if (srxl2RxIsActive()) {
    srxlTelemetryEnabled = 
# 782 "./src/main/telemetry/srxl.c" 3 4
                          1
# 782 "./src/main/telemetry/srxl.c"
                              ;
    srxl2 = 
# 783 "./src/main/telemetry/srxl.c" 3 4
           1
# 783 "./src/main/telemetry/srxl.c"
               ;

  } else {
    srxlTelemetryEnabled = 
# 786 "./src/main/telemetry/srxl.c" 3 4
                          0
# 786 "./src/main/telemetry/srxl.c"
                               ;
    srxl2 = 
# 787 "./src/main/telemetry/srxl.c" 3 4
           0
# 787 "./src/main/telemetry/srxl.c"
                ;
  }
 }


# 791 "./src/main/telemetry/srxl.c" 3 4
_Bool 
# 791 "./src/main/telemetry/srxl.c"
    checkSrxlTelemetryState(void)
{
