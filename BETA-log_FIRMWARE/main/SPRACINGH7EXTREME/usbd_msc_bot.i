# 1 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
# 27 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
...
void MSC_BOT_CplClrFeature(USBD_HandleTypeDef *pdev,
                            uint8_t epnum);
# 28 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c" 2
...
# 29 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c" 2
# 1 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_scsi.h" 1
# 30 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c" 2
# 79 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
static void MSC_BOT_SendData(USBD_HandleTypeDef *pdev, uint8_t *pbuf, uint32_t len);
static void MSC_BOT_CBW_Decode(USBD_HandleTypeDef *pdev);
static void MSC_BOT_Abort(USBD_HandleTypeDef *pdev);
# 98 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
void MSC_BOT_Init(USBD_HandleTypeDef *pdev)
{
  ...
  (void)USBD_LL_FlushEP(pdev, 0x01U);
  (void)USBD_LL_FlushEP(pdev, 0x81U);


  (void)USBD_LL_PrepareReceive(pdev, 0x01U, (uint8_t *)&hmsc->cbw,
                               31U);
}
...
void MSC_BOT_Reset(USBD_HandleTypeDef *pdev)
{
  ...
  (void)USBD_LL_ClearStallEP(pdev, 0x81U);
  (void)USBD_LL_ClearStallEP(pdev, 0x01U);
...
# 159 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
...
# 283 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
static void MSC_BOT_SendData(USBD_HandleTypeDef *pdev, uint8_t *pbuf, uint32_t len)
{
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef *)pdev->pMSC_ClassData;

  uint32_t length = __extension__ ({ __typeof__ (hmsc->cbw.dDataLength) _a = (hmsc->cbw.dDataLength); __typeof__ (len) _b = (len); _a < _b ? _a : _b; });

  hmsc->csw.dDataResidue -= len;
  hmsc->csw.bStatus = 0x00U;
  hmsc->bot_state = 4U;

  (void)USBD_LL_Transmit(pdev, 0x81U, pbuf, length);
}
# 303 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
void MSC_BOT_SendCSW(USBD_HandleTypeDef *pdev, uint8_t CSW_Status)
{
  ...
  (void)USBD_LL_Transmit(pdev, 0x81U, (uint8_t *)&hmsc->csw,
                         13U);
...
# 326 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
static void MSC_BOT_Abort(USBD_HandleTypeDef *pdev)
{
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef *)pdev->pMSC_ClassData;
  ...
  if ((hmsc->cbw.bmFlags == 0U) &&
      ...
      (hmsc->bot_status == 0U))
  {
    (void)USBD_LL_StallEP(pdev, 0x01U);
  }

  (void)USBD_LL_StallEP(pdev, 0x81U);
...
# 354 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
