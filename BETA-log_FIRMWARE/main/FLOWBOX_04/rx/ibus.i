...
static 
# 81 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 81 "./src/main/rx/ibus.c"
...
static void ibusDataReceive(uint16_t c, void *data)
{
    ...
    if (ibusFramePosition == ibusFrameSize - 1) {
        lastFrameTimeUs = now;
        ibusFrameDone = 
# 129 "./src/main/rx/ibus.c" 3 4
                       1
# 129 "./src/main/rx/ibus.c"
                           ;
    } else {
        ibusFramePosition++;
    }
...
static 
# 136 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 136 "./src/main/rx/ibus.c"
...
static 
# 150 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 150 "./src/main/rx/ibus.c"
           checksumIsOk(void) {
    if (ibusModel == 1 ) {
...
static uint8_t ibusFrameStatus(rxRuntimeState_t *rxRuntimeState)
{
    ...
    ibusFrameDone = 
# 181 "./src/main/rx/ibus.c" 3 4
                   0
# 181 "./src/main/rx/ibus.c"
                        ;
...
# 210 "./src/main/rx/ibus.c" 3 4
_Bool 
# 210 "./src/main/rx/ibus.c"
    ibusInit(const rxConfig_t *rxConfig, rxRuntimeState_t *rxRuntimeState)
{
    (void)(rxConfig);
    ibusSyncByte = 0;
    ...
    if (!portConfig) {
        return 
# 224 "./src/main/rx/ibus.c" 3 4
              0
# 224 "./src/main/rx/ibus.c"
                   ;
    }
...
# 238 "./src/main/rx/ibus.c" 3 4
       ((void *)0)
# 238 "./src/main/rx/ibus.c"
           ,
        115200,
    ...
    return ibusPort != 
# 250 "./src/main/rx/ibus.c" 3 4
                      ((void *)0)
# 250 "./src/main/rx/ibus.c"
                          ;
}
