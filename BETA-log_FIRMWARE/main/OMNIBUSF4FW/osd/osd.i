...
static 
# 123 "./src/main/osd/osd.c" 3 4
      _Bool 
# 123 "./src/main/osd/osd.c"
           showVisualBeeper = 
# 123 "./src/main/osd/osd.c" 3 4
                              0
# 123 "./src/main/osd/osd.c"
...
static 
# 135 "./src/main/osd/osd.c" 3 4
      _Bool 
# 135 "./src/main/osd/osd.c"
           osdIsReady;

static 
# 137 "./src/main/osd/osd.c" 3 4
      _Bool 
# 137 "./src/main/osd/osd.c"
...
int osdPrintFloat(char *buffer, char leadingSymbol, float value, char *formatString, unsigned decimalPlaces, 
# 193 "./src/main/osd/osd.c" 3 4
                                                                                                            _Bool 
# 193 "./src/main/osd/osd.c"
                                                                                                                 round, char trailingSymbol)
{
    char mask[7];
    int pos = 0;
...
void osdStatSetState(uint8_t statIndex, 
# 228 "./src/main/osd/osd.c" 3 4
                                       _Bool 
# 228 "./src/main/osd/osd.c"
                                            enabled)
{
    if (enabled) {
...
# 237 "./src/main/osd/osd.c" 3 4
_Bool 
# 237 "./src/main/osd/osd.c"
    osdStatGetState(uint8_t statIndex)
{
...
void osdWarnSetState(uint8_t warningIndex, 
# 242 "./src/main/osd/osd.c" 3 4
                                          _Bool 
# 242 "./src/main/osd/osd.c"
                                               enabled)
{
    if (enabled) {
...
# 251 "./src/main/osd/osd.c" 3 4
_Bool 
# 251 "./src/main/osd/osd.c"
    osdWarnGetState(uint8_t warningIndex)
{
...
# 322 "./src/main/osd/osd.c" 3 4
                                       1
# 322 "./src/main/osd/osd.c"
                                           );
    osdStatSetState(OSD_STAT_MIN_BATTERY, 
# 323 "./src/main/osd/osd.c" 3 4
                                         1
# 323 "./src/main/osd/osd.c"
                                             );
    osdStatSetState(OSD_STAT_MIN_RSSI, 
# 324 "./src/main/osd/osd.c" 3 4
                                      1
# 324 "./src/main/osd/osd.c"
                                          );
    osdStatSetState(OSD_STAT_MAX_CURRENT, 
# 325 "./src/main/osd/osd.c" 3 4
                                         1
# 325 "./src/main/osd/osd.c"
                                             );
    osdStatSetState(OSD_STAT_USED_MAH, 
# 326 "./src/main/osd/osd.c" 3 4
                                      1
# 326 "./src/main/osd/osd.c"
                                          );
...
# 329 "./src/main/osd/osd.c"
    ...
    for (int i=0; i < OSD_WARNING_COUNT; i++) {
        osdWarnSetState(i, 
# 335 "./src/main/osd/osd.c" 3 4
                          1
# 335 "./src/main/osd/osd.c"
                              );
    }

    osdWarnSetState(OSD_WARNING_RSSI, 
# 338 "./src/main/osd/osd.c" 3 4
                                     0
# 338 "./src/main/osd/osd.c"
                                          );
    osdWarnSetState(OSD_WARNING_LINK_QUALITY, 
# 339 "./src/main/osd/osd.c" 3 4
                                             0
# 339 "./src/main/osd/osd.c"
                                                  );
...
# 342 "./src/main/osd/osd.c" 3 4
                                         0
# 342 "./src/main/osd/osd.c"
                                              );
...
# 353 "./src/main/osd/osd.c" 3 4
                               (-0x7f - 1)
# 353 "./src/main/osd/osd.c"
                                                 ;
...
# 382 "./src/main/osd/osd.c" 3 4
                                     0
# 382 "./src/main/osd/osd.c"
                                          ;
...
static void osdCompleteInitialization(void)
{
    ...
    osdIsReady = 
# 460 "./src/main/osd/osd.c" 3 4
                1
# 460 "./src/main/osd/osd.c"
                    ;
}
...
# 476 "./src/main/osd/osd.c" 3 4
                                         1
# 476 "./src/main/osd/osd.c"
                                             )) {
...
# 879 "./src/main/osd/osd.c" 3 4
   _Bool 
# 879 "./src/main/osd/osd.c"
        displayLabel = 
# 879 "./src/main/osd/osd.c" 3 4
                       0
# 879 "./src/main/osd/osd.c"
    ...
    if (statsRowCount > 0) {
        ...
        int displayRows = __extension__ ({ __typeof__ (statsRowCount) _a = (statsRowCount); __typeof__ (availableRows) _b = (availableRows); _a < _b ? _a : _b; });
        if (statsRowCount < availableRows) {
            displayLabel = 
# 886 "./src/main/osd/osd.c" 3 4
                          1
# 886 "./src/main/osd/osd.c"
                              ;
            displayRows++;
        }
        top = (availableRows - displayRows) / 2;
    }
...
# 940 "./src/main/osd/osd.c"
                                      ;
    static 
# 941 "./src/main/osd/osd.c" 3 4
          _Bool 
# 941 "./src/main/osd/osd.c"
               osdStatsVisible = 
# 941 "./src/main/osd/osd.c" 3 4
                                 0
# 941 "./src/main/osd/osd.c"
    ...
    if (armState != (armingFlags & (ARMED))) {
        if ((armingFlags & (ARMED))) {
            osdStatsEnabled = 
# 947 "./src/main/osd/osd.c" 3 4
                             0
# 947 "./src/main/osd/osd.c"
                                  ;
            osdStatsVisible = 
# 948 "./src/main/osd/osd.c" 3 4
                             0
# 948 "./src/main/osd/osd.c"
                                  ;
            osdResetStats();
...
# 955 "./src/main/osd/osd.c"
    ...
    if ((armingFlags & (ARMED))) {
        ...
        if (displayIsGrabbed(osdDisplayPort)) {
            osdStatsEnabled = 
# 972 "./src/main/osd/osd.c" 3 4
                             0
# 972 "./src/main/osd/osd.c"
                                  ;
            resumeRefreshAt = 0;
            stats.armed_time = 0;
        } else {
            if (IS_RC_MODE_ACTIVE(BOXOSD) && osdStatsVisible) {
                osdStatsVisible = 
# 977 "./src/main/osd/osd.c" 3 4
                                 0
# 977 "./src/main/osd/osd.c"
                                      ;
                displayClearScreen(osdDisplayPort);
            } else if (!IS_RC_MODE_ACTIVE(BOXOSD)) {
                if (!osdStatsVisible) {
                    osdStatsVisible = 
# 981 "./src/main/osd/osd.c" 3 4
                                     1
# 981 "./src/main/osd/osd.c"
                                         ;
    ...
    if (resumeRefreshAt) {
        if (cmp32(currentTimeUs, resumeRefreshAt) < 0) {
            ...
            resumeRefreshAt = 0;
            osdStatsEnabled = 
# 1006 "./src/main/osd/osd.c" 3 4
                             0
# 1006 "./src/main/osd/osd.c"
                                  ;
            stats.armed_time = 0;
        }
    }
...
void osdUpdate(timeUs_t currentTimeUs)
{
    ...
    if (!osdIsReady) {
        if (!displayCheckReady(osdDisplayPort, 
# 1048 "./src/main/osd/osd.c" 3 4
                                              0
# 1048 "./src/main/osd/osd.c"
                                                   )) {
            return;
        }
    ...
    if (isBeeperOn()) {
        showVisualBeeper = 
# 1056 "./src/main/osd/osd.c" 3 4
                          1
# 1056 "./src/main/osd/osd.c"
                              ;
    }
# 1076 "./src/main/osd/osd.c"
    if (counter % 10 == 0) {
        osdRefresh(currentTimeUs);
        showVisualBeeper = 
# 1078 "./src/main/osd/osd.c" 3 4
                          0
# 1078 "./src/main/osd/osd.c"
                               ;
    } else {
...
void osdSuppressStats(
# 1096 "./src/main/osd/osd.c" 3 4
                     _Bool 
# 1096 "./src/main/osd/osd.c"
                          flag)
{
...
static 
# 1121 "./src/main/osd/osd.c" 3 4
      _Bool 
# 1121 "./src/main/osd/osd.c"
...
# 1127 "./src/main/osd/osd.c" 3 4
_Bool 
# 1127 "./src/main/osd/osd.c"
    osdNeedsAccelerometer(void)
{
