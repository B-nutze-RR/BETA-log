# 1 "./src/main/drivers/audio_stm32h7xx.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/audio_stm32h7xx.c"
# 21 "./src/main/drivers/audio_stm32h7xx.c"
# 1 "c:\\dev\\9 2020-q2-update\\lib\\gcc\\arm-none-eabi\\9.3.1\\include\\stdbool.h" 1 3 4
# 22 "./src/main/drivers/audio_stm32h7xx.c" 2
...
# 23 "./src/main/drivers/audio_stm32h7xx.c" 2
...
# 24 "./src/main/drivers/audio_stm32h7xx.c" 2
...
# 153 "./src/main/platform.h" 2
# 26 "./src/main/drivers/audio_stm32h7xx.c" 2
...
# 28 "./src/main/drivers/audio_stm32h7xx.c" 2
...
# 30 "./src/main/drivers/audio_stm32h7xx.c" 2
...
void audioSetupIO(void)
{
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->APB1LENR) |= ((0x1UL << (29U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->APB1LENR) & ((0x1UL << (29U)))); ((void)(tmpreg)); } while(0);
...
void audioGenerateWhiteNoise(void)
{
    ...
    sConfig.DAC_Trigger = ( (0x4UL << (2U)) | (0x1UL << (2U)) | (0x1UL << (1U)));
    sConfig.DAC_OutputBuffer = 0x00000000U;
    HAL_DAC_ConfigChannel(&hdac, &sConfig, 0x00000000U);

    HAL_DACEx_NoiseWaveGenerate(&hdac, 0x00000000U, ((0x8UL << (8U)) | (0x2UL << (8U)) ));
    HAL_DAC_SetValue(&hdac, 0x00000000U, 0x00000004U, 0xcd00);
