...
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_uart_stm32f30x.c"
# 30 "./src/main/drivers/serial_uart_stm32f30x.c"
...
# 45 "./src/main/drivers/serial_uart_stm32f30x.c" 2
...
# 46 "./src/main/drivers/serial_uart_stm32f30x.c" 2
# 98 "./src/main/drivers/serial_uart_stm32f30x.c"
const uartHardware_t uartHardware[(1 + 1 + 1 + 0 + 0 + 0 + 0 + 0 + 0)] = {
...

    {
        ...
        .rxDMAResource = (dmaResource_t *)0,
        .txDMAResource = (dmaResource_t *)0,
        .rxPins = { { ((ioTag_t)((((1) + 1) << 4) | (11))) }, { 0 }, { 0 } },
        .txPins = { { ((ioTag_t)((((1) + 1) << 4) | (10))) }, { 0 }, { 0 } },
...
# 200 "./src/main/drivers/serial_uart_stm32f30x.c"
};
...
void serialUARTInitIO(IO_t txIO, IO_t rxIO, portMode_e mode, portOptions_e options, uint8_t af, uint8_t index)
{
    if ((options & SERIAL_BIDIR) && txIO) {
        ioConfig_t ioCfg = ((GPIO_Mode_AF) | ((GPIO_Speed_Level_3) << 2) | ((((options & SERIAL_INVERTED) || (options & SERIAL_BIDIR_PP)) ? GPIO_OType_PP : GPIO_OType_OD) << 4) | (((options & SERIAL_INVERTED) ? GPIO_PuPd_DOWN : GPIO_PuPd_UP) << 5))
...
uartPort_t *serialUART(UARTDevice_e device, uint32_t baudRate, portMode_e mode, portOptions_e options)
{
    ...
    if (!uartDev) {
        return 
# 244 "./src/main/drivers/serial_uart_stm32f30x.c" 3 4
              ((void *)0)
# 244 "./src/main/drivers/serial_uart_stm32f30x.c"
                  ;
    }
...
void uartIrqHandler(uartPort_t *s)
{
    ...
    if (!s->rxDMAResource && (ISR & ((uint32_t)0x00000020))) {
    ...
    if (!s->txDMAResource && (ISR & ((uint32_t)0x00000080))) {
    ...
    if (ISR & ((uint32_t)0x00000010)) {
        if (s->port.idleCallback) {
            s->port.idleCallback();
        }

        USART_ClearITPendingBit(s->USARTx, ((uint32_t)0x00040104));
    }
}
