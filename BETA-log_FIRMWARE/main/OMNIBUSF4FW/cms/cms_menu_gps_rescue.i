...
# 177 "./src/main/cms/cms_menu_gps_rescue.c"
                                          , &(OSD_UINT16_t){ &gpsRescueConfig_angle, 0, 200 ,1 }, 0x10 },
    { "MIN DIST HOME   M", OME_UINT16, 
# 178 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                      ((void *)0)
# 178 "./src/main/cms/cms_menu_gps_rescue.c"
                                          , &(OSD_UINT16_t){ &gpsRescueConfig_minRescueDth, 50, 1000 ,1 }, 0x10 },
    { "INITAL ALT      M", OME_UINT16, 
# 179 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                      ((void *)0)
# 179 "./src/main/cms/cms_menu_gps_rescue.c"
                                          , &(OSD_UINT16_t){ &gpsRescueConfig_initialAltitudeM, 20, 100, 1 }, 0x10 },
    { "ALTITUDE MODE" , OME_TAB, 
# 180 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                   ((void *)0)
# 180 "./src/main/cms/cms_menu_gps_rescue.c"
                                       , &(OSD_TAB_t) { &gpsRescueConfig_altitudeMode, 2, lookupTableRescueAltitudeMode}, 0x10 },
    { "DESCENT DIST    M", OME_UINT16, 
# 181 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                      ((void *)0)
# 181 "./src/main/cms/cms_menu_gps_rescue.c"
                                          , &(OSD_UINT16_t){ &gpsRescueConfig_descentDistanceM, 30, 500, 1 }, 0x10 },
    { "LANDING ALT     M", OME_UINT16, 
# 182 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                      ((void *)0)
# 182 "./src/main/cms/cms_menu_gps_rescue.c"
                                          , &(OSD_UINT16_t){ &gpsRescueConfig_targetLandingAltitudeM, 3, 10, 1 }, 0x10 },
    { "LANDING DIST    M", OME_UINT16, 
# 183 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                      ((void *)0)
# 183 "./src/main/cms/cms_menu_gps_rescue.c"
                                          , &(OSD_UINT16_t){ &gpsRescueConfig_targetLandingDistanceM, 5, 15, 1 }, 0x10 },
    { "GROUND SPEED CM/S", OME_UINT16, 
# 184 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                      ((void *)0)
# 184 "./src/main/cms/cms_menu_gps_rescue.c"
                                          , &(OSD_UINT16_t){ &gpsRescueConfig_rescueGroundspeed, 30, 3000, 1 }, 0x10 },
    { "THROTTLE MIN", OME_UINT16, 
# 185 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                      ((void *)0)
# 185 "./src/main/cms/cms_menu_gps_rescue.c"
                                          , &(OSD_UINT16_t){ &gpsRescueConfig_throttleMin, 1000, 2000, 1 }, 0x10 },
    { "THROTTLE MAX", OME_UINT16, 
# 186 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                      ((void *)0)
# 186 "./src/main/cms/cms_menu_gps_rescue.c"
                                          , &(OSD_UINT16_t){ &gpsRescueConfig_throttleMax, 1000, 2000, 1 }, 0x10 },
    { "THROTTLE HOV", OME_UINT16, 
# 187 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                      ((void *)0)
# 187 "./src/main/cms/cms_menu_gps_rescue.c"
                                          , &(OSD_UINT16_t){ &gpsRescueConfig_throttleHover, 1000, 2000, 1 }, 0x10 },
    { "ASCEND RATE", OME_UINT16, 
# 188 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                      ((void *)0)
# 188 "./src/main/cms/cms_menu_gps_rescue.c"
                                          , &(OSD_UINT16_t){ &gpsRescueConfig_ascendRate, 100, 2500, 1 }, 0x10 },
    { "DESCEND RATE", OME_UINT16, 
# 189 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                      ((void *)0)
# 189 "./src/main/cms/cms_menu_gps_rescue.c"
                                          , &(OSD_UINT16_t){ &gpsRescueConfig_descendRate, 100, 500, 1 }, 0x10 },
    { "ARM WITHOUT FIX", OME_Bool, 
# 190 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                     ((void *)0)
# 190 "./src/main/cms/cms_menu_gps_rescue.c"
                                         , &gpsRescueConfig_allowArmingWithoutFix, 0x10 },
    { "MIN SATELITES", OME_UINT8, 
# 191 "./src/main/cms/cms_menu_gps_rescue.c" 3 4
                                     ((void *)0)
# 191 "./src/main/cms/cms_menu_gps_rescue.c"
                                         , &(OSD_UINT8_t){ &gpsRescueConfig_minSats, 5, 50, 1 }, 0x10 },
