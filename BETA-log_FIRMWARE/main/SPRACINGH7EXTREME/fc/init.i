...
# 52 "./src/main/drivers/bus_quadspi.h"
typedef enum {
...
# 105 "./src/main/drivers/bus_quadspi.h"
void quadSpiPreInit(void);


# 107 "./src/main/drivers/bus_quadspi.h" 3 4
_Bool 
# 107 "./src/main/drivers/bus_quadspi.h"
    quadSpiInit(QUADSPIDevice device);
void quadSpiSetDivisor(QUADSPI_TypeDef *instance, uint16_t divisor);


# 110 "./src/main/drivers/bus_quadspi.h" 3 4
_Bool 
# 110 "./src/main/drivers/bus_quadspi.h"
    quadSpiTransmit1LINE(QUADSPI_TypeDef *instance, uint8_t instruction, uint8_t dummyCycles, const uint8_t *out, int length);

# 111 "./src/main/drivers/bus_quadspi.h" 3 4
_Bool 
# 111 "./src/main/drivers/bus_quadspi.h"
    quadSpiReceive1LINE(QUADSPI_TypeDef *instance, uint8_t instruction, uint8_t dummyCycles, uint8_t *in, int length);


# 113 "./src/main/drivers/bus_quadspi.h" 3 4
_Bool 
# 113 "./src/main/drivers/bus_quadspi.h"
    quadSpiInstructionWithData1LINE(QUADSPI_TypeDef *instance, uint8_t instruction, uint8_t dummyCycles, const uint8_t *out, int length);


# 115 "./src/main/drivers/bus_quadspi.h" 3 4
_Bool 
# 115 "./src/main/drivers/bus_quadspi.h"
    quadSpiReceiveWithAddress1LINE(QUADSPI_TypeDef *instance, uint8_t instruction, uint8_t dummyCycles, uint32_t address, uint8_t addressSize, uint8_t *in, int length);

# 116 "./src/main/drivers/bus_quadspi.h" 3 4
_Bool 
# 116 "./src/main/drivers/bus_quadspi.h"
    quadSpiReceiveWithAddress4LINES(QUADSPI_TypeDef *instance, uint8_t instruction, uint8_t dummyCycles, uint32_t address, uint8_t addressSize, uint8_t *in, int length);

# 117 "./src/main/drivers/bus_quadspi.h" 3 4
_Bool 
# 117 "./src/main/drivers/bus_quadspi.h"
    quadSpiTransmitWithAddress1LINE(QUADSPI_TypeDef *instance, uint8_t instruction, uint8_t dummyCycles, uint32_t address, uint8_t addressSize, const uint8_t *out, int length);



# 120 "./src/main/drivers/bus_quadspi.h" 3 4
_Bool 
# 120 "./src/main/drivers/bus_quadspi.h"
    quadSpiInstructionWithAddress1LINE(QUADSPI_TypeDef *instance, uint8_t instruction, uint8_t dummyCycles, uint32_t address, uint8_t addressSize);
...
# 55 "./src/main/drivers/persistent.h"
...
# 36 "./src/main/drivers/vtx_common.h" 2
...
# 1 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc.h" 1
# 29 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc.h"
# 1 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_bot.h" 1
# 29 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_bot.h"
# 1 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h" 1
# 29 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h"
...
# 35 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\stdlib.h" 3
typedef struct
{
  int quot;
  int rem;
...
# 30 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h" 2
# 1 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_def.h" 1
# 163 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_def.h"
...
# 311 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_def.h"
...
# 31 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h" 2
# 1 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ioreq.h" 1
# 30 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ioreq.h"
# 1 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h" 1
# 31 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ioreq.h" 2
# 80 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ioreq.h"
...
# 32 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h" 2
# 1 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ctlreq.h" 1
# 76 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ctlreq.h"
...
# 33 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h" 2
# 85 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h"
...
# 30 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_bot.h" 2
# 80 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_bot.h"
typedef struct
{
  uint32_t dSignature;
  uint32_t dTag;
...
# 119 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_bot.h"
...
void MSC_BOT_CplClrFeature(USBD_HandleTypeDef *pdev,
                            uint8_t epnum);
# 30 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc.h" 2
# 1 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_scsi.h" 1
# 29 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_scsi.h"
# 1 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_def.h" 1
# 30 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_scsi.h" 2
# 122 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_scsi.h"
...
# 158 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc_scsi.h"
int8_t SCSI_ProcessCmd(USBD_HandleTypeDef *pdev, uint8_t lun, uint8_t *cmd);

void SCSI_SenseCode(USBD_HandleTypeDef *pdev, uint8_t lun, uint8_t sKey,
                    uint8_t ASC);
# 31 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc.h" 2
# 1 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_ioreq.h" 1
# 32 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc.h" 2
# 69 "./lib/main/STM32H7/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Inc/usbd_msc.h"
...
# 120 "./src/main/msp/msp_serial.h" 3 4
_Bool 
# 120 "./src/main/msp/msp_serial.h"
...
extern spiPinConfig_t spiPinConfig_SystemArray[6]; extern spiPinConfig_t spiPinConfig_CopyArray[6]; static inline const spiPinConfig_t* spiPinConfig(int _index) { return &spiPinConfig_SystemArray[_index]; } static inline spiPinConfig_t* spiPinConfigMutable(int _index) { return &spiPinConfig_SystemArray[_index]; } static inline spiPinConfig_t (* spiPinConfig_array(void))[6] { return &spiPinConfig_SystemArray; } struct _dummy;
# 140 "./src/main/fc/init.c" 2
# 1 "./src/main/pg/bus_quadspi.h" 1
# 21 "./src/main/pg/bus_quadspi.h"
       
# 30 "./src/main/pg/bus_quadspi.h"
...
extern quadSpiConfig_t quadSpiConfig_SystemArray[1]; extern quadSpiConfig_t quadSpiConfig_CopyArray[1]; static inline const quadSpiConfig_t* quadSpiConfig(int _index) { return &quadSpiConfig_SystemArray[_index]; } static inline quadSpiConfig_t* quadSpiConfigMutable(int _index) { return &quadSpiConfig_SystemArray[_index]; } static inline quadSpiConfig_t (* quadSpiConfig_array(void))[1] { return &quadSpiConfig_SystemArray; } struct _dummy;
# 141 "./src/main/fc/init.c" 2
...
# 171 "./src/main/fc/init.c" 2
# 184 "./src/main/fc/init.c"
uint8_t systemState = SYSTEM_STATE_INITIALISING;

void processLoopback(void)
{
# 197 "./src/main/fc/init.c"
}
# 213 "./src/main/fc/init.c"

# 213 "./src/main/fc/init.c" 3 4
_Bool 
# 213 "./src/main/fc/init.c"
    requiresSpiLeadingEdge(SPIDevice device)
{


    ((void)(device));
# 245 "./src/main/fc/init.c"
    return 
# 245 "./src/main/fc/init.c" 3 4
          0
# 245 "./src/main/fc/init.c"
               ;
}
...
# 422 "./src/main/fc/init.c" 3 4
   _Bool 
# 422 "./src/main/fc/init.c"
        haveFlash = flashInit(flashConfig());
...
# 435 "./src/main/fc/init.c" 3 4
   _Bool 
# 435 "./src/main/fc/init.c"
    ...
    if (!readSuccess || !isEEPROMVersionValid() || strncasecmp(systemConfig()->boardIdentifier, "SP7E", sizeof("SP7E"))) {
        resetEEPROM(
# 442 "./src/main/fc/init.c" 3 4
                   0
# 442 "./src/main/fc/init.c"
                        );
    }
    ...
    ledSet(2, 
# 475 "./src/main/fc/init.c" 3 4
   1
# 475 "./src/main/fc/init.c"
   );
...
# 494 "./src/main/fc/init.c"
    if ((!isMPUSoftReset())) {


        uint8_t secondsRemaining = 5;
        
# 498 "./src/main/fc/init.c" 3 4
       _Bool 
# 498 "./src/main/fc/init.c"
            bothButtonsHeld;
        do {
            ...
            if (bothButtonsHeld) {
                if (--secondsRemaining == 0) {
                    resetEEPROM(
# 503 "./src/main/fc/init.c" 3 4
                               0
# 503 "./src/main/fc/init.c"
                                    );
...
# 638 "./src/main/fc/init.c"
    ...
    i2cInit(I2CDEV_1);
# 699 "./src/main/fc/init.c"
    
# 699 "./src/main/fc/init.c" 3 4
   _Bool 
# 699 "./src/main/fc/init.c"
        useRTC6705 = rtc6705IOInit(vtxIOConfig());
    ...
    if (!sensorsAutodetect()) {
        ...
        if (
# 714 "./src/main/fc/init.c" 3 4
           1



            
# 718 "./src/main/fc/init.c"
           ) {
    ...
    ledSet(1, 
# 767 "./src/main/fc/init.c" 3 4
   1
# 767 "./src/main/fc/init.c"
   );
    ledSet(0, 
# 768 "./src/main/fc/init.c" 3 4
   0
# 768 "./src/main/fc/init.c"
   );
    ledSet(2, 
# 769 "./src/main/fc/init.c" 3 4
   0
# 769 "./src/main/fc/init.c"
   );
    ...
    for (int i = 0; i < 10; i++) {
        ...
        if (!(beeperConfig()->beeper_off_flags & (1 << (BEEPER_SYSTEM_INIT - 1)))) {
            systemBeep(
# 777 "./src/main/fc/init.c" 3 4
           1
# 777 "./src/main/fc/init.c"
           );
        }
        delay(25);
        systemBeep(
# 780 "./src/main/fc/init.c" 3 4
       0
# 780 "./src/main/fc/init.c"
       );
    ...
    ledSet(0, 
# 785 "./src/main/fc/init.c" 3 4
   0
# 785 "./src/main/fc/init.c"
   );
    ledSet(1, 
# 786 "./src/main/fc/init.c" 3 4
   0
# 786 "./src/main/fc/init.c"
   );
