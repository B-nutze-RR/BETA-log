...
# 30 "./src/main/drivers/transponder_ir_io_hal.c" 2
...
# 31 "./src/main/drivers/transponder_ir_io_hal.c" 2

# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 33 "./src/main/drivers/transponder_ir_io_hal.c" 2
...
# 34 "./src/main/drivers/transponder_ir_io_hal.c" 2
...
# 24 "./src/main/drivers/transponder_ir_arcitimer.h" 2
# 39 "./src/main/drivers/transponder_ir_arcitimer.h"
...
# 36 "./src/main/drivers/transponder_ir_io_hal.c" 2
...
# 37 "./src/main/drivers/transponder_ir_io_hal.c" 2
...
# 38 "./src/main/drivers/transponder_ir_io_hal.c" 2
...
__attribute__((section(".DMA_RAM"))) transponder_t transponder;
...
# 60 "./src/main/drivers/transponder_ir_io_hal.c" 3 4
_Bool 
# 60 "./src/main/drivers/transponder_ir_io_hal.c"
...
void transponderIrHardwareInit(ioTag_t ioTag, transponder_t *transponder)
{
    ...
    if (dmaSpec == 
# 84 "./src/main/drivers/transponder_ir_io_hal.c" 3 4
                  ((void *)0)
# 84 "./src/main/drivers/transponder_ir_io_hal.c"
                      ) {
        return;
    }
    ...
    if (dmaRef == 
# 95 "./src/main/drivers/transponder_ir_io_hal.c" 3 4
                 ((void *)0)
# 95 "./src/main/drivers/transponder_ir_io_hal.c"
                     ) {
        return;
    }
    ...
    IOConfigGPIOAF(transponderIO, (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000002U)) << 5)), timerHardware->alternateFunction);
    ...
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->AHB1ENR) |= ((0x1UL << (1U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->AHB1ENR) & ((0x1UL << (1U)))); ((void)(tmpreg)); } while(0);
    ...
    hdma_tim.Init.Direction = ((uint32_t)(0x1UL << (6U)));
    hdma_tim.Init.PeriphInc = ((uint32_t)0x00000000U);
    hdma_tim.Init.MemInc = ((uint32_t)(0x1UL << (10U)));
    hdma_tim.Init.PeriphDataAlignment = ((uint32_t)(0x2UL << (11U)));
    hdma_tim.Init.MemDataAlignment = ((uint32_t)(0x2UL << (13U)));
    hdma_tim.Init.Mode = ((uint32_t)0x00000000U);
    hdma_tim.Init.Priority = ((uint32_t)(0x2UL << (16U)));

    hdma_tim.Init.FIFOMode = ((uint32_t)0x00000000U);
    hdma_tim.Init.FIFOThreshold = ((uint32_t)(0x3UL << (0U)));
    hdma_tim.Init.MemBurst = ((uint32_t)0x00000000U);
    hdma_tim.Init.PeriphBurst = ((uint32_t)0x00000000U);
    ...
    dmaSetHandler(dmaGetIdentifier(dmaRef), TRANSPONDER_DMA_IRQHandler, (((((3)<<(4-(7-(((uint32_t)0x00000005)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0), dmaIndex);
    ...
    transponderInitialised = 
# 194 "./src/main/drivers/transponder_ir_io_hal.c" 3 4
                            1
# 194 "./src/main/drivers/transponder_ir_io_hal.c"
                                ;
}


# 197 "./src/main/drivers/transponder_ir_io_hal.c" 3 4
_Bool 
# 197 "./src/main/drivers/transponder_ir_io_hal.c"
    transponderIrInit(const ioTag_t ioTag, const transponderProvider_e provider)
{
    if (!ioTag) {
        return 
# 200 "./src/main/drivers/transponder_ir_io_hal.c" 3 4
              0
# 200 "./src/main/drivers/transponder_ir_io_hal.c"
                   ;
    }
    ...
    switch (provider) {
        ...
        default:
            return 
# 214 "./src/main/drivers/transponder_ir_io_hal.c" 3 4
                  0
# 214 "./src/main/drivers/transponder_ir_io_hal.c"
                       ;
    }
    ...
    return 
# 219 "./src/main/drivers/transponder_ir_io_hal.c" 3 4
          1
# 219 "./src/main/drivers/transponder_ir_io_hal.c"
              ;
}


# 222 "./src/main/drivers/transponder_ir_io_hal.c" 3 4
_Bool 
# 222 "./src/main/drivers/transponder_ir_io_hal.c"
    isTransponderIrReady(void)
{
...
void transponderIrDisable(void)
{
    ...
    IOConfigGPIOAF(transponderIO, (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000002U)) << 5)), alternateFunction);
}
