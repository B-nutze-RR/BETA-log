...
uint32_t persistentObjectRead(persistentObjectId_e id)
{
    RTC_HandleTypeDef rtcHandle = { .Instance = ((RTC_TypeDef *) (((0x40000000UL) + 0x18000000UL) + 0x4000UL)) };
...
# 87 "./src/main/drivers/persistent.c"
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->APB4ENR) |= ((0x1UL << (16U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->APB4ENR) & ((0x1UL << (16U)))); ((void)(tmpreg)); } while(0);
...
void persistentObjectInit(void)
{
    ...
    wasSoftReset = ((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->RSR & (0x1UL << (24U));
