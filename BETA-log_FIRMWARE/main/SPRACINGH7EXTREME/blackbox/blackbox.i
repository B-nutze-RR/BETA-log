...
const blackboxConfig_t pgResetTemplate_blackboxConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .sample_rate = BLACKBOX_RATE_QUARTER, .device = BLACKBOX_DEVICE_SDCARD, .fields_disabled_mask = 0, .mode = BLACKBOX_MODE_NORMAL }
