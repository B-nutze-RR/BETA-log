...
static uint32_t txBytesFree(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 139 "./src/main/io/displayport_max7456.c" 3 4
          (0xffffffffUL)
# 139 "./src/main/io/displayport_max7456.c"
                    ;
}

static 
# 142 "./src/main/io/displayport_max7456.c" 3 4
      _Bool 
# 142 "./src/main/io/displayport_max7456.c"
           layerSupported(displayPort_t *displayPort, displayPortLayer_e layer)
{
    (void)(displayPort);
...
static 
# 148 "./src/main/io/displayport_max7456.c" 3 4
      _Bool 
# 148 "./src/main/io/displayport_max7456.c"
           layerSelect(displayPort_t *displayPort, displayPortLayer_e layer)
{
    (void)(displayPort);
...
static 
# 154 "./src/main/io/displayport_max7456.c" 3 4
      _Bool 
# 154 "./src/main/io/displayport_max7456.c"
           layerCopy(displayPort_t *displayPort, displayPortLayer_e destLayer, displayPortLayer_e sourceLayer)
{
    (void)(displayPort);
...
static 
# 160 "./src/main/io/displayport_max7456.c" 3 4
      _Bool 
# 160 "./src/main/io/displayport_max7456.c"
...
static 
# 167 "./src/main/io/displayport_max7456.c" 3 4
      _Bool 
# 167 "./src/main/io/displayport_max7456.c"
           checkReady(displayPort_t *displayPort, 
# 167 "./src/main/io/displayport_max7456.c" 3 4
                                                  _Bool 
# 167 "./src/main/io/displayport_max7456.c"
                                                       rescan)
{
    ...
    if (!max7456IsDeviceDetected()) {
        if (!rescan) {
            return 
# 172 "./src/main/io/displayport_max7456.c" 3 4
                  0
# 172 "./src/main/io/displayport_max7456.c"
                       ;
        } else {
...
# 176 "./src/main/io/displayport_max7456.c"
    ...
    return 
# 186 "./src/main/io/displayport_max7456.c" 3 4
          1
# 186 "./src/main/io/displayport_max7456.c"
              ;
}
...
# 216 "./src/main/io/displayport_max7456.c" 3 4
_Bool 
# 216 "./src/main/io/displayport_max7456.c"
    max7456DisplayPortInit(const vcdProfile_t *vcdProfile, displayPort_t **displayPort)
{
    ...
    case MAX7456_INIT_NOT_CONFIGURED:
        ...
        *displayPort = 
# 225 "./src/main/io/displayport_max7456.c" 3 4
                      ((void *)0)
# 225 "./src/main/io/displayport_max7456.c"
                          ;
...
# 227 "./src/main/io/displayport_max7456.c"
    ...
    case MAX7456_INIT_NOT_FOUND:
        ...
        *displayPort = &max7456DisplayPort;
        ...
        return 
# 237 "./src/main/io/displayport_max7456.c" 3 4
              0
# 237 "./src/main/io/displayport_max7456.c"
                   ;
    ...
    return 
# 249 "./src/main/io/displayport_max7456.c" 3 4
          1
# 249 "./src/main/io/displayport_max7456.c"
              ;
}
