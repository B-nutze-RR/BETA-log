...
static uint32_t triggerLookupTable[] = {
    ...
    [BETAFLIGHT_EXTI_TRIGGER_RISING] = (0x11110000U),
    [BETAFLIGHT_EXTI_TRIGGER_FALLING] = (0x11210000U),
    [BETAFLIGHT_EXTI_TRIGGER_BOTH] = (0x11310000U)
...
void EXTIConfig(IO_t io, extiCallbackRec_t *cb, int irqPriority, ioConfig_t config, extiTrigger_t trigger)
{
    ...
    GPIO_InitTypeDef init = {
        .Pin = IO_Pin(io),
        .Mode = (0x00000000U) | (((config) >> 0) & 0x03) | triggerLookupTable[trigger],
        .Speed = (((config) >> 2) & 0x03),
        .Pull = (((config) >> 5) & 0x03),
    };
    ...
    if (extiGroupPriority[group] > irqPriority) {
        ...
        HAL_NVIC_SetPriority(extiGroupIRQn[group], (((irqPriority)>>(4-(7-(((uint32_t)0x00000005)))))>>4), (((irqPriority)&(0x0f>>(7-(((uint32_t)0x00000005)))))>>4));
        HAL_NVIC_EnableIRQ(extiGroupIRQn[group]);
    }
# 184 "./src/main/drivers/exti.c"
}
                             ...
                             enable)
{
    ...
    if (enable) {
        (((EXTI_Core_TypeDef *) ((((0x40000000UL) + 0x18000000UL) + 0x0000UL) + 0x0080UL))->IMR1) |= extiLine;
    } else {
        (((EXTI_Core_TypeDef *) ((((0x40000000UL) + 0x18000000UL) + 0x0000UL) + 0x0080UL))->IMR1) &= ~extiLine;
    }
# 233 "./src/main/drivers/exti.c"
}
...
{
    uint32_t exti_active = ((((EXTI_Core_TypeDef *) ((((0x40000000UL) + 0x18000000UL) + 0x0000UL) + 0x0080UL))->IMR1) & (((EXTI_Core_TypeDef *) ((((0x40000000UL) + 0x18000000UL) + 0x0000UL) + 0x0080UL))->PR1)) & 0xFFFF;

    while (exti_active) {
        unsigned idx = 31 - __builtin_clz(exti_active);
        uint32_t mask = 1 << idx;
        extiChannelRecs[idx].handler->fn(extiChannelRecs[idx].handler);
        (((EXTI_Core_TypeDef *) ((((0x40000000UL) + 0x18000000UL) + 0x0000UL) + 0x0080UL))->PR1) = mask;
        exti_active &= ~mask;
    }
}
