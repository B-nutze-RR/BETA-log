...
static 
# 80 "./src/main/io/displayport_oled.c" 3 4
      _Bool 
# 80 "./src/main/io/displayport_oled.c"
           oledIsTransferInProgress(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 83 "./src/main/io/displayport_oled.c" 3 4
          0
# 83 "./src/main/io/displayport_oled.c"
               ;
}

static 
# 86 "./src/main/io/displayport_oled.c" 3 4
      _Bool 
# 86 "./src/main/io/displayport_oled.c"
           oledIsSynced(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 89 "./src/main/io/displayport_oled.c" 3 4
          1
# 89 "./src/main/io/displayport_oled.c"
              ;
}
...
static uint32_t oledTxBytesFree(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 106 "./src/main/io/displayport_oled.c" 3 4
          (0xffffffffUL)
# 106 "./src/main/io/displayport_oled.c"
                    ;
}
...
static const displayPortVTable_t oledVTable = {
    ...
    .layerSupported = 
# 122 "./src/main/io/displayport_oled.c" 3 4
                     ((void *)0)
# 122 "./src/main/io/displayport_oled.c"
                         ,
    .layerSelect = 
# 123 "./src/main/io/displayport_oled.c" 3 4
                  ((void *)0)
# 123 "./src/main/io/displayport_oled.c"
                      ,
    .layerCopy = 
