...
0
# 116 "./src/main/config/config.c"
, .cpu_overclock = 0, .powerOnArmingGraceTime = 5, .boardIdentifier = "OBFW", .hseMhz = (8000000/1000000U), .configurationState = CONFIGURATION_STATE_DEFAULTS_BARE, .schedulerOptimizeRate = SCHEDULER_OPTIMIZE_RATE_AUTO, .enableStickArming = 
# 116 "./src/main/config/config.c" 3 4
0
# 116 "./src/main/config/config.c"
, }
