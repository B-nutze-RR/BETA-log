...
# 1 "<command-line>"
# 1 "./src/main/drivers/compass/compass_lis3mdl.c"
# 21 "./src/main/drivers/compass/compass_lis3mdl.c"
...
# 23 "./src/main/drivers/compass/compass_lis3mdl.c" 2
...
# 25 "./src/main/drivers/compass/compass_lis3mdl.c" 2
...
# 153 "./src/main/platform.h" 2
# 27 "./src/main/drivers/compass/compass_lis3mdl.c" 2
...
# 32 "./src/main/drivers/compass/compass_lis3mdl.c" 2
# 104 "./src/main/drivers/compass/compass_lis3mdl.c"
static 
# 104 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
      _Bool 
# 104 "./src/main/drivers/compass/compass_lis3mdl.c"
           lis3mdlRead(magDev_t * mag, int16_t *magData)
{
    uint8_t buf[6];
...
# 110 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
   _Bool 
# 110 "./src/main/drivers/compass/compass_lis3mdl.c"
        ack = busReadRegisterBuffer(busdev, 0x28, buf, 6);

    if (!ack) {
        return 
# 113 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
              0
# 113 "./src/main/drivers/compass/compass_lis3mdl.c"
                   ;
    }
    ...
    return 
# 120 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
          1
# 120 "./src/main/drivers/compass/compass_lis3mdl.c"
              ;
}

static 
# 123 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
      _Bool 
# 123 "./src/main/drivers/compass/compass_lis3mdl.c"
           lis3mdlInit(magDev_t *mag)
{
    ...
    busWriteRegister(busdev, 0x21, 0x00);
    busWriteRegister(busdev, 0x20, 0x80 | 0x60 | 0x1C);
    busWriteRegister(busdev, 0x24, 0x40);
    busWriteRegister(busdev, 0x23, 0x0C);
    busWriteRegister(busdev, 0x22, 0x00);
...
# 140 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
_Bool 
# 140 "./src/main/drivers/compass/compass_lis3mdl.c"
...
# 150 "./src/main/drivers/compass/compass_lis3mdl.c"
        ack = busReadRegisterBuffer(&mag->busdev, 0x0F, &sig, 1);
...
# 153 "./src/main/drivers/compass/compass_lis3mdl.c"
    ...
    return 
# 159 "./src/main/drivers/compass/compass_lis3mdl.c" 3 4
          1
# 159 "./src/main/drivers/compass/compass_lis3mdl.c"
              ;
}
