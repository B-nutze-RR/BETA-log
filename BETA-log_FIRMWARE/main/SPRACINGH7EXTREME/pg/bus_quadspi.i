...
# 26 "./src/main/pg/bus_quadspi.c" 2
...
# 28 "./src/main/pg/bus_quadspi.c" 2
# 1 "./src/main/pg/pg_ids.h" 1
# 21 "./src/main/pg/pg_ids.h"
       
# 29 "./src/main/pg/bus_quadspi.c" 2
...
# 24 "./src/main/pg/bus_quadspi.h" 2
...
# 31 "./src/main/pg/bus_quadspi.c" 2
...
const quadSpiDefaultConfig_t quadSpiDefaultConfig[] = {

    {
        QUADSPIDEV_1,
        ((ioTag_t)((((1) + 1) << 4) | (2))),
        ((ioTag_t)((((3) + 1) << 4) | (11))), ((ioTag_t)((((3) + 1) << 4) | (12))), ((ioTag_t)((((4) + 1) << 4) | (2))), ((ioTag_t)((((3) + 1) << 4) | (13))), ((ioTag_t)((((1) + 1) << 4) | (10))),
        ((ioTag_t)((((4) + 1) << 4) | (7))), ((ioTag_t)((((4) + 1) << 4) | (8))), ((ioTag_t)((((4) + 1) << 4) | (9))), ((ioTag_t)((((4) + 1) << 4) | (10))), 0,
...
extern void pgResetFn_quadSpiConfig(quadSpiConfig_t *); quadSpiConfig_t quadSpiConfig_SystemArray[1]; quadSpiConfig_t quadSpiConfig_CopyArray[1]; extern const pgRegistry_t quadSpiConfig_Registry; const pgRegistry_t quadSpiConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 548 | (1 << 12), .length = 1, .size = (sizeof(quadSpiConfig_t) * 1) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&quadSpiConfig_SystemArray, .copy = (uint8_t*)&quadSpiConfig_CopyArray, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_quadSpiConfig}, };

void pgResetFn_quadSpiConfig(quadSpiConfig_t *quadSpiConfig)
{
    for (size_t i = 0 ; i < (sizeof(quadSpiDefaultConfig) / sizeof((quadSpiDefaultConfig)[0])) ; i++) {
