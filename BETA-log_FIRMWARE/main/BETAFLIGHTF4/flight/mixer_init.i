...
motorMixer_t customMotorMixer_SystemArray[8]; motorMixer_t customMotorMixer_CopyArray[8]; extern const pgRegistry_t customMotorMixer_Registry; const pgRegistry_t customMotorMixer_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 4 | (0 << 12), .length = 8, .size = (sizeof(motorMixer_t) * 8) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&customMotorMixer_SystemArray, .copy = (uint8_t*)&customMotorMixer_CopyArray, .ptr = 0, .reset = {.ptr = 0}, };
...
void mixerInitProfile(void)
{
# 312 "./src/main/flight/mixer_init.c"
...
# 343 "./src/main/flight/mixer_init.c"
...
# 383 "./src/main/flight/mixer_init.c" 3 4
                              ((void *)0)
# 383 "./src/main/flight/mixer_init.c"
                                  ) {
...
# 403 "./src/main/flight/mixer_init.c"
void mixerInit(mixerMode_e mixerMode)
{
...
# 422 "./src/main/flight/mixer_init.c"
...
# 438 "./src/main/flight/mixer_init.c" 3 4
_Bool 
# 438 "./src/main/flight/mixer_init.c"
    mixerModeIsFixedWing(mixerMode_e mixerMode)
{
    switch (mixerMode) {
    ...
    case MIXER_CUSTOM_AIRPLANE:
        return 
# 444 "./src/main/flight/mixer_init.c" 3 4
              1
# 444 "./src/main/flight/mixer_init.c"
                  ;

        break;
    default:
        return 
# 448 "./src/main/flight/mixer_init.c" 3 4
              0
# 448 "./src/main/flight/mixer_init.c"
                   ;
...
# 454 "./src/main/flight/mixer_init.c" 3 4
_Bool 
# 454 "./src/main/flight/mixer_init.c"
    isFixedWing(void)
{
