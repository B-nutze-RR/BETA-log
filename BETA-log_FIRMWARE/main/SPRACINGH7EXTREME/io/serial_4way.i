...
{
    IOConfigGPIO(escHardware[selEsc].io, (((0x00000000U)) | (((0x00000000U)) << 2) | (((0x00000001U)) << 5)));
}

inline void setEscOutput(uint8_t selEsc)
{
    IOConfigGPIO(escHardware[selEsc].io, (((0x00000001U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)));
}
...
void esc4wayRelease(void)
{
    while (escCount > 0) {
        escCount--;
        IOConfigGPIO(escHardware[escCount].io, (((0x00000002U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)));
        setEscLo(escCount);
    }
    motorEnable();
}
...
# 441 "./src/main/io/serial_4way.c" 3 4
   _Bool 
# 441 "./src/main/io/serial_4way.c"
        isExitScheduled = 
# 441 "./src/main/io/serial_4way.c" 3 4
                          0
# 441 "./src/main/io/serial_4way.c"
    ...
    while (1) {
        ...
        ledSet(0, 
# 450 "./src/main/io/serial_4way.c" 3 4
       1
# 450 "./src/main/io/serial_4way.c"
       );
        ...
        ledSet(0, 
# 477 "./src/main/io/serial_4way.c" 3 4
       1
# 477 "./src/main/io/serial_4way.c"
       );
        ...
        if (ACK_OUT == 0x00)
        {
            ...
            switch (CMD) {
                ...
                case 0x33:
                {
                    ...
                    O_PARAM_LEN = 2;
                    Dummy.bytes[0] = (uint8_t) ((uint16_t) ((20 * 1000) + ((uint8_t) 0 * 100) + (uint8_t) 05) / 100);
                    Dummy.bytes[1] = (uint8_t) ((uint16_t) ((20 * 1000) + ((uint8_t) 0 * 100) + (uint8_t) 05) % 100);
                    break;
                }
                case 0x34:
                {
                    isExitScheduled = 
# 547 "./src/main/io/serial_4way.c" 3 4
                                     1
# 547 "./src/main/io/serial_4way.c"
                                         ;
                    break;
                }
                case 0x3F:
...
# 568 "./src/main/io/serial_4way.c" 3 4
                   _Bool 
# 568 "./src/main/io/serial_4way.c"
                        rebootEsc = 
# 568 "./src/main/io/serial_4way.c" 3 4
                                    0
# 568 "./src/main/io/serial_4way.c"
                    ...
                    if (ParamBuf[0] < escCount) {
                        ...
                        if (ioMem.D_FLASH_ADDR_L == 1) {
                            rebootEsc = 
# 573 "./src/main/io/serial_4way.c" 3 4
                                       1
# 573 "./src/main/io/serial_4way.c"
                                           ;
                        }
                    }
                    else {
        ...
        ledSet(0, 
# 882 "./src/main/io/serial_4way.c" 3 4
       0
# 882 "./src/main/io/serial_4way.c"
       );
        ...
        ledSet(0, 
# 905 "./src/main/io/serial_4way.c" 3 4
       0
# 905 "./src/main/io/serial_4way.c"
       );
        if (isExitScheduled) {
            esc4wayRelease();
            return;
