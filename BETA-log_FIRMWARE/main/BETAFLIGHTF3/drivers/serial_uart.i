...
static uint32_t uartTotalRxBytesWaiting(const serialPort_t *instance)
{
    ...
    if (s->rxDMAResource) {
        ...
        uint32_t rxDMAHead = DMA_GetCurrDataCounter((DMA_Channel_TypeDef *)(s->rxDMAResource));
...
static uint32_t uartTotalTxBytesFree(const serialPort_t *instance)
{
    ...
    if (s->txDMAResource) {
        ...
        bytesUsed += DMA_GetCurrDataCounter((DMA_Channel_TypeDef *)(s->txDMAResource));
...
# 325 "./src/main/drivers/serial_uart.c"
