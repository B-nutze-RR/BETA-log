...
# 40 "./src/main/scheduler/scheduler.c" 2
# 52 "./src/main/scheduler/scheduler.c"
static __attribute__ ((section(".fastram_bss"), aligned(4))) task_t *currentTask = 
# 52 "./src/main/scheduler/scheduler.c" 3 4
                                                ((void *)0)
# 52 "./src/main/scheduler/scheduler.c"
                                                    ;
...
# 57 "./src/main/scheduler/scheduler.c" 3 4
                          _Bool 
# 57 "./src/main/scheduler/scheduler.c"
                               calculateTaskStatistics;
...
static __attribute__ ((section(".fastram_data"), aligned(4))) int periodCalculationBasisOffset = 
# 63 "./src/main/scheduler/scheduler.c" 3 4
                                                   __builtin_offsetof (
# 63 "./src/main/scheduler/scheduler.c"
                                                   task_t
# 63 "./src/main/scheduler/scheduler.c" 3 4
                                                   , 
# 63 "./src/main/scheduler/scheduler.c"
...
# 63 "./src/main/scheduler/scheduler.c"
                                                                                     ;
static __attribute__ ((section(".fastram_bss"), aligned(4))) 
# 64 "./src/main/scheduler/scheduler.c" 3 4
                          _Bool 
# 64 "./src/main/scheduler/scheduler.c"
                               gyroEnabled;
...
# 77 "./src/main/scheduler/scheduler.c" 3 4
_Bool 
# 77 "./src/main/scheduler/scheduler.c"
    ...
    queueAdd(task_t *task)
{
    if ((taskQueueSize >= TASK_COUNT) || queueContains(task)) {
        return 
# 90 "./src/main/scheduler/scheduler.c" 3 4
              0
# 90 "./src/main/scheduler/scheduler.c"
                   ;
    }
    for (int ii = 0; ii <= taskQueueSize; ++ii) {
        if (taskQueueArray[ii] == 
# 93 "./src/main/scheduler/scheduler.c" 3 4
                                 ((void *)0) 
# 93 "./src/main/scheduler/scheduler.c"
    ...
    queueRemove(task_t *task)
{
    for (int ii = 0; ii < taskQueueSize; ++ii) {
        if (taskQueueArray[ii] == task) {
            ...
            --taskQueueSize;
            return 
# 109 "./src/main/scheduler/scheduler.c" 3 4
                  1
# 109 "./src/main/scheduler/scheduler.c"
                      ;
        }
    }
    return 
# 112 "./src/main/scheduler/scheduler.c" 3 4
          0
# 112 "./src/main/scheduler/scheduler.c"
               ;
}
...
__attribute__((section(".tcm_code"))) task_t *queueFirst(void)
{
    taskQueuePos = 0;
...
__attribute__((section(".tcm_code"))) task_t *queueNext(void)
{
...
void getCheckFuncInfo(cfCheckFuncInfo_t *checkFuncInfo)
{
    ...
    checkFuncInfo->averageExecutionTimeUs = checkFuncMovingSumExecutionTimeUs / 32;
    checkFuncInfo->averageDeltaTimeUs = checkFuncMovingSumDeltaTimeUs / 32;
}
...
void getTaskInfo(taskId_e taskId, taskInfo_t * taskInfo)
{
    ...
    taskInfo->averageExecutionTimeUs = getTask(taskId)->movingSumExecutionTimeUs / 32;
    taskInfo->averageDeltaTimeUs = getTask(taskId)->movingSumDeltaTimeUs / 32;
...
void rescheduleTask(taskId_e taskId, timeDelta_t newPeriodUs)
{
    if (taskId == TASK_SELF) {
        ...
        task->desiredPeriodUs = __extension__ ({ __typeof__ (10) _a = (10); __typeof__ (newPeriodUs) _b = (newPeriodUs); _a > _b ? _a : _b; });
...
void setTaskEnabled(taskId_e taskId, 
# 190 "./src/main/scheduler/scheduler.c" 3 4
                                    _Bool 
# 190 "./src/main/scheduler/scheduler.c"
                                         enabled)
{
...
void schedulerSetCalulateTaskStatistics(
# 213 "./src/main/scheduler/scheduler.c" 3 4
                                       _Bool 
# 213 "./src/main/scheduler/scheduler.c"
...
{
    calculateTaskStatistics = 
# 259 "./src/main/scheduler/scheduler.c" 3 4
                             1
# 259 "./src/main/scheduler/scheduler.c"
                                 ;
    queueClear();
...
# 266 "./src/main/scheduler/scheduler.c" 3 4
                                                 __builtin_offsetof (
# 266 "./src/main/scheduler/scheduler.c"
                                                 task_t
# 266 "./src/main/scheduler/scheduler.c" 3 4
                                                 , 
# 266 "./src/main/scheduler/scheduler.c"
...
__attribute__((section(".tcm_code"))) timeUs_t schedulerExecuteTask(task_t *selectedTask, timeUs_t currentTimeUs)
{
...
# 326 "./src/main/scheduler/scheduler.c"
__attribute__((section(".tcm_code"))) void scheduler(void)
{
    ...
    timeUs_t taskExecutionTimeUs = 0;
    task_t *selectedTask = 
# 332 "./src/main/scheduler/scheduler.c" 3 4
                          ((void *)0)
# 332 "./src/main/scheduler/scheduler.c"
                              ;
    uint16_t selectedTaskDynamicPriority = 0;
    uint16_t waitingTasks = 0;
    
# 335 "./src/main/scheduler/scheduler.c" 3 4
   _Bool 
# 335 "./src/main/scheduler/scheduler.c"
        realtimeTaskRan = 
# 335 "./src/main/scheduler/scheduler.c" 3 4
                          0
# 335 "./src/main/scheduler/scheduler.c"
    ...
    if (gyroEnabled) {
        ...
        if (cmpTimeUs(currentTimeUs, gyroExecuteTimeUs) >= 0) {
            ...
            realtimeTaskRan = 
# 352 "./src/main/scheduler/scheduler.c" 3 4
                             1
# 352 "./src/main/scheduler/scheduler.c"
                                 ;
        }
    }

    if (!gyroEnabled || realtimeTaskRan || (gyroTaskDelayUs > 10)) {



        for (task_t *task = queueFirst(); task != 
# 360 "./src/main/scheduler/scheduler.c" 3 4
                                                 ((void *)0)
# 360 "./src/main/scheduler/scheduler.c"
                                                     ; task = queueNext()) {
            if (task->staticPriority != TASK_PRIORITY_REALTIME) {
        ...
        if (selectedTask) {
            timeDelta_t taskRequiredTimeUs = 30;

            if (calculateTaskStatistics) {
                taskRequiredTimeUs = selectedTask->movingSumExecutionTimeUs / 32 + 5;
            }
            ...
            if (!gyroEnabled || realtimeTaskRan || (taskRequiredTimeUs < gyroTaskDelayUs)) {
                ...
                selectedTask = 
# 426 "./src/main/scheduler/scheduler.c" 3 4
                              ((void *)0)
# 426 "./src/main/scheduler/scheduler.c"
                                  ;
            }
        }
    }
...
{
    gyroEnabled = 
# 445 "./src/main/scheduler/scheduler.c" 3 4
                 1
# 445 "./src/main/scheduler/scheduler.c"
                     ;
}
