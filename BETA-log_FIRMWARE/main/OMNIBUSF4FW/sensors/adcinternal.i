...
void adcInternalProcess(timeUs_t currentTimeUs)
{
    ...
    {if (debugMode == (DEBUG_ADC_INTERNAL)) {debug[(0)] = (coreTemperature);}};
    {if (debugMode == (DEBUG_ADC_INTERNAL)) {debug[(1)] = (vrefintSample);}};
    {if (debugMode == (DEBUG_ADC_INTERNAL)) {debug[(2)] = (tempsensorSample);}};
    {if (debugMode == (DEBUG_ADC_INTERNAL)) {debug[(3)] = (vrefMv);}};
