...
# 41 "./src/main/drivers/adc_stm32f4xx.c" 2
...
# 44 "./src/main/drivers/adc_stm32f4xx.c" 2
...
const adcDevice_t adcHardware[] = {
    {
        .ADCx = ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)),
        .rccADC = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00000100))>65535L) + (8*(((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L)) >>8*(((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L)) >>8*(((((uint32_t)0x00000100))*1L >>16*((((uint32_t)0x00000100))>65535L))>255))/2+1))))),
    ...
    {
        .ADCx = ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2100)),
        .rccADC = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00000200))>65535L) + (8*(((((uint32_t)0x00000200))*1L >>16*((((uint32_t)0x00000200))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000200))*1L >>16*((((uint32_t)0x00000200))>65535L)) >>8*(((((uint32_t)0x00000200))*1L >>16*((((uint32_t)0x00000200))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000200))*1L >>16*((((uint32_t)0x00000200))>65535L)) >>8*(((((uint32_t)0x00000200))*1L >>16*((((uint32_t)0x00000200))>65535L))>255))/2+1))))),
    ...
    {
        .ADCx = ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2200)),
        .rccADC = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00000400))>65535L) + (8*(((((uint32_t)0x00000400))*1L >>16*((((uint32_t)0x00000400))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000400))*1L >>16*((((uint32_t)0x00000400))>65535L)) >>8*(((((uint32_t)0x00000400))*1L >>16*((((uint32_t)0x00000400))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000400))*1L >>16*((((uint32_t)0x00000400))>65535L)) >>8*(((((uint32_t)0x00000400))*1L >>16*((((uint32_t)0x00000400))>65535L))>255))/2+1))))),
...
# 109 "./src/main/drivers/adc_stm32f4xx.c"
...
void adcInitInternalInjected(const adcConfig_t *config)
{
    ...
    adcVREFINTCAL = config->vrefIntCalibration ? config->vrefIntCalibration : *(uint16_t *)0x1FFF7A2A;
    adcTSCAL1 = config->tempSensorCalibration1 ? config->tempSensorCalibration1 : *(uint16_t *)0x1FFF7A2C;
    adcTSCAL2 = config->tempSensorCalibration2 ? config->tempSensorCalibration2 : *(uint16_t *)0x1FFF7A2E;

    adcTSSlopeK = (110 - 30) * 1000 / (adcTSCAL2 - adcTSCAL1);
}
# 179 "./src/main/drivers/adc_stm32f4xx.c"
static 
# 179 "./src/main/drivers/adc_stm32f4xx.c" 3 4
      _Bool 
# 179 "./src/main/drivers/adc_stm32f4xx.c"
...
# 181 "./src/main/drivers/adc_stm32f4xx.c" 3 4
_Bool 
# 181 "./src/main/drivers/adc_stm32f4xx.c"
    adcInternalIsBusy(void)
{
    if (adcInternalConversionInProgress) {
        if (ADC_GetFlagStatus(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)), ((uint8_t)0x04)) != RESET) {
            adcInternalConversionInProgress = 
# 185 "./src/main/drivers/adc_stm32f4xx.c" 3 4
                                             0
# 185 "./src/main/drivers/adc_stm32f4xx.c"
                                                  ;
        }
    }
...
void adcInternalStartConversion(void)
{
    ...
    adcInternalConversionInProgress = 
# 197 "./src/main/drivers/adc_stm32f4xx.c" 3 4
                                     1
# 197 "./src/main/drivers/adc_stm32f4xx.c"
                                         ;
}
...
# 242 "./src/main/drivers/adc_stm32f4xx.c" 3 4
   _Bool 
# 242 "./src/main/drivers/adc_stm32f4xx.c"
        adcActive = 
# 242 "./src/main/drivers/adc_stm32f4xx.c" 3 4
                    0
# 242 "./src/main/drivers/adc_stm32f4xx.c"
    ...
    for (int i = 0; i < ADC_CHANNEL_COUNT; i++) {
        ...
        adcActive = 
# 248 "./src/main/drivers/adc_stm32f4xx.c" 3 4
                   1
# 248 "./src/main/drivers/adc_stm32f4xx.c"
                       ;
...
# 254 "./src/main/drivers/adc_stm32f4xx.c" 3 4
                                       1
# 254 "./src/main/drivers/adc_stm32f4xx.c"
                                           ;
    }
    ...
    dmaInit(dmaGetIdentifier(dmaSpec->ref), OWNER_ADC, (device + 1));

    DMA_DeInit((DMA_Stream_TypeDef *)(dmaSpec->ref));
    ...
    DMA_Init((DMA_Stream_TypeDef *)(dmaSpec->ref), &DMA_InitStructure);
    DMA_Cmd((DMA_Stream_TypeDef *)(dmaSpec->ref), ENABLE);
