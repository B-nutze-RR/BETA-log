# 1 "./src/main/startup/system_stm32f30x.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/startup/system_stm32f30x.c"
# 102 "./src/main/startup/system_stm32f30x.c"
...
# 153 "./src/main/platform.h" 2
# 103 "./src/main/startup/system_stm32f30x.c" 2
...
# 106 "./src/main/startup/system_stm32f30x.c" 2

uint32_t hse_value = 8000000;
# 133 "./src/main/startup/system_stm32f30x.c"
  uint32_t SystemCoreClock = 72000000;

  volatile const uint8_t AHBPrescTable[16] = {0, 0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4, 6, 7, 8, 9};
# 145 "./src/main/startup/system_stm32f30x.c"
void SetSysClock(void);
# 162 "./src/main/startup/system_stm32f30x.c"
void SystemInit(void)
{
...
# 203 "./src/main/startup/system_stm32f30x.c"
...
# 247 "./src/main/startup/system_stm32f30x.c"
...
# 299 "./src/main/startup/system_stm32f30x.c"
void SetSysClock(void)
{
