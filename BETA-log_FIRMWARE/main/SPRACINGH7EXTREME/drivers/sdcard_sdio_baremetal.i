# 1 "./src/main/drivers/sdcard_sdio_baremetal.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/sdcard_sdio_baremetal.c"
# 23 "./src/main/drivers/sdcard_sdio_baremetal.c"
# 1 "c:\\dev\\9 2020-q2-update\\lib\\gcc\\arm-none-eabi\\9.3.1\\include\\stdbool.h" 1 3 4
# 24 "./src/main/drivers/sdcard_sdio_baremetal.c" 2
...
# 25 "./src/main/drivers/sdcard_sdio_baremetal.c" 2
...
# 26 "./src/main/drivers/sdcard_sdio_baremetal.c" 2
...
# 153 "./src/main/platform.h" 2
# 28 "./src/main/drivers/sdcard_sdio_baremetal.c" 2
...
# 32 "./src/main/drivers/sdcard_sdio_baremetal.c" 2
...
# 33 "./src/main/drivers/sdcard_sdio_baremetal.c" 2
...
# 34 "./src/main/drivers/sdcard_sdio_baremetal.c" 2
...
# 35 "./src/main/drivers/sdcard_sdio_baremetal.c" 2
...
# 37 "./src/main/drivers/sdcard_sdio_baremetal.c" 2
...
# 39 "./src/main/drivers/sdcard_sdio_baremetal.c" 2
...
# 40 "./src/main/drivers/sdcard_sdio_baremetal.c" 2
...
# 42 "./src/main/drivers/sdcard_sdio_baremetal.c" 2
...
# 40 "./src/main/drivers/sdcard_impl.h"
typedef enum {
...
# 75 "./src/main/drivers/sdcard_impl.h" 3 4
   _Bool 
# 75 "./src/main/drivers/sdcard_impl.h"
        highCapacity;
...
# 88 "./src/main/drivers/sdcard_impl.h" 3 4
   _Bool 
# 88 "./src/main/drivers/sdcard_impl.h"
        enabled;
    
# 89 "./src/main/drivers/sdcard_impl.h" 3 4
   _Bool 
# 89 "./src/main/drivers/sdcard_impl.h"
        detectionInverted;
    IO_t cardDetectPin;
# 99 "./src/main/drivers/sdcard_impl.h"
...
_Static_assert((sizeof(sdcardCSD_t) == 16), "sdcard_csd_bitfields_didnt_pack_properly");


# 110 "./src/main/drivers/sdcard_impl.h" 3 4
_Bool 
# 110 "./src/main/drivers/sdcard_impl.h"
    sdcard_isInserted(void);
...
# 115 "./src/main/drivers/sdcard_impl.h" 3 4
   _Bool 
# 115 "./src/main/drivers/sdcard_impl.h"
        (*sdcard_readBlock)(uint32_t blockIndex, uint8_t *buffer, sdcard_operationCompleteCallback_c callback, uint32_t callbackData);
    sdcardOperationStatus_e (*sdcard_beginWriteBlocks)(uint32_t blockIndex, uint32_t blockCount);
    sdcardOperationStatus_e (*sdcard_writeBlock)(uint32_t blockIndex, uint8_t *buffer, sdcard_operationCompleteCallback_c callback, uint32_t callbackData);
    
# 118 "./src/main/drivers/sdcard_impl.h" 3 4
   _Bool 
# 118 "./src/main/drivers/sdcard_impl.h"
        (*sdcard_poll)(void);
    
# 119 "./src/main/drivers/sdcard_impl.h" 3 4
   _Bool 
# 119 "./src/main/drivers/sdcard_impl.h"
        (*sdcard_isFunctional)(void);
    
# 120 "./src/main/drivers/sdcard_impl.h" 3 4
   _Bool 
# 120 "./src/main/drivers/sdcard_impl.h"
        (*sdcard_isInitialized)(void);
    const sdcardMetadata_t* (*sdcard_getMetadata)(void);
...
# 43 "./src/main/drivers/sdcard_sdio_baremetal.c" 2

# 1 "./src/main/drivers/sdmmc_sdio.h" 1
# 74 "./src/main/drivers/sdmmc_sdio.h"
typedef enum
{
...
# 224 "./src/main/drivers/sdmmc_sdio.h" 3 4
_Bool 
# 224 "./src/main/drivers/sdmmc_sdio.h"
                SD_IsDetected (void);

# 225 "./src/main/drivers/sdmmc_sdio.h" 3 4
_Bool 
# 225 "./src/main/drivers/sdmmc_sdio.h"
                SD_GetState (void);
...
# 45 "./src/main/drivers/sdcard_sdio_baremetal.c" 2



uint8_t writeCache[512 * 16] __attribute__ ((aligned (4)));
...
static 
# 75 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
      _Bool 
# 75 "./src/main/drivers/sdcard_sdio_baremetal.c"
           sdcardSdio_isFunctional(void)
{
...
static void sdcard_reset(void)
{
    if (SD_Init() != 0) {
        sdcard.failureCount++;
        if (sdcard.failureCount >= 8 || !sdcard_isInserted()) {
...
static sdcardReceiveBlockStatus_e sdcard_receiveDataBlock(uint8_t *buffer, int count)
{
    ...
    if (SD_GetState() != 
# 120 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
                        1
# 120 "./src/main/drivers/sdcard_sdio_baremetal.c"
                            ) {
...
static 
# 127 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
      _Bool 
# 127 "./src/main/drivers/sdcard_sdio_baremetal.c"
           sdcard_receiveCID(void)
{
    ...
    if (error) {
         return 
# 132 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
               0
# 132 "./src/main/drivers/sdcard_sdio_baremetal.c"
                    ;
    }
    ...
    return 
# 148 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
          1
# 148 "./src/main/drivers/sdcard_sdio_baremetal.c"
              ;
}

static 
# 151 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
      _Bool 
# 151 "./src/main/drivers/sdcard_sdio_baremetal.c"
           sdcard_fetchCSD(void)
{
    ...
    if (error) {
        return 
# 160 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
              0
# 160 "./src/main/drivers/sdcard_sdio_baremetal.c"
                   ;
    }

    sdcard.metadata.numBlocks = sdinfo->CardCapacity;
    return 
# 164 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
          1
# 164 "./src/main/drivers/sdcard_sdio_baremetal.c"
              ;
}
...
static 
# 172 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
      _Bool 
# 172 "./src/main/drivers/sdcard_sdio_baremetal.c"
           sdcard_checkInitDone(void)
{
    if (SD_GetState()) {
        ...
        if (errorState != SD_OK) {
            return 
# 178 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
                  0
# 178 "./src/main/drivers/sdcard_sdio_baremetal.c"
                       ;
        }
        ...
        return 
# 183 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
              1
# 183 "./src/main/drivers/sdcard_sdio_baremetal.c"
                  ;
    }


    return 
# 187 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
          0
# 187 "./src/main/drivers/sdcard_sdio_baremetal.c"
               ;
}
...
# 220 "./src/main/drivers/sdcard_sdio_baremetal.c"
...
static 
# 255 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
      _Bool 
# 255 "./src/main/drivers/sdcard_sdio_baremetal.c"
           sdcard_isReady()
{
    return sdcard.state == SDCARD_STATE_READY || sdcard.state == SDCARD_STATE_WRITING_MULTIPLE_BLOCKS;
}
# 270 "./src/main/drivers/sdcard_sdio_baremetal.c"
...
static 
# 295 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
      _Bool 
# 295 "./src/main/drivers/sdcard_sdio_baremetal.c"
           sdcardSdio_poll(void)
{
    if (!sdcard.enabled) {
        sdcard.state = SDCARD_STATE_NOT_PRESENT;
        return 
# 299 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
              0
# 299 "./src/main/drivers/sdcard_sdio_baremetal.c"
                   ;
    }
...
# 337 "./src/main/drivers/sdcard_sdio_baremetal.c"
                sdcard.multiWriteBlocksRemain = 0;
...
# 470 "./src/main/drivers/sdcard_sdio_baremetal.c"
static sdcardOperationStatus_e sdcardSdio_writeBlock(uint32_t blockIndex, uint8_t *buffer, sdcard_operationCompleteCallback_c callback, uint32_t callbackData)
{
    ...
    if ((cache_getCount() < 16) &&
        (sdcard.multiWriteBlocksRemain != 0) && sdcard.useCache) {
        cache_write(buffer);
        if (cache_getCount() == 16 || sdcard.multiWriteBlocksRemain == 1) {
...
# 532 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
                                                                                                              ((void *)0)
# 532 "./src/main/drivers/sdcard_sdio_baremetal.c"
                                                                                                                  , sdcard.pendingOperation.callbackData);
        }
...
# 553 "./src/main/drivers/sdcard_sdio_baremetal.c"
...
# 586 "./src/main/drivers/sdcard_sdio_baremetal.c"
static 
# 586 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
      _Bool 
# 586 "./src/main/drivers/sdcard_sdio_baremetal.c"
           sdcardSdio_readBlock(uint32_t blockIndex, uint8_t *buffer, sdcard_operationCompleteCallback_c callback, uint32_t callbackData)
{
    if (sdcard.state != SDCARD_STATE_READY) {
  if (sdcard.state == SDCARD_STATE_WRITING_MULTIPLE_BLOCKS) {
   if (sdcard_endWriteBlocks() != SDCARD_OPERATION_SUCCESS) {
    return 
# 591 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
          0
# 591 "./src/main/drivers/sdcard_sdio_baremetal.c"
               ;
   }
  } else {
   return 
# 594 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
         0
# 594 "./src/main/drivers/sdcard_sdio_baremetal.c"
              ;
  }
    }
    ...
    if (status == SD_OK) {
        ...
        return 
# 615 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
              1
# 615 "./src/main/drivers/sdcard_sdio_baremetal.c"
                  ;
    } else {
        sdcard_reset();
        if (sdcard.pendingOperation.callback) {
...
# 622 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
               ((void *)0)
# 622 "./src/main/drivers/sdcard_sdio_baremetal.c"
                   ,
                sdcard.pendingOperation.callbackData
            );
        }
        return 
# 626 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
              0
# 626 "./src/main/drivers/sdcard_sdio_baremetal.c"
                   ;
    }
}
...
static 
# 633 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
      _Bool 
# 633 "./src/main/drivers/sdcard_sdio_baremetal.c"
           sdcardSdio_isInitialized(void)
{
...
# 652 "./src/main/drivers/sdcard_sdio_baremetal.c"
sdcardVTable_t sdcardSdioVTable = {
    
# 653 "./src/main/drivers/sdcard_sdio_baremetal.c" 3 4
   ((void *)0)
# 653 "./src/main/drivers/sdcard_sdio_baremetal.c"
       ,
    sdcardSdio_init,
