...
# 84 "./src/main/cms/cms_menu_osd.c"
    ...
    {"BATTERY EFFICIENCY", OME_VISIBLE, 
# 86 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 86 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_EFFICIENCY], 0x04},
...
# 109 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_VTX_CHANNEL], 0x04},
...
# 122 "./src/main/cms/cms_menu_osd.c"
    ...
    {"ESC TEMPERATURE", OME_VISIBLE, 
# 124 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 124 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_ESC_TMP], 0x04},
    {"ESC RPM", OME_VISIBLE, 
# 125 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 125 "./src/main/cms/cms_menu_osd.c"
                                           , &osdConfig_item_pos[OSD_ESC_RPM], 0x04},
...
# 313 "./src/main/cms/cms_menu_osd.c"
...
# 333 "./src/main/cms/cms_menu_osd.c"
    return 
# 333 "./src/main/cms/cms_menu_osd.c" 3 4
          ((void *)0)
# 333 "./src/main/cms/cms_menu_osd.c"
              ;
}
...
{
    {"---OSD---", OME_Label, 
# 373 "./src/main/cms/cms_menu_osd.c" 3 4
                                ((void *)0)
...
# 375 "./src/main/cms/cms_menu_osd.c"
    ...
    {"BACK", OME_Back, 
# 388 "./src/main/cms/cms_menu_osd.c" 3 4
                      ((void *)0)
# 388 "./src/main/cms/cms_menu_osd.c"
                          , 
# 388 "./src/main/cms/cms_menu_osd.c" 3 4
                            ((void *)0)
# 388 "./src/main/cms/cms_menu_osd.c"
                                , 0},
    {
# 389 "./src/main/cms/cms_menu_osd.c" 3 4
    ((void *)0)
# 389 "./src/main/cms/cms_menu_osd.c"
        , OME_END, 
# 389 "./src/main/cms/cms_menu_osd.c" 3 4
                      ((void *)0)
# 389 "./src/main/cms/cms_menu_osd.c"
...
CMS_Menu cmsx_menuOsd = {
    ...
    .onDisplayUpdate = 
# 399 "./src/main/cms/cms_menu_osd.c" 3 4
                      ((void *)0)
# 399 "./src/main/cms/cms_menu_osd.c"
                          ,
