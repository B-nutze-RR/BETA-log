...
# 39 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 2
# 54 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
static volatile timeDelta_t hcsr04SonarPulseTravelTime = 0;
static volatile timeMs_t lastMeasurementReceivedAt;
static int32_t lastCalculatedDistance = (-1);
...
# 97 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
...
void hcsr04_update(rangefinderDev_t *dev)
{
    ...
    if (lastMeasurementReceivedAt > lastMeasurementStartedAt && (lastMeasurementReceivedAt - lastMeasurementStartedAt) <= 60) {
    ...
    } else if ((lastMeasurementReceivedAt - lastMeasurementStartedAt) > 60) {
...
int32_t hcsr04_get_distance(rangefinderDev_t *dev)
{
    ...
    lastCalculatedDistance = (-3);

    return result;
}


# 151 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
_Bool 
# 151 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
...
# 153 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
    ...
    if (IOGetOwner(triggerIO) || IOGetOwner(echoIO)) {
        return 
# 159 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
              0
# 159 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                   ;
    }
    ...
    if (IORead(echoIO) == 
# 173 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
                         0
# 173 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                              ) {
        for (int i = 0; i < 5 && !detected; i++) {
            ...
            while ((millis() - requestTime) < 60) {
                if (IORead(echoIO) == 
# 179 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
                                     1
# 179 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                                         ) {
                    detected = 
# 180 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
                              1
# 180 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                                  ;
                    break;
                }
            }
    ...
    if (detected) {
        ...
        EXTIConfig(echoIO, &hcsr04_extiCallbackRec, (((((2)<<(4-(7-(((uint32_t)0x500)>>8))))|((0)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)), BETAFLIGHT_EXTI_TRIGGER_BOTH);
        EXTIEnable(echoIO, 
...
# 191 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
        ...
        return 
# 202 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
              1
# 202 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                  ;
    }
    else {
        ...
        IORelease(echoIO);
        return 
# 208 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c" 3 4
              0
# 208 "./src/main/drivers/rangefinder/rangefinder_hcsr04.c"
                   ;
    }
}
