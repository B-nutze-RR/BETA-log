...
extern const rangefinderConfig_t pgResetTemplate_rangefinderConfig; rangefinderConfig_t rangefinderConfig_System; rangefinderConfig_t rangefinderConfig_Copy; extern const pgRegistry_t rangefinderConfig_Registry; const pgRegistry_t rangefinderConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 527 | (0 << 12), .length = 1, .size = sizeof(rangefinderConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&rangefinderConfig_System, .copy = (uint8_t*)&rangefinderConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_rangefinderConfig}, };
...
extern const sonarConfig_t pgResetTemplate_sonarConfig; sonarConfig_t sonarConfig_System; sonarConfig_t sonarConfig_Copy; extern const pgRegistry_t sonarConfig_Registry; const pgRegistry_t sonarConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 516 | (1 << 12), .length = 1, .size = sizeof(sonarConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&sonarConfig_System, .copy = (uint8_t*)&sonarConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_sonarConfig}, };
           ...
           rangefinderDetect(rangefinderDev_t * dev, uint8_t rangefinderHardwareToUse)
{
    ...
    if (rangefinderHardware == RANGEFINDER_NONE) {
        ...
        return 
# 132 "./src/main/sensors/rangefinder.c" 3 4
              0
# 132 "./src/main/sensors/rangefinder.c"
                   ;
    }
    ...
    return 
# 137 "./src/main/sensors/rangefinder.c" 3 4
          1
# 137 "./src/main/sensors/rangefinder.c"
              ;
}
...
# 142 "./src/main/sensors/rangefinder.c" 3 4
                                     0
# 142 "./src/main/sensors/rangefinder.c"
                                          ;
    ...
    rangefinderInit(void)
{
    if (!rangefinderDetect(&rangefinder.dev, rangefinderConfig()->rangefinder_hardware)) {
        return 
# 149 "./src/main/sensors/rangefinder.c" 3 4
              0
# 149 "./src/main/sensors/rangefinder.c"
                   ;
    }
    ...
    return 
# 167 "./src/main/sensors/rangefinder.c" 3 4
          1
# 167 "./src/main/sensors/rangefinder.c"
              ;
}
...
# 228 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 228 "./src/main/sensors/rangefinder.c"
    ...
    if (
        ...
        if (rangefinder.snrThresholdReached) {
            ...
            return 
# 247 "./src/main/sensors/rangefinder.c" 3 4
                  1
# 247 "./src/main/sensors/rangefinder.c"
                      ;
        }
...
# 259 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 259 "./src/main/sensors/rangefinder.c"
    rangefinderProcess(float cosTiltAngle)
{
    if (rangefinder.dev.read) {
        ...
        if (distance == (-3)) {
            return 
# 266 "./src/main/sensors/rangefinder.c" 3 4
                  0
# 266 "./src/main/sensors/rangefinder.c"
                       ;
        }
        ...
        if (rangefinder.snrThresholdReached == 
# 283 "./src/main/sensors/rangefinder.c" 3 4
                                              0 
# 283 "./src/main/sensors/rangefinder.c"
                                                    && rangefinder.rawAltitude > 0) {
            ...
            if (rangefinder.snr >= 600) {
                rangefinder.snrThresholdReached = 
# 290 "./src/main/sensors/rangefinder.c" 3 4
                                                 1
# 290 "./src/main/sensors/rangefinder.c"
                                                     ;
            }
    ...
    return 
# 323 "./src/main/sensors/rangefinder.c" 3 4
          1
# 323 "./src/main/sensors/rangefinder.c"
              ;
}
