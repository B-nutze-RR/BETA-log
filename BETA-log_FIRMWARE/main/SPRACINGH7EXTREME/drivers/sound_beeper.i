...
static void beeperPwmInit(const ioTag_t tag, uint16_t frequency)
{
    ...
    if (beeperIO && timer) {
        ...
        IOConfigGPIOAF(beeperPwm.io, (((0x00000002U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)), timer->alternateFunction);
...
void beeperInit(const beeperDevConfig_t *config)
{
    ...
    if (beeperFrequency == 0) {
        ...
        if (beeperIO) {
            ...
            IOConfigGPIO(beeperIO, config->isOpenDrain ? (((0x00000011U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)) : (((0x00000001U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)));
        }
        systemBeep(
