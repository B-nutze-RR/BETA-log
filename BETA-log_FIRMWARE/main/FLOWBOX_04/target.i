# 1 "./src/main/target/FLOWBOX_04/target.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/target/FLOWBOX_04/target.c"
# 21 "./src/main/target/FLOWBOX_04/target.c"
...
# 22 "./src/main/target/FLOWBOX_04/target.c" 2
...
# 153 "./src/main/platform.h" 2
# 24 "./src/main/target/FLOWBOX_04/target.c" 2
...
# 25 "./src/main/target/FLOWBOX_04/target.c" 2
...
# 27 "./src/main/target/FLOWBOX_04/target.c" 2
...
# 28 "./src/main/target/FLOWBOX_04/target.c" 2


const timerHardware_t timerHardware[10] = {

    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((ioTag_t)((((0) + 1) << 4) | (15))), ((uint16_t)0x0000), TIM_USE_LED, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x01) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088)), ((uint32_t)0x06000000) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8)), ((uint32_t)0x06000000), DMA1_ST7_HANDLER },
};
