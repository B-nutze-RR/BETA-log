...
# 44 "./src/main/rx/rx_spi.c" 2
# 1 "./src/main/rx/cc2500_redpine.h" 1
# 21 "./src/main/rx/cc2500_redpine.h"
       
# 30 "./src/main/rx/cc2500_redpine.h"
...
# 33 "./src/main/rx/cc2500_redpine.h" 3 4
_Bool 
# 33 "./src/main/rx/cc2500_redpine.h"
    redpineSpiInit(const rxSpiConfig_t *rxSpiConfig, rxRuntimeState_t *rxRuntimeState, rxSpiExtiConfig_t *extiConfig);
# 45 "./src/main/rx/rx_spi.c" 2
# 1 "./src/main/rx/nrf24_cx10.h" 1
# 21 "./src/main/rx/nrf24_cx10.h"
...
# 28 "./src/main/rx/nrf24_cx10.h" 3 4
_Bool 
# 28 "./src/main/rx/nrf24_cx10.h"
    cx10Nrf24Init(const struct rxSpiConfig_s *rxSpiConfig, struct rxRuntimeState_s *rxRuntimeState, rxSpiExtiConfig_t *extiConfig);
...
# 46 "./src/main/rx/rx_spi.c" 2
# 1 "./src/main/rx/nrf24_syma.h" 1
# 21 "./src/main/rx/nrf24_syma.h"
...
# 28 "./src/main/rx/nrf24_syma.h" 3 4
_Bool 
# 28 "./src/main/rx/nrf24_syma.h"
    symaNrf24Init(const struct rxSpiConfig_s *rxSpiConfig, struct rxRuntimeState_s *rxRuntimeState, rxSpiExtiConfig_t *extiConfig);
...
# 47 "./src/main/rx/rx_spi.c" 2
# 1 "./src/main/rx/nrf24_v202.h" 1
# 21 "./src/main/rx/nrf24_v202.h"
...
# 28 "./src/main/rx/nrf24_v202.h" 3 4
_Bool 
# 28 "./src/main/rx/nrf24_v202.h"
    v202Nrf24Init(const struct rxSpiConfig_s *rxSpiConfig, struct rxRuntimeState_s *rxRuntimeState, rxSpiExtiConfig_t *extiConfig);
...
# 48 "./src/main/rx/rx_spi.c" 2
# 1 "./src/main/rx/nrf24_h8_3d.h" 1
# 21 "./src/main/rx/nrf24_h8_3d.h"
...
# 28 "./src/main/rx/nrf24_h8_3d.h" 3 4
_Bool 
# 28 "./src/main/rx/nrf24_h8_3d.h"
    h8_3dNrf24Init(const struct rxSpiConfig_s *rxSpiConfig, struct rxRuntimeState_s *rxRuntimeState, rxSpiExtiConfig_t *extiConfig);
...
# 49 "./src/main/rx/rx_spi.c" 2
# 1 "./src/main/rx/nrf24_inav.h" 1
# 21 "./src/main/rx/nrf24_inav.h"
...
# 28 "./src/main/rx/nrf24_inav.h" 3 4
_Bool 
# 28 "./src/main/rx/nrf24_inav.h"
    inavNrf24Init(const struct rxSpiConfig_s *rxSpiConfig, struct rxRuntimeState_s *rxRuntimeState, rxSpiExtiConfig_t *extiConfig);
...
# 50 "./src/main/rx/rx_spi.c" 2
# 1 "./src/main/rx/nrf24_kn.h" 1
# 21 "./src/main/rx/nrf24_kn.h"
...
# 28 "./src/main/rx/nrf24_kn.h" 3 4
_Bool 
# 28 "./src/main/rx/nrf24_kn.h"
    knNrf24Init(const struct rxConfig_s *rxConfig, struct rxRuntimeState_s *rxRuntimeState, rxSpiExtiConfig_t *extiConfig);
...
# 54 "./src/main/rx/rx_spi.c" 2


uint16_t rxSpiRcData[18];
static uint8_t rxSpiPayload[35];
static uint8_t rxSpiNewPacketAvailable;

typedef 
# 60 "./src/main/rx/rx_spi.c" 3 4
       _Bool 
# 60 "./src/main/rx/rx_spi.c"
            (*protocolInitFnPtr)(const rxSpiConfig_t *rxSpiConfig, rxRuntimeState_t *rxRuntimeState, rxSpiExtiConfig_t *extiConfig);
...
static uint16_t rxSpiReadRawRC(const rxRuntimeState_t *rxRuntimeState, uint8_t channel)
{
    _Static_assert((32 <= 35), "NRF24L01_MAX_PAYLOAD_SIZE_larger_than_RX_SPI_MAX_PAYLOAD_SIZE");
...
# 79 "./src/main/rx/rx_spi.c" 3 4
                                 0
# 79 "./src/main/rx/rx_spi.c"
                                      ;
    }
...
static 
# 84 "./src/main/rx/rx_spi.c" 3 4
                  _Bool 
# 84 "./src/main/rx/rx_spi.c"
                       rxSpiSetProtocol(rx_spi_protocol_e protocol)
{
    switch (protocol) {
# 172 "./src/main/rx/rx_spi.c"
    ...
    default:
        return 
# 179 "./src/main/rx/rx_spi.c" 3 4
              0
# 179 "./src/main/rx/rx_spi.c"
                   ;
    }

    return 
# 182 "./src/main/rx/rx_spi.c" 3 4
          1
# 182 "./src/main/rx/rx_spi.c"
              ;
}
...
static uint8_t rxSpiFrameStatus(rxRuntimeState_t *rxRuntimeState)
{
    ...
    if (result & RX_SPI_RECEIVED_DATA) {
        rxSpiNewPacketAvailable = 
# 199 "./src/main/rx/rx_spi.c" 3 4
                                 1
# 199 "./src/main/rx/rx_spi.c"
                                     ;
...
static 
# 210 "./src/main/rx/rx_spi.c" 3 4
      _Bool 
# 210 "./src/main/rx/rx_spi.c"
           rxSpiProcessFrame(const rxRuntimeState_t *rxRuntimeState)
{
    (void)(rxRuntimeState);
    ...
    if (protocolProcessFrame) {
        ...
        if (result & RX_SPI_RECEIVED_DATA) {
            rxSpiNewPacketAvailable = 
# 218 "./src/main/rx/rx_spi.c" 3 4
                                     1
# 218 "./src/main/rx/rx_spi.c"
                                         ;
        }

        if (result & RX_SPI_ROCESSING_REQUIRED) {
            return 
# 222 "./src/main/rx/rx_spi.c" 3 4
                  0
# 222 "./src/main/rx/rx_spi.c"
                       ;
        }
    }

    return 
# 226 "./src/main/rx/rx_spi.c" 3 4
          1
# 226 "./src/main/rx/rx_spi.c"
              ;
}
...
# 232 "./src/main/rx/rx_spi.c" 3 4
_Bool 
# 232 "./src/main/rx/rx_spi.c"
    rxSpiInit(const rxSpiConfig_t *rxSpiConfig, rxRuntimeState_t *rxRuntimeState)
{
    
# 234 "./src/main/rx/rx_spi.c" 3 4
   _Bool 
# 234 "./src/main/rx/rx_spi.c"
        ret = 
# 234 "./src/main/rx/rx_spi.c" 3 4
              0
# 234 "./src/main/rx/rx_spi.c"
    ...
    if (!rxSpiDeviceInit(rxSpiConfig)) {
        return 
# 237 "./src/main/rx/rx_spi.c" 3 4
              0
# 237 "./src/main/rx/rx_spi.c"
                   ;
    }

    if (!rxSpiSetProtocol(rxSpiConfig->rx_spi_protocol)) {
        return 
# 241 "./src/main/rx/rx_spi.c" 3 4
              0
# 241 "./src/main/rx/rx_spi.c"
                   ;
    }

    rxSpiExtiConfig_t extiConfig = {
        .ioConfig = ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)),
    ...
    rxSpiNewPacketAvailable = 
# 257 "./src/main/rx/rx_spi.c" 3 4
                             0
# 257 "./src/main/rx/rx_spi.c"
                                  ;
