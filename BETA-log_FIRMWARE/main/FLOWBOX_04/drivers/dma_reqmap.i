...
# 343 "./src/main/drivers/dma_reqmap.c"
static const dmaPeripheralMapping_t dmaPeripheralMapping[] = {


    { DMA_PERIPH_SPI_TX, SPIDEV_1, { { ((2 << 12)|(3 << 8)|(3 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x058)), ((uint32_t)0x06000000) }, { ((2 << 12)|(5 << 8)|(3 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088)), ((uint32_t)0x06000000) } } },
    { DMA_PERIPH_SPI_RX, SPIDEV_1, { { ((2 << 12)|(0 << 8)|(3 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x010)), ((uint32_t)0x06000000) }, { ((2 << 12)|(2 << 8)|(3 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x040)), ((uint32_t)0x06000000) } } },
    { DMA_PERIPH_SPI_TX, SPIDEV_2, { { ((1 << 12)|(4 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x070)), ((uint32_t)0x00000000) } } },
    { DMA_PERIPH_SPI_RX, SPIDEV_2, { { ((1 << 12)|(3 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x058)), ((uint32_t)0x00000000) } } },
    { DMA_PERIPH_SPI_TX, SPIDEV_3, { { ((1 << 12)|(5 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088)), ((uint32_t)0x00000000) }, { ((1 << 12)|(7 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x0B8)), ((uint32_t)0x00000000) } } },
    { DMA_PERIPH_SPI_RX, SPIDEV_3, { { ((1 << 12)|(0 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x010)), ((uint32_t)0x00000000) }, { ((1 << 12)|(2 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x040)), ((uint32_t)0x00000000) } } },


    { DMA_PERIPH_SPI_TX, SPIDEV_4, { { ((2 << 12)|(1 << 8)|(4 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028)), ((uint32_t)0x08000000) } } },
    { DMA_PERIPH_SPI_RX, SPIDEV_4, { { ((2 << 12)|(0 << 8)|(4 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x010)), ((uint32_t)0x08000000) } } },
# 370 "./src/main/drivers/dma_reqmap.c"
...
# 531 "./src/main/drivers/dma_reqmap.c"
const dmaChannelSpec_t *dmaGetChannelSpecByPeripheral(dmaPeripheral_e device, uint8_t index, int8_t opt)
{
    if (opt < 0 || opt >= 2) {
        return 
