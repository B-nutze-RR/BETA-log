...
# 45 "./src/main/io/flashfs.c" 2

static const flashPartition_t *flashPartition = 
# 46 "./src/main/io/flashfs.c" 3 4
                                               ((void *)0)
# 46 "./src/main/io/flashfs.c"
                                                   ;
...
static 
# 69 "./src/main/io/flashfs.c" 3 4
      _Bool 
# 69 "./src/main/io/flashfs.c"
...
void flashfsEraseCompletely(void)
{
    if (flashGeometry->sectors > 0 && flashPartitionCount() > 0) {
        ...
        const 
# 83 "./src/main/io/flashfs.c" 3 4
             _Bool 
# 83 "./src/main/io/flashfs.c"
...
# 135 "./src/main/io/flashfs.c" 3 4
_Bool 
# 135 "./src/main/io/flashfs.c"
    flashfsIsReady(void)
{
...
# 142 "./src/main/io/flashfs.c" 3 4
_Bool 
# 142 "./src/main/io/flashfs.c"
    flashfsIsSupported(void)
{
...
# 338 "./src/main/io/flashfs.c" 3 4
_Bool 
# 338 "./src/main/io/flashfs.c"
    flashfsFlushAsync(void)
{
    if (flashfsBufferIsEmpty()) {
        return 
...
# 349 "./src/main/io/flashfs.c" 3 4
                                                               0
# 349 "./src/main/io/flashfs.c"
                                                                    );
...
# 371 "./src/main/io/flashfs.c" 3 4
                                                1
# 371 "./src/main/io/flashfs.c"
                                                    );
...
void flashfsWrite(const uint8_t *data, unsigned int len, 
# 413 "./src/main/io/flashfs.c" 3 4
                                                        _Bool 
# 413 "./src/main/io/flashfs.c"
                                                             sync)
{
...
# 452 "./src/main/io/flashfs.c" 3 4
                                                            1
# 452 "./src/main/io/flashfs.c"
                                                                );
                flashfsClearBuffer();
            } else {
...
# 551 "./src/main/io/flashfs.c"
    ...
    while (left < right) {
        ...
        blockErased = 
# 562 "./src/main/io/flashfs.c" 3 4
                     1
# 562 "./src/main/io/flashfs.c"
                         ;
...
# 588 "./src/main/io/flashfs.c" 3 4
_Bool 
# 588 "./src/main/io/flashfs.c"
    flashfsIsEOF(void)
{
...
# 631 "./src/main/io/flashfs.c" 3 4
_Bool 
# 631 "./src/main/io/flashfs.c"
    flashfsVerifyEntireFlash(void)
{
...
# 646 "./src/main/io/flashfs.c" 3 4
                                                      1
# 646 "./src/main/io/flashfs.c"
                                                          );
    }
    flashfsFlushSync();
    flashfsClose();
