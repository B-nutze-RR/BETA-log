...
# 215 "./src/main/drivers/compass/compass_hmc5883l.c"
    ...
    return 
# 222 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
          1
# 222 "./src/main/drivers/compass/compass_hmc5883l.c"
              ;
}

static 
# 225 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
      _Bool 
# 225 "./src/main/drivers/compass/compass_hmc5883l.c"
           hmc5883lInit(magDev_t *mag)
{
    ...
    return 
# 238 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
          1
# 238 "./src/main/drivers/compass/compass_hmc5883l.c"
              ;
}


# 241 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
_Bool 
# 241 "./src/main/drivers/compass/compass_hmc5883l.c"
    hmc5883lDetect(magDev_t* mag)
{
    busDevice_t *busdev = &mag->busdev;

    uint8_t sig = 0;
# 254 "./src/main/drivers/compass/compass_hmc5883l.c"
...
# 259 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
   _Bool 
# 259 "./src/main/drivers/compass/compass_hmc5883l.c"
        ack = busReadRegisterBuffer(&mag->busdev, 0x0A, &sig, 1);

    if (!ack || sig != 0x48) {
        return 
# 262 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
              0
# 262 "./src/main/drivers/compass/compass_hmc5883l.c"
                   ;
    }
    ...
    return 
# 268 "./src/main/drivers/compass/compass_hmc5883l.c" 3 4
          1
# 268 "./src/main/drivers/compass/compass_hmc5883l.c"
              ;
}
