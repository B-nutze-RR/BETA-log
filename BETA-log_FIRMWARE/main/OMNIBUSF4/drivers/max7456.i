...
# 532 "./src/main/drivers/max7456.c"
    ...
    case 0:
        max7456SpiClock = spiCalculateDivider(10000000) * 2;
        break;

    case 1:
        max7456SpiClock = (cpuOverclock && (max7456DeviceType == 0)) ? spiCalculateDivider(10000000) * 2 : spiCalculateDivider(10000000);
        break;
