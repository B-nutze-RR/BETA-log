...
static void mpuIntExtiInit(gyroDev_t *gyro)
{
    ...
    EXTIConfig(mpuIntIO, &gyro->exti, (((((0x0f)<<(4-(7-(((uint32_t)0x00000005)))))|((0x0f)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0), (((0x00000000U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)), BETAFLIGHT_EXTI_TRIGGER_RISING);
    EXTIEnable(mpuIntIO, 
...
# 239 "./src/main/drivers/accgyro/accgyro_mpu.c"
    ...
    IOConfigGPIO(gyro->bus.busdev_u.spi.csnPin, (((0x00000001U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)));
...
void mpuPreInit(const struct gyroDeviceConfig_s *config)
{
    ...
    spiPreinitRegister(config->csnTag, (((0x00000000U)) | (((0x00000000U)) << 2) | (((0x00000001U)) << 5)), 1);
