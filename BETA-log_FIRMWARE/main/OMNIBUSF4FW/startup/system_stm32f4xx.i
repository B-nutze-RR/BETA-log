# 1 "./src/main/startup/system_stm32f4xx.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/startup/system_stm32f4xx.c"
# 317 "./src/main/startup/system_stm32f4xx.c"
...
# 318 "./src/main/startup/system_stm32f4xx.c" 2
...
# 319 "./src/main/startup/system_stm32f4xx.c" 2
...
# 320 "./src/main/startup/system_stm32f4xx.c" 2
# 1 "./src/main/startup/system_stm32f4xx.h" 1
# 321 "./src/main/startup/system_stm32f4xx.c" 2
...
# 153 "./src/main/platform.h" 2
# 322 "./src/main/startup/system_stm32f4xx.c" 2
...
# 323 "./src/main/startup/system_stm32f4xx.c" 2
# 373 "./src/main/startup/system_stm32f4xx.c"
volatile const uint8_t AHBPrescTable[16] = {0, 0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4, 6, 7, 8, 9};
# 383 "./src/main/startup/system_stm32f4xx.c"
void SetSysClock(void);
# 405 "./src/main/startup/system_stm32f4xx.c"
...
static const pllConfig_t overclockLevels[] = {
  ...
  { 216, 432, 2, 9 },
  { 240, 480, 2, 10 }
# 458 "./src/main/startup/system_stm32f4xx.c"
};
...
# 550 "./src/main/startup/system_stm32f4xx.c"
...
# 564 "./src/main/startup/system_stm32f4xx.c"
    SystemCoreClockUpdate();
}
# 603 "./src/main/startup/system_stm32f4xx.c"
void SystemCoreClockUpdate(void)
{
  ...
  switch (tmp)
  {
    ...
    case 0x08:
      ...
      break;
# 665 "./src/main/startup/system_stm32f4xx.c"
    default:
      SystemCoreClock = ((uint32_t)16000000);
      break;
  }
...
# 690 "./src/main/startup/system_stm32f4xx.c"
void SetSysClock(void)
{
    uint32_t hse_value = persistentObjectRead(PERSISTENT_OBJECT_HSE_VALUE);
...
# 709 "./src/main/startup/system_stm32f4xx.c"
    if (hse_value == 0) {
...
# 775 "./src/main/startup/system_stm32f4xx.c"
...
# 801 "./src/main/startup/system_stm32f4xx.c"
...
# 810 "./src/main/startup/system_stm32f4xx.c"
...
# 872 "./src/main/startup/system_stm32f4xx.c"
    uint32_t plli2s_n = ((27 * 4) * 2) / pll_input;


    RCC_PLLI2SConfig(plli2s_n, 2);
# 884 "./src/main/startup/system_stm32f4xx.c"
