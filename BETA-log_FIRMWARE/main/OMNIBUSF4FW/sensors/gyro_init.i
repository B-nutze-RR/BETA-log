...
static void gyroInitFilterDynamicNotch()
{
    ...
    if (isDynamicFilterActive()) {
        gyro.notchFilterDynApplyFn = (filterApplyFnPtr)biquadFilterApplyDF1;
        if(gyroConfig()->dyn_notch_width_percent != 0) {
            gyro.notchFilterDynApplyFn2 = (filterApplyFnPtr)biquadFilterApplyDF1;
        }
        const float notchQ = filterGetNotchQ(350, 300);
        for (int axis = 0; axis < 3; axis++) {
            biquadFilterInit(&gyro.notchFilterDyn[axis], 350, gyro.targetLooptime, notchQ, FILTER_NOTCH);
            biquadFilterInit(&gyro.notchFilterDyn2[axis], 350, gyro.targetLooptime, notchQ, FILTER_NOTCH);
        }
    }
}
...
# 155 "./src/main/sensors/gyro_init.c" 3 4
                                        ((void *)0)
# 155 "./src/main/sensors/gyro_init.c"
                                            ;
    ...
    default:
        return 
# 169 "./src/main/sensors/gyro_init.c" 3 4
              0
# 169 "./src/main/sensors/gyro_init.c"
                   ;
    }

    
# 172 "./src/main/sensors/gyro_init.c" 3 4
   _Bool 
# 172 "./src/main/sensors/gyro_init.c"
        ret = 
# 172 "./src/main/sensors/gyro_init.c" 3 4
              0
# 172 "./src/main/sensors/gyro_init.c"
...
# 193 "./src/main/sensors/gyro_init.c"
        ...
        case FILTER_BIQUAD:
            ...
            *lowpassFilterApplyFn = (filterApplyFnPtr) biquadFilterApplyDF1;
            ...
            ret = 
# 204 "./src/main/sensors/gyro_init.c" 3 4
                 1
# 204 "./src/main/sensors/gyro_init.c"
                     ;
            break;
        }
    }
...
# 281 "./src/main/sensors/gyro_init.c"
...
# 318 "./src/main/sensors/gyro_init.c" 3 4
                                                       1
# 318 "./src/main/sensors/gyro_init.c"
                                                           ;
        break;
    ...
    case GYRO_ICM20689:
        gyroSensor->gyroDev.gyroHasOverflowProtection = 
# 326 "./src/main/sensors/gyro_init.c" 3 4
                                                       0
# 326 "./src/main/sensors/gyro_init.c"
                                                            ;
        break;

    default:
        gyroSensor->gyroDev.gyroHasOverflowProtection = 
# 330 "./src/main/sensors/gyro_init.c" 3 4
                                                       0
# 330 "./src/main/sensors/gyro_init.c"
                                                            ;
        break;
    }
...
# 382 "./src/main/sensors/gyro_init.c"
    case GYRO_MPU6000:
    ...
    case GYRO_ICM20608G:
        ...
        __attribute__ ((fallthrough));
# 493 "./src/main/sensors/gyro_init.c"
    default:
...
static 
# 505 "./src/main/sensors/gyro_init.c" 3 4
      _Bool 
# 505 "./src/main/sensors/gyro_init.c"
...
# 511 "./src/main/sensors/gyro_init.c" 3 4
   _Bool 
# 511 "./src/main/sensors/gyro_init.c"
...
# 549 "./src/main/sensors/gyro_init.c" 3 4
_Bool 
# 549 "./src/main/sensors/gyro_init.c"
    gyroInit(void)
{
...
# 562 "./src/main/sensors/gyro_init.c" 3 4
                               0
# 562 "./src/main/sensors/gyro_init.c"
                                    ;
    gyro.gyroHasOverflowProtection = 
# 563 "./src/main/sensors/gyro_init.c" 3 4
                                    1
# 563 "./src/main/sensors/gyro_init.c"
                                        ;
    ...
    case DEBUG_DUAL_GYRO_SCALED:
        gyro.useDualGyroDebugging = 
# 578 "./src/main/sensors/gyro_init.c" 3 4
                                   1
# 578 "./src/main/sensors/gyro_init.c"
                                       ;
        break;
    }
    ...
    if (gyroDetectionFlags == GYRO_NONE_MASK) {
        return 
# 599 "./src/main/sensors/gyro_init.c" 3 4
              0
# 599 "./src/main/sensors/gyro_init.c"
                   ;
    }

    
# 602 "./src/main/sensors/gyro_init.c" 3 4
   _Bool 
# 602 "./src/main/sensors/gyro_init.c"
        eepromWriteRequired = 
# 602 "./src/main/sensors/gyro_init.c" 3 4
                              0
# 602 "./src/main/sensors/gyro_init.c"
    ...
    if (!gyrosToScan) {
        ...
        eepromWriteRequired = 
# 605 "./src/main/sensors/gyro_init.c" 3 4
                             1
# 605 "./src/main/sensors/gyro_init.c"
                                 ;
    }
    ...
    if ((gyro.gyroToUse == 2 && !((gyroDetectionFlags & GYRO_ALL_MASK) == GYRO_ALL_MASK))
        ...
        eepromWriteRequired = 
# 619 "./src/main/sensors/gyro_init.c" 3 4
                             1
# 619 "./src/main/sensors/gyro_init.c"
                                 ;
    }
...
# 629 "./src/main/sensors/gyro_init.c"
    ...
    return 
# 670 "./src/main/sensors/gyro_init.c" 3 4
          1
# 670 "./src/main/sensors/gyro_init.c"
              ;
}
...
{
    return &((gyro.gyroToUse == 1) ? &gyro.gyroSensor2 : &gyro.gyroSensor1)->gyroDev.bus;
}
