...
static serialPortUsage_t serialPortUsageList[7];

const serialPortIdentifier_e serialPortIdentifiers[7] = {
...
void pgResetFn_serialConfig(serialConfig_t *serialConfig)
{
    ...
    serialPortConfig_t *serialRxUartConfig = serialFindPortConfigurationMutable(SERIAL_PORT_USART6);
    ...
    serialPortConfig_t *serialTlemetryUartConfig = serialFindPortConfigurationMutable(SERIAL_PORT_USART2);
...
const serialPortConfig_t *findNextSerialPortConfig(serialPortFunction_e function)
{
    while (findSerialPortConfigState.lastIndex < 7) {
