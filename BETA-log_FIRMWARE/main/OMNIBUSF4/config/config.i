...
0
# 116 "./src/main/config/config.c"
, .cpu_overclock = 0, .powerOnArmingGraceTime = 5, .boardIdentifier = "OBF4", .hseMhz = (8000000/1000000U), .configurationState = CONFIGURATION_STATE_DEFAULTS_BARE, .schedulerOptimizeRate = SCHEDULER_OPTIMIZE_RATE_AUTO, .enableStickArming = 
# 116 "./src/main/config/config.c" 3 4
0
# 116 "./src/main/config/config.c"
, }
...
# 241 "./src/main/config/config.c"
    ...
    if (!(featureIsConfigured(FEATURE_RX_PARALLEL_PWM) || featureIsConfigured(FEATURE_RX_PPM) || featureIsConfigured(FEATURE_RX_SERIAL) || featureIsConfigured(FEATURE_RX_MSP) || featureIsConfigured(FEATURE_RX_SPI))) {
        featureEnableImmediate(FEATURE_RX_SPI);
    }
...
# 457 "./src/main/config/config.c"
    featureDisableImmediate(FEATURE_TELEMETRY);
# 493 "./src/main/config/config.c"
