...
static void indicate(uint8_t count, uint16_t duration)
{
    if (count) {
        ledSet(1, 
# 208 "./src/main/drivers/system.c" 3 4
       1
# 208 "./src/main/drivers/system.c"
       );
        ledSet(0, 
# 209 "./src/main/drivers/system.c" 3 4
       0
# 209 "./src/main/drivers/system.c"
       );
        ...
        while (count--) {
            ...
            ledToggle(0);
            systemBeep(
# 214 "./src/main/drivers/system.c" 3 4
           1
# 214 "./src/main/drivers/system.c"
           );
            delay(duration);
            ...
            ledToggle(0);
            systemBeep(
# 219 "./src/main/drivers/system.c" 3 4
           0
