...
# 40 "./src/main/pg/rx.c" 3 4
   0
# 40 "./src/main/pg/rx.c"
   , .rssi_channel = 0, .rssi_scale = 100, .rssi_offset = 0, .rssi_invert = 0, .rssi_src_frame_lpf_period = 30, .rcInterpolation = RC_SMOOTHING_AUTO, .rcInterpolationChannels = INTERPOLATION_CHANNELS_RPYT, .rcInterpolationInterval = 19, .fpvCamAngleDegrees = 0, .airModeActivateThreshold = 25, .max_aux_channel = (18 - 4), .rc_smoothing_type = RC_SMOOTHING_TYPE_FILTER, .rc_smoothing_input_cutoff = 0, .rc_smoothing_derivative_cutoff = 0, .rc_smoothing_debug_axis = ROLL, .rc_smoothing_input_type = RC_SMOOTHING_INPUT_BIQUAD, .rc_smoothing_derivative_type = RC_SMOOTHING_DERIVATIVE_AUTO, .rc_smoothing_auto_factor = 10, .srxl2_unit_id = 1, .srxl2_baud_fast = 
# 40 "./src/main/pg/rx.c" 3 4
   1
# 40 "./src/main/pg/rx.c"
   , .sbus_baud_fast = 
