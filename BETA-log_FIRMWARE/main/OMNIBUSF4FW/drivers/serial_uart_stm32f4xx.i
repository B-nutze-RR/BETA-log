...
# 40 "./src/main/drivers/serial_uart_stm32f4xx.c" 2
...
# 41 "./src/main/drivers/serial_uart_stm32f4xx.c" 2

const uartHardware_t uartHardware[(1 + 1 + 1 + 1 + 0 + 1 + 0 + 0 + 0)] = {
...

    {
        ...
        .rxPins = { { ((ioTag_t)((((0) + 1) << 4) | (3))) }, { 0 } },
        .txPins = { { ((ioTag_t)((((0) + 1) << 4) | (2))) }, { 0 } },
        .af = ((uint8_t)0x07),
...
uartPort_t *serialUART(UARTDevice_e device, uint32_t baudRate, portMode_e mode, portOptions_e options)
{
    ...
    if (!uart) return 
# 253 "./src/main/drivers/serial_uart_stm32f4xx.c" 3 4
                     ((void *)0)
# 253 "./src/main/drivers/serial_uart_stm32f4xx.c"
                         ;

    const uartHardware_t *hardware = uart->hardware;

    if (!hardware) return 
# 257 "./src/main/drivers/serial_uart_stm32f4xx.c" 3 4
                         ((void *)0)
# 257 "./src/main/drivers/serial_uart_stm32f4xx.c"
                             ;
