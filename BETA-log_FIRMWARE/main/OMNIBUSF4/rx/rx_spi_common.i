...
# 29 "./src/main/rx/rx_spi_common.c" 2
...
# 30 "./src/main/rx/rx_spi_common.c" 2
...
# 38 "./src/main/rx/rx_spi_common.h"
                                 reset);
# 31 "./src/main/rx/rx_spi_common.c" 2


static IO_t ledPin;
static 
# 34 "./src/main/rx/rx_spi_common.c" 3 4
      _Bool 
# 34 "./src/main/rx/rx_spi_common.c"
           ledInversion = 
# 34 "./src/main/rx/rx_spi_common.c" 3 4
                          0
# 34 "./src/main/rx/rx_spi_common.c"
...
static IO_t bindPin;
static 
# 37 "./src/main/rx/rx_spi_common.c" 3 4
      _Bool 
# 37 "./src/main/rx/rx_spi_common.c"
           bindRequested;
static 
# 38 "./src/main/rx/rx_spi_common.c" 3 4
      _Bool 
# 38 "./src/main/rx/rx_spi_common.c"
           lastBindPinStatus;
...
void rxSpiCommonIOInit(const rxSpiConfig_t *rxSpiConfig)
{
    if (rxSpiConfig->ledIoTag) {
        ...
        IOConfigGPIO(ledPin, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
    ...
    if (rxSpiConfig->bindIoTag) {
        ...
        IOConfigGPIO(bindPin, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_UP) << 5)));
...
{
    bindRequested = 
# 119 "./src/main/rx/rx_spi_common.c" 3 4
                   1
# 119 "./src/main/rx/rx_spi_common.c"
                       ;
}


# 122 "./src/main/rx/rx_spi_common.c" 3 4
_Bool 
# 122 "./src/main/rx/rx_spi_common.c"
    rxSpiCheckBindRequested(
# 122 "./src/main/rx/rx_spi_common.c" 3 4
                            _Bool 
# 122 "./src/main/rx/rx_spi_common.c"
...
# 125 "./src/main/rx/rx_spi_common.c" 3 4
       _Bool 
# 125 "./src/main/rx/rx_spi_common.c"
            bindPinStatus = IORead(bindPin);
        if (lastBindPinStatus && !bindPinStatus) {
            bindRequested = 
# 127 "./src/main/rx/rx_spi_common.c" 3 4
                           1
# 127 "./src/main/rx/rx_spi_common.c"
                               ;
        }
    ...
    if (!bindRequested) {
        return 
# 133 "./src/main/rx/rx_spi_common.c" 3 4
              0
# 133 "./src/main/rx/rx_spi_common.c"
                   ;
    } else {
        if (reset) {
            bindRequested = 
# 136 "./src/main/rx/rx_spi_common.c" 3 4
                           0
# 136 "./src/main/rx/rx_spi_common.c"
                                ;
        }

        return 
# 139 "./src/main/rx/rx_spi_common.c" 3 4
              1
# 139 "./src/main/rx/rx_spi_common.c"
                  ;
    }
}
