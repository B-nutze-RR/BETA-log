...
__attribute__((section(".tcm_code"))) float nullFilterApply(filter_t *filter, float input)
{
    ((void)(filter));
    return input;
}
...
__attribute__((section(".tcm_code"))) float pt1FilterApply(pt1Filter_t *filter, float input)
{
...
__attribute__((section(".tcm_code"))) float slewFilterApply(slewFilter_t *filter, float input)
{
...
__attribute__((section(".tcm_code"))) void biquadFilterUpdate(biquadFilter_t *filter, float filterFreq, uint32_t refreshRate, float Q, biquadFilterType_e filterType)
{
...
__attribute__((section(".tcm_code"))) void biquadFilterUpdateLPF(biquadFilter_t *filter, float filterFreq, uint32_t refreshRate)
{
    biquadFilterUpdate(filter, filterFreq, refreshRate, 1.0f / sqrtf(2.0f), FILTER_LPF);
}


__attribute__((section(".tcm_code"))) float biquadFilterApplyDF1(biquadFilter_t *filter, float input)
{
...
__attribute__((section(".tcm_code"))) float biquadFilterApply(biquadFilter_t *filter, float input)
{
...
__attribute__((section(".tcm_code"))) float laggedMovingAverageUpdate(laggedMovingAverage_t *filter, float input)
{
