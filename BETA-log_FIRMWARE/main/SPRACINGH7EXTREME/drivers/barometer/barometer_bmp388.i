# 1 "./src/main/drivers/barometer/barometer_bmp388.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/barometer/barometer_bmp388.c"
# 23 "./src/main/drivers/barometer/barometer_bmp388.c"
# 1 "c:\\dev\\9 2020-q2-update\\lib\\gcc\\arm-none-eabi\\9.3.1\\include\\stdbool.h" 1 3 4
# 24 "./src/main/drivers/barometer/barometer_bmp388.c" 2
...
# 25 "./src/main/drivers/barometer/barometer_bmp388.c" 2
...
# 153 "./src/main/platform.h" 2
# 27 "./src/main/drivers/barometer/barometer_bmp388.c" 2
...
# 29 "./src/main/drivers/barometer/barometer_bmp388.c" 2
...
# 33 "./src/main/drivers/barometer/barometer_bmp388.c" 2
...
# 35 "./src/main/drivers/barometer/barometer_bmp388.c" 2
...
# 37 "./src/main/drivers/barometer/barometer_bmp388.c" 2
...
# 24 "./src/main/drivers/bus_i2c_busdev.h"
    i2cBusWriteRegisterStart(const busDevice_t *busdev, uint8_t reg, uint8_t data);
...
# 27 "./src/main/drivers/bus_i2c_busdev.h"
    i2cBusReadRegisterBufferStart(const busDevice_t *busdev, uint8_t reg, uint8_t *data, uint8_t length);

# 28 "./src/main/drivers/bus_i2c_busdev.h" 3 4
_Bool 
# 28 "./src/main/drivers/bus_i2c_busdev.h"
    i2cBusBusy(const busDevice_t *busdev, 
# 28 "./src/main/drivers/bus_i2c_busdev.h" 3 4
                                          _Bool 
# 28 "./src/main/drivers/bus_i2c_busdev.h"
                                               *error);
void i2cBusDeviceRegister(const busDevice_t *busdev);
# 41 "./src/main/drivers/barometer/barometer_bmp388.c" 2
...
# 42 "./src/main/drivers/barometer/barometer_bmp388.c" 2
...
# 43 "./src/main/drivers/barometer/barometer_bmp388.c" 2
...
# 44 "./src/main/drivers/barometer/barometer_bmp388.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 45 "./src/main/drivers/barometer/barometer_bmp388.c" 2
...
# 47 "./src/main/drivers/barometer/barometer_bmp388.c" 2
# 146 "./src/main/drivers/barometer/barometer_bmp388.c"
...
_Static_assert((sizeof(bmp388_calib_param_t) == (((0x45) - (0x31)) + 1)), "bmp388_calibration_structure_incorrectly_packed");
...
static uint8_t sensor_data[(((0x09) - (0x04)) + 1)];

static int64_t t_lin = 0;

static void bmp388StartUT(baroDev_t *baro);
static 
# 175 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
      _Bool 
# 175 "./src/main/drivers/barometer/barometer_bmp388.c"
           bmp388GetUT(baroDev_t *baro);
static 
# 176 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
      _Bool 
# 176 "./src/main/drivers/barometer/barometer_bmp388.c"
           bmp388ReadUT(baroDev_t *baro);
static void bmp388StartUP(baroDev_t *baro);
static 
# 178 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
      _Bool 
# 178 "./src/main/drivers/barometer/barometer_bmp388.c"
           bmp388GetUP(baroDev_t *baro);
static 
# 179 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
      _Bool 
# 179 "./src/main/drivers/barometer/barometer_bmp388.c"
           bmp388ReadUP(baroDev_t *baro);

static void bmp388Calculate(int32_t *pressure, int32_t *temperature);
...
void bmp388_extiHandler(extiCallbackRec_t* cb)
{
    ...
    baroDev_t *baro = ( __extension__ ({ const typeof( ((baroDev_t *)0)->exti ) *__mptr = (cb); (baroDev_t *)( (char *)__mptr - 
# 192 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
                     __builtin_offsetof (
# 192 "./src/main/drivers/barometer/barometer_bmp388.c"
                     baroDev_t
# 192 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
                     , 
# 192 "./src/main/drivers/barometer/barometer_bmp388.c"
...
# 192 "./src/main/drivers/barometer/barometer_bmp388.c"
    ...
    uint8_t intStatus = 0;
    busReadRegisterBuffer(&baro->busdev, (0x11), &intStatus, 1);
}


void bmp388BusInit(busDevice_t *busdev)
{
# 209 "./src/main/drivers/barometer/barometer_bmp388.c"
    ((void)(busdev));
...
void bmp388BeginForcedMeasurement(busDevice_t *busdev)
{
    ...
    uint8_t mode = (0x01) << 4 | 1 << 1 | 1 << 0;
    busWriteRegisterStart(busdev, (0x1B), mode);
}


# 231 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
_Bool 
# 231 "./src/main/drivers/barometer/barometer_bmp388.c"
    bmp388Detect(const bmp388Config_t *config, baroDev_t *baro)
{
    delay(20);
    ...
    if (baroIntIO) {
        ...
        EXTIConfig(baroIntIO, &baro->exti, (((((0x0f)<<(4-(7-(((uint32_t)0x00000005)))))|((0x0f)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0), (((0x00000000U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)), BETAFLIGHT_EXTI_TRIGGER_RISING);
        EXTIEnable(baroIntIO, 
# 241 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
                             1
# 241 "./src/main/drivers/barometer/barometer_bmp388.c"
                                 );
    }
...
# 248 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
   _Bool 
# 248 "./src/main/drivers/barometer/barometer_bmp388.c"
...
# 248 "./src/main/drivers/barometer/barometer_bmp388.c"
    ...
    if ((busdev->bustype == BUSTYPE_I2C) && (busdev->busdev_u.i2c.address == 0)) {
        ...
        defaultAddressApplied = 
# 255 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
                               1
# 255 "./src/main/drivers/barometer/barometer_bmp388.c"
                                   ;
    }

    busReadRegisterBuffer(busdev, (0x00), &bmp388_chip_id, 1);

    if (bmp388_chip_id != (0x50)) {
        bmp388BusDeinit(busdev);
        if (defaultAddressApplied) {
            busdev->busdev_u.i2c.address = 0;
        }
        return 
# 265 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
              0
# 265 "./src/main/drivers/barometer/barometer_bmp388.c"
                   ;
    }
    ...
    if (baroIntIO) {
        uint8_t intCtrlValue = 1 << 6 |
                               0 << 4 |
                               0 << 3 |
                               0 << 2 |
                               1 << 1 |
                               0 << 0;
        busWriteRegister(busdev, (0x19), intCtrlValue);
    }



    busReadRegisterBuffer(busdev, (0x31), (uint8_t *)&bmp388_cal, sizeof(bmp388_calib_param_t));



    busWriteRegister(busdev, (0x1C),
        ((((0x03)) << 0) & (0x03)) |
        ((((0x00)) << 3) & (0x38))
    );
    ...
    baro->up_delay = 234 +
        (392 + (powerf(2, ((0x03)) + 1) * 2000)) +
        (313 + (powerf(2, ((0x00)) + 1) * 2000));

    baro->calculate = bmp388Calculate;

    while (busBusy(&baro->busdev, 
# 311 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
                                 ((void *)0)
# 311 "./src/main/drivers/barometer/barometer_bmp388.c"
                                     ));

    return 
# 313 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
          1
# 313 "./src/main/drivers/barometer/barometer_bmp388.c"
              ;
}
...
static 
# 322 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
      _Bool 
# 322 "./src/main/drivers/barometer/barometer_bmp388.c"
           bmp388ReadUT(baroDev_t *baro)
{
    ((void)(baro));

    return 
# 326 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
          1
# 326 "./src/main/drivers/barometer/barometer_bmp388.c"
              ;
}

static 
# 329 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
      _Bool 
# 329 "./src/main/drivers/barometer/barometer_bmp388.c"
           bmp388GetUT(baroDev_t *baro)
{
    ((void)(baro));

    return 
# 333 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
          1
# 333 "./src/main/drivers/barometer/barometer_bmp388.c"
              ;
}
...
static 
# 342 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
      _Bool 
# 342 "./src/main/drivers/barometer/barometer_bmp388.c"
           bmp388ReadUP(baroDev_t *baro)
{
    if (busBusy(&baro->busdev, 
# 344 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
                              ((void *)0)
# 344 "./src/main/drivers/barometer/barometer_bmp388.c"
                                  )) {
        return 
# 345 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
              0
# 345 "./src/main/drivers/barometer/barometer_bmp388.c"
                   ;
    }


    busReadRegisterBufferStart(&baro->busdev, (0x04), sensor_data, (((0x09) - (0x04)) + 1));

    return 
# 351 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
          1
# 351 "./src/main/drivers/barometer/barometer_bmp388.c"
              ;
}

static 
# 354 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
      _Bool 
# 354 "./src/main/drivers/barometer/barometer_bmp388.c"
           bmp388GetUP(baroDev_t *baro)
{
    if (busBusy(&baro->busdev, 
# 356 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
                              ((void *)0)
# 356 "./src/main/drivers/barometer/barometer_bmp388.c"
                                  )) {
        return 
# 357 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
              0
# 357 "./src/main/drivers/barometer/barometer_bmp388.c"
                   ;
    }
    ...
    return 
# 362 "./src/main/drivers/barometer/barometer_bmp388.c" 3 4
          1
# 362 "./src/main/drivers/barometer/barometer_bmp388.c"
              ;
}
