...
# 421 "./src/main/telemetry/smartport.c"
    ...
    frSkyDataIdTableInfo.index = 0;
# 443 "./src/main/telemetry/smartport.c"
}
...
# 619 "./src/main/telemetry/smartport.c"
                                   ;
                break;
# 637 "./src/main/telemetry/smartport.c"
...
# 639 "./src/main/telemetry/smartport.c"
                                   ;
                break;
# 699 "./src/main/telemetry/smartport.c"
...
# 791 "./src/main/telemetry/smartport.c"
                ...
                break;
            case FSSP_DATAID_T2 :
# 805 "./src/main/telemetry/smartport.c"
...
# 841 "./src/main/telemetry/smartport.c"
                                   ;
                break;
# 887 "./src/main/telemetry/smartport.c"
            case FSSP_DATAID_A4 :
