...
extern void pgResetFn_vtxSettingsConfig(vtxSettingsConfig_t *); vtxSettingsConfig_t vtxSettingsConfig_System; vtxSettingsConfig_t vtxSettingsConfig_Copy; extern const pgRegistry_t vtxSettingsConfig_Registry; const pgRegistry_t vtxSettingsConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 259 | (0 << 12), .length = 1, .size = sizeof(vtxSettingsConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&vtxSettingsConfig_System, .copy = (uint8_t*)&vtxSettingsConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_vtxSettingsConfig }, };
...
# 79 "./src/main/io/vtx.c" 3 4
   _Bool 
# 79 "./src/main/io/vtx.c"
        settingsUpdated = 
# 79 "./src/main/io/vtx.c" 3 4
                          0
# 79 "./src/main/io/vtx.c"
    ...
    if (vtxSettingsConfig()->band && freq != vtxSettingsConfig()->freq) {
        ...
        settingsUpdated = 
# 93 "./src/main/io/vtx.c" 3 4
                         1
# 93 "./src/main/io/vtx.c"
                             ;
    }
    ...
    if (vtxSettingsConfig()->pitModeFreq) {
        ...
        if (constrainedPitModeFreq != vtxSettingsConfig()->pitModeFreq) {
            ...
            settingsUpdated = 
# 102 "./src/main/io/vtx.c" 3 4
                             1
# 102 "./src/main/io/vtx.c"
                                 ;
        }
    }
...
# 165 "./src/main/io/vtx.c"
    ...
    return 
# 169 "./src/main/io/vtx.c" 3 4
          0
# 169 "./src/main/io/vtx.c"
               ;
}
           ...
           vtxProcessPower(vtxDevice_t *vtxDevice)
{
    ...
    if (vtxCommonGetPowerIndex(vtxDevice, &vtxPower)) {
        ...
        if (vtxPower != settings.power) {
            ...
            return 
# 180 "./src/main/io/vtx.c" 3 4
                  1
# 180 "./src/main/io/vtx.c"
                      ;
        }
    }
    return 
...
static 
# 186 "./src/main/io/vtx.c" 3 4
      _Bool 
# 186 "./src/main/io/vtx.c"
...
# 192 "./src/main/io/vtx.c" 3 4
       _Bool 
# 192 "./src/main/io/vtx.c"
...
# 206 "./src/main/io/vtx.c"
                ...
                if (vtxStatus & VTX_STATUS_PIT_MODE) {
                    vtxCommonSetPitMode(vtxDevice, 
# 210 "./src/main/io/vtx.c" 3 4
                                                  0
# 210 "./src/main/io/vtx.c"
                                                       );
           ...
           vtxProcessStateUpdate(vtxDevice_t *vtxDevice)
{
    ...
    return (
# 236 "./src/main/io/vtx.c" 3 4
           _Bool
# 236 "./src/main/io/vtx.c"
...
# 253 "./src/main/io/vtx.c" 3 4
       _Bool 
# 253 "./src/main/io/vtx.c"
            vtxUpdatePending = 
# 253 "./src/main/io/vtx.c" 3 4
                               0
# 253 "./src/main/io/vtx.c"
