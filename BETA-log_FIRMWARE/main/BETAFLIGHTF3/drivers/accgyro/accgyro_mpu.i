...
# 1 "./src/main/drivers/accgyro/accgyro_spi_icm42605.h" 1
# 21 "./src/main/drivers/accgyro/accgyro_spi_icm42605.h"
       




# 25 "./src/main/drivers/accgyro/accgyro_spi_icm42605.h" 3 4
_Bool 
# 25 "./src/main/drivers/accgyro/accgyro_spi_icm42605.h"
    icm42605AccDetect(accDev_t *acc);

# 26 "./src/main/drivers/accgyro/accgyro_spi_icm42605.h" 3 4
_Bool 
# 26 "./src/main/drivers/accgyro/accgyro_spi_icm42605.h"
    icm42605GyroDetect(gyroDev_t *gyro);
...
# 33 "./src/main/drivers/accgyro/accgyro_spi_icm42605.h" 3 4
_Bool 
# 33 "./src/main/drivers/accgyro/accgyro_spi_icm42605.h"
    icm42605SpiAccDetect(accDev_t *acc);

# 34 "./src/main/drivers/accgyro/accgyro_spi_icm42605.h" 3 4
_Bool 
# 34 "./src/main/drivers/accgyro/accgyro_spi_icm42605.h"
    icm42605SpiGyroDetect(gyroDev_t *gyro);
...
# 110 "./src/main/drivers/accgyro/accgyro_mpu.c"
...
# 141 "./src/main/drivers/accgyro/accgyro_mpu.c"
    IOInit(mpuIntIO, OWNER_GYRO_EXTI, 0);
    EXTIHandlerInit(&gyro->exti, mpuIntExtiHandler);
    EXTIConfig(mpuIntIO, &gyro->exti, (((((0x0f)<<(4-(7-(((uint32_t)0x500)>>8))))|((0x0f)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)), BETAFLIGHT_EXTI_TRIGGER_RISING);
    EXTIEnable(mpuIntIO, 
# 144 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                        1
...
# 148 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 148 "./src/main/drivers/accgyro/accgyro_mpu.c"
    mpuAccRead(accDev_t *acc)
{
    uint8_t data[6];

    const 
# 152 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
         _Bool 
...
# 164 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
...
# 181 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 181 "./src/main/drivers/accgyro/accgyro_mpu.c"
...
# 186 "./src/main/drivers/accgyro/accgyro_mpu.c"
    ...
    if (!ack) {
        return 
# 188 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              0
# 188 "./src/main/drivers/accgyro/accgyro_mpu.c"
                   ;
    }
    ...
    return 
# 195 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          1
# 195 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ;
}
...
static gyroSpiDetectFn_t gyroSpiDetectFnTable[] = {
    ...
    mpu6000SpiDetect,
# 231 "./src/main/drivers/accgyro/accgyro_mpu.c"
    
# 231 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
   ((void *)0)
...
static 
# 234 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
      _Bool 
# 234 "./src/main/drivers/accgyro/accgyro_mpu.c"
           detectSPISensorsAndUpdateDetectionResult(gyroDev_t *gyro, const gyroDeviceConfig_t *config)
{
    SPI_TypeDef *instance = spiInstanceByDevice(((config->spiBus) - 1));
...
# 239 "./src/main/drivers/accgyro/accgyro_mpu.c"
    ...
    IOInit(gyro->bus.busdev_u.spi.csnPin, OWNER_GYRO_CS, (config->index + 1));
    IOConfigGPIO(gyro->bus.busdev_u.spi.csnPin, ((GPIO_Mode_OUT) | ((GPIO_Speed_Level_3) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
    ...
    for (size_t index = 0 ; gyroSpiDetectFnTable[index] ; index++) {
        ...
        if (sensor != MPU_NONE) {
            ...
            return 
# 260 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                  1
# 260 "./src/main/drivers/accgyro/accgyro_mpu.c"
                      ;
        }
    }
    ...
    return 
# 268 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          0
# 268 "./src/main/drivers/accgyro/accgyro_mpu.c"
               ;
}
...
void mpuPreInit(const struct gyroDeviceConfig_s *config)
{
    ...
    spiPreinitRegister(config->csnTag, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_UP) << 5)), 1);
...
# 281 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 281 "./src/main/drivers/accgyro/accgyro_mpu.c"
    mpuDetect(gyroDev_t *gyro, const gyroDeviceConfig_t *config)
{
    ...
    if (config->bustype == BUSTYPE_NONE) {
        return 
# 287 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              0
# 287 "./src/main/drivers/accgyro/accgyro_mpu.c"
                   ;
    }
...
# 328 "./src/main/drivers/accgyro/accgyro_mpu.c"
...
# 363 "./src/main/drivers/accgyro/accgyro_mpu.c"
