# 1 "./src/main/drivers/rx/rx_cyrf6936.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/rx/rx_cyrf6936.c"
# 21 "./src/main/drivers/rx/rx_cyrf6936.c"
# 1 "c:\\dev\\9 2020-q2-update\\lib\\gcc\\arm-none-eabi\\9.3.1\\include\\stdbool.h" 1 3 4
# 22 "./src/main/drivers/rx/rx_cyrf6936.c" 2
...
# 23 "./src/main/drivers/rx/rx_cyrf6936.c" 2
...
# 24 "./src/main/drivers/rx/rx_cyrf6936.c" 2
...
# 153 "./src/main/platform.h" 2
# 26 "./src/main/drivers/rx/rx_cyrf6936.c" 2
...
# 30 "./src/main/drivers/rx/rx_cyrf6936.c" 2
...
# 31 "./src/main/drivers/rx/rx_cyrf6936.c" 2
...
# 32 "./src/main/drivers/rx/rx_cyrf6936.c" 2
...
# 33 "./src/main/drivers/rx/rx_cyrf6936.c" 2
...
# 34 "./src/main/drivers/rx/rx_cyrf6936.c" 2


# 35 "./src/main/drivers/rx/rx_cyrf6936.c" 3 4
_Bool 
# 35 "./src/main/drivers/rx/rx_cyrf6936.c"
    isError = 
# 35 "./src/main/drivers/rx/rx_cyrf6936.c" 3 4
              0
# 35 "./src/main/drivers/rx/rx_cyrf6936.c"
...
# 37 "./src/main/drivers/rx/rx_cyrf6936.c" 3 4
_Bool 
# 37 "./src/main/drivers/rx/rx_cyrf6936.c"
    cyrf6936RxFinished(timeUs_t *timeStamp)
{
    if (rxSpiPollExti()) {
        ...
        if ((rxIrqStatus & (1<<1)) || (rxIrqStatus & (1<<0))) {
            isError = (rxIrqStatus & (1<<0)) > 0x0;
        }

        rxSpiResetExti();

        return 
# 51 "./src/main/drivers/rx/rx_cyrf6936.c" 3 4
              1
# 51 "./src/main/drivers/rx/rx_cyrf6936.c"
                  ;
    }
    return 
# 53 "./src/main/drivers/rx/rx_cyrf6936.c" 3 4
          0
# 53 "./src/main/drivers/rx/rx_cyrf6936.c"
               ;
}


# 56 "./src/main/drivers/rx/rx_cyrf6936.c" 3 4
_Bool 
# 56 "./src/main/drivers/rx/rx_cyrf6936.c"
    cyrf6936Init(void)
{
    if (!rxSpiExtiConfigured()) {
        return 
# 59 "./src/main/drivers/rx/rx_cyrf6936.c" 3 4
              0
# 59 "./src/main/drivers/rx/rx_cyrf6936.c"
                   ;
    }
    ...
    cyrf6936WriteRegister(CYRF6936_MODE_OVERRIDE, (1<<0));
...
void cyrf6936WriteRegister(const uint8_t address, const uint8_t data)
{
    rxSpiWriteCommand((1<<7) | address, data);
}

void cyrf6936WriteBlock(const uint8_t address, const uint8_t *data, const uint8_t length)
{
    rxSpiWriteCommandMulti((1<<7) | address, &data[0], length);
}
...
uint8_t cyrf6936GetRssi(void)
{
    return cyrf6936ReadRegister(CYRF6936_RSSI) & 0x1F;
}
...
void cyrf6936SetMode(const uint8_t mode, const 
# 116 "./src/main/drivers/rx/rx_cyrf6936.c" 3 4
                                              _Bool 
# 116 "./src/main/drivers/rx/rx_cyrf6936.c"
                                                   force)
{
    if (force) {
        cyrf6936WriteRegister(CYRF6936_XACT_CFG, mode | (1<<5));
    } else {
...
void cyrf6936SendLen(const uint8_t *data, const uint8_t length)
{
    ...
    cyrf6936WriteRegister(CYRF6936_TX_CTRL, (1<<6));
    cyrf6936WriteBlock(CYRF6936_TX_BUFFER, data, length);
    cyrf6936WriteRegister(CYRF6936_TX_CTRL, (1<<7));
}

void cyrf6936StartRecv(void)
{
    cyrf6936WriteRegister(CYRF6936_RX_IRQ_STATUS, (1<<7));
    cyrf6936WriteRegister(CYRF6936_RX_CTRL, (1<<7) | (1<<1) | (1<<0));
}
