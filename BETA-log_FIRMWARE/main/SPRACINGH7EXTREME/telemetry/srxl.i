...
const srxlScheduleFnPtr srxlScheduleFuncs[(2 + (1 + 1 + 0 + 0 + 0))] = {

    srxlFrameQos,
    srxlFrameRpm,
    srxlFrameFlightPackCurrent,
# 733 "./src/main/telemetry/srxl.c"
    srxlFrameText,
...
static void processSrxl(timeUs_t currentTimeUs)
{
    ...
    if (srxlScheduleIndex < 2) {
        ...
        srxlScheduleUserIndex = (srxlScheduleUserIndex + 1) % (1 + 1 + 0 + 0 + 0);
