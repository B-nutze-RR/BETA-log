...
static 
# 133 "./src/main/io/displayport_msp.c" 3 4
      _Bool 
# 133 "./src/main/io/displayport_msp.c"
           isTransferInProgress(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 136 "./src/main/io/displayport_msp.c" 3 4
          0
# 136 "./src/main/io/displayport_msp.c"
               ;
}
...
static const displayPortVTable_t mspDisplayPortVTable = {
    ...
    .layerSupported = 
# 172 "./src/main/io/displayport_msp.c" 3 4
                     ((void *)0)
# 172 "./src/main/io/displayport_msp.c"
                         ,
    .layerSelect = 
# 173 "./src/main/io/displayport_msp.c" 3 4
                  ((void *)0)
# 173 "./src/main/io/displayport_msp.c"
                      ,
    .layerCopy = 
# 174 "./src/main/io/displayport_msp.c" 3 4
                ((void *)0)
# 174 "./src/main/io/displayport_msp.c"
                    ,
};
...
# 182 "./src/main/io/displayport_msp.c" 3 4
                                       1
# 182 "./src/main/io/displayport_msp.c"
                                           ;
    }
