# 1 "./src/main/flight/gyroanalyse.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/flight/gyroanalyse.c"
# 26 "./src/main/flight/gyroanalyse.c"
...
# 27 "./src/main/flight/gyroanalyse.c" 2
...
# 153 "./src/main/platform.h" 2
# 29 "./src/main/flight/gyroanalyse.c" 2
...
# 32 "./src/main/flight/gyroanalyse.c" 2
...
# 34 "./src/main/flight/gyroanalyse.c" 2
...
# 35 "./src/main/flight/gyroanalyse.c" 2
...
# 36 "./src/main/flight/gyroanalyse.c" 2
...
#pragma GCC diagnostic pop
# 39 "./src/main/flight/gyroanalyse.c" 2
...
# 40 "./src/main/flight/gyroanalyse.c" 2
...
# 42 "./src/main/flight/gyroanalyse.c" 2
...
# 44 "./src/main/flight/gyroanalyse.c" 2
# 89 "./src/main/flight/gyroanalyse.c"
...
static uint8_t __attribute__ ((section(".fastram_bss"), aligned(4))) fftStartBin;
static float __attribute__ ((section(".fastram_bss"), aligned(4))) dynNotchQ;
static float __attribute__ ((section(".fastram_bss"), aligned(4))) dynNotch1Ctr;
static float __attribute__ ((section(".fastram_bss"), aligned(4))) dynNotch2Ctr;
static uint16_t __attribute__ ((section(".fastram_bss"), aligned(4))) dynNotchMinHz;
static uint16_t __attribute__ ((section(".fastram_bss"), aligned(4))) dynNotchMaxHz;
static 
# 97 "./src/main/flight/gyroanalyse.c" 3 4
      _Bool 
# 97 "./src/main/flight/gyroanalyse.c"
           __attribute__ ((section(".fastram_data"), aligned(4))) dualNotch = 
# 97 "./src/main/flight/gyroanalyse.c" 3 4
                                                 1
# 97 "./src/main/flight/gyroanalyse.c"
                                                     ;
static uint16_t __attribute__ ((section(".fastram_bss"), aligned(4))) dynNotchMaxFFT;
static float __attribute__ ((section(".fastram_bss"), aligned(4))) smoothFactor;
static uint8_t __attribute__ ((section(".fastram_bss"), aligned(4))) samples;
...
void gyroDataAnalyseInit(uint32_t targetLooptimeUs)
{
    ...
    static 
# 107 "./src/main/flight/gyroanalyse.c" 3 4
          _Bool 
# 107 "./src/main/flight/gyroanalyse.c"
               gyroAnalyseInitialized;
    if (gyroAnalyseInitialized) {
        return;
    }
    gyroAnalyseInitialized = 
# 111 "./src/main/flight/gyroanalyse.c" 3 4
                            1
# 111 "./src/main/flight/gyroanalyse.c"
                                ;
    ...
    dynNotchMaxHz = __extension__ ({ __typeof__ (2 * dynNotchMinHz) _a = (2 * dynNotchMinHz); __typeof__ (gyroConfig()->dyn_notch_max_hz) _b = (gyroConfig()->dyn_notch_max_hz); _a > _b ? _a : _b; });

    if (gyroConfig()->dyn_notch_width_percent == 0) {
        dualNotch = 
# 121 "./src/main/flight/gyroanalyse.c" 3 4
                   0
# 121 "./src/main/flight/gyroanalyse.c"
                        ;
    }

    const int gyroLoopRateHz = lrintf((1.0f / targetLooptimeUs) * 1e6f);
    samples = __extension__ ({ __typeof__ (1) _a = (1); __typeof__ (gyroLoopRateHz / (2 * dynNotchMaxHz)) _b = (gyroLoopRateHz / (2 * dynNotchMaxHz)); _a > _b ? _a : _b; });
    ...
    fftStartBin = __extension__ ({ __typeof__ (2) _a = (2); __typeof__ (dynNotchMinHz / lrintf(fftResolution)) _b = (dynNotchMinHz / lrintf(fftResolution)); _a > _b ? _a : _b; });
    smoothFactor = 2 * 3.14159265358979323846f * 4 / (gyroLoopRateHz / 12);
...
static __attribute__((noinline)) void gyroDataAnalyseUpdate(gyroAnalyseState_t *state, biquadFilter_t *notchFilterDyn, biquadFilter_t *notchFilterDyn2)
{
    enum {
        STEP_ARM_CFFT_F32,
        STEP_BITREVERSAL,
    ...
    switch (state->updateStep) {
        ...
        case STEP_CALC_FREQUENCIES:
        {
            ...
            for (int i = fftStartBin; i < (32 / 2); i++) {
            ...
            if (binMax == 0) {
                ...
                for (int i = binMax - 1; i > 1; i--) {
                    ...
                    if (state->fftData[i - 1] > state->fftData[i]) {
                        break;
                    }
                }
                for (int i = binMax + 1; i < ((32 / 2) - 1); i++) {
            ...
            if(calculateThrottlePercentAbs() > 20) {
                dynNotchMaxFFT = __extension__ ({ __typeof__ (dynNotchMaxFFT) _a = (dynNotchMaxFFT); __typeof__ (state->centerFreq[state->updateAxis]) _b = (state->centerFreq[state->updateAxis]); _a > _b ? _a : _b; });
            }

            if (state->updateAxis == 0) {
                {if (debugMode == (DEBUG_FFT)) {debug[(3)] = (lrintf(fftMeanIndex * 100));}};
                {if (debugMode == (DEBUG_FFT_FREQ)) {debug[(0)] = (state->centerFreq[state->updateAxis]);}};
                {if (debugMode == (DEBUG_FFT_FREQ)) {debug[(1)] = (lrintf(dynamicFactor * 100));}};
                {if (debugMode == (DEBUG_DYN_LPF)) {debug[(1)] = (state->centerFreq[state->updateAxis]);}};
            }
