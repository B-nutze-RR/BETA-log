...
# 258 "./src/main/osd/osd_elements.c"
...
# 666 "./src/main/osd/osd_elements.c"
...
static const uint8_t osdElementDisplayOrder[] = {
    ...
    OSD_RTC_DATETIME,
# 1426 "./src/main/osd/osd_elements.c"
    OSD_RSSI_DBM_VALUE,
...
# 1706 "./src/main/osd/osd_elements.c"
    if (++blinkLoopCounter >= lrintf(osdConfig()->task_frequency / 5 / (2.5f * 2))) {
