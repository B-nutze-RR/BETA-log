...
# 128 "./src/main/sensors/battery.c"
 ;
...
void batteryUpdateVoltage(timeUs_t currentTimeUs)
{
    ...
    {if (debugMode == (DEBUG_BATTERY)) {debug[(0)] = (voltageMeter.unfiltered);}};
    {if (debugMode == (DEBUG_BATTERY)) {debug[(1)] = (voltageMeter.displayFiltered);}};
}
...
static 
# 178 "./src/main/sensors/battery.c" 3 4
      _Bool 
# 178 "./src/main/sensors/battery.c"
...
static 
# 183 "./src/main/sensors/battery.c" 3 4
      _Bool 
# 183 "./src/main/sensors/battery.c"
...
# 278 "./src/main/sensors/battery.c" 3 4
                                      1
# 278 "./src/main/sensors/battery.c"
                                          ;
...
void batteryInit(void)
{
    ...
    batteryCriticalHysteresisVoltage = 0;
    lowVoltageCutoff.enabled = 
# 360 "./src/main/sensors/battery.c" 3 4
                              0
# 360 "./src/main/sensors/battery.c"
                                   ;
    lowVoltageCutoff.percentage = 100;
    lowVoltageCutoff.startTime = 0;
