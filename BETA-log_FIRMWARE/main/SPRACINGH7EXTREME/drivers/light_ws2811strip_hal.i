...
# 101 "./src/main/drivers/light_ws2811strip_hal.c"
    ...
    IOConfigGPIOAF(ws2811IO, (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000002U)) << 5)), timerHardware->alternateFunction);
    ...
    dmaSetHandler(dmaGetIdentifier(dmaRef), WS2811_DMA_IRQHandler, (((((1)<<(4-(7-(((uint32_t)0x00000005)))))|((2)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0), dmaIndex);
...
void ws2811LedStripDMAEnable(void)
{
    if (DMA_SetCurrDataCounter(&TimHandle, timerChannel, ledStripDMABuffer, (32 * 24 + 42)) != HAL_OK) {
