# 1 "./src/main/drivers/bus_spi_hal.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/bus_spi_hal.c"
# 23 "./src/main/drivers/bus_spi_hal.c"
# 1 "c:\\dev\\9 2020-q2-update\\lib\\gcc\\arm-none-eabi\\9.3.1\\include\\stdbool.h" 1 3 4
# 24 "./src/main/drivers/bus_spi_hal.c" 2
...
# 25 "./src/main/drivers/bus_spi_hal.c" 2
# 1 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\strings.h" 1 3
# 32 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\strings.h" 3
...
# 33 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\strings.h" 2 3
...
# 26 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\sys\\_types.h" 2 3
...
# 27 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\sys\\_types.h" 2 3
...
# 34 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\strings.h" 2 3
...
# 37 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\strings.h" 2 3
...
# 26 "./src/main/drivers/bus_spi_hal.c" 2
...
# 22 "c:\\dev\\9 2020-q2-update\\arm-none-eabi\\include\\sys\\reent.h" 3
...
# 153 "./src/main/platform.h" 2
# 28 "./src/main/drivers/bus_spi_hal.c" 2
...
# 32 "./src/main/drivers/bus_spi_hal.c" 2
...
typedef struct spiHardware_s {
    SPIDevice device;
    SPI_TypeDef *reg;
    spiPinDef_t sckPins[5];
    spiPinDef_t misoPins[5];
    spiPinDef_t mosiPins[5];
...
extern spiDevice_t spiDevice[6];
...
# 33 "./src/main/drivers/bus_spi_hal.c" 2
...
# 34 "./src/main/drivers/bus_spi_hal.c" 2
...
# 35 "./src/main/drivers/bus_spi_hal.c" 2
...
# 36 "./src/main/drivers/bus_spi_hal.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 37 "./src/main/drivers/bus_spi_hal.c" 2
...
# 38 "./src/main/drivers/bus_spi_hal.c" 2

void spiInitDevice(SPIDevice device, 
# 39 "./src/main/drivers/bus_spi_hal.c" 3 4
                                    _Bool 
# 39 "./src/main/drivers/bus_spi_hal.c"
                                         leadingEdge)
{
...
# 64 "./src/main/drivers/bus_spi_hal.c"
    IOConfigGPIOAF(IOGetByTag(spi->sck), spi->leadingEdge ? (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000002U)) << 5)) : (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000001U)) << 5)), spi->sckAF);
    IOConfigGPIOAF(IOGetByTag(spi->miso), (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000001U)) << 5)), spi->misoAF);
    IOConfigGPIOAF(IOGetByTag(spi->mosi), (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)), spi->mosiAF);
# 75 "./src/main/drivers/bus_spi_hal.c"
    spi->hspi.Instance = spi->dev;

    HAL_SPI_DeInit(&spi->hspi);

    spi->hspi.Init.Mode = (0x1UL << (22U));
    spi->hspi.Init.Direction = (0x00000000UL);
    spi->hspi.Init.DataSize = (0x00000007UL);
    spi->hspi.Init.NSS = (0x1UL << (26U));
    spi->hspi.Init.FirstBit = (0x00000000UL);
    spi->hspi.Init.CRCPolynomial = 7;
    spi->hspi.Init.BaudRatePrescaler = (0x70000000UL);
    spi->hspi.Init.CRCCalculation = (0x00000000UL);
    spi->hspi.Init.TIMode = (0x00000000UL);

    spi->hspi.Init.FifoThreshold = (0x00000000UL);
    spi->hspi.Init.MasterKeepIOState = (0x1UL << (31U));


    if (spi->leadingEdge) {
        spi->hspi.Init.CLKPolarity = (0x00000000UL);
        spi->hspi.Init.CLKPhase = (0x00000000UL);
    }
    else {
        spi->hspi.Init.CLKPolarity = (0x1UL << (25U));
        spi->hspi.Init.CLKPhase = (0x1UL << (24U));
    }
...
# 118 "./src/main/drivers/bus_spi_hal.c" 3 4
_Bool 
# 118 "./src/main/drivers/bus_spi_hal.c"
    spiIsBusBusy(SPI_TypeDef *instance)
{
    SPIDevice device = spiDeviceByInstance(instance);
    if(spiDevice[device].hspi.State == HAL_SPI_STATE_BUSY)
        return 
# 122 "./src/main/drivers/bus_spi_hal.c" 3 4
              1
# 122 "./src/main/drivers/bus_spi_hal.c"
                  ;
    else
        return 
# 124 "./src/main/drivers/bus_spi_hal.c" 3 4
              0
# 124 "./src/main/drivers/bus_spi_hal.c"
                   ;
}


# 127 "./src/main/drivers/bus_spi_hal.c" 3 4
_Bool 
# 127 "./src/main/drivers/bus_spi_hal.c"
    spiTransfer(SPI_TypeDef *instance, const uint8_t *out, uint8_t *in, int len)
{
    SPIDevice device = spiDeviceByInstance(instance);
    ...
    if (!in) {
        ...
        status = HAL_SPI_Transmit(&spiDevice[device].hspi, out, len, 10);
    } else if(!out) {

        status = HAL_SPI_Receive(&spiDevice[device].hspi, in, len, 10);
    } else {

        status = HAL_SPI_TransmitReceive(&spiDevice[device].hspi, out, in, len, 10);
    }
    ...
    return 
# 149 "./src/main/drivers/bus_spi_hal.c" 3 4
          1
# 149 "./src/main/drivers/bus_spi_hal.c"
              ;
}
...
void spiSetDivisor(SPI_TypeDef *instance, uint16_t divisor)
{
    ...
    if (prescalerIndex < 0 || prescalerIndex >= (int)(sizeof(baudRatePrescaler) / sizeof((baudRatePrescaler)[0]))) {
        return;
    }
