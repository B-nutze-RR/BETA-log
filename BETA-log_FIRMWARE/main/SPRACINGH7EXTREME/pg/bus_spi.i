...
const spiDefaultConfig_t spiDefaultConfig[] = {
    ...
    { SPIDEV_2, ((ioTag_t)((((3) + 1) << 4) | (3))), ((ioTag_t)((((2) + 1) << 4) | (2))), ((ioTag_t)((((2) + 1) << 4) | (3))), ((-1)), ((-1)) },


    { SPIDEV_3, ((ioTag_t)((((1) + 1) << 4) | (3))), ((ioTag_t)((((1) + 1) << 4) | (4))), ((ioTag_t)((((3) + 1) << 4) | (6))), ((-1)), ((-1)) },


    { SPIDEV_4, ((ioTag_t)((((4) + 1) << 4) | (12))), ((ioTag_t)((((4) + 1) << 4) | (13))), ((ioTag_t)((((4) + 1) << 4) | (14))), ((-1)), ((-1)) },

};

extern void pgResetFn_spiPinConfig(spiPinConfig_t *); spiPinConfig_t spiPinConfig_SystemArray[6]; spiPinConfig_t spiPinConfig_CopyArray[6]; extern const pgRegistry_t spiPinConfig_Registry; const pgRegistry_t spiPinConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 520 | (1 << 12), .length = 6, .size = (sizeof(spiPinConfig_t) * 6) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&spiPinConfig_SystemArray, .copy = (uint8_t*)&spiPinConfig_CopyArray, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_spiPinConfig}, };
