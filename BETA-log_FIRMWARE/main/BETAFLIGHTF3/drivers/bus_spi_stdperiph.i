...
void spiInitDevice(SPIDevice device, 
# 47 "./src/main/drivers/bus_spi_stdperiph.c" 3 4
                                    _Bool 
# 47 "./src/main/drivers/bus_spi_stdperiph.c"
                                         leadingEdge)
{
...
# 82 "./src/main/drivers/bus_spi_stdperiph.c"
    SPI_I2S_DeInit(spi->dev);


    if (spi->leadingEdge) {
        defaultInit.SPI_CPOL = ((uint16_t)0x0000);
        defaultInit.SPI_CPHA = ((uint16_t)0x0000);
    } else

    {
        defaultInit.SPI_CPOL = ((uint16_t)0x0002);
        defaultInit.SPI_CPHA = ((uint16_t)0x0001);
    }
...
# 135 "./src/main/drivers/bus_spi_stdperiph.c" 3 4
_Bool 
# 135 "./src/main/drivers/bus_spi_stdperiph.c"
    spiIsBusBusy(SPI_TypeDef *instance)
{
...
# 145 "./src/main/drivers/bus_spi_stdperiph.c" 3 4
_Bool 
# 145 "./src/main/drivers/bus_spi_stdperiph.c"
    spiTransfer(SPI_TypeDef *instance, const uint8_t *txData, uint8_t *rxData, int len)
{
    uint16_t spiTimeout = 1000;
    ...
    return 
# 178 "./src/main/drivers/bus_spi_stdperiph.c" 3 4
          1
# 178 "./src/main/drivers/bus_spi_stdperiph.c"
              ;
}
