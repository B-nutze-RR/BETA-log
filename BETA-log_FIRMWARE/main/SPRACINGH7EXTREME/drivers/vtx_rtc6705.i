# 1 "./src/main/drivers/vtx_rtc6705.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/vtx_rtc6705.c"
# 28 "./src/main/drivers/vtx_rtc6705.c"
# 1 "c:\\dev\\9 2020-q2-update\\lib\\gcc\\arm-none-eabi\\9.3.1\\include\\stdbool.h" 1 3 4
# 29 "./src/main/drivers/vtx_rtc6705.c" 2
...
# 30 "./src/main/drivers/vtx_rtc6705.c" 2
...
# 153 "./src/main/platform.h" 2
# 32 "./src/main/drivers/vtx_rtc6705.c" 2
...
# 36 "./src/main/drivers/vtx_rtc6705.c" 2
...
# 38 "./src/main/drivers/vtx_rtc6705.c" 2
...
# 39 "./src/main/drivers/vtx_rtc6705.c" 2
...
# 40 "./src/main/drivers/vtx_rtc6705.c" 2
...
# 41 "./src/main/drivers/vtx_rtc6705.c" 2
# 1 "./src/main/drivers/vtx_rtc6705_soft_spi.h" 1
# 21 "./src/main/drivers/vtx_rtc6705_soft_spi.h"
...
# 26 "./src/main/drivers/vtx_rtc6705_soft_spi.h" 2


# 27 "./src/main/drivers/vtx_rtc6705_soft_spi.h" 3 4
_Bool 
# 27 "./src/main/drivers/vtx_rtc6705_soft_spi.h"
    rtc6705SoftSpiIOInit(const vtxIOConfig_t *vtxIOConfig, const IO_t csnPin);
void rtc6705SoftSpiSetFrequency(uint16_t freq);
void rtc6705SoftSpiSetRFPower(uint8_t rf_power);
# 42 "./src/main/drivers/vtx_rtc6705.c" 2
...
# 44 "./src/main/drivers/vtx_rtc6705.c" 2
# 56 "./src/main/drivers/vtx_rtc6705.c"
static IO_t vtxPowerPin = ((IO_t)0);


static busDevice_t *busdev = 
# 59 "./src/main/drivers/vtx_rtc6705.c" 3 4
                            ((void *)0)
# 59 "./src/main/drivers/vtx_rtc6705.c"
                                ;
# 81 "./src/main/drivers/vtx_rtc6705.c"
...
# 95 "./src/main/drivers/vtx_rtc6705.c" 3 4
_Bool 
# 95 "./src/main/drivers/vtx_rtc6705.c"
    rtc6705IOInit(const vtxIOConfig_t *vtxIOConfig)
{
    ...
    if (!csnPin) {
        return 
# 101 "./src/main/drivers/vtx_rtc6705.c" 3 4
              0
# 101 "./src/main/drivers/vtx_rtc6705.c"
                   ;
    }
    ...
    if (vtxPowerPin) {
        ...
        IOConfigGPIO(vtxPowerPin, (((0x00000001U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)));
    }

    SPI_TypeDef *vtxSpiInstance = spiInstanceByDevice(((vtxIOConfig->spiDevice) - 1));
    if (vtxSpiInstance) {
        busdev = &busInstance;
        ...
        IOConfigGPIO(busdev->busdev_u.spi.csnPin, (((0x00000001U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)));

        busdev->bustype = BUSTYPE_SPI;
        spiBusSetInstance(busdev, vtxSpiInstance);

        return 
# 128 "./src/main/drivers/vtx_rtc6705.c" 3 4
              1
# 128 "./src/main/drivers/vtx_rtc6705.c"
                  ;
    ...
    return 
# 135 "./src/main/drivers/vtx_rtc6705.c" 3 4
          0
# 135 "./src/main/drivers/vtx_rtc6705.c"
               ;;
}
...
void rtc6705SetFrequency(uint16_t frequency)
{
    ...
    frequency = constrain(frequency, 5600, 5950);

    const uint32_t val_a = ((((uint64_t)frequency*(uint64_t)1000000*(uint64_t)400)/(uint64_t)1000000) % 1024) / 16;
    const uint32_t val_n = (((uint64_t)frequency*(uint64_t)1000000*(uint64_t)400)/(uint64_t)1000000) / 1024;

    uint32_t val_hex = 0x11;
    val_hex |= (val_a << 5);
    val_hex |= (val_n << 12);

    spiSetDivisor(busdev->busdev_u.spi.instance, spiCalculateDivider(1000000));

    rtc6705Transfer(0x3210);
...
void rtc6705SetRFPower(uint8_t rf_power)
{
    ...
    uint32_t val_hex = (1 << 4);
    val_hex |= (0x07);
    const uint32_t data = rf_power > 1 ? 0x4FBD : (0x4FBD | 0x0040) & (~(0x0180 | 0x0E00));
    val_hex |= data << 5;
