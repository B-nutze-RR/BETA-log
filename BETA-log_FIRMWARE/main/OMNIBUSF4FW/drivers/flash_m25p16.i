...
# 55 "./src/main/drivers/flash_m25p16.c"
...
static void m25p16_performOneByteCommand(busDevice_t *bus, uint8_t command)
{
    ...
    m25p16_transfer(bus, &command, 
# 158 "./src/main/drivers/flash_m25p16.c" 3 4
                                  ((void *)0)
# 158 "./src/main/drivers/flash_m25p16.c"
                                      , 1);
...
{
    m25p16_performOneByteCommand(fdevice->io.handle.busdev, 0x06);


    fdevice->couldBeBusy = 
# 175 "./src/main/drivers/flash_m25p16.c" 3 4
                          1
# 175 "./src/main/drivers/flash_m25p16.c"
                              ;
}
...
static 
# 188 "./src/main/drivers/flash_m25p16.c" 3 4
      _Bool 
# 188 "./src/main/drivers/flash_m25p16.c"
           m25p16_isReady(flashDevice_t *fdevice)
{

    fdevice->couldBeBusy = fdevice->couldBeBusy && ((m25p16_readStatus(fdevice->io.handle.busdev) & 0x01) != 0);
           ...
           m25p16_waitForReady(flashDevice_t *fdevice)
{
    while (!m25p16_isReady(fdevice)) {
        ...
        if (cmp32(now, fdevice->timeoutAt) >= 0) {
            return 
# 207 "./src/main/drivers/flash_m25p16.c" 3 4
                  0
# 207 "./src/main/drivers/flash_m25p16.c"
                       ;
        }
    }
...
# 221 "./src/main/drivers/flash_m25p16.c" 3 4
_Bool 
# 221 "./src/main/drivers/flash_m25p16.c"
    m25p16_detect(flashDevice_t *fdevice, uint32_t chipID)
{
    ...
    if (m25p16FlashConfig[index].jedecID == 0) {
        ...
        return 
# 242 "./src/main/drivers/flash_m25p16.c" 3 4
              0
# 242 "./src/main/drivers/flash_m25p16.c"
                   ;
    }
...
# 256 "./src/main/drivers/flash_m25p16.c" 3 4
                               1
# 256 "./src/main/drivers/flash_m25p16.c"
                                   ;
        m25p16_performOneByteCommand(fdevice->io.handle.busdev, 0xB7);
    }

    fdevice->couldBeBusy = 
# 260 "./src/main/drivers/flash_m25p16.c" 3 4
                          1
# 260 "./src/main/drivers/flash_m25p16.c"
                              ;
    fdevice->vTable = &m25p16_vTable;
    return 
# 262 "./src/main/drivers/flash_m25p16.c" 3 4
          1
# 262 "./src/main/drivers/flash_m25p16.c"
              ;
}

static void m25p16_setCommandAddress(uint8_t *buf, uint32_t address, 
# 265 "./src/main/drivers/flash_m25p16.c" 3 4
                                                                    _Bool 
# 265 "./src/main/drivers/flash_m25p16.c"
                                                                         useLongAddress)
{
    if (useLongAddress) {
        *buf++ = (address >> 24) & 0xff;
...
static void m25p16_eraseCompletely(flashDevice_t *fdevice)
{
    ...
    m25p16_performOneByteCommand(fdevice->io.handle.busdev, 0xC7);

    m25p16_setTimeout(fdevice, 50000);
}
...
static void m25p16_pageProgramContinue(flashDevice_t *fdevice, const uint8_t *data, int length)
{
    ...
    spiTransfer(fdevice->io.handle.busdev->busdev_u.spi.instance, command, 
# 327 "./src/main/drivers/flash_m25p16.c" 3 4
                                                                          ((void *)0)
# 327 "./src/main/drivers/flash_m25p16.c"
                                                                              , fdevice->isLargeFlash ? 5 : 4);
    spiTransfer(fdevice->io.handle.busdev->busdev_u.spi.instance, data, 
...
# 361 "./src/main/drivers/flash_m25p16.c"
...
static int m25p16_readBytes(flashDevice_t *fdevice, uint32_t address, uint8_t *buffer, int length)
{
    ...
    spiTransfer(fdevice->io.handle.busdev->busdev_u.spi.instance, command, 
# 396 "./src/main/drivers/flash_m25p16.c" 3 4
                                                                          ((void *)0)
# 396 "./src/main/drivers/flash_m25p16.c"
                                                                              , fdevice->isLargeFlash ? 5 : 4);
    spiTransfer(fdevice->io.handle.busdev->busdev_u.spi.instance, 
# 397 "./src/main/drivers/flash_m25p16.c" 3 4
                                                                 ((void *)0)
# 397 "./src/main/drivers/flash_m25p16.c"
                                                                     , buffer, length);
