...
# 31 "./src/main/drivers/flash_w25n01g.c" 2
...
# 51 "./src/main/drivers/flash_impl.h" 3 4
   _Bool 
# 51 "./src/main/drivers/flash_impl.h"
        isLargeFlash;



    
# 55 "./src/main/drivers/flash_impl.h" 3 4
   _Bool 
# 55 "./src/main/drivers/flash_impl.h"
        couldBeBusy;
    uint32_t timeoutAt;
    flashDeviceIO_t io;
} flashDevice_t;
...
# 61 "./src/main/drivers/flash_impl.h" 3 4
   _Bool 
# 61 "./src/main/drivers/flash_impl.h"
        (*isReady)(flashDevice_t *fdevice);
    
# 62 "./src/main/drivers/flash_impl.h" 3 4
   _Bool 
# 62 "./src/main/drivers/flash_impl.h"
...
# 32 "./src/main/drivers/flash_w25n01g.c" 2
...
# 33 "./src/main/drivers/flash_w25n01g.c" 2
...
# 34 "./src/main/drivers/flash_w25n01g.c" 2
...
# 35 "./src/main/drivers/flash_w25n01g.c" 2
...
# 37 "./src/main/drivers/flash_w25n01g.c" 2
# 131 "./src/main/drivers/flash_w25n01g.c"
...
static 
# 141 "./src/main/drivers/flash_w25n01g.c" 3 4
      _Bool 
# 141 "./src/main/drivers/flash_w25n01g.c"
...
static void w25n01g_performOneByteCommand(flashDeviceIO_t *io, uint8_t command)
{
    if (io->mode == FLASHIO_SPI) {
        ...
        __asm volatile ("nop"); IOLo((busdev)->busdev_u.spi.csnPin);
        spiTransferByte(busdev->busdev_u.spi.instance, command);
        IOHi((busdev)->busdev_u.spi.csnPin); __asm volatile ("nop");

    }

    else if (io->mode == FLASHIO_QUADSPI) {
        QUADSPI_TypeDef *quadSpi = io->handle.quadSpi;
        quadSpiTransmit1LINE(quadSpi, command, 0, 
# 165 "./src/main/drivers/flash_w25n01g.c" 3 4
                                                 ((void *)0)
# 165 "./src/main/drivers/flash_w25n01g.c"
                                                     , 0);
    }
...
static void w25n01g_performCommandWithPageAddress(flashDeviceIO_t *io, uint8_t command, uint32_t pageAddress)
{
    if (io->mode == FLASHIO_SPI) {
        ...
        __asm volatile ("nop"); IOLo((busdev)->busdev_u.spi.csnPin);
        spiTransfer(busdev->busdev_u.spi.instance, cmd, 
# 178 "./src/main/drivers/flash_w25n01g.c" 3 4
                                                       ((void *)0)
# 178 "./src/main/drivers/flash_w25n01g.c"
                                                           , sizeof(cmd));
        IOHi((busdev)->busdev_u.spi.csnPin); __asm volatile ("nop");
    }
        ...
        quadSpiInstructionWithAddress1LINE(quadSpi, command, 0, pageAddress & 0xffff, 16 + 8);
    }
...
static uint8_t w25n01g_readRegister(flashDeviceIO_t *io, uint8_t reg)
{
    if (io->mode == FLASHIO_SPI) {
        ...
        __asm volatile ("nop"); IOLo((busdev)->busdev_u.spi.csnPin);
        const uint8_t cmd[3] = { 0x05, reg, 0 };
        uint8_t in[3];
        ...
        uint8_t in[1];
        quadSpiReceiveWithAddress1LINE(quadSpi, 0x05, 0, reg, 8, in, sizeof(in));
...
static void w25n01g_writeRegister(flashDeviceIO_t *io, uint8_t reg, uint8_t data)
{
    if (io->mode == FLASHIO_SPI) {
        busDevice_t *busdev = io->handle.busdev;
        const uint8_t cmd[3] = { 0x01, reg, data };

        __asm volatile ("nop"); IOLo((busdev)->busdev_u.spi.csnPin);
        spiTransfer(busdev->busdev_u.spi.instance, cmd, 
# 225 "./src/main/drivers/flash_w25n01g.c" 3 4
                                                       ((void *)0)
# 225 "./src/main/drivers/flash_w25n01g.c"
                                                           , sizeof(cmd));
        IOHi((busdev)->busdev_u.spi.csnPin); __asm volatile ("nop");
   }
       ...
       quadSpiTransmitWithAddress1LINE(quadSpi, 0x01, 0, reg, 8, &data, 1);
   }
...
static void w25n01g_deviceReset(flashDevice_t *fdevice)
{
    ...
    w25n01g_performOneByteCommand(io, 0xFF);

    w25n01g_setTimeout(fdevice, 500);
    ...
    w25n01g_writeRegister(io, 0xA0, (0));


    w25n01g_writeRegister(io, 0xB0, (1 << 4)|(1 << 3));
}


# 258 "./src/main/drivers/flash_w25n01g.c" 3 4
_Bool 
# 258 "./src/main/drivers/flash_w25n01g.c"
    w25n01g_isReady(flashDevice_t *fdevice)
{
    uint8_t status = w25n01g_readRegister(&fdevice->io, 0xC0);

    return ((status & (1 << 0)) == 0);
}

static 
# 265 "./src/main/drivers/flash_w25n01g.c" 3 4
      _Bool 
# 265 "./src/main/drivers/flash_w25n01g.c"
           w25n01g_waitForReady(flashDevice_t *fdevice)
{
    while (!w25n01g_isReady(fdevice)) {
        ...
        if (cmp32(now, fdevice->timeoutAt) >= 0) {
            return 
# 270 "./src/main/drivers/flash_w25n01g.c" 3 4
                  0
# 270 "./src/main/drivers/flash_w25n01g.c"
                       ;
        }
    }
    fdevice->timeoutAt = 0;
    ...
    return 
# 275 "./src/main/drivers/flash_w25n01g.c" 3 4
          1
# 275 "./src/main/drivers/flash_w25n01g.c"
              ;
}
...
{
    w25n01g_performOneByteCommand(&fdevice->io, 0x06);


    fdevice->couldBeBusy = 
# 287 "./src/main/drivers/flash_w25n01g.c" 3 4
                          1
# 287 "./src/main/drivers/flash_w25n01g.c"
                              ;
}
...
# 299 "./src/main/drivers/flash_w25n01g.c" 3 4
_Bool 
# 299 "./src/main/drivers/flash_w25n01g.c"
    w25n01g_detect(flashDevice_t *fdevice, uint32_t chipID)
{
    switch (chipID) {
    case 0xEFAA21:
    ...
    default:
        ...
        return 
# 315 "./src/main/drivers/flash_w25n01g.c" 3 4
              0
# 315 "./src/main/drivers/flash_w25n01g.c"
                   ;
    }
    ...
    fdevice->couldBeBusy = 
# 326 "./src/main/drivers/flash_w25n01g.c" 3 4
                          1
# 326 "./src/main/drivers/flash_w25n01g.c"
                              ;

    w25n01g_deviceReset(fdevice);
# 344 "./src/main/drivers/flash_w25n01g.c"
    w25n01g_deviceInit(fdevice);

    fdevice->vTable = &w25n01g_vTable;

    return 
# 348 "./src/main/drivers/flash_w25n01g.c" 3 4
          1
# 348 "./src/main/drivers/flash_w25n01g.c"
              ;
}
...
void w25n01g_eraseSector(flashDevice_t *fdevice, uint32_t address)
{
    ...
    w25n01g_performCommandWithPageAddress(&fdevice->io, 0xD8, ((address) / 2048));

    w25n01g_setTimeout(fdevice, 15);
}
...
void w25n01g_eraseCompletely(flashDevice_t *fdevice)
{
    for (uint32_t block = 0; block < fdevice->geometry.sectors; block++) {
        w25n01g_eraseSector(fdevice, (((block) * 64) * 2048));
    }
}
...
static void w25n01g_programDataLoad(flashDevice_t *fdevice, uint16_t columnAddress, const uint8_t *data, int length)
{
    ...
    if (fdevice->io.mode == FLASHIO_SPI) {
        ...
        const uint8_t cmd[] = { 0x02, columnAddress >> 8, columnAddress & 0xff };

        __asm volatile ("nop"); IOLo((busdev)->busdev_u.spi.csnPin);
        spiTransfer(busdev->busdev_u.spi.instance, cmd, 
# 387 "./src/main/drivers/flash_w25n01g.c" 3 4
                                                       ((void *)0)
# 387 "./src/main/drivers/flash_w25n01g.c"
                                                           , sizeof(cmd));
        spiTransfer(busdev->busdev_u.spi.instance, data, 
# 388 "./src/main/drivers/flash_w25n01g.c" 3 4
                                                        ((void *)0)
# 388 "./src/main/drivers/flash_w25n01g.c"
                                                            , length);
        IOHi((busdev)->busdev_u.spi.csnPin); __asm volatile ("nop");
   }
       ...
       quadSpiTransmitWithAddress1LINE(quadSpi, 0x02, 0, columnAddress, 16, data, length);
    }


    w25n01g_setTimeout(fdevice, 2);
}

static void w25n01g_randomProgramDataLoad(flashDevice_t *fdevice, uint16_t columnAddress, const uint8_t *data, int length)
{
    const uint8_t cmd[] = { 0x84, columnAddress >> 8, columnAddress & 0xff };
    ...
    if (fdevice->io.mode == FLASHIO_SPI) {
        ...
        __asm volatile ("nop"); IOLo((busdev)->busdev_u.spi.csnPin);
        spiTransfer(busdev->busdev_u.spi.instance, cmd, 
# 412 "./src/main/drivers/flash_w25n01g.c" 3 4
                                                       ((void *)0)
# 412 "./src/main/drivers/flash_w25n01g.c"
                                                           , sizeof(cmd));
        spiTransfer(busdev->busdev_u.spi.instance, data, 
# 413 "./src/main/drivers/flash_w25n01g.c" 3 4
                                                        ((void *)0)
# 413 "./src/main/drivers/flash_w25n01g.c"
                                                            , length);
        IOHi((busdev)->busdev_u.spi.csnPin); __asm volatile ("nop");
        ...
        quadSpiTransmitWithAddress1LINE(quadSpi, 0x84, 0, columnAddress, 16, data, length);
     }
...
static void w25n01g_programExecute(flashDevice_t *fdevice, uint32_t pageAddress)
{
    ...
    w25n01g_performCommandWithPageAddress(&fdevice->io, 0x10, pageAddress);

    w25n01g_setTimeout(fdevice, 2);
}
# 472 "./src/main/drivers/flash_w25n01g.c"
static uint32_t programStartAddress;
static uint32_t programLoadAddress;

# 474 "./src/main/drivers/flash_w25n01g.c" 3 4
_Bool 
# 474 "./src/main/drivers/flash_w25n01g.c"
    bufferDirty = 
# 474 "./src/main/drivers/flash_w25n01g.c" 3 4
                  0
# 474 "./src/main/drivers/flash_w25n01g.c"
...
# 475 "./src/main/drivers/flash_w25n01g.c" 3 4
_Bool 
# 475 "./src/main/drivers/flash_w25n01g.c"
    isProgramming = 
# 475 "./src/main/drivers/flash_w25n01g.c" 3 4
                    0
# 475 "./src/main/drivers/flash_w25n01g.c"
...
void w25n01g_pageProgramBegin(flashDevice_t *fdevice, uint32_t address)
{
    if (bufferDirty) {
        if (address != programLoadAddress) {
            ...
            isProgramming = 
# 483 "./src/main/drivers/flash_w25n01g.c" 3 4
                           0
# 483 "./src/main/drivers/flash_w25n01g.c"
                                ;

            w25n01g_writeEnable(fdevice);

            w25n01g_programExecute(fdevice, ((programStartAddress) / 2048));

            bufferDirty = 
# 489 "./src/main/drivers/flash_w25n01g.c" 3 4
                         0
# 489 "./src/main/drivers/flash_w25n01g.c"
                              ;
            isProgramming = 
# 490 "./src/main/drivers/flash_w25n01g.c" 3 4
                           1
# 490 "./src/main/drivers/flash_w25n01g.c"
                               ;
        }
    } else {
...
void w25n01g_pageProgramContinue(flashDevice_t *fdevice, const uint8_t *data, int length)
{
    ...
    isProgramming = 
# 505 "./src/main/drivers/flash_w25n01g.c" 3 4
                   0
# 505 "./src/main/drivers/flash_w25n01g.c"
                        ;

    if (!bufferDirty) {
        w25n01g_programDataLoad(fdevice, ((programLoadAddress) % 2048), data, length);
    } else {
        w25n01g_randomProgramDataLoad(fdevice, ((programLoadAddress) % 2048), data, length);
    }



    bufferDirty = 
# 515 "./src/main/drivers/flash_w25n01g.c" 3 4
                 1
# 515 "./src/main/drivers/flash_w25n01g.c"
                     ;
    programLoadAddress += length;
}

static uint32_t currentPage = 
# 519 "./src/main/drivers/flash_w25n01g.c" 3 4
                             (0xffffffffUL)
# 519 "./src/main/drivers/flash_w25n01g.c"
                                       ;

void w25n01g_pageProgramFinish(flashDevice_t *fdevice)
{
    if (bufferDirty && ((programLoadAddress) % 2048) == 0) {

        currentPage = ((programStartAddress) / 2048);

        w25n01g_programExecute(fdevice, ((programStartAddress) / 2048));

        bufferDirty = 
# 529 "./src/main/drivers/flash_w25n01g.c" 3 4
                     0
# 529 "./src/main/drivers/flash_w25n01g.c"
                          ;
        isProgramming = 
# 530 "./src/main/drivers/flash_w25n01g.c" 3 4
                       1
# 530 "./src/main/drivers/flash_w25n01g.c"
                           ;

        programStartAddress = programLoadAddress;
    }
}
# 552 "./src/main/drivers/flash_w25n01g.c"
...
void w25n01g_flush(flashDevice_t *fdevice)
{
    if (bufferDirty) {
        ...
        bufferDirty = 
# 566 "./src/main/drivers/flash_w25n01g.c" 3 4
                     0
# 566 "./src/main/drivers/flash_w25n01g.c"
                          ;
        isProgramming = 
# 567 "./src/main/drivers/flash_w25n01g.c" 3 4
                       1
# 567 "./src/main/drivers/flash_w25n01g.c"
                           ;
    } else {
        isProgramming = 
# 569 "./src/main/drivers/flash_w25n01g.c" 3 4
                       0
# 569 "./src/main/drivers/flash_w25n01g.c"
                            ;
    }
}
...
int w25n01g_readBytes(flashDevice_t *fdevice, uint32_t address, uint8_t *buffer, int length)
{
    ...
    if (currentPage != targetPage) {
        ...
        currentPage = 
# 608 "./src/main/drivers/flash_w25n01g.c" 3 4
                     (0xffffffffUL)
# 608 "./src/main/drivers/flash_w25n01g.c"
                               ;

        w25n01g_performCommandWithPageAddress(&fdevice->io, 0x13, targetPage);
    ...
    uint16_t column = ((address) % 2048);
    uint16_t transferLength;

    if (length > 2048 - column) {
        transferLength = 2048 - column;
    } else {
    ...
    if (fdevice->io.mode == FLASHIO_SPI) {
        ...
        __asm volatile ("nop"); IOLo((busdev)->busdev_u.spi.csnPin);
        spiTransfer(busdev->busdev_u.spi.instance, cmd, 
# 639 "./src/main/drivers/flash_w25n01g.c" 3 4
                                                       ((void *)0)
# 639 "./src/main/drivers/flash_w25n01g.c"
                                                           , sizeof(cmd));
        spiTransfer(busdev->busdev_u.spi.instance, 
# 640 "./src/main/drivers/flash_w25n01g.c" 3 4
                                                  ((void *)0)
# 640 "./src/main/drivers/flash_w25n01g.c"
                                                      , buffer, length);
        IOHi((busdev)->busdev_u.spi.csnPin); __asm volatile ("nop");
        ...
        quadSpiReceiveWithAddress4LINES(quadSpi, 0x6B, 8, column, 16, buffer, length);
    }
    ...
    uint8_t statReg = w25n01g_readRegister(&fdevice->io, 0xC0);
...
int w25n01g_readExtensionBytes(flashDevice_t *fdevice, uint32_t address, uint8_t *buffer, int length)
{
    ...
    w25n01g_performCommandWithPageAddress(&fdevice->io, 0x13, ((address) / 2048));
    ...
    if (fdevice->io.mode == FLASHIO_SPI) {
        ...
        __asm volatile ("nop"); IOLo((busdev)->busdev_u.spi.csnPin);
        spiTransfer(busdev->busdev_u.spi.instance, cmd, 
# 699 "./src/main/drivers/flash_w25n01g.c" 3 4
                                                       ((void *)0)
# 699 "./src/main/drivers/flash_w25n01g.c"
                                                           , sizeof(cmd));
        spiTransfer(busdev->busdev_u.spi.instance, 
# 700 "./src/main/drivers/flash_w25n01g.c" 3 4
                                                  ((void *)0)
# 700 "./src/main/drivers/flash_w25n01g.c"
                                                      , buffer, length);
        IOHi((busdev)->busdev_u.spi.csnPin); __asm volatile ("nop");
        ...
        quadSpiReceiveWithAddress1LINE(quadSpi, 0x03, 8, column, 16, buffer, length);
    }
...
void w25n01g_readBBLUT(flashDevice_t *fdevice, bblut_t *bblut, int lutsize)
{
    ...
    if (fdevice->io.mode == FLASHIO_SPI) {
        ...
        spiTransfer(busdev->busdev_u.spi.instance, cmd, 
# 756 "./src/main/drivers/flash_w25n01g.c" 3 4
                                                       ((void *)0)
# 756 "./src/main/drivers/flash_w25n01g.c"
                                                           , 2);

        for (int i = 0 ; i < lutsize ; i++) {
            spiTransfer(busdev->busdev_u.spi.instance, 
# 759 "./src/main/drivers/flash_w25n01g.c" 3 4
                                                      ((void *)0)
# 759 "./src/main/drivers/flash_w25n01g.c"
                                                          , in, 4);
        ...
        uint8_t bblutBuffer[20 * 4];
        quadSpiReceive1LINE(quadSpi, 0xA5, 8, bblutBuffer, sizeof(bblutBuffer));
...
void w25n01g_writeBBLUT(flashDevice_t *fdevice, uint16_t lba, uint16_t pba)
{
    ...
    if (fdevice->io.mode == FLASHIO_SPI) {
        ...
        uint8_t cmd[5] = { 0xA1, lba >> 8, lba, pba >> 8, pba };

        __asm volatile ("nop"); IOLo((busdev)->busdev_u.spi.csnPin);
        spiTransfer(busdev->busdev_u.spi.instance, cmd, 
# 796 "./src/main/drivers/flash_w25n01g.c" 3 4
                                                       ((void *)0)
# 796 "./src/main/drivers/flash_w25n01g.c"
                                                           , sizeof(cmd));
        IOHi((busdev)->busdev_u.spi.csnPin); __asm volatile ("nop");
    }
        ...
        quadSpiInstructionWithData1LINE(quadSpi, 0xA1, 0, data, sizeof(data));
    }
