...
SPIDevice spiDeviceByInstance(SPI_TypeDef *instance)
{
    ...
    if (instance == ((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3400UL)))
        return SPIDEV_4;
...
# 99 "./src/main/drivers/bus_spi.c"
    ...
    case SPIDEV_4:
        ...
        spiInitDevice(device, leadingEdge);
        return 
# 107 "./src/main/drivers/bus_spi.c" 3 4
              1
# 107 "./src/main/drivers/bus_spi.c"
                  ;
