...
void mwDisarm(void);
# 51 "./src/main/sensors/barometer.c" 2
...
# 53 "./src/main/sensors/barometer.c" 2
...
# 55 "./src/main/sensors/barometer.c" 2
...
# 135 "./src/main/sensors/barometer.c"
...
static 
# 150 "./src/main/sensors/barometer.c" 3 4
      _Bool 
# 150 "./src/main/sensors/barometer.c"
           baroReady = 
# 150 "./src/main/sensors/barometer.c" 3 4
                       0
# 150 "./src/main/sensors/barometer.c"
...
void baroPreInit(void)
{
    ...
    if (barometerConfig()->baro_bustype == BUSTYPE_SPI) {
        spiPreinitRegister(barometerConfig()->baro_spi_csn, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_UP) << 5)), 1);
    }
    ...
    baroDetect(baroDev_t *dev, baroSensor_e baroHardwareToUse)
{
    ...
    case BUSTYPE_SPI:
        {
            SPI_TypeDef *instance = spiInstanceByDevice(((barometerConfig()->baro_spi_device) - 1));
            if (!instance) {
                return 
# 185 "./src/main/sensors/barometer.c" 3 4
                      0
# 185 "./src/main/sensors/barometer.c"
                           ;
            }
    ...
    default:
        return 
# 196 "./src/main/sensors/barometer.c" 3 4
              0
# 196 "./src/main/sensors/barometer.c"
                   ;
    }
...
# 218 "./src/main/sensors/barometer.c"
    ...
    case BARO_DPS310:
# 247 "./src/main/sensors/barometer.c"
        __attribute__ ((fallthrough));
...
# 264 "./src/main/sensors/barometer.c"
    ...
    if (baroHardware == BARO_NONE) {
        return 
# 289 "./src/main/sensors/barometer.c" 3 4
              0
# 289 "./src/main/sensors/barometer.c"
                   ;
    }
    ...
    return 
# 294 "./src/main/sensors/barometer.c" 3 4
          1
# 294 "./src/main/sensors/barometer.c"
              ;
}


# 297 "./src/main/sensors/barometer.c" 3 4
_Bool 
# 297 "./src/main/sensors/barometer.c"
    baroIsCalibrationComplete(void)
{
...
static int32_t applyBarometerMedianFilter(int32_t newPressureReading)
{
    ...
    static 
# 323 "./src/main/sensors/barometer.c" 3 4
          _Bool 
# 323 "./src/main/sensors/barometer.c"
               medianFilterReady = 
# 323 "./src/main/sensors/barometer.c" 3 4
                                   0
# 323 "./src/main/sensors/barometer.c"
    ...
    if (nextSampleIndex == 3) {
        nextSampleIndex = 0;
        medianFilterReady = 
# 329 "./src/main/sensors/barometer.c" 3 4
                           1
# 329 "./src/main/sensors/barometer.c"
                               ;
    }
...
static uint32_t recalculateBarometerTotal(uint32_t pressureTotal, int32_t newPressureReading)
{
    ...
    if (currentSampleIndex >= barometerConfig()->baro_sample_count) {
        nextSampleIndex = 0;
        baroReady = 
# 350 "./src/main/sensors/barometer.c" 3 4
                   1
# 350 "./src/main/sensors/barometer.c"
                       ;
    } else {
...
# 375 "./src/main/sensors/barometer.c" 3 4
_Bool 
# 375 "./src/main/sensors/barometer.c"
    isBaroReady(void) {
    return baroReady;
}
