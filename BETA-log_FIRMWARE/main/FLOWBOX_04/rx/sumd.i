...
static void sumdDataReceive(uint16_t c, void *data)
{
    ...
    if (sumdIndex == 0) {
        if (c != 0xA8) {
            ...
            sumdFrameDone = 
# 99 "./src/main/rx/sumd.c" 3 4
                           0
# 99 "./src/main/rx/sumd.c"
                                ;
            crc = 0;
        }
    } else if (sumdIndex == 2) {
    ...
    if (sumdIndex <= sumdChannelCount * 2 + 3) {
        ...
        sumdIndex = 0;
        sumdFrameDone = 
# 116 "./src/main/rx/sumd.c" 3 4
                       1
# 116 "./src/main/rx/sumd.c"
                           ;
    }
}
...
static uint8_t sumdFrameStatus(rxRuntimeState_t *rxRuntimeState)
{
    ...
    sumdFrameDone = 
# 130 "./src/main/rx/sumd.c" 3 4
                   0
# 130 "./src/main/rx/sumd.c"
                        ;
...
# 176 "./src/main/rx/sumd.c" 3 4
_Bool 
# 176 "./src/main/rx/sumd.c"
    sumdInit(const rxConfig_t *rxConfig, rxRuntimeState_t *rxRuntimeState)
{
    (void)(rxConfig);
...
# 201 "./src/main/rx/sumd.c"
    ...
    return sumdPort != 
# 213 "./src/main/rx/sumd.c" 3 4
                      ((void *)0)
# 213 "./src/main/rx/sumd.c"
                          ;
}
