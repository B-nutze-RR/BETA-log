...
# 24 "./src/main/drivers/light_ws2811strip_stdperiph.c" 2
...
# 41 "./src/main/drivers/light_ws2811strip_stdperiph.c" 2

static IO_t ws2811IO = ((IO_t)0);

static dmaResource_t *dmaRef = 
# 44 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
                              ((void *)0)
# 44 "./src/main/drivers/light_ws2811strip_stdperiph.c"
                                  ;
...
static void WS2811_DMA_IRQHandler(dmaChannelDescriptor_t *descriptor)
{
    ...
    if ((descriptor->dma->ISR & (((uint32_t)0x00000002) << descriptor->flagsShift))) {
        ...
        } else if (counter == (32 + 2)) {
            counter = 0;
            ws2811LedDataTransferInProgress = 
# 64 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
                                             0
# 64 "./src/main/drivers/light_ws2811strip_stdperiph.c"
                                                  ;
            DMA_Cmd((DMA_Channel_TypeDef *)(descriptor->ref), DISABLE);
        }
...
# 76 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
_Bool 
# 76 "./src/main/drivers/light_ws2811strip_stdperiph.c"
    ws2811LedStripHardwareInit(ioTag_t ioTag)
{
    if (!ioTag) {
        return 
# 79 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
              0
# 79 "./src/main/drivers/light_ws2811strip_stdperiph.c"
                   ;
    }
    ...
    if (timerHardware == 
# 88 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
                        ((void *)0)
# 88 "./src/main/drivers/light_ws2811strip_stdperiph.c"
                            ) {
        return 
# 89 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
              0
# 89 "./src/main/drivers/light_ws2811strip_stdperiph.c"
                   ;
    }

    timer = timerHardware->tim;
# 106 "./src/main/drivers/light_ws2811strip_stdperiph.c"
    ...
    if (dmaRef == 
# 112 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
                 ((void *)0)
# 112 "./src/main/drivers/light_ws2811strip_stdperiph.c"
                     ) {
        return 
# 113 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
              0
# 113 "./src/main/drivers/light_ws2811strip_stdperiph.c"
                   ;
    }
    ...
    dmaSetHandler(dmaGetIdentifier(dmaRef), WS2811_DMA_IRQHandler, (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((2)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), 0);

    DMA_DeInit((DMA_Channel_TypeDef *)(dmaRef));


    DMA_Cmd((DMA_Channel_TypeDef *)(dmaRef), DISABLE);
    DMA_DeInit((DMA_Channel_TypeDef *)(dmaRef));
    DMA_StructInit(&DMA_InitStructure);
    DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)timerCCR(timer, timerHardware->channel);
    DMA_InitStructure.DMA_BufferSize = (1 * 24);
    DMA_InitStructure.DMA_PeripheralInc = ((uint32_t)0x00000000);
    DMA_InitStructure.DMA_MemoryInc = ((uint32_t)0x00000080);
# 196 "./src/main/drivers/light_ws2811strip_stdperiph.c"
    ...
    DMA_Init((DMA_Channel_TypeDef *)(dmaRef), &DMA_InitStructure);
    TIM_DMACmd(timer, timerDmaSource(timerHardware->channel), ENABLE);
    DMA_ITConfig((DMA_Channel_TypeDef *)(dmaRef), ((uint32_t)0x00000002), ENABLE);

    return 
# 214 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
          1
# 214 "./src/main/drivers/light_ws2811strip_stdperiph.c"
              ;
}

void ws2811LedStripDMAEnable(void)
{
    DMA_SetCurrDataCounter((DMA_Channel_TypeDef *)(dmaRef), (1 * 24));
    TIM_SetCounter(timer, 0);
    TIM_Cmd(timer, ENABLE);
    DMA_Cmd((DMA_Channel_TypeDef *)(dmaRef), ENABLE);
}
