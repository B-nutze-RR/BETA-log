...
# 346 "./lib/main/CMSIS/DSP/Include/arm_math.h"
...
# 61 "./src/main/cms/cms_menu_imu.c" 2
...
# 322 "./src/main/cms/cms_menu_imu.c" 3 4
                                        ((void *)0)
# 322 "./src/main/cms/cms_menu_imu.c"
                                            , 
# 322 "./src/main/cms/cms_menu_imu.c" 3 4
                                              ((void *)0)
# 322 "./src/main/cms/cms_menu_imu.c"
                                                  , 0},
    { "PID TUNING", OME_TAB, 
# 323 "./src/main/cms/cms_menu_imu.c" 3 4
                                 ((void *)0)
# 323 "./src/main/cms/cms_menu_imu.c"
                                     , &(OSD_TAB_t) { &cmsx_simplified_pids_mode, PID_SIMPLIFIED_TUNING_MODE_COUNT - 1, lookupTableSimplifiedTuningPidsMode }, 0 },
    { "MASTER MULT", OME_FLOAT, 
# 324 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 324 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_FLOAT_t) { &cmsx_simplified_master_multiplier, 50, 200, 1, 10 }, 0 },
    { "R/P RATIO", OME_FLOAT, 
# 325 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 325 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_FLOAT_t) { &cmsx_simplified_roll_pitch_ratio, 50, 200, 1, 10 }, 0 },
    { "I GAIN", OME_FLOAT, 
# 326 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 326 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_FLOAT_t) { &cmsx_simplified_i_gain, 50, 200, 1, 10 }, 0 },
    { "PD RATIO", OME_FLOAT, 
# 327 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 327 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_FLOAT_t) { &cmsx_simplified_pd_ratio, 50, 200, 1, 10 }, 0 },
    { "PD GAIN", OME_FLOAT, 
# 328 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 328 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_FLOAT_t) { &cmsx_simplified_pd_gain, 50, 200, 1, 10 }, 0 },
    { "DMIN RATIO", OME_FLOAT, 
# 329 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 329 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_FLOAT_t) { &cmsx_simplified_dmin_ratio, 50, 200, 1, 10 }, 0 },
    { "FF GAIN", OME_FLOAT, 
# 330 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 330 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_FLOAT_t) { &cmsx_simplified_ff_gain, 50, 200, 1, 10 }, 0 },

    { "-- SIMPLIFIED FILTER --", OME_Label, 
# 332 "./src/main/cms/cms_menu_imu.c" 3 4
                                           ((void *)0)
# 332 "./src/main/cms/cms_menu_imu.c"
                                               , 
# 332 "./src/main/cms/cms_menu_imu.c" 3 4
                                                 ((void *)0)
# 332 "./src/main/cms/cms_menu_imu.c"
...
# 333 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_TAB_t) { &cmsx_simplified_gyro_filter, 1, lookupTableOffOn }, 0 },
    { "GYRO MULT", OME_FLOAT, 
# 334 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 334 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_FLOAT_t) { &cmsx_simplified_gyro_filter_multiplier, 50, 200, 1, 10 }, 0 },
    { "DTERM TUNING", OME_TAB, 
# 335 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 335 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_TAB_t) { &cmsx_simplified_dterm_filter, 1, lookupTableOffOn }, 0 },
    { "DTERM MULT", OME_FLOAT, 
# 336 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 336 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_FLOAT_t) { &cmsx_simplified_dterm_filter_multiplier, 50, 200, 1, 10 }, 0 },

    { "-- GENERAL --", OME_Label, 
# 338 "./src/main/cms/cms_menu_imu.c" 3 4
                                 ((void *)0)
# 338 "./src/main/cms/cms_menu_imu.c"
                                     , 
# 338 "./src/main/cms/cms_menu_imu.c" 3 4
                                       ((void *)0)
# 338 "./src/main/cms/cms_menu_imu.c"
                                           , 0},
    { "APPLY TUNING", OME_Funcall, cmsx_applySimplifiedTuning, 
...
static const void *cmsx_RateProfileWriteback(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    return 
# 374 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 374 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
static const void *cmsx_RateProfileOnEnter(displayPort_t *pDisp)
{
    ...
    return 
# 384 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 384 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
{
    { "-- RATE --", OME_Label, 
# 389 "./src/main/cms/cms_menu_imu.c" 3 4
                              ((void *)0)
# 389 "./src/main/cms/cms_menu_imu.c"
                                  , rateProfileIndexString, 0 },

    { "RC R RATE", OME_FLOAT, 
# 391 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 391 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rcRates[FD_ROLL], 1, 255, 1, 10 }, 0 },
    { "RC P RATE", OME_FLOAT, 
# 392 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 392 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rcRates[FD_PITCH], 1, 255, 1, 10 }, 0 },
    { "RC Y RATE", OME_FLOAT, 
# 393 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 393 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rcRates[FD_YAW], 1, 255, 1, 10 }, 0 },

    { "ROLL SUPER", OME_FLOAT, 
# 395 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 395 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rates[FD_ROLL], 0, 255, 1, 10 }, 0 },
    { "PITCH SUPER", OME_FLOAT, 
# 396 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 396 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rates[FD_PITCH], 0, 255, 1, 10 }, 0 },
    { "YAW SUPER", OME_FLOAT, 
# 397 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 397 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_FLOAT_t) { &rateProfile.rates[FD_YAW], 0, 255, 1, 10 }, 0 },
...
# 406 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 406 "./src/main/cms/cms_menu_imu.c"
...
# 408 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_TAB_t) { &rateProfile.throttle_limit_type, THROTTLE_LIMIT_TYPE_COUNT - 1, osdTableThrottleLimitType}, 0 },
    { "THR LIM %", OME_UINT8, 
# 409 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 409 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &rateProfile.throttle_limit_percent, 25, 100, 1}, 0 },

    { "ROLL LVL EXPO", OME_FLOAT, 
# 411 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 411 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_FLOAT_t) { &rateProfile.levelExpo[FD_ROLL], 0, 100, 1, 10 }, 0 },
    { "PITCH LVL EXPO", OME_FLOAT, 
# 412 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 412 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_FLOAT_t) { &rateProfile.levelExpo[FD_PITCH], 0, 100, 1, 10 }, 0 },
...
# 414 "./src/main/cms/cms_menu_imu.c"
                                 , 0 },
    { 
# 415 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 415 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 415 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 415 "./src/main/cms/cms_menu_imu.c"
...
static CMS_Menu cmsx_menuRateProfile = {
    ...
    .onDisplayUpdate = 
# 425 "./src/main/cms/cms_menu_imu.c" 3 4
                      ((void *)0)
# 425 "./src/main/cms/cms_menu_imu.c"
                          ,
...
static const void *cmsx_launchControlOnEnter(displayPort_t *pDisp)
{
    ...
    return 
# 448 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 448 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
# 468 "./src/main/cms/cms_menu_imu.c" 3 4
                                        ((void *)0)
# 468 "./src/main/cms/cms_menu_imu.c"
                                            , pidProfileIndexString, 0 },
...
# 470 "./src/main/cms/cms_menu_imu.c"
                                        , &(OSD_TAB_t) { &cmsx_launchControlMode, LAUNCH_CONTROL_MODE_COUNT - 1, osdLaunchControlModeNames}, 0 },
    { "ALLOW RESET", OME_Bool, 
# 471 "./src/main/cms/cms_menu_imu.c" 3 4
                                    ((void *)0)
# 471 "./src/main/cms/cms_menu_imu.c"
                                        , &cmsx_launchControlAllowTriggerReset, 0 },
    { "TRIGGER THROTTLE", OME_UINT8, 
# 472 "./src/main/cms/cms_menu_imu.c" 3 4
                                    ((void *)0)
# 472 "./src/main/cms/cms_menu_imu.c"
                                        , &(OSD_UINT8_t) { &cmsx_launchControlThrottlePercent, 0, 90, 1 } , 0 },
    { "ANGLE LIMIT", OME_UINT8, 
# 473 "./src/main/cms/cms_menu_imu.c" 3 4
                                    ((void *)0)
# 473 "./src/main/cms/cms_menu_imu.c"
                                        , &(OSD_UINT8_t) { &cmsx_launchControlAngleLimit, 0, 80, 1 } , 0 },
    { "ITERM GAIN", OME_UINT8, 
# 474 "./src/main/cms/cms_menu_imu.c" 3 4
                                    ((void *)0)
# 474 "./src/main/cms/cms_menu_imu.c"
                                        , &(OSD_UINT8_t) { &cmsx_launchControlGain, 0, 200, 1 } , 0 },
...
# 476 "./src/main/cms/cms_menu_imu.c"
                                 , 0 },
    { 
# 477 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 477 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 477 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 477 "./src/main/cms/cms_menu_imu.c"
...
static const void *cmsx_profileOtherOnEnter(displayPort_t *pDisp)
{
    ...
    return 
# 569 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 569 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
static const void *cmsx_profileOtherOnExit(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    initEscEndpoints();
    return 
# 618 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 618 "./src/main/cms/cms_menu_imu.c"
              ;
}

static const OSD_Entry cmsx_menuProfileOtherEntries[] = {
    { "-- OTHER PP --", OME_Label, 
# 622 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 622 "./src/main/cms/cms_menu_imu.c"
                                      , pidProfileIndexString, 0 },

    { "FF TRANS", OME_FLOAT, 
# 624 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 624 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_FLOAT_t) { &cmsx_feedForwardTransition, 0, 100, 1, 10 }, 0 },

    { "FF MODE", OME_TAB, 
# 626 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 626 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_TAB_t) { &cmsx_ff_interpolate_sp, 4, lookupTableInterpolatedSetpoint}, 0 },
    { "FF SMOOTHNESS", OME_UINT8, 
# 627 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 627 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_UINT8_t) { &cmsx_ff_smooth_factor, 0, 75, 1 } , 0 },

    { "FF BOOST", OME_UINT8, 
# 629 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 629 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_ff_boost, 0, 50, 1 } , 0 },
    { "ANGLE STR", OME_UINT8, 
# 630 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 630 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_angleStrength, 0, 200, 1 } , 0 },
    { "HORZN STR", OME_UINT8, 
# 631 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 631 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_horizonStrength, 0, 200, 1 } , 0 },
    { "HORZN TRS", OME_UINT8, 
# 632 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 632 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_horizonTransition, 0, 200, 1 } , 0 },
    { "AG GAIN", OME_UINT16, 
# 633 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 633 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT16_t) { &cmsx_itermAcceleratorGain, 0, 30000, 10 } , 0 },
    { "AG THR", OME_UINT16, 
# 634 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 634 "./src/main/cms/cms_menu_imu.c"
...
# 639 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_thrustLinearization, 0, 150, 1 } , 0 },
...
# 642 "./src/main/cms/cms_menu_imu.c"
                                        , &(OSD_TAB_t) { &cmsx_iterm_relax, ITERM_RELAX_COUNT - 1, lookupTableItermRelax }, 0 },
    { "I_RELAX TYPE", OME_TAB, 
# 643 "./src/main/cms/cms_menu_imu.c" 3 4
                                    ((void *)0)
# 643 "./src/main/cms/cms_menu_imu.c"
                                        , &(OSD_TAB_t) { &cmsx_iterm_relax_type, ITERM_RELAX_TYPE_COUNT - 1, lookupTableItermRelaxType }, 0 },
    { "I_RELAX CUTOFF", OME_UINT8, 
# 644 "./src/main/cms/cms_menu_imu.c" 3 4
                                    ((void *)0)
# 644 "./src/main/cms/cms_menu_imu.c"
                                        , &(OSD_UINT8_t) { &cmsx_iterm_relax_cutoff, 1, 50, 1 }, 0 },


    {"LAUNCH CONTROL", OME_Submenu, cmsMenuChange, &cmsx_menuLaunchControl, 0 },

    { "MTR OUT LIM %",OME_UINT8, 
# 649 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 649 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_motorOutputLimit, 1, 100, 1}, 0 },

    { "AUTO CELL CNT", OME_INT8, 
# 651 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 651 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_INT8_t) { &cmsx_autoProfileCellCount, AUTO_PROFILE_CELL_COUNT_CHANGE, 8, 1}, 0 },


    { "D_MIN ROLL", OME_UINT8, 
# 654 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 654 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_d_min[FD_ROLL], 0, 100, 1 }, 0 },
    { "D_MIN PITCH", OME_UINT8, 
# 655 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 655 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_d_min[FD_PITCH], 0, 100, 1 }, 0 },
    { "D_MIN YAW", OME_UINT8, 
# 656 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 656 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_d_min[FD_YAW], 0, 100, 1 }, 0 },
    { "D_MIN GAIN", OME_UINT8, 
# 657 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 657 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_d_min_gain, 0, 100, 1 }, 0 },
    { "D_MIN ADV", OME_UINT8, 
# 658 "./src/main/cms/cms_menu_imu.c" 3 4
                                ((void *)0)
# 658 "./src/main/cms/cms_menu_imu.c"
                                    , &(OSD_UINT8_t) { &cmsx_d_min_advance, 0, 200, 1 }, 0 },



    { "VBAT_SAG_COMP", OME_UINT8, 
# 662 "./src/main/cms/cms_menu_imu.c" 3 4
                                  ((void *)0)
# 662 "./src/main/cms/cms_menu_imu.c"
                                      , &(OSD_UINT8_t) { &cmsx_vbat_sag_compensation, 0, 150, 1 }, 0 },


    { "BACK", OME_Back, 
# 665 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 665 "./src/main/cms/cms_menu_imu.c"
                           , 
# 665 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0)
# 665 "./src/main/cms/cms_menu_imu.c"
...
static CMS_Menu cmsx_menuProfileOther = {
    ...
    .onDisplayUpdate = 
# 676 "./src/main/cms/cms_menu_imu.c" 3 4
                      ((void *)0)
# 676 "./src/main/cms/cms_menu_imu.c"
                          ,
...
static const void *cmsx_menuGyro_onEnter(displayPort_t *pDisp)
{
    ...
    return 
# 701 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 701 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
static const void *cmsx_menuGyro_onExit(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    return 
# 717 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 717 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
# 722 "./src/main/cms/cms_menu_imu.c" 3 4
                                     ((void *)0)
# 722 "./src/main/cms/cms_menu_imu.c"
                                         , 
# 722 "./src/main/cms/cms_menu_imu.c" 3 4
                                           ((void *)0)
# 722 "./src/main/cms/cms_menu_imu.c"
    ...
    { "GYRO LPF", OME_UINT16, 
# 724 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 724 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t) { &gyroConfig_gyro_lowpass_hz, 0, 4000, 1 }, 0 },

    { "GYRO LPF2", OME_UINT16, 
# 726 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 726 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t) { &gyroConfig_gyro_lowpass2_hz, 0, 4000, 1 }, 0 },

    { "GYRO NF1", OME_UINT16, 
# 728 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 728 "./src/main/cms/cms_menu_imu.c"
...
# 729 "./src/main/cms/cms_menu_imu.c"
    ...
    { "GYRO NF2", OME_UINT16, 
# 730 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 730 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t) { &gyroConfig_gyro_soft_notch_hz_2, 0, 500, 1 }, 0 },
    { "GYRO NF2C", OME_UINT16, 
# 731 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 731 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t) { &gyroConfig_gyro_soft_notch_cutoff_2, 0, 500, 1 }, 0 },

    { "GYRO TO USE", OME_TAB, 
# 733 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 733 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_TAB_t) { &gyroConfig_gyro_to_use, 2, osdTableGyroToUse}, 0x10 },
...
# 736 "./src/main/cms/cms_menu_imu.c"
                                 , 0 },
    { 
# 737 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 737 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 737 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 737 "./src/main/cms/cms_menu_imu.c"
...
static CMS_Menu cmsx_menuFilterGlobal = {
    ...
    .onDisplayUpdate = 
# 747 "./src/main/cms/cms_menu_imu.c" 3 4
                      ((void *)0)
# 747 "./src/main/cms/cms_menu_imu.c"
                          ,
...
static const void *cmsx_FilterPerProfileRead(displayPort_t *pDisp)
{
    ...
    return 
# 870 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 870 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
static const void *cmsx_FilterPerProfileWriteback(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    return 
# 886 "./src/main/cms/cms_menu_imu.c" 3 4
          ((void *)0)
# 886 "./src/main/cms/cms_menu_imu.c"
              ;
}
...
{
    { "-- FILTER PP  --", OME_Label, 
# 891 "./src/main/cms/cms_menu_imu.c" 3 4
                                    ((void *)0)
# 891 "./src/main/cms/cms_menu_imu.c"
                                        , 
# 891 "./src/main/cms/cms_menu_imu.c" 3 4
                                          ((void *)0)
# 891 "./src/main/cms/cms_menu_imu.c"
...
# 893 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 893 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t){ &cmsx_dterm_lowpass_hz, 0, 4000, 1 }, 0 },
    { "DTERM LPF2", OME_UINT16, 
# 894 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 894 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t){ &cmsx_dterm_lowpass2_hz, 0, 4000, 1 }, 0 },
    { "DTERM NF", OME_UINT16, 
# 895 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 895 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t){ &cmsx_dterm_notch_hz, 0, 4000, 1 }, 0 },
    { "DTERM NFCO", OME_UINT16, 
# 896 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 896 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t){ &cmsx_dterm_notch_cutoff, 0, 4000, 1 }, 0 },
    { "YAW LPF", OME_UINT16, 
# 897 "./src/main/cms/cms_menu_imu.c" 3 4
                               ((void *)0)
# 897 "./src/main/cms/cms_menu_imu.c"
                                   , &(OSD_UINT16_t){ &cmsx_yaw_lowpass_hz, 0, 500, 1 }, 0 },

    { "BACK", OME_Back, 
# 899 "./src/main/cms/cms_menu_imu.c" 3 4
                       ((void *)0)
# 899 "./src/main/cms/cms_menu_imu.c"
                           , 
# 899 "./src/main/cms/cms_menu_imu.c" 3 4
                             ((void *)0)
# 899 "./src/main/cms/cms_menu_imu.c"
                                 , 0 },
    { 
# 900 "./src/main/cms/cms_menu_imu.c" 3 4
     ((void *)0)
# 900 "./src/main/cms/cms_menu_imu.c"
         , OME_END, 
# 900 "./src/main/cms/cms_menu_imu.c" 3 4
                    ((void *)0)
# 900 "./src/main/cms/cms_menu_imu.c"
...
static CMS_Menu cmsx_menuFilterPerProfile = {
    ...
    .onDisplayUpdate = 
# 910 "./src/main/cms/cms_menu_imu.c" 3 4
                      ((void *)0)
# 910 "./src/main/cms/cms_menu_imu.c"
                          ,
...
{
    { "-- PROFILE --", OME_Label, 
# 991 "./src/main/cms/cms_menu_imu.c" 3 4
                                 ((void *)0)
# 991 "./src/main/cms/cms_menu_imu.c"
                                     , 
# 991 "./src/main/cms/cms_menu_imu.c" 3 4
                                       ((void *)0)
# 991 "./src/main/cms/cms_menu_imu.c"
...
# 1013 "./src/main/cms/cms_menu_imu.c"
                                , 0},
    {
# 1014 "./src/main/cms/cms_menu_imu.c" 3 4
    ((void *)0)
# 1014 "./src/main/cms/cms_menu_imu.c"
        , OME_END, 
# 1014 "./src/main/cms/cms_menu_imu.c" 3 4
                   ((void *)0)
# 1014 "./src/main/cms/cms_menu_imu.c"
...
CMS_Menu cmsx_menuImu = {
    ...
    .onDisplayUpdate = 
# 1024 "./src/main/cms/cms_menu_imu.c" 3 4
                      ((void *)0)
# 1024 "./src/main/cms/cms_menu_imu.c"
                          ,
