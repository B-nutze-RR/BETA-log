...
# 35 "./src/main/flight/rpm_filter.c" 2
...
# 37 "./src/main/flight/rpm_filter.c" 2
...
# 42 "./src/main/flight/rpm_filter.c" 2
...
# 44 "./src/main/flight/rpm_filter.c" 2
...
# 46 "./src/main/flight/rpm_filter.c" 2
...
extern void pgResetFn_rpmFilterConfig(rpmFilterConfig_t *); rpmFilterConfig_t rpmFilterConfig_System; rpmFilterConfig_t rpmFilterConfig_Copy; extern const pgRegistry_t rpmFilterConfig_Registry; const pgRegistry_t rpmFilterConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 544 | (4 << 12), .length = 1, .size = sizeof(rpmFilterConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&rpmFilterConfig_System, .copy = (uint8_t*)&rpmFilterConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_rpmFilterConfig }, };
...
void rpmFilterInit(const rpmFilterConfig_t *config)
{
    ...
    if (!motorConfig()->dev.useDshotTelemetry) {
        gyroFilter = 
# 118 "./src/main/flight/rpm_filter.c" 3 4
                    ((void *)0)
# 118 "./src/main/flight/rpm_filter.c"
                        ;
        return;
    }
    ...
    if (config->gyro_rpm_notch_harmonics) {
        ...
        gyroFilter = 
# 130 "./src/main/flight/rpm_filter.c" 3 4
                    ((void *)0)
# 130 "./src/main/flight/rpm_filter.c"
                        ;
    }
...
{
    if (filter == 
# 147 "./src/main/flight/rpm_filter.c" 3 4
                 ((void *)0)
# 147 "./src/main/flight/rpm_filter.c"
                     ) {
        return value;
    }
    for (int motor = 0; motor < getMotorCount(); motor++) {
...
{
    if (gyroFilter == 
# 167 "./src/main/flight/rpm_filter.c" 3 4
                     ((void *)0)
# 167 "./src/main/flight/rpm_filter.c"
                         ) {
        return;
    }
    ...
    for (int motor = 0; motor < getMotorCount(); motor++) {
        ...
        if (motor < 4) {
            {if (debugMode == (DEBUG_RPM_FILTER)) {debug[(motor)] = (motorFrequency[motor]);}};
        }
...
# 214 "./src/main/flight/rpm_filter.c" 3 4
_Bool 
# 214 "./src/main/flight/rpm_filter.c"
    isRpmFilterEnabled(void)
{
