...
# 35 "./src/main/drivers/vtx_common.h"
...
# 687 "./src/main/msp/msp.c"
    ...
    case 160:
        sbufWriteU32(dst, (*(uint32_t*)(0x1FF1E800UL)));
        sbufWriteU32(dst, (*(uint32_t*)((0x1FF1E800UL) + 4)));
        sbufWriteU32(dst, (*(uint32_t*)((0x1FF1E800UL) + 8)));
        break;
