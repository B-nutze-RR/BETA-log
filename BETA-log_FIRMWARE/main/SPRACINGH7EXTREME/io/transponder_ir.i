...
static 
# 58 "./src/main/io/transponder_ir.c" 3 4
      _Bool 
# 58 "./src/main/io/transponder_ir.c"
...
# 58 "./src/main/io/transponder_ir.c"
                                         ;
static 
# 59 "./src/main/io/transponder_ir.c" 3 4
      _Bool 
# 59 "./src/main/io/transponder_ir.c"
           transponderRepeat = 
# 59 "./src/main/io/transponder_ir.c" 3 4
                               0
# 59 "./src/main/io/transponder_ir.c"
...
void transponderUpdate(timeUs_t currentTimeUs)
{
    ...
    const 
# 81 "./src/main/io/transponder_ir.c" 3 4
         _Bool 
# 81 "./src/main/io/transponder_ir.c"
...
# 103 "./src/main/io/transponder_ir.c"
...
{
    transponderRepeat = 
# 118 "./src/main/io/transponder_ir.c" 3 4
                       0
# 118 "./src/main/io/transponder_ir.c"
                            ;
}
...
void transponderStartRepeating(void)
{
    ...
    transponderRepeat = 
# 127 "./src/main/io/transponder_ir.c" 3 4
                       1
# 127 "./src/main/io/transponder_ir.c"
                           ;
}
