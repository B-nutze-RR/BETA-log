...
# 170 "./src/main/rx/fport.c"
    ...
    static 
# 172 "./src/main/rx/fport.c" 3 4
          _Bool 
# 172 "./src/main/rx/fport.c"
               telemetryFrame = 
# 172 "./src/main/rx/fport.c" 3 4
                                0
# 172 "./src/main/rx/fport.c"
    ...
    clearToSend = 
# 176 "./src/main/rx/fport.c" 3 4
                 0
# 176 "./src/main/rx/fport.c"
                      ;
...
# 195 "./src/main/rx/fport.c"
                ...
                telemetryFrame = 
# 197 "./src/main/rx/fport.c" 3 4
                                0
# 197 "./src/main/rx/fport.c"
                                     ;
            }
...
# 218 "./src/main/rx/fport.c"
                ...
                escapedCharacter = 
# 220 "./src/main/rx/fport.c" 3 4
                                  1
# 220 "./src/main/rx/fport.c"
                                      ;
            ...
            if (framePosition == 2 && val == FPORT_FRAME_TYPE_TELEMETRY_REQUEST) {
                telemetryFrame = 
# 226 "./src/main/rx/fport.c" 3 4
                                1
# 226 "./src/main/rx/fport.c"
                                    ;
            }
...
{
    static 
# 249 "./src/main/rx/fport.c" 3 4
          _Bool 
# 249 "./src/main/rx/fport.c"
               hasTelemetryRequest = 
# 249 "./src/main/rx/fport.c" 3 4
                                     0
# 249 "./src/main/rx/fport.c"
    ...
    static 
# 253 "./src/main/rx/fport.c" 3 4
          _Bool 
# 253 "./src/main/rx/fport.c"
               rxDrivenFrameRate = 
# 253 "./src/main/rx/fport.c" 3 4
                                   0
# 253 "./src/main/rx/fport.c"
                    ...
                    if (frameLength != (sizeof(uint8_t) + sizeof(smartPortPayload_t))) {
                        ...
                        case FPORT_FRAME_ID_DATA:
                            if (!rxDrivenFrameRate) {
                                rxDrivenFrameRate = 
# 300 "./src/main/rx/fport.c" 3 4
                                                   1
# 300 "./src/main/rx/fport.c"
                                                       ;
                            }
                        ...
                        case FPORT_FRAME_ID_NULL:
                            if (!rxDrivenFrameRate) {
                                if (consecutiveTelemetryFrameCount >= 2 && !(mspPayload && smartPortPayloadContainsMSP(mspPayload))) {
                                    ...
                                    hasTelemetryRequest = 
# 311 "./src/main/rx/fport.c" 3 4
                                                         1
# 311 "./src/main/rx/fport.c"
                                                             ;
           ...
           fportProcessFrame(const rxRuntimeState_t *rxRuntimeState)
{
    ...
    if (cmpTimeUs(currentTimeUs, lastTelemetryFrameReceivedUs) > 2000) {
       clearToSend = 
# 367 "./src/main/rx/fport.c" 3 4
                    0
# 367 "./src/main/rx/fport.c"
                         ;
    }
...
# 376 "./src/main/rx/fport.c"
    ...
    mspPayload = 
# 383 "./src/main/rx/fport.c" 3 4
                ((void *)0)
# 383 "./src/main/rx/fport.c"
                    ;
...
# 394 "./src/main/rx/fport.c" 3 4
_Bool 
# 394 "./src/main/rx/fport.c"
    fportRxInit(const rxConfig_t *rxConfig, rxRuntimeState_t *rxRuntimeState)
{
    ...
    if (!portConfig) {
        return 
# 409 "./src/main/rx/fport.c" 3 4
              0
# 409 "./src/main/rx/fport.c"
                   ;
    }
...
# 415 "./src/main/rx/fport.c" 3 4
       ((void *)0)
# 415 "./src/main/rx/fport.c"
           ,
        115200,
        MODE_RXTX,
    ...
    return fportPort != 
# 431 "./src/main/rx/fport.c" 3 4
                       ((void *)0)
# 431 "./src/main/rx/fport.c"
                           ;
}
