...
# 220 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 220 "./src/main/io/beeper.c"
     ,"SYSTEM_INIT" },
    { BEEPER_USB,18,
# 221 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 221 "./src/main/io/beeper.c"
     ,"ON_USB" },
...
# 230 "./src/main/io/beeper.c" 3 4
                                                     ((void *)0)
# 230 "./src/main/io/beeper.c"
                                                         ;
...
{
    systemBeep(
# 281 "./src/main/io/beeper.c" 3 4
   0
# 281 "./src/main/io/beeper.c"
   );
    beeperIsOn = 
# 282 "./src/main/io/beeper.c" 3 4
                0
# 282 "./src/main/io/beeper.c"
    ...
    currentBeeperEntry = 
# 290 "./src/main/io/beeper.c" 3 4
                        ((void *)0)
# 290 "./src/main/io/beeper.c"
                            ;
}
...
void beeperUpdate(timeUs_t currentTimeUs)
{
    ...
    if (currentBeeperEntry == 
# 388 "./src/main/io/beeper.c" 3 4
                             ((void *)0)
# 388 "./src/main/io/beeper.c"
                                 ) {
        return;
    }
...
# 411 "./src/main/io/beeper.c"
                ...
                beeperIsOn = 
# 412 "./src/main/io/beeper.c" 3 4
                            1
# 412 "./src/main/io/beeper.c"
                                ;
            }
        ...
        if (currentBeeperEntry->sequence[beeperPos] != 0) {
            systemBeep(
# 427 "./src/main/io/beeper.c" 3 4
           0
# 427 "./src/main/io/beeper.c"
           );
            beeperIsOn = 
# 428 "./src/main/io/beeper.c" 3 4
                        0
# 428 "./src/main/io/beeper.c"
                             ;
...
# 489 "./src/main/io/beeper.c" 3 4
                                                                                      ((void *)0)
# 489 "./src/main/io/beeper.c"
                                                                                          ;
}
...
# 503 "./src/main/io/beeper.c" 3 4
_Bool 
# 503 "./src/main/io/beeper.c"
    isBeeperOn(void)
{
    return beeperIsOn;
}
