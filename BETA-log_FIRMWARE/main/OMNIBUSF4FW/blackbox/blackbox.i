...
# 31 "./src/main/drivers/accgyro/accgyro.h"
...
# 91 "./src/main/blackbox/blackbox.c"
extern const blackboxConfig_t pgResetTemplate_blackboxConfig; blackboxConfig_t blackboxConfig_System; blackboxConfig_t blackboxConfig_Copy; extern const pgRegistry_t blackboxConfig_Registry; const pgRegistry_t blackboxConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 5 | (2 << 12), .length = 1, .size = sizeof(blackboxConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&blackboxConfig_System, .copy = (uint8_t*)&blackboxConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_blackboxConfig}, };
...
# 113 "./src/main/blackbox/blackbox.c"
...
# 340 "./src/main/blackbox/blackbox.c" 3 4
   _Bool 
# 340 "./src/main/blackbox/blackbox.c"
        rxSignalReceived;
...
static 
# 398 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 398 "./src/main/blackbox/blackbox.c"
...
static 
# 408 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 408 "./src/main/blackbox/blackbox.c"
...
static 
# 413 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 413 "./src/main/blackbox/blackbox.c"
           ...
           testBlackboxConditionUncached(FlightLogFieldCondition condition)
{
    ...
    case FLIGHT_LOG_FIELD_CONDITION_ALWAYS:
        return 
# 422 "./src/main/blackbox/blackbox.c" 3 4
              1
# 422 "./src/main/blackbox/blackbox.c"
                  ;
    ...
    case FLIGHT_LOG_FIELD_CONDITION_RANGEFINDER:
        ...
        return 
# 475 "./src/main/blackbox/blackbox.c" 3 4
              0
# 475 "./src/main/blackbox/blackbox.c"
                   ;
    ...
    case FLIGHT_LOG_FIELD_CONDITION_NEVER:
        return 
# 494 "./src/main/blackbox/blackbox.c" 3 4
              0
# 494 "./src/main/blackbox/blackbox.c"
                   ;

    default:
        return 
# 497 "./src/main/blackbox/blackbox.c" 3 4
              0
# 497 "./src/main/blackbox/blackbox.c"
                   ;
    }
}
...
static void blackboxSetState(BlackboxState newState)
{
    ...
    case BLACKBOX_STATE_PREPARE_LOG_FILE:
        blackboxLoggedAnyFrames = 
# 521 "./src/main/blackbox/blackbox.c" 3 4
                                 0
# 521 "./src/main/blackbox/blackbox.c"
                                      ;
        break;
...
# 622 "./src/main/blackbox/blackbox.c"
    ...
    blackboxLoggedAnyFrames = 
# 663 "./src/main/blackbox/blackbox.c" 3 4
                             1
# 663 "./src/main/blackbox/blackbox.c"
                                 ;
}
...
# 770 "./src/main/blackbox/blackbox.c"
    if (testBlackboxCondition(FLIGHT_LOG_FIELD_CONDITION_RSSI)) {
...
# 778 "./src/main/blackbox/blackbox.c"
    ...
    if (testBlackboxCondition(FLIGHT_LOG_FIELD_CONDITION_ACC)) {
        blackboxWriteMainStateArrayUsingAveragePredictor(
# 781 "./src/main/blackbox/blackbox.c" 3 4
                                                        __builtin_offsetof (
# 781 "./src/main/blackbox/blackbox.c"
                                                        blackboxMainState_t
# 781 "./src/main/blackbox/blackbox.c" 3 4
                                                        , 
# 781 "./src/main/blackbox/blackbox.c"
...
# 781 "./src/main/blackbox/blackbox.c"
    ...
    if (testBlackboxCondition(FLIGHT_LOG_FIELD_CONDITION_DEBUG_LOG)) {
        blackboxWriteMainStateArrayUsingAveragePredictor(
# 784 "./src/main/blackbox/blackbox.c" 3 4
                                                        __builtin_offsetof (
# 784 "./src/main/blackbox/blackbox.c"
                                                        blackboxMainState_t
# 784 "./src/main/blackbox/blackbox.c" 3 4
                                                        , 
# 784 "./src/main/blackbox/blackbox.c"
...
# 784 "./src/main/blackbox/blackbox.c"
    ...
    if (isFieldEnabled(FLIGHT_LOG_FIELD_SELECT_MOTOR)) {
        blackboxWriteMainStateArrayUsingAveragePredictor(
# 788 "./src/main/blackbox/blackbox.c" 3 4
                                                        __builtin_offsetof (
# 788 "./src/main/blackbox/blackbox.c"
                                                        blackboxMainState_t
# 788 "./src/main/blackbox/blackbox.c" 3 4
                                                        , 
# 788 "./src/main/blackbox/blackbox.c"
...
# 788 "./src/main/blackbox/blackbox.c"
    ...
    blackboxLoggedAnyFrames = 
# 800 "./src/main/blackbox/blackbox.c" 3 4
                             1
# 800 "./src/main/blackbox/blackbox.c"
                                 ;
}
...
static 
# 843 "./src/main/blackbox/blackbox.c" 3 4
                  _Bool 
# 843 "./src/main/blackbox/blackbox.c"
                       writeSlowFrameIfNeeded(void)
{

    
# 846 "./src/main/blackbox/blackbox.c" 3 4
   _Bool 
# 846 "./src/main/blackbox/blackbox.c"
    ...
    if (shouldWrite) {
        ...
        if (memcmp(&newSlowState, &slowHistory, sizeof(slowHistory)) != 0) {
            ...
            shouldWrite = 
# 859 "./src/main/blackbox/blackbox.c" 3 4
                         1
# 859 "./src/main/blackbox/blackbox.c"
                             ;
        }
    }
...
# 924 "./src/main/blackbox/blackbox.c"
...
# 953 "./src/main/blackbox/blackbox.c" 3 4
                                                  ((void *)0)
# 953 "./src/main/blackbox/blackbox.c"
                                                      );
...
static void stopInTestMode(void)
{
    if (startedLoggingInTestMode) {
        blackboxFinish();
        startedLoggingInTestMode = 
# 983 "./src/main/blackbox/blackbox.c" 3 4
                                  0
# 983 "./src/main/blackbox/blackbox.c"
                                       ;
    }
}
# 996 "./src/main/blackbox/blackbox.c"
static 
# 996 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 996 "./src/main/blackbox/blackbox.c"
    ...
    if (!(armingFlags & (ARMED)) && areMotorsRunning()) {
        ...
        return 
# 1001 "./src/main/blackbox/blackbox.c" 3 4
              1
# 1001 "./src/main/blackbox/blackbox.c"
                  ;
    } else {
    ...
    return 
# 1006 "./src/main/blackbox/blackbox.c" 3 4
          0
...
# 1136 "./src/main/blackbox/blackbox.c"
static 
# 1136 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 1136 "./src/main/blackbox/blackbox.c"
        ...
        const void *secondFieldDefinition, int fieldCount, const uint8_t *conditions, const uint8_t *secondCondition)
{
    ...
    static 
# 1141 "./src/main/blackbox/blackbox.c" 3 4
          _Bool 
# 1141 "./src/main/blackbox/blackbox.c"
               needComma = 
# 1141 "./src/main/blackbox/blackbox.c" 3 4
                           0
# 1141 "./src/main/blackbox/blackbox.c"
    ...
    if (xmitState.u.fieldIndex == -1) {
        if (xmitState.headerIndex >= headerCount) {
            return 
# 1159 "./src/main/blackbox/blackbox.c" 3 4
                  0
# 1159 "./src/main/blackbox/blackbox.c"
                       ;
        }
        ...
        if (blackboxDeviceReserveBufferSpace(charsToBeWritten) != BLACKBOX_RESERVE_SUCCESS) {
            return 
# 1165 "./src/main/blackbox/blackbox.c" 3 4
                  1
# 1165 "./src/main/blackbox/blackbox.c"
                      ;
        }
    ...
    for (; xmitState.u.fieldIndex < fieldCount; xmitState.u.fieldIndex++) {
        ...
        if (!conditions || testBlackboxCondition(conditions[conditionsStride * xmitState.u.fieldIndex])) {
            ...
            if (blackboxDeviceReserveBufferSpace(bytesToWrite) != BLACKBOX_RESERVE_SUCCESS) {
                ...
                return 
# 1196 "./src/main/blackbox/blackbox.c" 3 4
                      1
# 1196 "./src/main/blackbox/blackbox.c"
                          ;
            }
            ...
            if (needComma) {
                ...
                needComma = 
# 1204 "./src/main/blackbox/blackbox.c" 3 4
                           1
# 1204 "./src/main/blackbox/blackbox.c"
                               ;
            }
...
# 1262 "./src/main/blackbox/blackbox.c"
static 
# 1262 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 1262 "./src/main/blackbox/blackbox.c"
           blackboxWriteSysinfo(void)
{
    ...
    if (blackboxDeviceReserveBufferSpace(64) != BLACKBOX_RESERVE_SUCCESS) {
        return 
# 1270 "./src/main/blackbox/blackbox.c" 3 4
              0
# 1270 "./src/main/blackbox/blackbox.c"
                   ;
    }
    ...
    switch (xmitState.headerIndex) {
        ...
        case 1: blackboxPrintfHeaderLine("Firmware revision", "%s %s (%s) %s", "Betaflight", "4" "." "3" "." "0", shortGitRevision, targetName); break;;
        ...
        case 23: blackboxPrintfHeaderLine("tpa_rate", "%d", currentControlRateProfile->dynThrPID); break;;
        ...
        case 86: blackboxPrintfHeaderLine("baro_hardware", "%d", barometerConfig()->baro_hardware); break;;


        case 87: blackboxPrintfHeaderLine("mag_hardware", "%d", compassConfig()->mag_hardware); break;;

        case 88: blackboxPrintfHeaderLine("gyro_cal_on_first_arm", "%d", armingConfig()->gyro_cal_on_first_arm); break;;
        case 89: blackboxPrintfHeaderLine("rc_interpolation", "%d", rxConfig()->rcInterpolation); break;;
        case 90: blackboxPrintfHeaderLine("rc_interpolation_interval", "%d", rxConfig()->rcInterpolationInterval); break;;
        case 91: blackboxPrintfHeaderLine("rc_interpolation_channels", "%d", rxConfig()->rcInterpolationChannels); break;;
        case 92: blackboxPrintfHeaderLine("airmode_activate_throttle", "%d", rxConfig()->airModeActivateThreshold); break;;
        case 93: blackboxPrintfHeaderLine("serialrx_provider", "%d", rxConfig()->serialrx_provider); break;;
        case 94: blackboxPrintfHeaderLine("use_unsynced_pwm", "%d", motorConfig()->dev.useUnsyncedPwm); break;;
        case 95: blackboxPrintfHeaderLine("motor_pwm_protocol", "%d", motorConfig()->dev.motorPwmProtocol); break;;
        case 96: blackboxPrintfHeaderLine("motor_pwm_rate", "%d", motorConfig()->dev.motorPwmRate); break;;
        case 97: blackboxPrintfHeaderLine("dshot_idle_value", "%d", motorConfig()->digitalIdleOffsetValue); break;;
        case 98: blackboxPrintfHeaderLine("debug_mode", "%d", debugMode); break;;
        case 99: blackboxPrintfHeaderLine("features", "%d", featureConfig()->enabledFeatures); break;;


        case 100: blackboxPrintfHeaderLine("rc_smoothing_type", "%d", rxConfig()->rc_smoothing_type); break;;
        case 101: blackboxPrintfHeaderLine("rc_smoothing_debug_axis", "%d", rcSmoothingData->debugAxis); break;;
        case 102: blackboxPrintfHeaderLine("rc_smoothing_cutoffs", "%d, %d", rcSmoothingData->inputCutoffSetting, rcSmoothingData->derivativeCutoffSetting); break;
                                                                                                                     ;
        case 103: blackboxPrintfHeaderLine("rc_smoothing_auto_factor", "%d", rcSmoothingData->autoSmoothnessFactor); break;;
        case 104: blackboxPrintfHeaderLine("rc_smoothing_filter_type", "%d, %d", rcSmoothingData->inputFilterType, rcSmoothingData->derivativeFilterType); break;
                                                                                                                  ;
        case 105: blackboxPrintfHeaderLine("rc_smoothing_active_cutoffs", "%d, %d", rcSmoothingData->inputCutoffFrequency, rcSmoothingData->derivativeCutoffFrequency); break;
                                                                                                                       ;
        case 106: blackboxPrintfHeaderLine("rc_smoothing_rx_average", "%d", rcSmoothingData->averageFrameTimeUs); break;;

        case 107: blackboxPrintfHeaderLine("rates_type", "%d", currentControlRateProfile->rates_type); break;;

        case 108: blackboxPrintfHeaderLine("fields_disabled_mask", "%d", blackboxConfig()->fields_disabled_mask); break;;


        case 109: blackboxPrintfHeaderLine("vbat_sag_compensation", "%d", currentPidProfile->vbat_sag_compensation); break;;



        case 110: blackboxPrintfHeaderLine("dynamic_idle_min_rpm", "%d", currentPidProfile->dyn_idle_min_rpm); break;;


        default:
            return 
# 1483 "./src/main/blackbox/blackbox.c" 3 4
                  1
# 1483 "./src/main/blackbox/blackbox.c"
    ...
    return 
# 1488 "./src/main/blackbox/blackbox.c" 3 4
          0
# 1488 "./src/main/blackbox/blackbox.c"
               ;
}
...
static 
# 1564 "./src/main/blackbox/blackbox.c" 3 4
                  _Bool 
# 1564 "./src/main/blackbox/blackbox.c"
...
static 
# 1569 "./src/main/blackbox/blackbox.c" 3 4
                  _Bool 
# 1569 "./src/main/blackbox/blackbox.c"
...
# 1734 "./src/main/blackbox/blackbox.c" 3 4
               ((void *)0)
# 1734 "./src/main/blackbox/blackbox.c"
                   , 
# 1734 "./src/main/blackbox/blackbox.c" 3 4
                     ((void *)0)
# 1734 "./src/main/blackbox/blackbox.c"
