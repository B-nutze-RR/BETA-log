...
const timerHardware_t *timerGetByTagAndIndex(ioTag_t ioTag, unsigned timerIndex)
{
    ...
    if (!ioTag || !timerIndex) {
        return 
# 61 "./src/main/drivers/timer_common.c" 3 4
              ((void *)0)
# 61 "./src/main/drivers/timer_common.c"
                  ;
    }
    ...
    return 
# 74 "./src/main/drivers/timer_common.c" 3 4
          ((void *)0)
# 74 "./src/main/drivers/timer_common.c"
              ;
}
...
const timerHardware_t *timerAllocate(ioTag_t ioTag, resourceOwner_e owner, uint8_t resourceIndex)
{
    if (!ioTag) {
        return 
# 108 "./src/main/drivers/timer_common.c" 3 4
              ((void *)0)
# 108 "./src/main/drivers/timer_common.c"
                  ;
    }
...
# 116 "./src/main/drivers/timer_common.c"
    ...
    return 
# 126 "./src/main/drivers/timer_common.c" 3 4
          ((void *)0)
# 126 "./src/main/drivers/timer_common.c"
              ;
}
# 153 "./src/main/drivers/timer_common.c"
ioTag_t timerioTagGetByUsage(timerUsageFlag_e usageFlag, uint8_t index)
{
