...
void renderOsdWarning(char *warningText, 
# 66 "./src/main/osd/osd_warnings.c" 3 4
                                        _Bool 
# 66 "./src/main/osd/osd_warnings.c"
                                             *blinking, uint8_t *displayAttr)
{
    ...
    *blinking = 
# 76 "./src/main/osd/osd_warnings.c" 3 4
               0
# 76 "./src/main/osd/osd_warnings.c"
                    ;
    ...
    if (osdWarnGetState(OSD_WARNING_FAIL_SAFE) && failsafeIsActive()) {
        ...
        *blinking = 
# 130 "./src/main/osd/osd_warnings.c" 3 4
                   1
# 130 "./src/main/osd/osd_warnings.c"
                       ;;
        return;
    }
...
# 156 "./src/main/osd/osd_warnings.c"
    ...
    if (osdWarnGetState(OSD_WARNING_RSSI) && (getRssiPercent() < osdConfig()->rssi_alarm)) {
        ...
        *displayAttr = DISPLAYPORT_ATTR_WARNING;
        *blinking = 
# 168 "./src/main/osd/osd_warnings.c" 3 4
                   1
# 168 "./src/main/osd/osd_warnings.c"
                       ;;
        return;
    }
...
# 219 "./src/main/osd/osd_warnings.c"
    ...
    if ((flightModeFlags & (HEADFREE_MODE))) {
        ...
        *displayAttr = DISPLAYPORT_ATTR_WARNING;
        *blinking = 
# 230 "./src/main/osd/osd_warnings.c" 3 4
                   1
# 230 "./src/main/osd/osd_warnings.c"
                       ;;
        return;
    }
    ...
    if (osdWarnGetState(OSD_WARNING_CORE_TEMPERATURE) && coreTemperature >= osdConfig()->core_temp_alarm) {
        ...
        *displayAttr = DISPLAYPORT_ATTR_WARNING;
        *blinking = 
# 239 "./src/main/osd/osd_warnings.c" 3 4
                   1
# 239 "./src/main/osd/osd_warnings.c"
                       ;;
        return;
    }
...
# 291 "./src/main/osd/osd_warnings.c"
    ...
    if (osdWarnGetState(OSD_WARNING_BATTERY_WARNING) && batteryState == BATTERY_WARNING) {
        ...
        *displayAttr = DISPLAYPORT_ATTR_WARNING;
        *blinking = 
# 300 "./src/main/osd/osd_warnings.c" 3 4
                   1
# 300 "./src/main/osd/osd_warnings.c"
                       ;;
        return;
    }
...
# 309 "./src/main/osd/osd_warnings.c"
    ...
    if (osdWarnGetState(OSD_WARNING_OVER_CAP) && (armingFlags & (ARMED)) && osdConfig()->cap_alarm > 0 && getMAhDrawn() >= osdConfig()->cap_alarm) {
        ...
        *displayAttr = DISPLAYPORT_ATTR_WARNING;
        *blinking = 
# 318 "./src/main/osd/osd_warnings.c" 3 4
                   1
# 318 "./src/main/osd/osd_warnings.c"
                       ;;
        return;
    }
