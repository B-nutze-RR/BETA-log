...
# 51 "./src/main/cms/cms_menu_misc.c" 2
...
# 53 "./src/main/cms/cms_menu_misc.c" 2
...
# 55 "./src/main/cms/cms_menu_misc.c" 2
...
# 57 "./src/main/cms/cms_menu_misc.c" 2
...
# 89 "./src/main/cms/cms_menu_misc.c"
    ...
    { "PITCH", OME_INT16, 
# 90 "./src/main/cms/cms_menu_misc.c" 3 4
                         ((void *)0)
# 90 "./src/main/cms/cms_menu_misc.c"
...
# 95 "./src/main/cms/cms_menu_misc.c"
    ...
    { "AUX3", OME_INT16, 
# 96 "./src/main/cms/cms_menu_misc.c" 3 4
                         ((void *)0)
# 96 "./src/main/cms/cms_menu_misc.c"
...
# 97 "./src/main/cms/cms_menu_misc.c"
    ...
    { "BACK", OME_Back, 
# 99 "./src/main/cms/cms_menu_misc.c" 3 4
                        ((void *)0)
# 99 "./src/main/cms/cms_menu_misc.c"
                            , 
# 99 "./src/main/cms/cms_menu_misc.c" 3 4
                              ((void *)0)
# 99 "./src/main/cms/cms_menu_misc.c"
                                  , 0},
    {
# 100 "./src/main/cms/cms_menu_misc.c" 3 4
    ((void *)0)
# 100 "./src/main/cms/cms_menu_misc.c"
        , OME_END, 
# 100 "./src/main/cms/cms_menu_misc.c" 3 4
                   ((void *)0)
# 100 "./src/main/cms/cms_menu_misc.c"
...
static const void *cmsx_menuMiscOnExit(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    return 
# 138 "./src/main/cms/cms_menu_misc.c" 3 4
          ((void *)0)
# 138 "./src/main/cms/cms_menu_misc.c"
              ;
}
...
{
    { "-- MISC --", OME_Label, 
# 143 "./src/main/cms/cms_menu_misc.c" 3 4
                              ((void *)0)
# 143 "./src/main/cms/cms_menu_misc.c"
                                  , 
# 143 "./src/main/cms/cms_menu_misc.c" 3 4
                                    ((void *)0)
# 143 "./src/main/cms/cms_menu_misc.c"
    ...
    { "MIN THR", OME_UINT16, 
# 145 "./src/main/cms/cms_menu_misc.c" 3 4
                                   ((void *)0)
# 145 "./src/main/cms/cms_menu_misc.c"
                                       , &(OSD_UINT16_t){ &motorConfig_minthrottle, 1000, 2000, 1 }, 0x10 },
    { "DIGITAL IDLE", OME_UINT8, 
# 146 "./src/main/cms/cms_menu_misc.c" 3 4
                                   ((void *)0)
# 146 "./src/main/cms/cms_menu_misc.c"
                                       , &(OSD_UINT8_t) { &motorConfig_digitalIdleOffsetValue, 0, 200, 1 }, 0x10 },
    { "FPV CAM ANGLE", OME_UINT8, 
# 147 "./src/main/cms/cms_menu_misc.c" 3 4
                                   ((void *)0)
# 147 "./src/main/cms/cms_menu_misc.c"
                                       , &(OSD_UINT8_t) { &rxConfig_fpvCamAngleDegrees, 0, 90, 1 }, 0 },
    { "RC PREV", OME_Submenu, cmsMenuChange, &cmsx_menuRcPreview, 0},

    { "BACK", OME_Back, 
# 150 "./src/main/cms/cms_menu_misc.c" 3 4
                       ((void *)0)
# 150 "./src/main/cms/cms_menu_misc.c"
                           , 
# 150 "./src/main/cms/cms_menu_misc.c" 3 4
                             ((void *)0)
# 150 "./src/main/cms/cms_menu_misc.c"
                                 , 0},
    { 
# 151 "./src/main/cms/cms_menu_misc.c" 3 4
     ((void *)0)
# 151 "./src/main/cms/cms_menu_misc.c"
         , OME_END, 
# 151 "./src/main/cms/cms_menu_misc.c" 3 4
                    ((void *)0)
# 151 "./src/main/cms/cms_menu_misc.c"
