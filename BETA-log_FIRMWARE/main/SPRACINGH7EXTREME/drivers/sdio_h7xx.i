# 1 "./src/main/drivers/sdio_h7xx.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/sdio_h7xx.c"
# 28 "./src/main/drivers/sdio_h7xx.c"
# 1 "c:\\dev\\9 2020-q2-update\\lib\\gcc\\arm-none-eabi\\9.3.1\\include\\stdbool.h" 1 3 4
# 29 "./src/main/drivers/sdio_h7xx.c" 2
...
# 30 "./src/main/drivers/sdio_h7xx.c" 2
...
# 153 "./src/main/platform.h" 2
# 32 "./src/main/drivers/sdio_h7xx.c" 2
...
# 36 "./src/main/drivers/sdio_h7xx.c" 2
...
# 38 "./src/main/drivers/sdio_h7xx.c" 2
...
# 41 "./src/main/drivers/sdio_h7xx.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 42 "./src/main/drivers/sdio_h7xx.c" 2
...
# 43 "./src/main/drivers/sdio_h7xx.c" 2
...
# 74 "./src/main/drivers/sdio_h7xx.c"
typedef struct sdioHardware_s {
    SDMMC_TypeDef *instance;
    IRQn_Type irqn;
    sdioPin_t sdioPinCK[2];
    sdioPin_t sdioPinCMD[2];
    sdioPin_t sdioPinD0[2];
    sdioPin_t sdioPinD1[2];
    sdioPin_t sdioPinD2[2];
    sdioPin_t sdioPinD3[2];
} sdioHardware_t;
...
static const sdioHardware_t sdioPinHardware[2] = {
    {
        .instance = ((SDMMC_TypeDef *) (((0x40000000UL) + 0x12000000UL) + 0x7000UL)),
        .irqn = SDMMC1_IRQn,
        .sdioPinCK = { { ((ioTag_t)((((2) + 1) << 4) | (12))), ((uint8_t)0x0C) } },
        .sdioPinCMD = { { ((ioTag_t)((((3) + 1) << 4) | (2))), ((uint8_t)0x0C) } },
        .sdioPinD0 = { { ((ioTag_t)((((2) + 1) << 4) | (8))), ((uint8_t)0x0C) } },
        .sdioPinD1 = { { ((ioTag_t)((((2) + 1) << 4) | (9))), ((uint8_t)0x0C) } },
        .sdioPinD2 = { { ((ioTag_t)((((2) + 1) << 4) | (10))), ((uint8_t)0x0C) } },
        .sdioPinD3 = { { ((ioTag_t)((((2) + 1) << 4) | (11))), ((uint8_t)0x0C) } },
    },
    {
        .instance = ((SDMMC_TypeDef *) (((0x40000000UL) + 0x08020000UL) + 0x2400UL)),
        .irqn = SDMMC2_IRQn,
        .sdioPinCK = { { ((ioTag_t)((((2) + 1) << 4) | (1))), ((uint8_t)0x09) }, { ((ioTag_t)((((3) + 1) << 4) | (6))), ((uint8_t)0x0B) } },
        .sdioPinCMD = { { ((ioTag_t)((((0) + 1) << 4) | (0))), ((uint8_t)0x09) }, { ((ioTag_t)((((3) + 1) << 4) | (7))), ((uint8_t)0x0B) } },
        .sdioPinD0 = { { ((ioTag_t)((((1) + 1) << 4) | (14))), ((uint8_t)0x09) } },
        .sdioPinD1 = { { ((ioTag_t)((((1) + 1) << 4) | (15))), ((uint8_t)0x09) } },
        .sdioPinD2 = { { ((ioTag_t)((((1) + 1) << 4) | (3))), ((uint8_t)0x09) } },
        .sdioPinD3 = { { ((ioTag_t)((((1) + 1) << 4) | (4))), ((uint8_t)0x09) } },
    }
};
...
static const sdioPin_t *sdioFindPinDef(const sdioPin_t *pindefs, ioTag_t pin)
{
    ...
    return 
# 126 "./src/main/drivers/sdio_h7xx.c" 3 4
          ((void *)0)
# 126 "./src/main/drivers/sdio_h7xx.c"
              ;
}
# 137 "./src/main/drivers/sdio_h7xx.c"
void sdioPinConfigure(void)
{
    SDIODevice device = ((sdioConfig()->device) - 1);
    ...
    { const sdioPin_t *pindef; pindef = sdioFindPinDef(sdioHardware->sdioPinCK, sdioPinConfig()->CKPin); if (pindef) { sdioPin[4] = *pindef; } } struct dummy;
    { const sdioPin_t *pindef; pindef = sdioFindPinDef(sdioHardware->sdioPinCMD, sdioPinConfig()->CMDPin); if (pindef) { sdioPin[5] = *pindef; } } struct dummy;
    { const sdioPin_t *pindef; pindef = sdioFindPinDef(sdioHardware->sdioPinD0, sdioPinConfig()->D0Pin); if (pindef) { sdioPin[0] = *pindef; } } struct dummy;

    if (sdioConfig()->use4BitWidth) {
        { const sdioPin_t *pindef; pindef = sdioFindPinDef(sdioHardware->sdioPinD1, sdioPinConfig()->D1Pin); if (pindef) { sdioPin[1] = *pindef; } } struct dummy;
        { const sdioPin_t *pindef; pindef = sdioFindPinDef(sdioHardware->sdioPinD2, sdioPinConfig()->D2Pin); if (pindef) { sdioPin[2] = *pindef; } } struct dummy;
        { const sdioPin_t *pindef; pindef = sdioFindPinDef(sdioHardware->sdioPinD3, sdioPinConfig()->D3Pin); if (pindef) { sdioPin[3] = *pindef; } } struct dummy;
    }
}
...
void HAL_SD_MspInit(SD_HandleTypeDef* hsd)
{
    ...
    if (sdioHardware->instance == ((SDMMC_TypeDef *) (((0x40000000UL) + 0x12000000UL) + 0x7000UL))) {
        do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->AHB3ENR) |= ((0x1UL << (16U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->AHB3ENR) & ((0x1UL << (16U)))); ((void)(tmpreg)); } while(0);
    } else if (sdioHardware->instance == ((SDMMC_TypeDef *) (((0x40000000UL) + 0x08020000UL) + 0x2400UL))) {
        do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->AHB2ENR) |= ((0x1UL << (9U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->AHB2ENR) & ((0x1UL << (9U)))); ((void)(tmpreg)); } while(0);
    }

    uint8_t is4BitWidth = sdioConfig()->use4BitWidth;

    const IO_t clk = IOGetByTag(sdioPin[4].pin);
    const IO_t cmd = IOGetByTag(sdioPin[5].pin);
    const IO_t d0 = IOGetByTag(sdioPin[0].pin);
    const IO_t d1 = IOGetByTag(sdioPin[1].pin);
    const IO_t d2 = IOGetByTag(sdioPin[2].pin);
    const IO_t d3 = IOGetByTag(sdioPin[3].pin);

    IOConfigGPIOAF(clk, (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)), sdioPin[4].af);
    IOConfigGPIOAF(cmd, (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)), sdioPin[5].af);
    IOConfigGPIOAF(d0, (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)), sdioPin[0].af);

    if(is4BitWidth) {
        IOConfigGPIOAF(d1, (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)), sdioPin[1].af);
        IOConfigGPIOAF(d2, (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)), sdioPin[2].af);
        IOConfigGPIOAF(d3, (((0x00000002U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)), sdioPin[3].af);
    }

    HAL_NVIC_SetPriority(sdioHardware->irqn, ((((((((0)<<(4-(7-(((uint32_t)0x00000005)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0))>>(4-(7-(((uint32_t)0x00000005)))))>>4), ((((((((0)<<(4-(7-(((uint32_t)0x00000005)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0))&(0x0f>>(7-(((uint32_t)0x00000005)))))>>4));
...
void SDIO_GPIO_Init(void)
{
    ...
    IOHi(d0);
    IOConfigGPIO(d0, (((0x00000001U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)));

    if(is4BitWidth) {
        IOHi(d1);
        IOHi(d2);
        IOHi(d3);
        IOConfigGPIO(d1, (((0x00000001U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)));
        IOConfigGPIO(d2, (((0x00000001U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)));
        IOConfigGPIO(d3, (((0x00000001U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)));
    }

    IOHi(clk);
    IOHi(cmd);
    IOConfigGPIO(clk, (((0x00000001U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)));
    IOConfigGPIO(cmd, (((0x00000001U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)));
}
...
# 250 "./src/main/drivers/sdio_h7xx.c" 3 4
_Bool 
# 250 "./src/main/drivers/sdio_h7xx.c"
    SD_GetState(void)
{
    HAL_SD_CardStateTypeDef cardState = HAL_SD_GetCardState(&hsd1);

    return (cardState == 0x00000004U);
}
...
SD_Error_t SD_Init(void)
{
    ...
    hsd1.Init.ClockEdge = ((uint32_t)0x00000000U);
    hsd1.Init.ClockPowerSave = (0x1UL << (12U));
    if (sdioConfig()->use4BitWidth) {
        hsd1.Init.BusWide = (0x1UL << (14U));
    } else {
        hsd1.Init.BusWide = ((uint32_t)0x00000000U);
    }
    hsd1.Init.HardwareFlowControl = (0x1UL << (17U));
    ...
    _Static_assert((sizeof(SD_Handle.CSD) == sizeof(hsd1.CSD)), "hal-csd-size-error");
    memcpy(&SD_Handle.CSD, &hsd1.CSD, sizeof(SD_Handle.CSD));

    _Static_assert((sizeof(SD_Handle.CID) == sizeof(hsd1.CID)), "hal-cid-size-error");
