...
# 46 "./src/main/drivers/light_ws2811strip.c" 2
# 64 "./src/main/drivers/light_ws2811strip.c"
uint32_t ledStripDMABuffer[(32 * 24 + 42)];



static ioTag_t ledStripIoTag;
static 
# 69 "./src/main/drivers/light_ws2811strip.c" 3 4
      _Bool 
# 69 "./src/main/drivers/light_ws2811strip.c"
           ws2811Initialised = 
# 69 "./src/main/drivers/light_ws2811strip.c" 3 4
                               0
# 69 "./src/main/drivers/light_ws2811strip.c"
                                    ;
volatile 
# 70 "./src/main/drivers/light_ws2811strip.c" 3 4
        _Bool 
# 70 "./src/main/drivers/light_ws2811strip.c"
             ws2811LedDataTransferInProgress = 
# 70 "./src/main/drivers/light_ws2811strip.c" 3 4
                                               0
# 70 "./src/main/drivers/light_ws2811strip.c"
...
void setUsedLedCount(unsigned ledCount)
{
    ...
    needsFullRefresh = 
# 121 "./src/main/drivers/light_ws2811strip.c" 3 4
                      1
# 121 "./src/main/drivers/light_ws2811strip.c"
                          ;
}
...
void ws2811LedStripEnable(void)
{
    if (!ws2811Initialised) {
        ...
        ws2811Initialised = 
# 143 "./src/main/drivers/light_ws2811strip.c" 3 4
                           1
# 143 "./src/main/drivers/light_ws2811strip.c"
                               ;
    }
}


# 147 "./src/main/drivers/light_ws2811strip.c" 3 4
_Bool 
# 147 "./src/main/drivers/light_ws2811strip.c"
    isWS2811LedStripReady(void)
{
...
static void updateLEDDMABuffer(ledStripFormatRGB_e ledFormat, rgbColor24bpp_t *color, unsigned ledIndex)
{
    ...
    for (int index = 23; index >= 0; index--) {
        ledStripDMABuffer[ledIndex * 24 + dmaBufferOffset++] = (packed_colour & (1 << index)) ? BIT_COMPARE_1 : BIT_COMPARE_0;
    }
}
...
void ws2811UpdateStrip(ledStripFormatRGB_e ledFormat)
{
    ...
    needsFullRefresh = 
# 196 "./src/main/drivers/light_ws2811strip.c" 3 4
                      0
# 196 "./src/main/drivers/light_ws2811strip.c"
                           ;
    ...
    ws2811LedDataTransferInProgress = 
# 202 "./src/main/drivers/light_ws2811strip.c" 3 4
                                     1
# 202 "./src/main/drivers/light_ws2811strip.c"
                                         ;
