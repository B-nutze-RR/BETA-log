...
# 253 "./src/main/rx/jetiexbus.c" 3 4
_Bool 
# 253 "./src/main/rx/jetiexbus.c"
    jetiExBusInit(const rxConfig_t *rxConfig, rxRuntimeState_t *rxRuntimeState)
{
    (void)(rxConfig);
...
# 275 "./src/main/rx/jetiexbus.c" 3 4
       ((void *)0)
# 275 "./src/main/rx/jetiexbus.c"
           ,
        125000,
        MODE_RXTX,
...
# 280 "./src/main/rx/jetiexbus.c" 3 4
                           ((void *)0)
# 280 "./src/main/rx/jetiexbus.c"
                               ;
}
