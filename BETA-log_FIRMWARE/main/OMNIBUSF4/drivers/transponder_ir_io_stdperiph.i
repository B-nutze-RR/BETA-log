...
# 46 "./src/main/drivers/transponder_ir_io_stdperiph.c" 3 4
                              ((void *)0)
# 46 "./src/main/drivers/transponder_ir_io_stdperiph.c"
                                  ;
...
void transponderIrHardwareInit(ioTag_t ioTag, transponder_t *transponder)
{
    ...
    if (dmaSpec == 
# 77 "./src/main/drivers/transponder_ir_io_stdperiph.c" 3 4
                  ((void *)0)
# 77 "./src/main/drivers/transponder_ir_io_stdperiph.c"
                      ) {
        return;
    }
...
# 92 "./src/main/drivers/transponder_ir_io_stdperiph.c"
    if (dmaRef == 
# 92 "./src/main/drivers/transponder_ir_io_stdperiph.c" 3 4
                 ((void *)0)
# 92 "./src/main/drivers/transponder_ir_io_stdperiph.c"
                     ) {
        return;
    ...
    dmaSetHandler(dmaGetIdentifier(dmaRef), TRANSPONDER_DMA_IRQHandler, (((((3)<<(4-(7-(((uint32_t)0x500)>>8))))|((0)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), 0);
...
# 171 "./src/main/drivers/transponder_ir_io_stdperiph.c" 3 4
_Bool 
# 171 "./src/main/drivers/transponder_ir_io_stdperiph.c"
    transponderIrInit(const ioTag_t ioTag, const transponderProvider_e provider)
{
    if (!ioTag) {
        return 
# 174 "./src/main/drivers/transponder_ir_io_stdperiph.c" 3 4
              0
# 174 "./src/main/drivers/transponder_ir_io_stdperiph.c"
                   ;
    }
    ...
    switch (provider) {
        ...
        default:
            return 
# 188 "./src/main/drivers/transponder_ir_io_stdperiph.c" 3 4
                  0
# 188 "./src/main/drivers/transponder_ir_io_stdperiph.c"
                       ;
    }
    ...
    return 
# 193 "./src/main/drivers/transponder_ir_io_stdperiph.c" 3 4
          1
# 193 "./src/main/drivers/transponder_ir_io_stdperiph.c"
              ;
}


# 196 "./src/main/drivers/transponder_ir_io_stdperiph.c" 3 4
_Bool 
# 196 "./src/main/drivers/transponder_ir_io_stdperiph.c"
    isTransponderIrReady(void)
{
...
void transponderIrDMAEnable(transponder_t *transponder)
{
    DMA_SetCurrDataCounter((DMA_Stream_TypeDef *)(dmaRef), transponder->dma_buffer_size);
...
void transponderIrDisable(void)
{
    ...
    IOInit(transponderIO, OWNER_TRANSPONDER, 0);
    IOConfigGPIOAF(transponderIO, ((GPIO_Mode_AF) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_DOWN) << 5)), alternateFunction);
