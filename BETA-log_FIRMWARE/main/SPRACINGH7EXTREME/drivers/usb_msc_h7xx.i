# 1 "./src/main/drivers/usb_msc_h7xx.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/usb_msc_h7xx.c"
# 26 "./src/main/drivers/usb_msc_h7xx.c"
...
# 29 "./src/main/drivers/usb_msc_h7xx.c" 2
...
# 153 "./src/main/platform.h" 2
# 31 "./src/main/drivers/usb_msc_h7xx.c" 2
...
# 35 "./src/main/drivers/usb_msc_h7xx.c" 2
...
# 39 "./src/main/drivers/usb_msc_h7xx.c" 2
...
# 40 "./src/main/drivers/usb_msc_h7xx.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 41 "./src/main/drivers/usb_msc_h7xx.c" 2
...
# 42 "./src/main/drivers/usb_msc_h7xx.c" 2
...
# 43 "./src/main/drivers/usb_msc_h7xx.c" 2
...
# 44 "./src/main/drivers/usb_msc_h7xx.c" 2
...
# 45 "./src/main/drivers/usb_msc_h7xx.c" 2
...
# 47 "./src/main/drivers/usb_msc_h7xx.c" 2
...
# 49 "./src/main/drivers/usb_msc_h7xx.c" 2
...
# 50 "./src/main/drivers/usb_msc_h7xx.c" 2
...
# 52 "./src/main/drivers/usb_msc_h7xx.c" 2
...
# 54 "./src/main/drivers/usb_msc_h7xx.c" 2
...
uint8_t mscStart(void)
{
    ...
    __NVIC_SetPriority(SysTick_IRQn, (((((0)<<(4-(7-(((uint32_t)0x00000005)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0));
