# 1 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_spi_ex.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_spi_ex.c"
# 26 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_spi_ex.c"
...
# 27 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_spi_ex.c" 2
# 76 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_spi_ex.c"
HAL_StatusTypeDef HAL_SPIEx_FlushRxFifo(SPI_HandleTypeDef *hspi)
{
  uint8_t count = 0;
  ...
  while (((hspi->Instance->SR & (0x3UL << (13U))) != (0x00000000UL)) || ((itflag & (0x1UL << (15U))) != 0UL))
  {
    count += (uint8_t)4UL;
    tmpreg = hspi->Instance->RXDR;
    ((void)(tmpreg));

    if ((((hspi->Instance) == ((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL))) || ((hspi->Instance) == ((SPI_TypeDef *) ((0x40000000UL) + 0x3800UL))) || ((hspi->Instance) == ((SPI_TypeDef *) ((0x40000000UL) + 0x3C00UL)))))
    {
      if (count > 16UL)
      {
        return HAL_TIMEOUT;
...
# 115 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_spi_ex.c"
HAL_StatusTypeDef HAL_SPIEx_EnableLockConfiguration(SPI_HandleTypeDef *hspi)
{
  ...
  if ((hspi->Instance->CR1 & (0x1UL << (0U))) != (0x1UL << (0U)))
  {
    ((hspi->Instance->CR1) |= ((0x1UL << (16U))));
  }
  else
  {
...
# 163 "./lib/main/STM32H7/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_spi_ex.c"
HAL_StatusTypeDef HAL_SPIEx_ConfigureUnderrun(SPI_HandleTypeDef *hspi, uint32_t UnderrunDetection, uint32_t UnderrunBehaviour)
{
  HAL_StatusTypeDef errorcode = HAL_OK;
  ...
  if ((hspi->State != HAL_SPI_STATE_READY) || (hspi->Init.Mode != (0x00000000UL)))
  {
    errorcode = HAL_BUSY;
    hspi->State = HAL_SPI_STATE_READY;
  ...
  if ((hspi->Instance->CR1 & (0x1UL << (0U))) != (0x1UL << (0U)))
  {
    ...
    (((hspi->Instance->CFG1)) = ((((((hspi->Instance->CFG1))) & (~((0x3UL << (11U))))) | (UnderrunDetection))));
    (((hspi->Instance->CFG1)) = ((((((hspi->Instance->CFG1))) & (~((0x3UL << (9U))))) | (UnderrunBehaviour))));
  }
  else
  {
