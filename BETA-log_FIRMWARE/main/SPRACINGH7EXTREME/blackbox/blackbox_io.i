...
void blackboxWrite(uint8_t value)
{
    ...
    default:
        {
            ...
            bbBits += 2;
            {if (debugMode == (DEBUG_BLACKBOX_OUTPUT)) {debug[(3)] = (txBytesFree);}};


            if (txBytesFree == 0) {

                ++bbDrops;
                {if (debugMode == (DEBUG_BLACKBOX_OUTPUT)) {debug[(2)] = (bbDrops);}};
    ...
    if (now > bbLastclearMs + 100) {
        ...
        {if (debugMode == (DEBUG_BLACKBOX_OUTPUT)) {debug[(0)] = (bbRate);}};
        if (bbRate > bbRateMax) {
            bbRateMax = bbRate;
            {if (debugMode == (DEBUG_BLACKBOX_OUTPUT)) {debug[(1)] = (bbRateMax);}};
        }
        bbLastclearMs = now;
        bbBits = 0;
    }
...
# 266 "./src/main/blackbox/blackbox_io.c"
            ...
            return 
# 269 "./src/main/blackbox/blackbox_io.c" 3 4
                  0
...
# 350 "./src/main/blackbox/blackbox_io.c"
    ...
    case BLACKBOX_DEVICE_SDCARD:
        if (afatfs_getFilesystemState() == AFATFS_FILESYSTEM_STATE_FATAL || afatfs_getFilesystemState() == AFATFS_FILESYSTEM_STATE_UNKNOWN || afatfs_isFull()) {
            return 
# 356 "./src/main/blackbox/blackbox_io.c" 3 4
                  0
# 356 "./src/main/blackbox/blackbox_io.c"
                       ;
        }
        ...
        return 
# 361 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 361 "./src/main/blackbox/blackbox_io.c"
                  ;
        break;
...
# 388 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 388 "./src/main/blackbox/blackbox_io.c"
    isBlackboxErased(void)
{
    switch (blackboxConfig()->device) {
    case BLACKBOX_DEVICE_FLASH:
    ...
    default:
        ...
        return 
# 396 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 396 "./src/main/blackbox/blackbox_io.c"
                  ;
        break;
    }
}
...
void blackboxDeviceClose(void)
{
    ...
    case BLACKBOX_DEVICE_SERIAL:
        ...
        blackboxPort = 
# 412 "./src/main/blackbox/blackbox_io.c" 3 4
                      ((void *)0)
# 412 "./src/main/blackbox/blackbox_io.c"
                          ;
        ...
        while (afatfs_findNext(blackboxSDCard.logDirectory, &blackboxSDCard.logDirectoryFinder, &directoryEntry) == AFATFS_OPERATION_SUCCESS) {
            if (directoryEntry && !fat_isDirectoryEntryTerminator(directoryEntry)) {
                ...
                if (strncmp(directoryEntry->filename, "LOG", strlen("LOG")) == 0
                    ...
                    blackboxSDCard.largestLogFileNumber = __extension__ ({ __typeof__ ((int32_t)atoi(logSequenceNumberString)) _a = ((int32_t)atoi(logSequenceNumberString)); __typeof__ (blackboxSDCard.largestLogFileNumber) _b = (blackboxSDCard.largestLogFileNumber); _a > _b ? _a : _b; });
                }
            } else {
...
# 529 "./src/main/blackbox/blackbox_io.c" 3 4
                                                      ((void *)0)
# 529 "./src/main/blackbox/blackbox_io.c"
                                                          );
            blackboxSDCard.logDirectory = 
# 530 "./src/main/blackbox/blackbox_io.c" 3 4
                                         ((void *)0)
# 530 "./src/main/blackbox/blackbox_io.c"
                                             ;
    ...
    case BLACKBOX_SDCARD_READY_TO_LOG:
        return 
# 542 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 542 "./src/main/blackbox/blackbox_io.c"
                  ;
    }


    return 
# 546 "./src/main/blackbox/blackbox_io.c" 3 4
          0
# 546 "./src/main/blackbox/blackbox_io.c"
               ;
}
# 556 "./src/main/blackbox/blackbox_io.c"

# 556 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 556 "./src/main/blackbox/blackbox_io.c"
    blackboxDeviceBeginLog(void)
{
    ...
    default:
        return 
# 564 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 564 "./src/main/blackbox/blackbox_io.c"
                  ;
    }

}
# 576 "./src/main/blackbox/blackbox_io.c"

# 576 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 576 "./src/main/blackbox/blackbox_io.c"
    blackboxDeviceEndLog(
# 576 "./src/main/blackbox/blackbox_io.c" 3 4
...
# 587 "./src/main/blackbox/blackbox_io.c" 3 4
                                                               ((void *)0)
# 587 "./src/main/blackbox/blackbox_io.c"
                                                                   ))
            || (!retainLog && afatfs_funlink(blackboxSDCard.logFile, 
# 588 "./src/main/blackbox/blackbox_io.c" 3 4
                                                                    ((void *)0)
...
# 591 "./src/main/blackbox/blackbox_io.c" 3 4
                                    ((void *)0)
# 591 "./src/main/blackbox/blackbox_io.c"
                                        ;
            blackboxSDCard.state = BLACKBOX_SDCARD_READY_TO_CREATE_LOG;
            return 
# 593 "./src/main/blackbox/blackbox_io.c" 3 4
                  1
# 593 "./src/main/blackbox/blackbox_io.c"
                      ;
        }
        return 
# 595 "./src/main/blackbox/blackbox_io.c" 3 4
              0
# 595 "./src/main/blackbox/blackbox_io.c"
    ...
    default:
        return 
# 598 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 598 "./src/main/blackbox/blackbox_io.c"
                  ;
    }
}


# 602 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
    ...
    isBlackboxDeviceFull(void)
{
    ...
    case BLACKBOX_DEVICE_SERIAL:
        return 
# 606 "./src/main/blackbox/blackbox_io.c" 3 4
              0
# 606 "./src/main/blackbox/blackbox_io.c"
                   ;
    ...
    default:
        return 
# 619 "./src/main/blackbox/blackbox_io.c" 3 4
              0
...
# 623 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 623 "./src/main/blackbox/blackbox_io.c"
    isBlackboxDeviceWorking(void)
{
    switch (blackboxConfig()->device) {
    case BLACKBOX_DEVICE_SERIAL:
        return blackboxPort != 
# 627 "./src/main/blackbox/blackbox_io.c" 3 4
                              ((void *)0)
# 627 "./src/main/blackbox/blackbox_io.c"
                                  ;
    ...
    default:
        return 
# 640 "./src/main/blackbox/blackbox_io.c" 3 4
              0
# 640 "./src/main/blackbox/blackbox_io.c"
                   ;
    }
}
...
# 703 "./src/main/blackbox/blackbox_io.c"
blackboxBufferReserveStatus_e blackboxDeviceReserveBufferSpace(int32_t bytes)
{
