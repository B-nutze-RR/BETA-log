...
# 96 "./src/main/drivers/flash.c"
void flashPreInit(const flashConfig_t *flashConfig)
{
    spiPreinitRegister(flashConfig->csTag, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_UP) << 5)), 1);
}
...
# 121 "./src/main/drivers/flash.c"
    ...
    spiBusTransactionInit(busdev, SPI_MODE3_POL_HIGH_EDGE_2ND, spiCalculateDivider(5000000));
    ...
    if (m25p16_detect(&flashDevice, chipID)) {
        return 
# 164 "./src/main/drivers/flash.c" 3 4
              1
# 164 "./src/main/drivers/flash.c"
                  ;
    }
