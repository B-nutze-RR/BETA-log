...
# 49 "./src/main/io/asyncfatfs/asyncfatfs.c" 2
...
# 54 "./src/main/io/asyncfatfs/asyncfatfs.c" 2
...
# 56 "./src/main/io/asyncfatfs/asyncfatfs.c" 2
# 120 "./src/main/io/asyncfatfs/asyncfatfs.c"
typedef enum {
...
# 201 "./src/main/io/asyncfatfs/asyncfatfs.c"
    unsigned locked:1;
...
# 380 "./src/main/io/asyncfatfs/asyncfatfs.c"
    uint32_t logicalSize;
# 393 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
typedef struct afatfs_t {
    ...
    afatfsCacheBlockDescriptor_t cacheDescriptor[11];
    uint32_t cacheTimer;

    int cacheDirtyEntries;
    
# 471 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
   _Bool 
# 471 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 485 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
   _Bool 
# 485 "./src/main/io/asyncfatfs/asyncfatfs.c"
        filesystemFull;
...
static __attribute__((section(".DMA_RW_AXI"))) uint8_t afatfs_cache[512 * 11] __attribute__((aligned(32)));
...
# 549 "./src/main/io/asyncfatfs/asyncfatfs.c"
static 
# 549 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 549 "./src/main/io/asyncfatfs/asyncfatfs.c"
           afatfs_assert(
# 549 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
...
static 
# 564 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 564 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
static int afatfs_getCacheDescriptorIndexForBuffer(uint8_t *memory)
{
    ...
    if (afatfs_assert(index >= 0 && index < 11)) {
        return index;
    } else {
        return -1;
    }
...
static void afatfs_sdcardReadComplete(sdcardBlockOperation_e operation, uint32_t sectorIndex, uint8_t *buffer, uint32_t callbackData)
{
    ...
    for (int i = 0; i < 11; i++) {
        if (afatfs.cacheDescriptor[i].state != AFATFS_CACHE_STATE_EMPTY
            ...
            if (buffer == 
# 662 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                         ((void *)0)
# 662 "./src/main/io/asyncfatfs/asyncfatfs.c"
                             ) {
...
# 684 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                 0
# 684 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                      ;
...
static void afatfs_cacheFlushSector(int cacheIndex)
{
    ...
    switch (sdcard_writeBlock(cacheDescriptor->sectorIndex, afatfs_cacheSectorGetMemory(cacheIndex), afatfs_sdcardWriteComplete, 0)) {
        case SDCARD_OPERATION_IN_PROGRESS:
            ...
            afatfs.cacheFlushInProgress = 
# 725 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                         1
# 725 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                             ;
            break;
...
# 742 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 742 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_sectorCacheInSync(void)
{
    for (int i = 0; i < 11; i++) {
        if ((afatfs.cacheDescriptor[i].state == AFATFS_CACHE_STATE_WRITING) ||
            ...
            return 
# 747 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 747 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
    }
    return 
# 750 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 750 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
...
static afatfsCacheBlockDescriptor_t* afatfs_findCacheSector(uint32_t sectorIndex)
{
    ...
    return 
# 765 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          ((void *)0)
# 765 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 779 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 853 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 853 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_flush(void)
{
    if (afatfs.cacheDirtyEntries > 0) {
        ...
        if (earliestSectorIndex > -1) {
            ...
            return 
# 873 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 873 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
    }

    return 
# 877 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 877 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
...
# 883 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 883 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_isFull(void)
{
...
# 940 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 975 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        default:
            ...
            afatfs_assert(
# 1005 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                         0
# 1005 "./src/main/io/asyncfatfs/asyncfatfs.c"
                              );
            return AFATFS_OPERATION_FAILURE;
    }
}
           ...
           afatfs_parseMBR(const uint8_t *sector)
{
    ...
    if (sector[512 - 2] != 0x55 || sector[512 - 1] != 0xAA)
        return 
# 1017 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 1017 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
...
# 1033 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    return 
# 1037 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          0
# 1037 "./src/main/io/asyncfatfs/asyncfatfs.c"
               ;
}

static 
# 1040 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1040 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1048 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    if (afatfs.sectorsPerCluster < 1 || afatfs.sectorsPerCluster > 128 || !isPowerOfTwo(afatfs.sectorsPerCluster)) {
        return 
# 1055 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 1055 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    }
    ...
    if (afatfs.numClusters <= 4084) {
        ...
        return 
# 1072 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 1072 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    ...
    return 
# 1090 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 1090 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
...
static 
# 1111 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
...
# 1133 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1161 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1228 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1234 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
   _Bool 
# 1234 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    switch (condition) {
        ...
        default:
            afatfs_assert(
# 1255 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                         0
# 1255 "./src/main/io/asyncfatfs/asyncfatfs.c"
                              );
            return AFATFS_FIND_CLUSTER_FATAL;
    }
...
# 1332 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1413 "./src/main/io/asyncfatfs/asyncfatfs.c"
        switch (pattern) {
...
# 1472 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1538 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1614 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                   1
# 1614 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                       ;
            return AFATFS_OPERATION_FAILURE;
        break;
    }
...
# 1643 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1680 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1703 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1768 "./src/main/io/asyncfatfs/asyncfatfs.c"
static afatfsOperationStatus_e afatfs_appendSupercluster(afatfsFilePtr_t file)
{
    ...
    if (afatfs.freeFile.logicalSize < superClusterSize) {
        afatfs.filesystemFull = 
# 1777 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                               1
# 1777 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                   ;
    }
...
static 
# 1820 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1820 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
static uint8_t* afatfs_fileRetainCursorSectorForRead(afatfsFilePtr_t file)
{
    ...
    if (file->readRetainCacheIndex != -1) {
        if (!afatfs_assert(physicalSector == afatfs.cacheDescriptor[file->readRetainCacheIndex].sectorIndex)) {
            return 
# 1846 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1846 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
...
# 1852 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        if (status != AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 1866 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1866 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
...
static uint8_t* afatfs_fileLockCursorSectorForWrite(afatfsFilePtr_t file)
{
    ...
    if (file->writeLockedCacheIndex != -1) {
        ...
        if (!afatfs_assert(physicalSector == afatfs.cacheDescriptor[file->writeLockedCacheIndex].sectorIndex)) {
            return 
# 1891 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1891 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
        ...
        if (afatfs_isEndOfAllocatedFile(file) && afatfs_appendFreeCluster(file) != AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 1901 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1901 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
...
# 1960 "./src/main/io/asyncfatfs/asyncfatfs.c"
static 
# 1960 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1960 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1968 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    if (file->type == AFATFS_FILE_TYPE_FAT16_ROOT_DIRECTORY) {
        ...
        return 
# 1978 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 1978 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
    ...
    if (offset > (int32_t) clusterSizeBytes || offset < -(int32_t) offsetInCluster) {
        return 
# 1988 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 1988 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    }
    ...
    if (newOffsetInCluster >= clusterSizeBytes) {
        ...
        if (status == AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 2008 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 2008 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
    }
...
static 
# 2023 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 2023 "./src/main/io/asyncfatfs/asyncfatfs.c"
           afatfs_fseekInternalContinue(afatfsFile_t *file)
{
    ...
    while (offsetInCluster + opState->seekOffset >= clusterSizeBytes && !afatfs_isEndOfAllocatedFile(file)) {
        ...
        if (status == AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 2049 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 2049 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
    }
    ...
    return 
# 2066 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 2066 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 2080 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2117 "./src/main/io/asyncfatfs/asyncfatfs.c"
afatfsOperationStatus_e afatfs_fseek(afatfsFilePtr_t file, int32_t offset, afatfsSeek_e whence)
{
...
# 2155 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                                ((void *)0)
# 2155 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                    );
}
    ...
    afatfs_ftell(afatfsFilePtr_t file, uint32_t *position)
{
    if (afatfs_fileIsBusy(file)) {
        return 
# 2166 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2166 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    } else {
        *position = file->cursorOffset;
        return 
# 2169 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2169 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
}
# 2181 "./src/main/io/asyncfatfs/asyncfatfs.c"
afatfsOperationStatus_e afatfs_findNext(afatfsFilePtr_t directory, afatfsFinder_t *finder, fatDirectoryEntry_t **dirEntry)
{
    uint8_t *sector;
    ...
    if (sector) {
        ...
        *dirEntry = (fatDirectoryEntry_t*) sector + finder->entryIndex;
        ...
        if (afatfs_isEndOfAllocatedFile(directory)) {
            *dirEntry = 
# 2206 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                       ((void *)0)
# 2206 "./src/main/io/asyncfatfs/asyncfatfs.c"
                           ;
...
static afatfsOperationStatus_e afatfs_extendSubdirectoryContinue(afatfsFile_t *directory)
{
    ...
    switch (opState->phase) {
        ...
        case AFATFS_EXTEND_SUBDIRECTORY_PHASE_FAILURE:
            ...
            if (opState->callback) {
                opState->callback(
# 2314 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                 ((void *)0)
# 2314 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                     );
            }
            return AFATFS_OPERATION_FAILURE;
        break;
...
# 2373 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2391 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                         ((void *)0)
# 2391 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                             , 
# 2391 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                               ((void *)0)
# 2391 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
static afatfsFilePtr_t afatfs_allocateFileHandle(void)
{
    ...
    return 
# 2418 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          ((void *)0)
# 2418 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 2428 "./src/main/io/asyncfatfs/asyncfatfs.c"
static afatfsOperationStatus_e afatfs_ftruncateContinue(afatfsFilePtr_t file, 
# 2428 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                             _Bool 
# 2428 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                  markDeleted)
{
...
# 2535 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2535 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2535 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_ftruncate(afatfsFilePtr_t file, afatfsFileCallback_t callback)
{
    ...
    if (afatfs_fileIsBusy(file))
        return 
# 2540 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2540 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    ...
    return 
# 2568 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 2568 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
            ...
            do {
                ...
                switch (status) {
                    case AFATFS_OPERATION_SUCCESS:
                        ...
                        if (entry == 
# 2603 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                    ((void *)0) 
# 2603 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        case AFATFS_CREATEFILE_PHASE_CREATE_NEW_FILE:
            ...
            if (status == AFATFS_OPERATION_SUCCESS) {
                ...
                if (dt.year != 0) {
                    ...
                    fileDate = (local_dt.day | (local_dt.month << 5) | ((local_dt.year - 1980) << 9));
                    fileTime = ((local_dt.seconds / 2) | (local_dt.minutes << 5) | (local_dt.hours << 11));
                }
...
# 2761 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                           1
# 2761 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                               );
...
# 2776 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2776 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_funlink(afatfsFilePtr_t file, afatfsCallback_t callback)
{
    afatfsUnlinkFile_t *opState = &file->operation.state.unlinkFile;
    ...
    if (!file || file->type == AFATFS_FILE_TYPE_NONE) {
        return 
# 2781 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2781 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
...
# 2790 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                               ((void *)0)
# 2790 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                   ))
        return 
# 2791 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2791 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    ...
    return 
# 2801 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 2801 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 2814 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2913 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2913 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2913 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_fclose(afatfsFilePtr_t file, afatfsCallback_t callback)
{
    if (!file || file->type == AFATFS_FILE_TYPE_NONE) {
        return 
# 2916 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2916 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
...
# 2918 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        return 
# 2925 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2925 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
}
# 2936 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2936 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2936 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2943 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    return file != 
# 2946 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 2946 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
}
# 2956 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2956 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2956 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_chdir(afatfsFilePtr_t directory)
{
    if (afatfs_fileIsBusy(&afatfs.currentDirectory)) {
        return 
# 2959 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2959 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    }
    ...
    if (directory) {
        if (afatfs_fileIsBusy(directory)) {
            return 
# 2964 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 2964 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }

        memcpy(&afatfs.currentDirectory, directory, sizeof(*directory));
        return 
# 2968 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2968 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    } else {
        ...
        return 
# 2987 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2987 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
}
# 3017 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 3017 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 3017 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_fopen(const char *filename, const char *mode, afatfsFileCallback_t complete)
{
    ...
    if (file) {
        ...
        complete(
# 3054 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                ((void *)0)
# 3054 "./src/main/io/asyncfatfs/asyncfatfs.c"
                    );
    }

    return file != 
# 3057 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 3057 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
}
...
# 3094 "./src/main/io/asyncfatfs/asyncfatfs.c"
uint32_t afatfs_fwrite(afatfsFilePtr_t file, const uint8_t *buffer, uint32_t len)
{
    if ((file->mode & (4 | 2)) == 0) {
        return 0;
...
# 3131 "./src/main/io/asyncfatfs/asyncfatfs.c"
        if (afatfs_fseekInternal(file, bytesToWriteThisSector, 
# 3131 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                              ((void *)0)
# 3131 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                  ) == AFATFS_OPERATION_IN_PROGRESS) {
            break;
...
# 3161 "./src/main/io/asyncfatfs/asyncfatfs.c"
uint32_t afatfs_fread(afatfsFilePtr_t file, uint8_t *buffer, uint32_t len)
{
    if ((file->mode & 1) == 0) {
        return 0;
...
# 3206 "./src/main/io/asyncfatfs/asyncfatfs.c"
        if (afatfs_fseekInternal(file, bytesToReadThisSector, 
# 3206 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                             ((void *)0)
# 3206 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                 ) == AFATFS_OPERATION_IN_PROGRESS) {
            break;
...
# 3222 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 3222 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_feof(afatfsFilePtr_t file)
{
...
# 3249 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                          0
# 3249 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                               );
        break;
...
# 3319 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 3424 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        case AFATFS_INITIALIZATION_READ_VOLUME_ID:
            if (afatfs_cacheSector(afatfs.partitionStartSector, &sector, 1 | 8, 0) == AFATFS_OPERATION_SUCCESS) {
                if (afatfs_parseVolumeID(sector)) {
                    ...
                    afatfs_chdir(
# 3450 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                ((void *)0)
# 3450 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                    );
        ...
        break;
# 3544 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 3617 "./src/main/io/asyncfatfs/asyncfatfs.c"
afatfsFilesystemState_e afatfs_getFilesystemState(void)
{
...
# 3646 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 3646 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_destroy(
# 3646 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                   _Bool 
# 3646 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 3654 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                   ((void *)0)
...
# 3668 "./src/main/io/asyncfatfs/asyncfatfs.c"
        if (afatfs.freeFile.type != AFATFS_FILE_TYPE_NONE) {
            afatfs_fclose(&afatfs.freeFile, 
# 3669 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                           ((void *)0)
# 3669 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                               );
            openFileCount++;
        }
...
# 3675 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                   ((void *)0)
# 3675 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                       );
            openFileCount++;
        }
        ...
        if (!afatfs_flush()) {
            return 
# 3682 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 3682 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }

        if (afatfs.cacheFlushInProgress) {
            return 
# 3686 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 3686 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }

        if (openFileCount > 0) {
            return 
# 3690 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 3690 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
# 3701 "./src/main/io/asyncfatfs/asyncfatfs.c"
    }
    ...
    return 
# 3706 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 3706 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
