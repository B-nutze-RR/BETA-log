...
# 67 "./src/main/drivers/light_led.h"
                         state);
# 41 "./src/main/msc/usbd_storage_sd_spi.c" 2
...
# 43 "./src/main/msc/usbd_storage_sd_spi.c" 2
...
# 46 "./src/main/msc/usbd_storage_sd_spi.c" 2
# 63 "./src/main/msc/usbd_storage_sd_spi.c"
...
# 126 "./src/main/msc/usbd_storage_sd_spi.c"
...
# 146 "./src/main/msc/usbd_storage_sd_spi.c"
static int8_t STORAGE_Init (uint8_t lun)
{
 (void)(lun);
 ledSet(0, 
# 149 "./src/main/msc/usbd_storage_sd_spi.c" 3 4
0
# 149 "./src/main/msc/usbd_storage_sd_spi.c"
);
...
# 166 "./src/main/msc/usbd_storage_sd_spi.c"
...
# 182 "./src/main/msc/usbd_storage_sd_spi.c"
static int8_t STORAGE_IsReady (uint8_t lun)
{
 (void)(lun);
 int8_t ret = -1;
...
# 199 "./src/main/msc/usbd_storage_sd_spi.c"
static int8_t STORAGE_IsWriteProtected (uint8_t lun)
{
  (void)(lun);
  return 0;
}
# 212 "./src/main/msc/usbd_storage_sd_spi.c"
static int8_t STORAGE_Read (uint8_t lun,
                 uint8_t *buf,
                 uint32_t blk_addr,
                 uint16_t blk_len)
...
# 239 "./src/main/msc/usbd_storage_sd_spi.c" 3 4
                                                         ((void *)0)
# 239 "./src/main/msc/usbd_storage_sd_spi.c"
                                                             , 
# 239 "./src/main/msc/usbd_storage_sd_spi.c" 3 4
                                                               ((void *)0)
# 239 "./src/main/msc/usbd_storage_sd_spi.c"
