...
void pgResetFn_gyroDeviceConfig(gyroDeviceConfig_t *devconf)
{
    ...
    gyroResetSpiDeviceConfig(&devconf[0], ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)), ((ioTag_t)((((0) + 1) << 4) | (4))), ((ioTag_t)((((2) + 1) << 4) | (4))), CW180_DEG, customAlignment1);
    ...
    gyroResetSpiDeviceConfig(&devconf[1], ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)), 0, 0, CW0_DEG, customAlignment2);
