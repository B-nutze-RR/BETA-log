...
static void ghstDataReceive(uint16_t c, void *data)
{
    ...
    if (ghstFrameIdx < fullFrameLength) {
        ...
        if (ghstFrameIdx >= fullFrameLength) {
            ...
            ghstFrameAvailable = 
# 172 "./src/main/rx/ghst.c" 3 4
                                1
# 172 "./src/main/rx/ghst.c"
                                    ;
...
static 
# 180 "./src/main/rx/ghst.c" 3 4
      _Bool 
# 180 "./src/main/rx/ghst.c"
...
static uint8_t ghstFrameStatus(rxRuntimeState_t *rxRuntimeState)
{
    ...
    if (ghstFrameAvailable) {
        ghstFrameAvailable = 
# 193 "./src/main/rx/ghst.c" 3 4
                            0
# 193 "./src/main/rx/ghst.c"
                                 ;
        ...
        if (crc == ghstValidatedFrame.bytes[fullFrameLength - 1] && ghstValidatedFrame.frame.addr == GHST_ADDR_FC) {
            ghstValidatedFrameAvailable = 
# 198 "./src/main/rx/ghst.c" 3 4
                                         1
# 198 "./src/main/rx/ghst.c"
                                             ;
            return RX_FRAME_COMPLETE | RX_FRAME_PROCESSING_REQUIRED;
        }

        if (crc != ghstValidatedFrame.bytes[fullFrameLength - 1]) {
            {if (debugMode == (DEBUG_GHST)) {debug[(DEBUG_GHST_CRC_ERRORS)] = (++crcErrorCount);}};
        }
...
static 
# 216 "./src/main/rx/ghst.c" 3 4
      _Bool 
# 216 "./src/main/rx/ghst.c"
           ghstProcessFrame(const rxRuntimeState_t *rxRuntimeState)
{
    ...
    if (shouldSendTelemetryFrame()) {
        ghstTransmittingTelemetry = 
# 227 "./src/main/rx/ghst.c" 3 4
                                   1
# 227 "./src/main/rx/ghst.c"
                                       ;
        ...
        if (ghstValidatedFrame.frame.type >= GHST_UL_RC_CHANS_HS4_FIRST &&
            ...
            switch(ghstValidatedFrame.frame.type) {
                case GHST_UL_RC_CHANS_HS4_RSSI: {
                    ...
                    {if (debugMode == (DEBUG_GHST)) {debug[(DEBUG_GHST_RX_RSSI)] = (-rssiFrame->rssi);}};
                    {if (debugMode == (DEBUG_GHST)) {debug[(DEBUG_GHST_RX_LQ)] = (rssiFrame->lq);}};

                    if (rssiSource == RSSI_SOURCE_RX_PROTOCOL) {

                        const uint16_t rssiPercentScaled = scaleRange(-rssiFrame->rssi, (-117), 0, (-60), 1023);
                ...
                default:
                    {if (debugMode == (DEBUG_GHST)) {debug[(DEBUG_GHST_UNKNOWN_FRAMES)] = (++unknownFrameCount);}};
                    break;
            }
...
static uint16_t ghstReadRawRC(const rxRuntimeState_t *rxRuntimeState, uint8_t chan)
{
    (void)(rxRuntimeState);
...
static void ghstIdle()
{
    if (ghstTransmittingTelemetry) {
        ghstTransmittingTelemetry = 
# 317 "./src/main/rx/ghst.c" 3 4
                                   0
# 317 "./src/main/rx/ghst.c"
                                        ;
    }
}


# 321 "./src/main/rx/ghst.c" 3 4
_Bool 
# 321 "./src/main/rx/ghst.c"
    ghstRxInit(const rxConfig_t *rxConfig, rxRuntimeState_t *rxRuntimeState)
{
    ...
    if (!portConfig) {
        return 
# 337 "./src/main/rx/ghst.c" 3 4
              0
# 337 "./src/main/rx/ghst.c"
                   ;
    }
...
# 343 "./src/main/rx/ghst.c" 3 4
       ((void *)0)
# 343 "./src/main/rx/ghst.c"
           ,
        420000,
        MODE_RXTX,
...
# 363 "./src/main/rx/ghst.c" 3 4
_Bool 
# 363 "./src/main/rx/ghst.c"
    ghstRxIsActive(void)
{
    return serialPort != 
# 365 "./src/main/rx/ghst.c" 3 4
                        ((void *)0)
# 365 "./src/main/rx/ghst.c"
                            ;
}
