# 1 "./src/main/drivers/memprot_hal.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/memprot_hal.c"
# 21 "./src/main/drivers/memprot_hal.c"
...
# 22 "./src/main/drivers/memprot_hal.c" 2
...
# 153 "./src/main/platform.h" 2
# 24 "./src/main/drivers/memprot_hal.c" 2
...
# 26 "./src/main/drivers/memprot_hal.c" 2
...
void memProtConfigure(mpuRegion_t *regions, unsigned regionCount)
{
    ...
    MPU_InitStruct.TypeExtField = ((uint8_t)0x00);
...
void memProtReset(void)
{
    ...
    for (uint8_t region = 0; region <= 8; region++) {
        MPU_InitStruct.Enable = ((uint8_t)0x00);
