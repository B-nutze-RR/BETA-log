...
extern void pgResetFn_compassConfig(compassConfig_t *); compassConfig_t compassConfig_System; compassConfig_t compassConfig_Copy; extern const pgRegistry_t compassConfig_Registry; const pgRegistry_t compassConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 40 | (3 << 12), .length = 1, .size = sizeof(compassConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&compassConfig_System, .copy = (uint8_t*)&compassConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_compassConfig }, };
...
void compassPreInit(void)
{
    ...
    if (compassConfig()->mag_bustype == BUSTYPE_SPI) {
        spiPreinitRegister(compassConfig()->mag_spi_csn, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_UP) << 5)), 1);
    }
...
# 124 "./src/main/sensors/compass.c" 3 4
_Bool 
# 124 "./src/main/sensors/compass.c"
    compassDetect(magDev_t *dev, uint8_t *alignment)
{
    *alignment = ALIGN_DEFAULT;
    ...
    case BUSTYPE_SPI:
        {
            SPI_TypeDef *instance = spiInstanceByDevice(((compassConfig()->mag_spi_device) - 1));
            if (!instance) {
                return 
# 150 "./src/main/sensors/compass.c" 3 4
                      0
# 150 "./src/main/sensors/compass.c"
                           ;
            }
        ...
        break;
# 174 "./src/main/sensors/compass.c"
    default:
        return 
# 175 "./src/main/sensors/compass.c" 3 4
              0
# 175 "./src/main/sensors/compass.c"
                   ;
    }
    ...
    case MAG_AK8975:
# 228 "./src/main/sensors/compass.c"
        __attribute__ ((fallthrough));
...
# 284 "./src/main/sensors/compass.c"
    if (magHardware == MAG_NONE) {
        return 
# 285 "./src/main/sensors/compass.c" 3 4
              0
# 285 "./src/main/sensors/compass.c"
                   ;
    }
    ...
    return 
# 290 "./src/main/sensors/compass.c" 3 4
          1
# 290 "./src/main/sensors/compass.c"
              ;
}
# 302 "./src/main/sensors/compass.c"

# 302 "./src/main/sensors/compass.c" 3 4
_Bool 
# 302 "./src/main/sensors/compass.c"
    compassInit(void)
{
    ...
    if (!compassDetect(&magDev, &alignment)) {
        return 
# 309 "./src/main/sensors/compass.c" 3 4
              0
# 309 "./src/main/sensors/compass.c"
                   ;
    }
...
# 312 "./src/main/sensors/compass.c"
    ...
    magDev.init(&magDev);
    ledSet(1, 
# 314 "./src/main/sensors/compass.c" 3 4
   0
# 314 "./src/main/sensors/compass.c"
   );
    magInit = 1;
    ...
    return 
# 325 "./src/main/sensors/compass.c" 3 4
          1
# 325 "./src/main/sensors/compass.c"
              ;
}
...
# 344 "./src/main/sensors/compass.c" 3 4
_Bool 
# 344 "./src/main/sensors/compass.c"
    compassIsCalibrationComplete(void)
{
    return tCal == 0;
}
