...
static 
# 74 "./src/main/io/displayport_hott.c" 3 4
      _Bool 
# 74 "./src/main/io/displayport_hott.c"
           hottIsTransferInProgress(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 77 "./src/main/io/displayport_hott.c" 3 4
          0
# 77 "./src/main/io/displayport_hott.c"
               ;
}
...
static uint32_t hottTxBytesFree(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 97 "./src/main/io/displayport_hott.c" 3 4
          (0xffffffffUL)
# 97 "./src/main/io/displayport_hott.c"
                    ;
}
...
static const displayPortVTable_t hottVTable = {
    ...
    .layerSupported = 
# 126 "./src/main/io/displayport_hott.c" 3 4
                     ((void *)0)
# 126 "./src/main/io/displayport_hott.c"
                         ,
    .layerSelect = 
# 127 "./src/main/io/displayport_hott.c" 3 4
                  ((void *)0)
# 127 "./src/main/io/displayport_hott.c"
                      ,
    .layerCopy = 
...
# 133 "./src/main/io/displayport_hott.c" 3 4
                            ((void *)0)
# 133 "./src/main/io/displayport_hott.c"
                                ;
...
# 154 "./src/main/io/displayport_hott.c" 3 4
                                   _Bool 
# 154 "./src/main/io/displayport_hott.c"
                                        keepCmsOpen)
{
    switch (hottKey) {
        case 0xB:
