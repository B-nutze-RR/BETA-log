...
ADCDevice adcDeviceByInstance(ADC_TypeDef *instance)
{
    if (instance == ((ADC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))) {
        return ADCDEV_1;
    }
# 80 "./src/main/drivers/adc.c"
    return ADCINVALID;
}
...
uint16_t adcInternalCompensateVref(uint16_t vrefAdcValue)
{
    ...
    return (uint16_t)((uint32_t)(adcVREFINTCAL * (3300UL)) / vrefAdcValue);
}
...
int16_t adcInternalComputeTemperature(uint16_t tempAdcValue, uint16_t vrefValue)
{
    ...
    return ((((int32_t)((tempAdcValue * vrefValue) / (3300UL)) - adcTSCAL1) * adcTSSlopeK) + 500) / 1000 + (30L);
}
