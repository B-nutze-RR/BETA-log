...
# 64 "./src/main/osd/osd_elements.c" 2
...
# 65 "./src/main/osd/osd_elements.c" 2
...
# 66 "./src/main/osd/osd_elements.c" 2
...
int toupper (int __c);
int isblank (int __c);
# 67 "./src/main/osd/osd_elements.c" 2
...
# 68 "./src/main/osd/osd_elements.c" 2
...
# 153 "./src/main/platform.h" 2
# 70 "./src/main/osd/osd_elements.c" 2
...
# 74 "./src/main/osd/osd_elements.c" 2
...
# 75 "./src/main/osd/osd_elements.c" 2
...
# 78 "./src/main/osd/osd_elements.c" 2
...
# 80 "./src/main/osd/osd_elements.c" 2
...
# 81 "./src/main/osd/osd_elements.c" 2
...
# 82 "./src/main/osd/osd_elements.c" 2
...
# 83 "./src/main/osd/osd_elements.c" 2
...
# 85 "./src/main/osd/osd_elements.c" 2
...
# 87 "./src/main/osd/osd_elements.c" 2
...
# 88 "./src/main/osd/osd_elements.c" 2
...
# 90 "./src/main/osd/osd_elements.c" 2
...
# 93 "./src/main/osd/osd_elements.c" 2
...
# 94 "./src/main/osd/osd_elements.c" 2
...
# 96 "./src/main/osd/osd_elements.c" 2
...
# 97 "./src/main/osd/osd_elements.c" 2
...
# 98 "./src/main/osd/osd_elements.c" 2
...
# 99 "./src/main/osd/osd_elements.c" 2
...
void mwDisarm(void);
# 100 "./src/main/osd/osd_elements.c" 2
...
# 108 "./src/main/osd/osd_elements.c" 2
...
# 111 "./src/main/osd/osd_elements.c" 2
...
# 112 "./src/main/osd/osd_elements.c" 2
...
# 116 "./src/main/osd/osd_elements.c" 2
...
# 118 "./src/main/osd/osd_elements.c" 2
...
static 
# 177 "./src/main/osd/osd_elements.c" 3 4
      _Bool 
# 177 "./src/main/osd/osd_elements.c"
...
static 
# 180 "./src/main/osd/osd_elements.c" 3 4
      _Bool 
# 180 "./src/main/osd/osd_elements.c"
           blinkState = 
# 180 "./src/main/osd/osd_elements.c" 3 4
                        1
# 180 "./src/main/osd/osd_elements.c"
...
# 272 "./src/main/osd/osd_elements.c" 3 4
                                                                                                         1
...
# 331 "./src/main/osd/osd_elements.c" 3 4
                                                                         0
# 331 "./src/main/osd/osd_elements.c"
                                                                              , displaySymbol);
}
...
# 340 "./src/main/osd/osd_elements.c" 3 4
_Bool 
# 340 "./src/main/osd/osd_elements.c"
    osdFormatRtcDateTime(char *buffer)
{
    dateTime_t dateTime;
    if (!rtcGetDateTime(&dateTime)) {
        ...
        return 
# 346 "./src/main/osd/osd_elements.c" 3 4
              0
# 346 "./src/main/osd/osd_elements.c"
                   ;
    }
    ...
    return 
# 351 "./src/main/osd/osd_elements.c" 3 4
          1
# 351 "./src/main/osd/osd_elements.c"
              ;
}
...
void osdFormatTimer(char *buff, 
# 414 "./src/main/osd/osd_elements.c" 3 4
                               _Bool 
# 414 "./src/main/osd/osd_elements.c"
                                    showSymbol, 
# 414 "./src/main/osd/osd_elements.c" 3 4
                                                _Bool 
# 414 "./src/main/osd/osd_elements.c"
...
# 559 "./src/main/osd/osd_elements.c" 3 4
   _Bool 
# 559 "./src/main/osd/osd_elements.c"
        haveBaro = 
# 559 "./src/main/osd/osd_elements.c" 3 4
                   0
# 559 "./src/main/osd/osd_elements.c"
...
# 560 "./src/main/osd/osd_elements.c" 3 4
   _Bool 
# 560 "./src/main/osd/osd_elements.c"
        haveGps = 
# 560 "./src/main/osd/osd_elements.c" 3 4
                  0
# 560 "./src/main/osd/osd_elements.c"
...
# 580 "./src/main/osd/osd_elements.c" 3 4
                                                                                                                                               1
# 580 "./src/main/osd/osd_elements.c"
                                                                                                                                                   , 0x00);
}
...
static void osdElementArtificialHorizon(osdElementParms_t *element)
{
    ...
    element->drawElement = 
# 615 "./src/main/osd/osd_elements.c" 3 4
                          0
# 615 "./src/main/osd/osd_elements.c"
                               ;
}
...
static void osdElementUpDownReference(osdElementParms_t *element)
{
    ...
    if (__extension__ ({ __typeof__ (earthUpinBodyFrame[2]) _x = (earthUpinBodyFrame[2]); _x > 0 ? _x : -_x; }) < 0.422618261740699f && __extension__ ({ __typeof__ (earthUpinBodyFrame[1]) _x = (earthUpinBodyFrame[1]); _x > 0 ? _x : -_x; }) < 0.422618261740699f) {
        ...
        int posX = element->elemPosX + round(scaleRangef(psiB, -3.14159265358979323846f / 4, 3.14159265358979323846f / 4, -14, 14));
        int posY = element->elemPosY + round(scaleRangef(thetaB, -3.14159265358979323846f / 4, 3.14159265358979323846f / 4, -8, 8));

        osdDisplayWrite(element, posX, posY, DISPLAYPORT_ATTR_NONE, symbol[direction]);
    }
    element->drawElement = 
# 643 "./src/main/osd/osd_elements.c" 3 4
                          0
# 643 "./src/main/osd/osd_elements.c"
                               ;
}
...
# 650 "./src/main/osd/osd_elements.c" 3 4
                                                                                   0
# 650 "./src/main/osd/osd_elements.c"
                                                                                        , 0x06);
}
...
static void osdBackgroundCameraFrame(osdElementParms_t *element)
{
    ...
    element->drawElement = 
# 687 "./src/main/osd/osd_elements.c" 3 4
                          0
# 687 "./src/main/osd/osd_elements.c"
                               ;
}
...
# 762 "./src/main/osd/osd_elements.c" 3 4
                                                              0
# 762 "./src/main/osd/osd_elements.c"
                                                                   , 0x9A);
}
...
# 911 "./src/main/osd/osd_elements.c" 3 4
                                                            1
...
static void osdBackgroundHorizonSidebars(osdElementParms_t *element)
{
    ...
    element->drawElement = 
# 1015 "./src/main/osd/osd_elements.c" 3 4
                          0
...
# 1126 "./src/main/osd/osd_elements.c" 3 4
                                                                                                                        1
# 1126 "./src/main/osd/osd_elements.c"
                                                                                                                            , 0x06);
}
...
static void osdElementMotorDiagnostics(osdElementParms_t *element)
{
    int i = 0;
    const 
# 1132 "./src/main/osd/osd_elements.c" 3 4
         _Bool 
# 1132 "./src/main/osd/osd_elements.c"
...
static void osdElementRcChannels(osdElementParms_t *element)
{
    ...
    element->drawElement = 
# 1220 "./src/main/osd/osd_elements.c" 3 4
                          0
# 1220 "./src/main/osd/osd_elements.c"
                               ;
}
...
# 1317 "./src/main/osd/osd_elements.c" 3 4
                                 1
...
# 1356 "./src/main/osd/osd_elements.c" 3 4
   _Bool 
# 1356 "./src/main/osd/osd_elements.c"
        elementBlinking = 
# 1356 "./src/main/osd/osd_elements.c" 3 4
                          0
# 1356 "./src/main/osd/osd_elements.c"
...
const osdElementDrawFn osdElementDrawFunction[OSD_ITEM_COUNT] = {
    [OSD_CAMERA_FRAME] = 
# 1449 "./src/main/osd/osd_elements.c" 3 4
                                   ((void *)0)
# 1449 "./src/main/osd/osd_elements.c"
                                       ,
    ...
    [OSD_HORIZON_SIDEBARS] = 
# 1457 "./src/main/osd/osd_elements.c" 3 4
                                   ((void *)0)
# 1457 "./src/main/osd/osd_elements.c"
                                       ,
    [OSD_ITEM_TIMER_1] = osdElementTimer,
    [OSD_ITEM_TIMER_2] = osdElementTimer,
    [OSD_FLYMODE] = osdElementFlymode,
    [OSD_CRAFT_NAME] = 
# 1461 "./src/main/osd/osd_elements.c" 3 4
                                   ((void *)0)
# 1461 "./src/main/osd/osd_elements.c"
                                       ,
...
static void osdDrawSingleElement(displayPort_t *osdDisplayPort, uint8_t item)
{
    ...
    element.drawElement = 
# 1651 "./src/main/osd/osd_elements.c" 3 4
                         1
# 1651 "./src/main/osd/osd_elements.c"
                             ;
...
static void osdDrawSingleElementBackground(displayPort_t *osdDisplayPort, uint8_t item)
{
    ...
    element.osdDisplayPort = osdDisplayPort;
    element.drawElement = 
# 1679 "./src/main/osd/osd_elements.c" 3 4
                         1
# 1679 "./src/main/osd/osd_elements.c"
                             ;
...
void osdElementsInit(
# 1733 "./src/main/osd/osd_elements.c" 3 4
                    _Bool 
# 1733 "./src/main/osd/osd_elements.c"
                         backgroundLayerFlag)
{
...
static 
# 1836 "./src/main/osd/osd_elements.c" 3 4
      _Bool 
# 1836 "./src/main/osd/osd_elements.c"
...
# 1840 "./src/main/osd/osd_elements.c"
    ...
    return 
# 1843 "./src/main/osd/osd_elements.c" 3 4
          0
# 1843 "./src/main/osd/osd_elements.c"
               ;
}



# 1847 "./src/main/osd/osd_elements.c" 3 4
_Bool 
# 1847 "./src/main/osd/osd_elements.c"
    osdElementsNeedAccelerometer(void)
{
