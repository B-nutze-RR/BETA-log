# 1 "./src/main/rx/cyrf6936_spektrum.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/rx/cyrf6936_spektrum.c"
# 21 "./src/main/rx/cyrf6936_spektrum.c"
...
# 22 "./src/main/rx/cyrf6936_spektrum.c" 2
...
# 153 "./src/main/platform.h" 2
# 23 "./src/main/rx/cyrf6936_spektrum.c" 2
...
# 27 "./src/main/rx/cyrf6936_spektrum.c" 2
...
# 29 "./src/main/rx/cyrf6936_spektrum.c" 2
# 1 "./src/main/drivers/rx/rx_cyrf6936.h" 1
# 21 "./src/main/drivers/rx/rx_cyrf6936.h"
...
# 80 "./src/main/drivers/rx/rx_cyrf6936.h"
enum {
...
# 106 "./src/main/drivers/rx/rx_cyrf6936.h"
enum {
...
# 186 "./src/main/drivers/rx/rx_cyrf6936.h"
enum {
    CYRF6936_PA_M35 = 0x0,
    CYRF6936_PA_M30 = 0x1,
    CYRF6936_PA_M24 = 0x2,
...
extern 
# 204 "./src/main/drivers/rx/rx_cyrf6936.h" 3 4
      _Bool 
# 204 "./src/main/drivers/rx/rx_cyrf6936.h"
           isError;


# 206 "./src/main/drivers/rx/rx_cyrf6936.h" 3 4
_Bool 
# 206 "./src/main/drivers/rx/rx_cyrf6936.h"
    cyrf6936Init(void);


# 208 "./src/main/drivers/rx/rx_cyrf6936.h" 3 4
_Bool 
# 208 "./src/main/drivers/rx/rx_cyrf6936.h"
    cyrf6936RxFinished(uint32_t *timeStamp);
...
void cyrf6936SetMode(const uint8_t mode, const 
# 219 "./src/main/drivers/rx/rx_cyrf6936.h" 3 4
                                              _Bool 
# 219 "./src/main/drivers/rx/rx_cyrf6936.h"
                                                   force);
...
# 30 "./src/main/rx/cyrf6936_spektrum.c" 2
...
# 34 "./src/main/drivers/rx/rx_spi.h" 3 4
_Bool 
# 34 "./src/main/drivers/rx/rx_spi.h"
...
# 42 "./src/main/drivers/rx/rx_spi.h" 3 4
_Bool 
# 42 "./src/main/drivers/rx/rx_spi.h"
    rxSpiExtiConfigured(void);

# 43 "./src/main/drivers/rx/rx_spi.h" 3 4
_Bool 
# 43 "./src/main/drivers/rx/rx_spi.h"
    rxSpiGetExtiState(void);

# 44 "./src/main/drivers/rx/rx_spi.h" 3 4
_Bool 
# 44 "./src/main/drivers/rx/rx_spi.h"
    rxSpiPollExti(void);
void rxSpiResetExti(void);
timeUs_t rxSpiGetLastExtiTimeUs(void);
# 31 "./src/main/rx/cyrf6936_spektrum.c" 2
...
# 32 "./src/main/rx/cyrf6936_spektrum.c" 2
...
# 33 "./src/main/rx/cyrf6936_spektrum.c" 2
...
# 35 "./src/main/rx/cyrf6936_spektrum.c" 2
...
# 37 "./src/main/rx/cyrf6936_spektrum.c" 2
...
# 38 "./src/main/rx/cyrf6936_spektrum.c" 2


# 1 "./src/main/pg/pg_ids.h" 1
# 21 "./src/main/pg/pg_ids.h"
       
# 41 "./src/main/rx/cyrf6936_spektrum.c" 2
...
# 42 "./src/main/rx/cyrf6936_spektrum.c" 2
...
# 44 "./src/main/rx/cyrf6936_spektrum.c" 2
# 1 "./src/main/rx/rx_spi.h" 1
# 21 "./src/main/rx/rx_spi.h"
       
# 31 "./src/main/rx/rx_spi.h"
typedef enum {
...
# 45 "./src/main/rx/cyrf6936_spektrum.c" 2
...
# 38 "./src/main/rx/rx_spi_common.h"
                                 reset);
# 46 "./src/main/rx/cyrf6936_spektrum.c" 2
...
# 48 "./src/main/rx/cyrf6936_spektrum.c" 2
...
static const uint8_t cyrf6936Config[][2] = {
    {CYRF6936_CLK_EN, (1<<1)},
    {CYRF6936_AUTO_CAL_TIME, 0x3C},
    {CYRF6936_AUTO_CAL_OFFSET, 0x14},
    {CYRF6936_RX_CFG, (1<<6) | (1<<3)},
    {CYRF6936_TX_OFFSET_LSB, 0x55},
    {CYRF6936_TX_OFFSET_MSB, 0x05},
    {CYRF6936_XACT_CFG, CYRF6936_MODE_SYNTH_RX | (1<<5)},
    {CYRF6936_TX_CFG, (1<<5) | CYRF6936_DATA_MODE_SDR | CYRF6936_PA_4},
    {CYRF6936_DATA64_THOLD, 0x0E},
};
static const uint8_t cyrf6936BindConfig[][2] = {
    {CYRF6936_TX_CFG, (1<<5) | CYRF6936_DATA_MODE_SDR | CYRF6936_PA_4},
    {CYRF6936_FRAMING_CFG, (1<<6) | 0xE},
    {CYRF6936_RX_OVERRIDE, (1<<4) | (1<<2)},
    {CYRF6936_EOP_CTRL, 0x02},
    {CYRF6936_TX_OVERRIDE, (1<<2)},
};
static const uint8_t cyrf6936TransferConfig[][2] = {
    {CYRF6936_TX_CFG, (1<<5) | CYRF6936_DATA_MODE_8DR | CYRF6936_PA_4},
    {CYRF6936_FRAMING_CFG, (1<<7) | (1<<6) | (1<<5) | 0xE},
    {CYRF6936_TX_OVERRIDE, 0x00},
    {CYRF6936_RX_OVERRIDE, 0x00},
};
...
# 177 "./src/main/rx/cyrf6936_spektrum.c" 3 4
   _Bool 
# 177 "./src/main/rx/cyrf6936_spektrum.c"
        bound;
...
# 186 "./src/main/rx/cyrf6936_spektrum.c" 3 4
   _Bool 
# 186 "./src/main/rx/cyrf6936_spektrum.c"
        sendTelemetry;

} dsmReceiver_t;

static dsmReceiver_t dsmReceiver;

extern const spektrumConfig_t pgResetTemplate_spektrumConfig; spektrumConfig_t spektrumConfig_System; spektrumConfig_t spektrumConfig_Copy; extern const pgRegistry_t spektrumConfig_Registry; const pgRegistry_t spektrumConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 542 | (0 << 12), .length = 1, .size = sizeof(spektrumConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&spektrumConfig_System, .copy = (uint8_t*)&spektrumConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_spektrumConfig}, };
const spektrumConfig_t pgResetTemplate_spektrumConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .protocol = 0, .mfgId = {0, 0, 0, 0}, .numChannels = 0 };
...
static void dsmGenerateDsmxChannels(void)
{
    ...
    while (idx < 23) {
        ...
        idTmp = idTmp * 0x0019660D + 0x3C6EF35F;
...
{
    const uint8_t pnRow = (dsmReceiver.protocol == DSM2_22 || dsmReceiver.protocol == DSM2_11 || dsmReceiver.protocol == DSM2_11_DX6 || dsmReceiver.protocol == DSM2_11_DX8) ? channel % 5 : (channel - 2) % 5;
...
static void dsmReceiverSetNextSyncChannel(void)
{
    ...
    dsmReceiver.rfChannel = (dsmReceiver.rfChannel + 1) % 0x4F;
...
{
    dsmReceiver.rfChannelIdx = (dsmReceiver.protocol == DSM2_22 || dsmReceiver.protocol == DSM2_11 || dsmReceiver.protocol == DSM2_11_DX6 || dsmReceiver.protocol == DSM2_11_DX8) ? (dsmReceiver.rfChannelIdx + 1) % 2 : (dsmReceiver.rfChannelIdx + 1) % 23;
    dsmReceiver.crcSeed = ~dsmReceiver.crcSeed;
...
static void resetReceiveTimeout(const uint32_t timeStamp)
{
    ...
    if (dsmReceiver.crcSeed == ((dsmReceiver.mfgId[0] << 8) + dsmReceiver.mfgId[1])) {
        dsmReceiver.timeout = 4500;
    } else {
        dsmReceiver.timeout = (dsmReceiver.numChannels < 8 ? 18500 : 7500);
    }
}
...
static void dsmReceiverStartTransfer(void)
{
    ...
    cyrf6936SetConfigLen(cyrf6936TransferConfig, (sizeof(cyrf6936TransferConfig) / sizeof((cyrf6936TransferConfig)[0])));
    ...
    if ((!(dsmReceiver.protocol == DSM2_22 || dsmReceiver.protocol == DSM2_11 || dsmReceiver.protocol == DSM2_11_DX6 || dsmReceiver.protocol == DSM2_11_DX8))) {
    ...
    dsmReceiver.timeLastPacket = micros();
    dsmReceiver.timeout = 20000 << 2;
    cyrf6936StartRecv();
}


# 320 "./src/main/rx/cyrf6936_spektrum.c" 3 4
_Bool 
# 320 "./src/main/rx/cyrf6936_spektrum.c"
    spektrumSpiInit(const struct rxSpiConfig_s *rxConfig, struct rxRuntimeState_s *rxRuntimeState, rxSpiExtiConfig_t *extiConfig)
{
    (void)(extiConfig);
    ...
    if (!rxSpiExtiConfigured()) {
        return 
# 325 "./src/main/rx/cyrf6936_spektrum.c" 3 4
              0
# 325 "./src/main/rx/cyrf6936_spektrum.c"
                   ;
    }
    ...
    extiConfig->ioConfig = ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_DOWN) << 5));
    extiConfig->trigger = BETAFLIGHT_EXTI_TRIGGER_FALLING;

    if (!cyrf6936Init()) {
        return 
# 337 "./src/main/rx/cyrf6936_spektrum.c" 3 4
              0
# 337 "./src/main/rx/cyrf6936_spektrum.c"
                   ;
    }
    ...
    cyrf6936SetConfigLen(cyrf6936Config, (sizeof(cyrf6936Config) / sizeof((cyrf6936Config)[0])));


    dsmReceiver.timeLastTelemetry = micros() + 176000;
    dsmReceiver.sendTelemetry = 
# 348 "./src/main/rx/cyrf6936_spektrum.c" 3 4
                               0
# 348 "./src/main/rx/cyrf6936_spektrum.c"
                                    ;
    ...
    if (spektrumConfig()->mfgId[0] || spektrumConfig()->mfgId[1]
        ...
        dsmReceiver.bound = 
# 353 "./src/main/rx/cyrf6936_spektrum.c" 3 4
                           1
# 353 "./src/main/rx/cyrf6936_spektrum.c"
                               ;
        memcpy(dsmReceiver.mfgId, spektrumConfig()->mfgId, 4);
        dsmReceiverStartTransfer();
    } else {
        dsmReceiver.bound = 
# 357 "./src/main/rx/cyrf6936_spektrum.c" 3 4
                           0
# 357 "./src/main/rx/cyrf6936_spektrum.c"
                                ;
        dsmReceiverStartBind();
    }

    return 
# 361 "./src/main/rx/cyrf6936_spektrum.c" 3 4
          1
# 361 "./src/main/rx/cyrf6936_spektrum.c"
              ;
}
...
static void dsmSendTelemetryPacket(void)
{
    ...
    cyrf6936SetMode(CYRF6936_MODE_IDLE, 
# 379 "./src/main/rx/cyrf6936_spektrum.c" 3 4
                                       1
# 379 "./src/main/rx/cyrf6936_spektrum.c"
                                           );
...
static void dsmSendBindPacket(void)
{
    ...
    packet[9] = sum & 0xff;
    cyrf6936SetMode(CYRF6936_MODE_IDLE, 
# 400 "./src/main/rx/cyrf6936_spektrum.c" 3 4
                                       1
# 400 "./src/main/rx/cyrf6936_spektrum.c"
                                           );
...
static void checkTimeout(void)
{
    ...
    if (featureIsEnabled(FEATURE_TELEMETRY) && (time - dsmReceiver.timeLastTelemetry) > 176000) {
        dsmReceiver.timeLastTelemetry = time;
        dsmReceiver.sendTelemetry = 
# 411 "./src/main/rx/cyrf6936_spektrum.c" 3 4
                                   1
# 411 "./src/main/rx/cyrf6936_spektrum.c"
                                       ;
    }


    if ((time - dsmReceiver.timeLastPacket) > dsmReceiver.timeout) {
        cyrf6936SetMode(CYRF6936_MODE_SYNTH_RX, 
# 416 "./src/main/rx/cyrf6936_spektrum.c" 3 4
                                               1
# 416 "./src/main/rx/cyrf6936_spektrum.c"
                                                   );
        ...
        case DSM_RECEIVER_BIND:
            dsmReceiver.rfChannel = (dsmReceiver.rfChannel + 2) % 0x4F;
            cyrf6936SetChannel(dsmReceiver.rfChannel);
            dsmReceiver.timeout = 11000;
            cyrf6936StartRecv();
            break;
        case DSM_RECEIVER_BIND2:
            if (dsmReceiver.bindPackets++ > 500) {
                dsmReceiverStartTransfer();
            } else {
                dsmReceiver.timeout = 11000;
                dsmSendBindPacket();
        ...
        case DSM_RECEIVER_SYNC_B:
            (dsmReceiver.protocol == DSM2_22 || dsmReceiver.protocol == DSM2_11 || dsmReceiver.protocol == DSM2_11_DX6 || dsmReceiver.protocol == DSM2_11_DX8) ? dsmReceiverSetNextSyncChannel() : dsmReceiverSetNextChannel();
            dsmReceiver.timeout = 20000;
            cyrf6936StartRecv();
            break;
        case DSM_RECEIVER_RECV:
            dsmReceiver.missedPackets++;
            {if (debugMode == (DEBUG_RX_SPEKTRUM_SPI)) {debug[(0)] = (dsmReceiver.missedPackets);}};
            if (dsmReceiver.missedPackets < 31) {
                dsmReceiverSetNextChannel();
                if (dsmReceiver.crcSeed == ((dsmReceiver.mfgId[0] << 8) + dsmReceiver.mfgId[1])) {
                    dsmReceiver.timeout = 4500;
                } else {
        ...
        case DSM_RECEIVER_TLM:
            {if (debugMode == (DEBUG_RX_SPEKTRUM_SPI)) {debug[(2)] = ((cyrf6936ReadRegister(CYRF6936_TX_IRQ_STATUS) & (1<<1)) == 0);}};
            dsmReceiverSetNextChannel();
            dsmReceiver.status = DSM_RECEIVER_RECV;
            dsmReceiver.timeout = (dsmReceiver.numChannels < 8 ? 18500 : 7500) - 1500;
            cyrf6936StartRecv();
            break;
...
{
    if (rcData && payload) {
        const uint8_t divider = (uint8_t) (!(dsmReceiver.protocol == DSM2_22 || dsmReceiver.protocol == DSM2_11 || dsmReceiver.protocol == DSM2_11_DX6 || dsmReceiver.protocol == DSM2_11_DX8));
        const uint8_t bitShift = 10 + divider;
        const uint16_t valueMax = (!(dsmReceiver.protocol == DSM2_22 || dsmReceiver.protocol == DSM2_11 || dsmReceiver.protocol == DSM2_11_DX6 || dsmReceiver.protocol == DSM2_11_DX8)) ? 0x7FF : 0x3FF;
...
static 
# 493 "./src/main/rx/cyrf6936_spektrum.c" 3 4
      _Bool 
# 493 "./src/main/rx/cyrf6936_spektrum.c"
           isValidPacket(const uint8_t *packet)
{
    {if (debugMode == (DEBUG_RX_SPEKTRUM_SPI)) {debug[(1)] = (isError);}};

    if (isError) {
        if (dsmReceiver.status != DSM_RECEIVER_RECV && (cyrf6936GetRxStatus() & (1<<3))) {
            dsmReceiver.crcSeed = ~dsmReceiver.crcSeed;
        } else {
            return 
# 501 "./src/main/rx/cyrf6936_spektrum.c" 3 4
                  0
# 501 "./src/main/rx/cyrf6936_spektrum.c"
                       ;
        }
    }
    if (!(((dsmReceiver.protocol == DSM2_22 || dsmReceiver.protocol == DSM2_11 || dsmReceiver.protocol == DSM2_11_DX6 || dsmReceiver.protocol == DSM2_11_DX8) && packet[0] == (~dsmReceiver.mfgId[2]&0xFF) && packet[1] == (~dsmReceiver.mfgId[3]&0xFF)) || ((!(dsmReceiver.protocol == DSM2_22 || dsmReceiver.protocol == DSM2_11 || dsmReceiver.protocol == DSM2_11_DX6 || dsmReceiver.protocol == DSM2_11_DX8)) && packet[0] == dsmReceiver.mfgId[2] && packet[1] == dsmReceiver.mfgId[3]))) {
        return 
# 505 "./src/main/rx/cyrf6936_spektrum.c" 3 4
              0
# 505 "./src/main/rx/cyrf6936_spektrum.c"
                   ;
    }
    return 
# 507 "./src/main/rx/cyrf6936_spektrum.c" 3 4
          1
# 507 "./src/main/rx/cyrf6936_spektrum.c"
              ;
}
...
rx_spi_received_e spektrumReadPacket(uint8_t *payload, const uint32_t timeStamp)
{
    ...
    cyrf6936WriteRegister(CYRF6936_XACT_CFG, CYRF6936_MODE_SYNTH_RX | (1<<5));
    cyrf6936WriteRegister(CYRF6936_RX_ABORT, 0x00);
    ...
    case DSM_RECEIVER_BIND:
        ...
        dsmReceiver.timeout = 11000;
        dsmReceiver.bound = 
# 571 "./src/main/rx/cyrf6936_spektrum.c" 3 4
                           1
# 571 "./src/main/rx/cyrf6936_spektrum.c"
                               ;
    ...
    case DSM_RECEIVER_RECV:
        if (isValidPacket(packet)) {
            ...
            if (dsmReceiver.sendTelemetry && dsmReceiver.crcSeed == ((dsmReceiver.mfgId[0] << 8) + dsmReceiver.mfgId[1])) {
                ...
                dsmReceiver.sendTelemetry = 
# 622 "./src/main/rx/cyrf6936_spektrum.c" 3 4
                                           0
# 622 "./src/main/rx/cyrf6936_spektrum.c"
                                                ;
                dsmReceiver.timeLastPacket = timeStamp;
                dsmReceiver.timeout = 1500;
...
# 649 "./src/main/rx/cyrf6936_spektrum.c" 3 4
                               1
# 649 "./src/main/rx/cyrf6936_spektrum.c"
                                   )) {
        dsmReceiver.bound = 
# 650 "./src/main/rx/cyrf6936_spektrum.c" 3 4
                           0
# 650 "./src/main/rx/cyrf6936_spektrum.c"
                                ;
        dsmReceiverStartBind();
    }
