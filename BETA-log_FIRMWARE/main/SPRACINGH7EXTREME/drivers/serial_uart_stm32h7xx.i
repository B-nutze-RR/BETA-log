# 1 "./src/main/drivers/serial_uart_stm32h7xx.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_uart_stm32h7xx.c"
# 25 "./src/main/drivers/serial_uart_stm32h7xx.c"
# 1 "c:\\dev\\9 2020-q2-update\\lib\\gcc\\arm-none-eabi\\9.3.1\\include\\stdbool.h" 1 3 4
# 26 "./src/main/drivers/serial_uart_stm32h7xx.c" 2
...
# 27 "./src/main/drivers/serial_uart_stm32h7xx.c" 2
...
# 153 "./src/main/platform.h" 2
# 29 "./src/main/drivers/serial_uart_stm32h7xx.c" 2
...
# 33 "./src/main/drivers/serial_uart_stm32h7xx.c" 2
...
# 34 "./src/main/drivers/serial_uart_stm32h7xx.c" 2
...
# 35 "./src/main/drivers/serial_uart_stm32h7xx.c" 2
# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 36 "./src/main/drivers/serial_uart_stm32h7xx.c" 2
...
# 37 "./src/main/drivers/serial_uart_stm32h7xx.c" 2
...
# 39 "./src/main/drivers/serial_uart_stm32h7xx.c" 2
...
# 40 "./src/main/drivers/serial_uart_stm32h7xx.c" 2
# 1 "./src/main/drivers/serial_uart_impl.h" 1
# 21 "./src/main/drivers/serial_uart_impl.h"
       
# 157 "./src/main/drivers/serial_uart_impl.h"
...
typedef struct uartHardware_s {
    ...
    uartPinDef_t rxPins[5];
    uartPinDef_t txPins[5];
...
# 246 "./src/main/drivers/serial_uart_impl.h"
...
extern volatile uint8_t uart6RxBuffer[128]; extern volatile uint8_t uart6TxBuffer[1280]; struct dummy_s;
...
extern volatile uint8_t uart8RxBuffer[128]; extern volatile uint8_t uart8TxBuffer[1280]; struct dummy_s;
# 41 "./src/main/drivers/serial_uart_stm32h7xx.c" 2
# 91 "./src/main/drivers/serial_uart_stm32h7xx.c"
const uartHardware_t uartHardware[(1 + 1 + 1 + 1 + 1 + 1 + 0 + 1 + 0)] = {

    {
        ...
        .rxDMAChannel = 41U,
        .rxDMAResource = (dmaResource_t *)
# 98 "./src/main/drivers/serial_uart_stm32h7xx.c" 3 4
                                         ((void *)0)
# 98 "./src/main/drivers/serial_uart_stm32h7xx.c"
                                                            ,
        .txDMAChannel = 42U,
        .txDMAResource = (dmaResource_t *)
# 100 "./src/main/drivers/serial_uart_stm32h7xx.c" 3 4
                                         ((void *)0)
# 100 "./src/main/drivers/serial_uart_stm32h7xx.c"
                                                            ,

        .rxPins = {
            { ((ioTag_t)((((0) + 1) << 4) | (10))), ((uint8_t)0x07) },
            { ((ioTag_t)((((1) + 1) << 4) | (7))), ((uint8_t)0x04) },
            { ((ioTag_t)((((1) + 1) << 4) | (15))), ((uint8_t)0x04) },
        },
        .txPins = {
            { ((ioTag_t)((((0) + 1) << 4) | (9))), ((uint8_t)0x07) },
            { ((ioTag_t)((((1) + 1) << 4) | (6))), ((uint8_t)0x04) },
        ...
        .rxIrq = USART1_IRQn,
        .txPriority = (((((1)<<(4-(7-(((uint32_t)0x00000005)))))|((1)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0),
        .rxPriority = (((((1)<<(4-(7-(((uint32_t)0x00000005)))))|((1)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0),
...

    {
        ...
        .rxDMAChannel = 43U,
        .rxDMAResource = (dmaResource_t *)
# 129 "./src/main/drivers/serial_uart_stm32h7xx.c" 3 4
                                         ((void *)0)
# 129 "./src/main/drivers/serial_uart_stm32h7xx.c"
                                                            ,
        .txDMAChannel = 44U,
        .txDMAResource = (dmaResource_t *)
# 131 "./src/main/drivers/serial_uart_stm32h7xx.c" 3 4
                                         ((void *)0)
# 131 "./src/main/drivers/serial_uart_stm32h7xx.c"
                                                            ,

        .rxPins = {
            { ((ioTag_t)((((0) + 1) << 4) | (3))), ((uint8_t)0x07) },
            { ((ioTag_t)((((3) + 1) << 4) | (6))), ((uint8_t)0x07) }
        },
        .txPins = {
            { ((ioTag_t)((((0) + 1) << 4) | (2))), ((uint8_t)0x07) },
            { ((ioTag_t)((((3) + 1) << 4) | (5))), ((uint8_t)0x07) }
        },
        .rcc = (((RCC_APB1L) << 5) | (16*(((0x1UL << (17U)))>65535L) + (8*((((0x1UL << (17U)))*1L >>16*(((0x1UL << (17U)))>65535L))>255) + (8 - 90/((((((0x1UL << (17U)))*1L >>16*(((0x1UL << (17U)))>65535L)) >>8*((((0x1UL << (17U)))*1L >>16*(((0x1UL << (17U)))>65535L))>255))/4+14)|1) - 2/(((((0x1UL << (17U)))*1L >>16*(((0x1UL << (17U)))>65535L)) >>8*((((0x1UL << (17U)))*1L >>16*(((0x1UL << (17U)))>65535L))>255))/2+1))))),
        .rxIrq = USART2_IRQn,
        .txPriority = (((((1)<<(4-(7-(((uint32_t)0x00000005)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0),
        .rxPriority = (((((1)<<(4-(7-(((uint32_t)0x00000005)))))|((2)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0),
...

    {
        ...
        .rxDMAChannel = 45U,
        .rxDMAResource = (dmaResource_t *)
# 158 "./src/main/drivers/serial_uart_stm32h7xx.c" 3 4
                                         ((void *)0)
# 158 "./src/main/drivers/serial_uart_stm32h7xx.c"
                                                            ,
        .txDMAChannel = 46U,
        .txDMAResource = (dmaResource_t *)
# 160 "./src/main/drivers/serial_uart_stm32h7xx.c" 3 4
                                         ((void *)0)
# 160 "./src/main/drivers/serial_uart_stm32h7xx.c"
                                                            ,

        .rxPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (11))), ((uint8_t)0x07) },
            { ((ioTag_t)((((2) + 1) << 4) | (11))), ((uint8_t)0x07) },
            { ((ioTag_t)((((3) + 1) << 4) | (9))), ((uint8_t)0x07) }
        },
        .txPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (10))), ((uint8_t)0x07) },
            { ((ioTag_t)((((2) + 1) << 4) | (10))), ((uint8_t)0x07) },
            { ((ioTag_t)((((3) + 1) << 4) | (8))), ((uint8_t)0x07) }
        },
        .rcc = (((RCC_APB1L) << 5) | (16*(((0x1UL << (18U)))>65535L) + (8*((((0x1UL << (18U)))*1L >>16*(((0x1UL << (18U)))>65535L))>255) + (8 - 90/((((((0x1UL << (18U)))*1L >>16*(((0x1UL << (18U)))>65535L)) >>8*((((0x1UL << (18U)))*1L >>16*(((0x1UL << (18U)))>65535L))>255))/4+14)|1) - 2/(((((0x1UL << (18U)))*1L >>16*(((0x1UL << (18U)))>65535L)) >>8*((((0x1UL << (18U)))*1L >>16*(((0x1UL << (18U)))>65535L))>255))/2+1))))),
        .rxIrq = USART3_IRQn,
        .txPriority = (((((1)<<(4-(7-(((uint32_t)0x00000005)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0),
        .rxPriority = (((((1)<<(4-(7-(((uint32_t)0x00000005)))))|((2)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0),
...

    {
        ...
        .rxDMAChannel = 63U,
        .rxDMAResource = (dmaResource_t *)
# 189 "./src/main/drivers/serial_uart_stm32h7xx.c" 3 4
                                         ((void *)0)
# 189 "./src/main/drivers/serial_uart_stm32h7xx.c"
                                                            ,
        .txDMAChannel = 64U,
        .txDMAResource = (dmaResource_t *)
# 191 "./src/main/drivers/serial_uart_stm32h7xx.c" 3 4
                                         ((void *)0)
# 191 "./src/main/drivers/serial_uart_stm32h7xx.c"
                                                            ,

        .rxPins = {
            { ((ioTag_t)((((0) + 1) << 4) | (1))), ((uint8_t)0x08) },
            { ((ioTag_t)((((0) + 1) << 4) | (11))), ((uint8_t)0x06) },
            { ((ioTag_t)((((1) + 1) << 4) | (8))), ((uint8_t)0x08) },
            { ((ioTag_t)((((2) + 1) << 4) | (11))), ((uint8_t)0x08) },
            { ((ioTag_t)((((3) + 1) << 4) | (0))), ((uint8_t)0x08) }
        },
        .txPins = {
            { ((ioTag_t)((((0) + 1) << 4) | (0))), ((uint8_t)0x08) },
            { ((ioTag_t)((((0) + 1) << 4) | (12))), ((uint8_t)0x06) },
            { ((ioTag_t)((((1) + 1) << 4) | (9))), ((uint8_t)0x08) },
            { ((ioTag_t)((((2) + 1) << 4) | (10))), ((uint8_t)0x08) },
            { ((ioTag_t)((((3) + 1) << 4) | (1))), ((uint8_t)0x08) }
        },
        .rcc = (((RCC_APB1L) << 5) | (16*(((0x1UL << (19U)))>65535L) + (8*((((0x1UL << (19U)))*1L >>16*(((0x1UL << (19U)))>65535L))>255) + (8 - 90/((((((0x1UL << (19U)))*1L >>16*(((0x1UL << (19U)))>65535L)) >>8*((((0x1UL << (19U)))*1L >>16*(((0x1UL << (19U)))>65535L))>255))/4+14)|1) - 2/(((((0x1UL << (19U)))*1L >>16*(((0x1UL << (19U)))>65535L)) >>8*((((0x1UL << (19U)))*1L >>16*(((0x1UL << (19U)))>65535L))>255))/2+1))))),
        .rxIrq = UART4_IRQn,
        .txPriority = (((((1)<<(4-(7-(((uint32_t)0x00000005)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0),
        .rxPriority = (((((1)<<(4-(7-(((uint32_t)0x00000005)))))|((2)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0),
...

    {
        ...
        .rxDMAChannel = 65U,
        .rxDMAResource = (dmaResource_t *)
# 224 "./src/main/drivers/serial_uart_stm32h7xx.c" 3 4
                                         ((void *)0)
# 224 "./src/main/drivers/serial_uart_stm32h7xx.c"
                                                            ,
        .txDMAChannel = 66U,
        .txDMAResource = (dmaResource_t *)
# 226 "./src/main/drivers/serial_uart_stm32h7xx.c" 3 4
                                         ((void *)0)
# 226 "./src/main/drivers/serial_uart_stm32h7xx.c"
                                                            ,

        .rxPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (5))), ((uint8_t)0x0E) },
            { ((ioTag_t)((((1) + 1) << 4) | (12))), ((uint8_t)0x0E) },
            { ((ioTag_t)((((3) + 1) << 4) | (2))), ((uint8_t)0x08) },
        },
        .txPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (6))), ((uint8_t)0x0E) },
            { ((ioTag_t)((((1) + 1) << 4) | (13))), ((uint8_t)0x0E) },
            { ((ioTag_t)((((2) + 1) << 4) | (12))), ((uint8_t)0x08) },
        },
        .rcc = (((RCC_APB1L) << 5) | (16*(((0x1UL << (20U)))>65535L) + (8*((((0x1UL << (20U)))*1L >>16*(((0x1UL << (20U)))>65535L))>255) + (8 - 90/((((((0x1UL << (20U)))*1L >>16*(((0x1UL << (20U)))>65535L)) >>8*((((0x1UL << (20U)))*1L >>16*(((0x1UL << (20U)))>65535L))>255))/4+14)|1) - 2/(((((0x1UL << (20U)))*1L >>16*(((0x1UL << (20U)))>65535L)) >>8*((((0x1UL << (20U)))*1L >>16*(((0x1UL << (20U)))>65535L))>255))/2+1))))),
        .rxIrq = UART5_IRQn,
        .txPriority = (((((1)<<(4-(7-(((uint32_t)0x00000005)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0),
        .rxPriority = (((((1)<<(4-(7-(((uint32_t)0x00000005)))))|((2)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0),
    ...
    {
        .device = UARTDEV_6,
        .reg = ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1400UL)),

        .rxDMAChannel = 71U,
        .rxDMAResource = (dmaResource_t *)
# 255 "./src/main/drivers/serial_uart_stm32h7xx.c" 3 4
                                         ((void *)0)
# 255 "./src/main/drivers/serial_uart_stm32h7xx.c"
                                                            ,
        .txDMAChannel = 72U,
        .txDMAResource = (dmaResource_t *)
# 257 "./src/main/drivers/serial_uart_stm32h7xx.c" 3 4
                                         ((void *)0)
# 257 "./src/main/drivers/serial_uart_stm32h7xx.c"
                                                            ,

        .rxPins = {
            { ((ioTag_t)((((2) + 1) << 4) | (7))), ((uint8_t)0x07) },
            { ((ioTag_t)((((6) + 1) << 4) | (9))), ((uint8_t)0x07) }
        },
        .txPins = {
            { ((ioTag_t)((((2) + 1) << 4) | (6))), ((uint8_t)0x07) },
            { ((ioTag_t)((((6) + 1) << 4) | (14))), ((uint8_t)0x07) }
        },
        .rcc = (((RCC_APB2) << 5) | (16*(((0x1UL << (5U)))>65535L) + (8*((((0x1UL << (5U)))*1L >>16*(((0x1UL << (5U)))>65535L))>255) + (8 - 90/((((((0x1UL << (5U)))*1L >>16*(((0x1UL << (5U)))>65535L)) >>8*((((0x1UL << (5U)))*1L >>16*(((0x1UL << (5U)))>65535L))>255))/4+14)|1) - 2/(((((0x1UL << (5U)))*1L >>16*(((0x1UL << (5U)))>65535L)) >>8*((((0x1UL << (5U)))*1L >>16*(((0x1UL << (5U)))>65535L))>255))/2+1))))),
        .rxIrq = USART6_IRQn,
        .txPriority = (((((1)<<(4-(7-(((uint32_t)0x00000005)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0),
        .rxPriority = (((((1)<<(4-(7-(((uint32_t)0x00000005)))))|((2)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0),
...
# 312 "./src/main/drivers/serial_uart_stm32h7xx.c"
    {
        .device = UARTDEV_8,
        .reg = ((USART_TypeDef *) ((0x40000000UL) + 0x7C00UL)),

        .rxDMAChannel = 81U,
        .rxDMAResource = (dmaResource_t *)
# 317 "./src/main/drivers/serial_uart_stm32h7xx.c" 3 4
                                         ((void *)0)
# 317 "./src/main/drivers/serial_uart_stm32h7xx.c"
                                                            ,
        .txDMAChannel = 82U,
        .txDMAResource = (dmaResource_t *)
# 319 "./src/main/drivers/serial_uart_stm32h7xx.c" 3 4
                                         ((void *)0)
# 319 "./src/main/drivers/serial_uart_stm32h7xx.c"
                                                            ,

        .rxPins = {
            { ((ioTag_t)((((4) + 1) << 4) | (0))), ((uint8_t)0x08) }
        },
        .txPins = {
            { ((ioTag_t)((((4) + 1) << 4) | (1))), ((uint8_t)0x08) }
        },
        .rcc = (((RCC_APB1L) << 5) | (16*(((0x1UL << (31U)))>65535L) + (8*((((0x1UL << (31U)))*1L >>16*(((0x1UL << (31U)))>65535L))>255) + (8 - 90/((((((0x1UL << (31U)))*1L >>16*(((0x1UL << (31U)))>65535L)) >>8*((((0x1UL << (31U)))*1L >>16*(((0x1UL << (31U)))>65535L))>255))/4+14)|1) - 2/(((((0x1UL << (31U)))*1L >>16*(((0x1UL << (31U)))>65535L)) >>8*((((0x1UL << (31U)))*1L >>16*(((0x1UL << (31U)))>65535L))>255))/2+1))))),
        .rxIrq = UART8_IRQn,
        .txPriority = (((((1)<<(4-(7-(((uint32_t)0x00000005)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0),
        .rxPriority = (((((1)<<(4-(7-(((uint32_t)0x00000005)))))|((2)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0),
...
# 367 "./src/main/drivers/serial_uart_stm32h7xx.c"
};
...
uartPort_t *serialUART(UARTDevice_e device, uint32_t baudRate, portMode_e mode, portOptions_e options)
{
    ...
    if (!uartdev) {
        return 
# 375 "./src/main/drivers/serial_uart_stm32h7xx.c" 3 4
              ((void *)0)
# 375 "./src/main/drivers/serial_uart_stm32h7xx.c"
                  ;
    }
    ...
    if ((options & SERIAL_BIDIR) && txIO) {
        ioConfig_t ioCfg = ((((options & SERIAL_INVERTED) || (options & SERIAL_BIDIR_PP)) ? (0x00000002U) : (0x00000012U)) | (((0x00000002U)) << 2) | (((options & SERIAL_INVERTED) ? (0x00000002U) : (0x00000001U)) << 5))
        ...
        if ((mode & MODE_TX) && txIO) {
            IOInit(txIO, OWNER_SERIAL_TX, (device + 1));
            IOConfigGPIOAF(txIO, (((0x00000002U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)), uartdev->tx.af);
        }

        if ((mode & MODE_RX) && rxIO) {
            IOInit(rxIO, OWNER_SERIAL_RX, (device + 1));
            IOConfigGPIOAF(rxIO, (((0x00000002U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)), uartdev->rx.af);
        }
    }
    ...
    {
        HAL_NVIC_SetPriority(hardware->rxIrq, (((hardware->rxPriority)>>(4-(7-(((uint32_t)0x00000005)))))>>4), (((hardware->rxPriority)&(0x0f>>(7-(((uint32_t)0x00000005)))))>>4));
