...
# 40 "./src/main/drivers/sdcard.c" 2
...
# 41 "./src/main/drivers/sdcard.c" 2
# 66 "./src/main/drivers/sdcard.c"
sdcard_t sdcard;
...
# 77 "./src/main/drivers/sdcard.c" 3 4
                                  0
# 77 "./src/main/drivers/sdcard.c"
                                       ;
    }

    if (sdcard.cardDetectPin) {
        IOInit(sdcard.cardDetectPin, OWNER_SDCARD_DETECT, 0);
        IOConfigGPIO(sdcard.cardDetectPin, (((0x00000000U)) | (((0x00000000U)) << 2) | (((0x00000001U)) << 5)));
    }
}
...
# 89 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 89 "./src/main/drivers/sdcard.c"
    sdcard_isInserted(void)
{
    
# 91 "./src/main/drivers/sdcard.c" 3 4
   _Bool 
# 91 "./src/main/drivers/sdcard.c"
        result = 
# 91 "./src/main/drivers/sdcard.c" 3 4
                 1
# 91 "./src/main/drivers/sdcard.c"
...
# 154 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 154 "./src/main/drivers/sdcard.c"
    sdcard_poll(void)
{
    ...
    if (sdcardVTable) {
        ...
        return 
# 160 "./src/main/drivers/sdcard.c" 3 4
              0
# 160 "./src/main/drivers/sdcard.c"
                   ;
    }
}


# 164 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 164 "./src/main/drivers/sdcard.c"
    sdcard_isFunctional(void)
{
    ...
    if (sdcardVTable) {
        ...
        return 
# 171 "./src/main/drivers/sdcard.c" 3 4
              0
# 171 "./src/main/drivers/sdcard.c"
                   ;
    }
}


# 175 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 175 "./src/main/drivers/sdcard.c"
    sdcard_isInitialized(void)
{
