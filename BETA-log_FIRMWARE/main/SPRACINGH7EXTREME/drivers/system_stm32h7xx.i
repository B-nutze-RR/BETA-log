# 1 "./src/main/drivers/system_stm32h7xx.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/system_stm32h7xx.c"
# 18 "./src/main/drivers/system_stm32h7xx.c"
...
# 19 "./src/main/drivers/system_stm32h7xx.c" 2
# 1 "c:\\dev\\9 2020-q2-update\\lib\\gcc\\arm-none-eabi\\9.3.1\\include\\stdbool.h" 1 3 4
# 20 "./src/main/drivers/system_stm32h7xx.c" 2
...
# 21 "./src/main/drivers/system_stm32h7xx.c" 2
...
# 22 "./src/main/drivers/system_stm32h7xx.c" 2
...
# 153 "./src/main/platform.h" 2
# 24 "./src/main/drivers/system_stm32h7xx.c" 2
...
# 26 "./src/main/drivers/system_stm32h7xx.c" 2

# 1 "./src/main/drivers/nvic.h" 1
# 21 "./src/main/drivers/nvic.h"
       
# 28 "./src/main/drivers/system_stm32h7xx.c" 2
...
# 29 "./src/main/drivers/system_stm32h7xx.c" 2
...
# 30 "./src/main/drivers/system_stm32h7xx.c" 2
...
# 57 "./src/main/drivers/system_stm32h7xx.c" 3 4
_Bool 
# 57 "./src/main/drivers/system_stm32h7xx.c"
    isMPUSoftReset(void)
{
    if (cachedRccCsrValue & (0x1UL << (24U)))
        return 
# 60 "./src/main/drivers/system_stm32h7xx.c" 3 4
              1
# 60 "./src/main/drivers/system_stm32h7xx.c"
                  ;
    else
        return 
# 62 "./src/main/drivers/system_stm32h7xx.c" 3 4
              0
# 62 "./src/main/drivers/system_stm32h7xx.c"
                   ;
}
...
void systemInit(void)
{
    ...
    cachedRccCsrValue = ((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->RSR;
# 81 "./src/main/drivers/system_stm32h7xx.c"
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->AHB2ENR) |= ((0x1UL << (29U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->AHB2ENR) & ((0x1UL << (29U)))); ((void)(tmpreg)); } while(0);
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->AHB2ENR) |= ((0x1UL << (30U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->AHB2ENR) & ((0x1UL << (30U)))); ((void)(tmpreg)); } while(0);
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->AHB2ENR) |= ((0x1UL << (31U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->AHB2ENR) & ((0x1UL << (31U)))); ((void)(tmpreg)); } while(0);
# 99 "./src/main/drivers/system_stm32h7xx.c"
    cycleCounterInit();
...
void systemResetToBootloader(bootloaderRequestType_e requestType)
{
    ...
    case BOOTLOADER_REQUEST_FLASH:
        persistentObjectWrite(PERSISTENT_OBJECT_RESET_REASON, 5);
...
# 150 "./src/main/drivers/system_stm32h7xx.c"
...
void systemJumpToBootloader(void)
{
    ...
    uint32_t bootStack = ((uint32_t *)0x1ff09800)[0];

    bootJumpPtr SysMemBootJump = (bootJumpPtr)((uint32_t *)0x1ff09800)[1];
