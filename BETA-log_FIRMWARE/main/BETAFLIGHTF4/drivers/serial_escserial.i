...
reload:
        ...
        escSerial->isTransmittingData = 
# 479 "./src/main/drivers/serial_escserial.c" 3 4
                                       1
# 479 "./src/main/drivers/serial_escserial.c"
                                           ;
    ...
    if (isEscSerialTransmitBufferEmpty((serialPort_t *)escSerial)) {
        escSerial->isTransmittingData = 
# 525 "./src/main/drivers/serial_escserial.c" 3 4
                                       0
# 525 "./src/main/drivers/serial_escserial.c"
                                            ;
        escSerialInputPortConfig(escSerial->rxTimerHardware);
    }
}
...
static void onSerialTimerEsc(timerCCHandlerRec_t *cbRec, captureCompare_t capture)
{
    (void)(capture);
    escSerial_t *escSerial = ( __extension__ ({ const typeof( ((escSerial_t *)0)->timerCb ) *__mptr = (cbRec); (escSerial_t *)( (char *)__mptr - 
# 533 "./src/main/drivers/serial_escserial.c" 3 4
                            __builtin_offsetof (
# 533 "./src/main/drivers/serial_escserial.c"
                            escSerial_t
# 533 "./src/main/drivers/serial_escserial.c" 3 4
                            , 
# 533 "./src/main/drivers/serial_escserial.c"
...
# 542 "./src/main/drivers/serial_escserial.c" 3 4
                                                       0
# 542 "./src/main/drivers/serial_escserial.c"
                                                                         , 0);
        }
    }
...
static void escSerialTimerTxConfig(const timerHardware_t *timerHardwarePtr, uint8_t reference)
{
    ...
    timerChConfigCallbacks(timerHardwarePtr, &escSerialPorts[reference].timerCb, 
# 555 "./src/main/drivers/serial_escserial.c" 3 4
                                                                                ((void *)0)
# 555 "./src/main/drivers/serial_escserial.c"
                                                                                    );
}
...
static void onSerialRxPinChangeEsc(timerCCHandlerRec_t *cbRec, captureCompare_t capture)
{
    ...
    escSerial_t *escSerial = ( __extension__ ({ const typeof( ((escSerial_t *)0)->edgeCb ) *__mptr = (cbRec); (escSerial_t *)( (char *)__mptr - 
# 581 "./src/main/drivers/serial_escserial.c" 3 4
                            __builtin_offsetof (
# 581 "./src/main/drivers/serial_escserial.c"
                            escSerial_t
# 581 "./src/main/drivers/serial_escserial.c" 3 4
                            , 
# 581 "./src/main/drivers/serial_escserial.c"
...
# 581 "./src/main/drivers/serial_escserial.c"
    ...
    else
    {
        if (!escSerial->isReceivingData)
        {
            ...
            timerChConfigIC(escSerial->rxTimerHardware, 
# 620 "./src/main/drivers/serial_escserial.c" 3 4
                                                       1
# 620 "./src/main/drivers/serial_escserial.c"
                                                                        , 0);
        }
    }
    escSerial->receiveTimeout = 0;
...
# 643 "./src/main/drivers/serial_escserial.c" 3 4
                                     0
# 643 "./src/main/drivers/serial_escserial.c"
                                                       , 0);
    timerChCCHandlerInit(&escSerialPorts[reference].edgeCb, onSerialRxPinChangeEsc);
    timerChConfigCallbacks(timerHardwarePtr, &escSerialPorts[reference].edgeCb, 
# 645 "./src/main/drivers/serial_escserial.c" 3 4
                                                                               ((void *)0)
# 645 "./src/main/drivers/serial_escserial.c"
                                                                                   );
}
...
static serialPort_t *openEscSerial(const motorDevConfig_t *motorConfig, escSerialPortIndex_e portIndex, serialReceiveCallbackPtr callback, uint16_t output, uint32_t baud, portOptions_e options, uint8_t mode)
{
    ...
    if (escSerialConfig()->ioTag == 0) {
        return 
# 667 "./src/main/drivers/serial_escserial.c" 3 4
              ((void *)0)
# 667 "./src/main/drivers/serial_escserial.c"
                  ;
    }
    if (mode != PROTOCOL_KISSALL) {
        ...
        if (timerHardware == 
# 673 "./src/main/drivers/serial_escserial.c" 3 4
                            ((void *)0)
# 673 "./src/main/drivers/serial_escserial.c"
                                ) {
            return 
# 674 "./src/main/drivers/serial_escserial.c" 3 4
                  ((void *)0)
# 674 "./src/main/drivers/serial_escserial.c"
                      ;
        }
        ...
        if (escSerial->rxTimerHardware->output & TIMER_OUTPUT_N_CHANNEL) {
            return 
# 680 "./src/main/drivers/serial_escserial.c" 3 4
                  ((void *)0)
# 680 "./src/main/drivers/serial_escserial.c"
                      ;
        }
...
# 690 "./src/main/drivers/serial_escserial.c"
        ...
        return 
# 691 "./src/main/drivers/serial_escserial.c" 3 4
              ((void *)0)
# 691 "./src/main/drivers/serial_escserial.c"
                  ;
    }
    ...
    escSerial->isTransmittingData = 
# 706 "./src/main/drivers/serial_escserial.c" 3 4
                                   0
# 706 "./src/main/drivers/serial_escserial.c"
                                        ;

    escSerial->isSearchingForStartBit = 
# 708 "./src/main/drivers/serial_escserial.c" 3 4
                                       1
# 708 "./src/main/drivers/serial_escserial.c"
                                           ;
    escSerial->rxBitIndex = 0;
    ...
    if (mode==PROTOCOL_BLHELI) {
        ...
        for (volatile uint8_t i = 0; i < 8; i++) {
            if (pwmMotors[i].enabled && pwmMotors[i].io != ((IO_t)0)) {
...
# 786 "./src/main/drivers/serial_escserial.c" 3 4
                                                         ((void *)0)
# 786 "./src/main/drivers/serial_escserial.c"
                                                             ,
# 786 "./src/main/drivers/serial_escserial.c" 3 4
                                                              ((void *)0)
# 786 "./src/main/drivers/serial_escserial.c"
...
# 790 "./src/main/drivers/serial_escserial.c" 3 4
                                                     ((void *)0)
# 790 "./src/main/drivers/serial_escserial.c"
                                                         ,
# 790 "./src/main/drivers/serial_escserial.c" 3 4
                                                          ((void *)0)
# 790 "./src/main/drivers/serial_escserial.c"
...
const struct serialPortVTable escSerialVTable[] = {
    {
        ...
        .setCtrlLineStateCb = 
# 865 "./src/main/drivers/serial_escserial.c" 3 4
                             ((void *)0)
# 865 "./src/main/drivers/serial_escserial.c"
                                 ,
        .setBaudRateCb = 
# 866 "./src/main/drivers/serial_escserial.c" 3 4
                        ((void *)0)
# 866 "./src/main/drivers/serial_escserial.c"
                            ,
        .writeBuf = 
# 867 "./src/main/drivers/serial_escserial.c" 3 4
                   ((void *)0)
# 867 "./src/main/drivers/serial_escserial.c"
                       ,
        .beginWrite = 
# 868 "./src/main/drivers/serial_escserial.c" 3 4
                     ((void *)0)
# 868 "./src/main/drivers/serial_escserial.c"
                         ,
        .endWrite = 
# 869 "./src/main/drivers/serial_escserial.c" 3 4
                   ((void *)0)
    
# 870 "./src/main/drivers/serial_escserial.c"
   }
};
...
static 
# 895 "./src/main/drivers/serial_escserial.c" 3 4
      _Bool 
# 895 "./src/main/drivers/serial_escserial.c"
           processExitCommand(uint8_t c)
{
    if (currentPort.c_state == IDLE) {
        if (c == '$') {
            ...
            return 
# 901 "./src/main/drivers/serial_escserial.c" 3 4
                  0
# 901 "./src/main/drivers/serial_escserial.c"
                       ;
        }
        ...
        if (currentPort.checksum == c) {
            ...
            if ((currentPort.cmdMSP == 0xF4) && (currentPort.dataSize==0))
            {
                currentPort.c_state = IDLE;
                return 
# 933 "./src/main/drivers/serial_escserial.c" 3 4
                      1
# 933 "./src/main/drivers/serial_escserial.c"
                          ;
            }
        } else {
            currentPort.c_state = IDLE;
    ...
    return 
# 939 "./src/main/drivers/serial_escserial.c" 3 4
          0
# 939 "./src/main/drivers/serial_escserial.c"
               ;
}



# 943 "./src/main/drivers/serial_escserial.c" 3 4
_Bool 
# 943 "./src/main/drivers/serial_escserial.c"
    escEnablePassthrough(serialPort_t *escPassthroughPort, const motorDevConfig_t *motorConfig, uint16_t escIndex, uint8_t mode)
{
    
# 945 "./src/main/drivers/serial_escserial.c" 3 4
   _Bool 
# 945 "./src/main/drivers/serial_escserial.c"
        exitEsc = 
# 945 "./src/main/drivers/serial_escserial.c" 3 4
                  0
# 945 "./src/main/drivers/serial_escserial.c"
    ...
    ledSet(0, 
# 947 "./src/main/drivers/serial_escserial.c" 3 4
   0
# 947 "./src/main/drivers/serial_escserial.c"
   );
    ledSet(1, 
# 948 "./src/main/drivers/serial_escserial.c" 3 4
   0
# 948 "./src/main/drivers/serial_escserial.c"
   );
    ...
    } else if (motor_output >= 8) {
        return 
# 971 "./src/main/drivers/serial_escserial.c" 3 4
              0
# 971 "./src/main/drivers/serial_escserial.c"
                   ;
    }

    escPort = openEscSerial(motorConfig, ESCSERIAL1, 
# 974 "./src/main/drivers/serial_escserial.c" 3 4
                                                    ((void *)0)
# 974 "./src/main/drivers/serial_escserial.c"
                                                        , motor_output, escBaudrate, 0, mode);

    if (!escPort) {
        return 
# 977 "./src/main/drivers/serial_escserial.c" 3 4
              0
# 977 "./src/main/drivers/serial_escserial.c"
                   ;
    }
...
# 985 "./src/main/drivers/serial_escserial.c"
                ...
                ledSet(0, 
# 991 "./src/main/drivers/serial_escserial.c" 3 4
               0
# 991 "./src/main/drivers/serial_escserial.c"
               );
            }
        }
        if (serialRxBytesWaiting(escPassthroughPort)) {
            ledSet(1, 
# 995 "./src/main/drivers/serial_escserial.c" 3 4
           1
# 995 "./src/main/drivers/serial_escserial.c"
           );
            while (serialRxBytesWaiting(escPassthroughPort))
            {
                ...
                if (exitEsc)
                {
                    ...
                    return 
# 1009 "./src/main/drivers/serial_escserial.c" 3 4
                          1
# 1009 "./src/main/drivers/serial_escserial.c"
                              ;
                }
                if (mode==PROTOCOL_BLHELI) {
                    serialWrite(escPassthroughPort, ch);
            ...
            ledSet(1, 
# 1016 "./src/main/drivers/serial_escserial.c" 3 4
           0
# 1016 "./src/main/drivers/serial_escserial.c"
           );
        }
