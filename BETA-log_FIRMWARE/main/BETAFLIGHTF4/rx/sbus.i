...
# 136 "./src/main/rx/sbus.c"
            ...
            sbusFrameData->done = 
# 138 "./src/main/rx/sbus.c" 3 4
                                 1
# 138 "./src/main/rx/sbus.c"
                                     ;
...
static uint8_t sbusFrameStatus(rxRuntimeState_t *rxRuntimeState)
{
    ...
    sbusFrameData->done = 
# 150 "./src/main/rx/sbus.c" 3 4
                         0
# 150 "./src/main/rx/sbus.c"
                              ;
...
# 168 "./src/main/rx/sbus.c" 3 4
_Bool 
# 168 "./src/main/rx/sbus.c"
    sbusInit(const rxConfig_t *rxConfig, rxRuntimeState_t *rxRuntimeState)
{
    ...
    if (!portConfig) {
        return 
# 193 "./src/main/rx/sbus.c" 3 4
              0
# 193 "./src/main/rx/sbus.c"
                   ;
    }
...
# 199 "./src/main/rx/sbus.c" 3 4
   _Bool 
# 199 "./src/main/rx/sbus.c"
        portShared = 
# 199 "./src/main/rx/sbus.c" 3 4
                     0
# 199 "./src/main/rx/sbus.c"
    ...
    return sBusPort != 
# 221 "./src/main/rx/sbus.c" 3 4
                      ((void *)0)
# 221 "./src/main/rx/sbus.c"
                          ;
}
