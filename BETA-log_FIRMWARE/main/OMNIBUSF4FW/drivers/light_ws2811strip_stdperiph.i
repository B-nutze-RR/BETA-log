...
# 68 "./src/main/drivers/light_ws2811strip_stdperiph.c"
        ws2811LedDataTransferInProgress = 
# 68 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
                                         0
# 68 "./src/main/drivers/light_ws2811strip_stdperiph.c"
                                              ;
        DMA_Cmd((DMA_Stream_TypeDef *)(descriptor->ref), DISABLE);
...
# 89 "./src/main/drivers/light_ws2811strip_stdperiph.c"
    ...
    if (dmaSpec == 
# 97 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
                  ((void *)0)
# 97 "./src/main/drivers/light_ws2811strip_stdperiph.c"
                      ) {
        return 
# 98 "./src/main/drivers/light_ws2811strip_stdperiph.c" 3 4
              0
# 98 "./src/main/drivers/light_ws2811strip_stdperiph.c"
                   ;
    }
...
# 113 "./src/main/drivers/light_ws2811strip_stdperiph.c"
    ...
    DMA_InitStructure.DMA_BufferSize = (32 * 24 + 42);
...
# 207 "./src/main/drivers/light_ws2811strip_stdperiph.c"
    DMA_InitStructure.DMA_Mode = ((uint32_t)0x00000000);


    DMA_Init((DMA_Stream_TypeDef *)(dmaRef), &DMA_InitStructure);
...
void ws2811LedStripDMAEnable(void)
{
    DMA_SetCurrDataCounter((DMA_Stream_TypeDef *)(dmaRef), (32 * 24 + 42));
    TIM_SetCounter(timer, 0);
    TIM_Cmd(timer, ENABLE);
    DMA_Cmd((DMA_Stream_TypeDef *)(dmaRef), ENABLE);
}
