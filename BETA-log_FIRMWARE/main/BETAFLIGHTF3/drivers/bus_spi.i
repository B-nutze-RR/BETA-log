...
# 33 "./src/main/drivers/bus_spi_impl.h"
...
# 71 "./src/main/drivers/bus_spi_impl.h" 3 4
   _Bool 
# 71 "./src/main/drivers/bus_spi_impl.h"
        leadingEdge;
# 82 "./src/main/drivers/bus_spi_impl.h"
} spiDevice_t;

extern spiDevice_t spiDevice[3];

void spiInitDevice(SPIDevice device, 
# 86 "./src/main/drivers/bus_spi_impl.h" 3 4
                                    _Bool 
# 86 "./src/main/drivers/bus_spi_impl.h"
                                         leadingEdge);
...
SPIDevice spiDeviceByInstance(SPI_TypeDef *instance)
{
    ...
    if (instance == ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)))
        return SPIDEV_2;
# 62 "./src/main/drivers/bus_spi.c"
    return SPIINVALID;
}

SPI_TypeDef *spiInstanceByDevice(SPIDevice device)
{
    if (device == SPIINVALID || device >= 3) {
        return 
# 68 "./src/main/drivers/bus_spi.c" 3 4
              ((void *)0)
# 68 "./src/main/drivers/bus_spi.c"
                  ;
    }
...
# 74 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 74 "./src/main/drivers/bus_spi.c"
    spiInit(SPIDevice device, 
# 74 "./src/main/drivers/bus_spi.c" 3 4
                              _Bool 
# 74 "./src/main/drivers/bus_spi.c"
                                   leadingEdge)
{
    ...
    case SPIINVALID:
        return 
# 78 "./src/main/drivers/bus_spi.c" 3 4
              0
# 78 "./src/main/drivers/bus_spi.c"
    ...
    case SPIDEV_1:
        ...
        return 
# 83 "./src/main/drivers/bus_spi.c" 3 4
              1
# 83 "./src/main/drivers/bus_spi.c"
                  ;
...
# 91 "./src/main/drivers/bus_spi.c"
    ...
    return 
# 128 "./src/main/drivers/bus_spi.c" 3 4
          0
# 128 "./src/main/drivers/bus_spi.c"
               ;
}
    ...
    spiBusTransfer(const busDevice_t *bus, const uint8_t *txData, uint8_t *rxData, int length)
{
    ...
    return 
# 146 "./src/main/drivers/bus_spi.c" 3 4
          1
# 146 "./src/main/drivers/bus_spi.c"
              ;
}
...
# 183 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 183 "./src/main/drivers/bus_spi.c"
    spiBusRawTransfer(const busDevice_t *bus, const uint8_t *txData, uint8_t *rxData, int len)
{
    ...
    spiBusWriteRegister(const busDevice_t *bus, uint8_t reg, uint8_t data)
{
    ...
    return 
# 195 "./src/main/drivers/bus_spi.c" 3 4
          1
# 195 "./src/main/drivers/bus_spi.c"
              ;
}


# 198 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 198 "./src/main/drivers/bus_spi.c"
    spiBusRawReadRegisterBuffer(const busDevice_t *bus, uint8_t reg, uint8_t *data, uint8_t length)
{
    IOLo(bus->busdev_u.spi.csnPin);
    spiTransferByte(bus->busdev_u.spi.instance, reg);
    spiTransfer(bus->busdev_u.spi.instance, 
# 202 "./src/main/drivers/bus_spi.c" 3 4
                                           ((void *)0)
# 202 "./src/main/drivers/bus_spi.c"
                                               , data, length);
    IOHi(bus->busdev_u.spi.csnPin);

    return 
# 205 "./src/main/drivers/bus_spi.c" 3 4
          1
# 205 "./src/main/drivers/bus_spi.c"
              ;
}
...
# 307 "./src/main/drivers/bus_spi.c"
void spiBusDeviceRegister(const busDevice_t *bus)
{
    (void)(bus);
