...
# 47 "./src/main/drivers/flash_w25m.c" 2
# 56 "./src/main/drivers/flash_w25m.c"
...
# 78 "./src/main/drivers/flash_w25m.c" 3 4
                                   ((void *)0)
# 78 "./src/main/drivers/flash_w25m.c"
                                       , 2);
...
static 
# 84 "./src/main/drivers/flash_w25m.c" 3 4
      _Bool 
# 84 "./src/main/drivers/flash_w25m.c"
...
# 90 "./src/main/drivers/flash_w25m.c"
    ...
    return 
# 95 "./src/main/drivers/flash_w25m.c" 3 4
          1
# 95 "./src/main/drivers/flash_w25m.c"
              ;
}
...
# 98 "./src/main/drivers/flash_w25m.c"
           w25m_waitForReady(flashDevice_t *fdevice)
{
    for (int die = 0 ; die < dieCount ; die++) {
        w25m_dieSelect(fdevice->io.handle.busdev, die);
        if (!dieDevice[die].vTable->waitForReady(&dieDevice[die])) {
            return 
# 103 "./src/main/drivers/flash_w25m.c" 3 4
                  0
# 103 "./src/main/drivers/flash_w25m.c"
                       ;
        }
    }

    return 
# 107 "./src/main/drivers/flash_w25m.c" 3 4
          1
# 107 "./src/main/drivers/flash_w25m.c"
              ;
}


# 110 "./src/main/drivers/flash_w25m.c" 3 4
_Bool 
# 110 "./src/main/drivers/flash_w25m.c"
    w25m_detect(flashDevice_t *fdevice, uint32_t chipID)
{
    ...
    case 0xEF7119:
        ...
        break;
# 146 "./src/main/drivers/flash_w25m.c"
    default:
        ...
        return 
# 152 "./src/main/drivers/flash_w25m.c" 3 4
              0
# 152 "./src/main/drivers/flash_w25m.c"
                   ;
    }
    ...
    return 
# 163 "./src/main/drivers/flash_w25m.c" 3 4
          1
# 163 "./src/main/drivers/flash_w25m.c"
              ;
}
