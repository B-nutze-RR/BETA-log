...
# 77 "./src/main/telemetry/crsf.c"
static 
# 77 "./src/main/telemetry/crsf.c" 3 4
      _Bool 
# 77 "./src/main/telemetry/crsf.c"
           crsfTelemetryEnabled;
static 
# 78 "./src/main/telemetry/crsf.c" 3 4
      _Bool 
# 78 "./src/main/telemetry/crsf.c"
...
# 94 "./src/main/telemetry/crsf.c" 3 4
_Bool 
# 94 "./src/main/telemetry/crsf.c"
    bufferCrsfMspFrame(uint8_t *frameStart, int frameLength)
{
    if (mspRxBuffer.len + 1 + frameLength > 96) {
        return 
# 97 "./src/main/telemetry/crsf.c" 3 4
              0
# 97 "./src/main/telemetry/crsf.c"
                   ;
    } else {
        ...
        *p++ = frameLength;
        ...
        return 
# 103 "./src/main/telemetry/crsf.c" 3 4
              1
# 103 "./src/main/telemetry/crsf.c"
                  ;
    }
}
...
# 109 "./src/main/telemetry/crsf.c"
    ...
    if (!mspRxBuffer.len) {
        return 
# 111 "./src/main/telemetry/crsf.c" 3 4
              0
# 111 "./src/main/telemetry/crsf.c"
                   ;
    }
    int pos = 0;
    while (
# 114 "./src/main/telemetry/crsf.c" 3 4
          1
# 114 "./src/main/telemetry/crsf.c"
              ) {
        const int mspFrameLength = mspRxBuffer.bytes[pos];
        if (handleMspFrame(&mspRxBuffer.bytes[1 + pos], mspFrameLength, 
# 116 "./src/main/telemetry/crsf.c" 3 4
                                                                                            ((void *)0)
# 116 "./src/main/telemetry/crsf.c"
                                                                                                )) {
...
# 309 "./src/main/telemetry/crsf.c"
void crsfFrameDeviceInfo(sbuf_t *dst) {

    char buff[30];
    tfp_sprintf(buff, "%s %s: %s", "Betaflight", "4" "." "3" "." "0", systemConfig()->boardIdentifier);
...
static 
# 434 "./src/main/telemetry/crsf.c" 3 4
      _Bool 
# 434 "./src/main/telemetry/crsf.c"
           mspReplyPending;

void crsfScheduleMspResponse(void)
{
    mspReplyPending = 
# 438 "./src/main/telemetry/crsf.c" 3 4
                     1
# 438 "./src/main/telemetry/crsf.c"
                         ;
}
...
{
    deviceInfoReplyPending = 
# 493 "./src/main/telemetry/crsf.c" 3 4
                            1
# 493 "./src/main/telemetry/crsf.c"
                                ;
}
...
void initCrsfTelemetry(void)
{
    ...
    deviceInfoReplyPending = 
# 507 "./src/main/telemetry/crsf.c" 3 4
                            0
# 507 "./src/main/telemetry/crsf.c"
                                 ;

    mspReplyPending = 
# 509 "./src/main/telemetry/crsf.c" 3 4
                     0
# 509 "./src/main/telemetry/crsf.c"
                          ;
...
# 530 "./src/main/telemetry/crsf.c" 3 4
_Bool 
# 530 "./src/main/telemetry/crsf.c"
    checkCrsfTelemetryState(void)
{
...
void handleCrsfTelemetry(timeUs_t currentTimeUs)
{
    ...
    if (deviceInfoReplyPending) {
        ...
        crsfFinalize(dst);
        deviceInfoReplyPending = 
# 590 "./src/main/telemetry/crsf.c" 3 4
                                0
# 590 "./src/main/telemetry/crsf.c"
                                     ;
        crsfLastCycleTime = currentTimeUs;
        return;
    }
...
# 597 "./src/main/telemetry/crsf.c" 3 4
                                        0
# 597 "./src/main/telemetry/crsf.c"
                                             ;
...
# 608 "./src/main/telemetry/crsf.c" 3 4
                                          0
# 608 "./src/main/telemetry/crsf.c"
                                               ;
