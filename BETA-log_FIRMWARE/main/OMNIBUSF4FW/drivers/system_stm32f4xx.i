...
# 31 "./src/main/drivers/system_stm32f4xx.c" 2
...
# 140 "./src/main/drivers/system_stm32f4xx.c" 3 4
_Bool 
# 140 "./src/main/drivers/system_stm32f4xx.c"
    isMPUSoftReset(void)
{
    if (cachedRccCsrValue & ((uint32_t)0x10000000))
        return 
# 143 "./src/main/drivers/system_stm32f4xx.c" 3 4
              1
# 143 "./src/main/drivers/system_stm32f4xx.c"
                  ;
    else
        return 
# 145 "./src/main/drivers/system_stm32f4xx.c" 3 4
              0
# 145 "./src/main/drivers/system_stm32f4xx.c"
                   ;
}
