...
# 35 "./src/main/drivers/serial_usb_vcp.h"
...
uint32_t CDC_Send_FreeBytes(void)
{
    ...
    for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((6)<<(4-(7-(((uint32_t)0x00000005)))))|((0)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
