...
# 112 "./src/main/cms/cms_menu_power.c"
                             , &(OSD_TAB_t){ &batteryConfig_voltageMeterSource, VOLTAGE_METER_COUNT - 1, voltageMeterSourceNames }, 0x10 },
    { "I METER", OME_TAB, 
# 113 "./src/main/cms/cms_menu_power.c" 3 4
                         ((void *)0)
# 113 "./src/main/cms/cms_menu_power.c"
                             , &(OSD_TAB_t){ &batteryConfig_currentMeterSource, CURRENT_METER_COUNT - 1, currentMeterSourceNames }, 0x10 },

    { "VBAT CLMIN", OME_UINT16, 
# 115 "./src/main/cms/cms_menu_power.c" 3 4
                               ((void *)0)
# 115 "./src/main/cms/cms_menu_power.c"
                                   , &(OSD_UINT16_t) { &batteryConfig_vbatmincellvoltage, 100, 500, 1 }, 0 },
    { "VBAT CLMAX", OME_UINT16, 
# 116 "./src/main/cms/cms_menu_power.c" 3 4
                               ((void *)0)
# 116 "./src/main/cms/cms_menu_power.c"
                                   , &(OSD_UINT16_t) { &batteryConfig_vbatmaxcellvoltage, 100, 500, 1 }, 0 },
    { "VBAT CLWARN", OME_UINT16, 
# 117 "./src/main/cms/cms_menu_power.c" 3 4
                                ((void *)0)
# 117 "./src/main/cms/cms_menu_power.c"
                                    , &(OSD_UINT16_t) { &batteryConfig_vbatwarningcellvoltage, 100, 500, 1 }, 0 },
...
# 122 "./src/main/cms/cms_menu_power.c"
                                   , &(OSD_INT16_t){ &currentSensorADCConfig_offset, -32000, 32000, 5 }, 0 },
...
# 126 "./src/main/cms/cms_menu_power.c"
                                         , &(OSD_UINT16_t){ &currentSensorVirtualConfig_offset, 0, 16000, 5 }, 0 },
