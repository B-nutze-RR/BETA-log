...
# 541 "./src/main/io/vtx_smartaudio.c"
...
static 
# 570 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 570 "./src/main/io/vtx_smartaudio.c"
           saQueueEmpty(void)
{
...
static 
# 575 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 575 "./src/main/io/vtx_smartaudio.c"
           saQueueFull(void)
{
...
static 
# 611 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 611 "./src/main/io/vtx_smartaudio.c"
...
# 664 "./src/main/io/vtx_smartaudio.c"
void saSetMode(int mode)
{
...
# 683 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 683 "./src/main/io/vtx_smartaudio.c"
    vtxSmartAudioInit(void)
{
...
# 709 "./src/main/io/vtx_smartaudio.c" 3 4
                                                                                              ((void *)0)
# 709 "./src/main/io/vtx_smartaudio.c"
                                                                                                  , 
# 709 "./src/main/io/vtx_smartaudio.c" 3 4
                                                                                                    ((void *)0)
# 709 "./src/main/io/vtx_smartaudio.c"
    ...
    if (!smartAudioSerialPort) {
        return 
# 713 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 713 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
    ...
    return 
# 731 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 731 "./src/main/io/vtx_smartaudio.c"
              ;
}
...
static void vtxSAProcess(vtxDevice_t *vtxDevice, timeUs_t currentTimeUs)
{
    ...
    if (smartAudioSerialPort == 
# 746 "./src/main/io/vtx_smartaudio.c" 3 4
                               ((void *)0)
# 746 "./src/main/io/vtx_smartaudio.c"
                                   ) {
        return;
    }
...
# 807 "./src/main/io/vtx_smartaudio.c"
            if (saDevice.version >= 2 ) {

                saDevice.willBootIntoPitMode = (saDevice.mode & 2) ? 
# 809 "./src/main/io/vtx_smartaudio.c" 3 4
                                                                                      1 
# 809 "./src/main/io/vtx_smartaudio.c"
                                                                                           : 
# 809 "./src/main/io/vtx_smartaudio.c" 3 4
                                                                                             0
# 809 "./src/main/io/vtx_smartaudio.c"
...
static 
# 977 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 977 "./src/main/io/vtx_smartaudio.c"
           vtxSAGetBandAndChannel(const vtxDevice_t *vtxDevice, uint8_t *pBand, uint8_t *pChannel)
{
    if (!vtxSAIsReady(vtxDevice)) {
        return 
# 980 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 980 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
    ...
    if (saDevice.mode & 1) {
        ...
        *pChannel = 0;
        return 
# 986 "./src/main/io/vtx_smartaudio.c" 3 4
              1
# 986 "./src/main/io/vtx_smartaudio.c"
                  ;
    } else {
        *pBand = ((saDevice.channel) / (uint8_t)vtxTableChannelCount) + 1;
        *pChannel = ((saDevice.channel) % (uint8_t)vtxTableChannelCount) + 1;
        return 
# 990 "./src/main/io/vtx_smartaudio.c" 3 4
              1
# 990 "./src/main/io/vtx_smartaudio.c"
                  ;
    }
}

static 
# 994 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 994 "./src/main/io/vtx_smartaudio.c"
           vtxSAGetPowerIndex(const vtxDevice_t *vtxDevice, uint8_t *pIndex)
{
    if (!vtxSAIsReady(vtxDevice)) {
        return 
# 997 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 997 "./src/main/io/vtx_smartaudio.c"
                   ;
    }

    *pIndex = saDevice.power;
    return 
# 1001 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 1001 "./src/main/io/vtx_smartaudio.c"
              ;
}

static 
# 1004 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 1004 "./src/main/io/vtx_smartaudio.c"
           vtxSAGetFreq(const vtxDevice_t *vtxDevice, uint16_t *pFreq)
{
    if (!vtxSAIsReady(vtxDevice)) {
        return 
# 1007 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 1007 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
    ...
    *pFreq = (saDevice.mode & 1) ? saDevice.freq :
             vtxCommonLookupFrequency(&vtxSmartAudio,
                                      ...
                                      ((saDevice.channel) % (uint8_t)vtxTableChannelCount) + 1);
    return 
# 1015 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 1015 "./src/main/io/vtx_smartaudio.c"
              ;
}

static 
# 1018 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 1018 "./src/main/io/vtx_smartaudio.c"
           vtxSAGetStatus(const vtxDevice_t *vtxDevice, unsigned *status)
{
    if (!vtxSAIsReady(vtxDevice) || saDevice.version < 2) {
        return 
# 1021 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 1021 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
