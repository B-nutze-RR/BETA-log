...
# 94 "./src/main/cms/cms.c" 3 4
_Bool 
# 94 "./src/main/cms/cms.c"
    cmsDisplayPortRegister(displayPort_t *pDisplay)
{
...
static displayPort_t *cmsDisplayPortSelectNext(void)
{
    if (cmsDeviceCount == 0) {
        return 
# 121 "./src/main/cms/cms.c" 3 4
              ((void *)0)
# 121 "./src/main/cms/cms.c"
                  ;
    }
...
# 129 "./src/main/cms/cms.c" 3 4
_Bool 
# 129 "./src/main/cms/cms.c"
    cmsDisplayPortSelect(displayPort_t *instance)
{
    for (unsigned i = 0; i < cmsDeviceCount; i++) {
        if (cmsDisplayPortSelectNext() == instance) {
            return 
# 133 "./src/main/cms/cms.c" 3 4
                  1
# 133 "./src/main/cms/cms.c"
                      ;
        }
    }
    return 
...
# 163 "./src/main/cms/cms.c"
static 
# 163 "./src/main/cms/cms.c" 3 4
      _Bool 
# 163 "./src/main/cms/cms.c"
              smallScreen;
...
static 
# 169 "./src/main/cms/cms.c" 3 4
      _Bool 
# 169 "./src/main/cms/cms.c"
           osdElementEditing = 
# 169 "./src/main/cms/cms.c" 3 4
                               0
# 169 "./src/main/cms/cms.c"
...
# 171 "./src/main/cms/cms.c" 3 4
_Bool 
# 171 "./src/main/cms/cms.c"
    cmsInMenu = 
# 171 "./src/main/cms/cms.c" 3 4
                0
# 171 "./src/main/cms/cms.c"
...
static 
# 188 "./src/main/cms/cms.c" 3 4
      _Bool 
# 188 "./src/main/cms/cms.c"
           saveMenuInhibited = 
# 188 "./src/main/cms/cms.c" 3 4
                               0
# 188 "./src/main/cms/cms.c"
                                    ;
# 219 "./src/main/cms/cms.c"
...
# 392 "./src/main/cms/cms.c" 3 4
                                                                                     _Bool 
# 392 "./src/main/cms/cms.c"
                                                                                          selectedRow, uint8_t *flags, cmsTableTicker_t *ticker)
{
    ...
    case OME_Funcall:
        if (((*flags) & 0x01)) {
            ...
            if (p->type == OME_Submenu && p->func && *flags & 0x08) {
    ...
    case OME_TAB:
        if (((*flags) & 0x01) || ((*flags) & 0x20)) {
            
# 457 "./src/main/cms/cms.c" 3 4
           _Bool 
# 457 "./src/main/cms/cms.c"
                drawText = 
# 457 "./src/main/cms/cms.c" 3 4
                           0
# 457 "./src/main/cms/cms.c"
            ...
            if (((*flags) & 0x01)) {
                drawText = 
# 469 "./src/main/cms/cms.c" 3 4
                          1
# 469 "./src/main/cms/cms.c"
                              ;
                ticker->state = 0;
                ticker->loopCounter = 0;
                if (displayLength > availableSpace) {
                    do { (*flags) |= 0x20; } while (0);
                } else {
                    do { (*flags) &= ~0x20; } while (0);
                }
            } else if (((*flags) & 0x20)) {
                ...
                if (ticker->loopCounter >= loopLimit) {
                    ticker->loopCounter = 0;
                    drawText = 
# 482 "./src/main/cms/cms.c" 3 4
                              1
# 482 "./src/main/cms/cms.c"
                                  ;
                    ticker->state++;
...
static const void *cmsMenuBack(displayPort_t *pDisplay)
{
    ...
    saveMenuInhibited = 
# 634 "./src/main/cms/cms.c" 3 4
                       0
# 634 "./src/main/cms/cms.c"
                            ;
...
# 637 "./src/main/cms/cms.c"
    ...
    return 
# 649 "./src/main/cms/cms.c" 3 4
          ((void *)0)
# 649 "./src/main/cms/cms.c"
              ;
}


static 
# 653 "./src/main/cms/cms.c" 3 4
      _Bool 
# 653 "./src/main/cms/cms.c"
...
# 656 "./src/main/cms/cms.c"
    ...
    if (row->type == OME_String) {
        return 
# 660 "./src/main/cms/cms.c" 3 4
              1
# 660 "./src/main/cms/cms.c"
                  ;
    }

    if ((row->type == OME_UINT16 || row->type == OME_INT16) && row->flags == 0x04) {
        return 
...
static void cmsDrawMenu(displayPort_t *pDisplay, uint32_t currentTimeUs)
{
    ...
    const 
# 675 "./src/main/cms/cms.c" 3 4
         _Bool 
# 675 "./src/main/cms/cms.c"
    ...
    pDisplay->cleared = 
# 680 "./src/main/cms/cms.c" 3 4
                       0
# 680 "./src/main/cms/cms.c"
                            ;



    
# 684 "./src/main/cms/cms.c" 3 4
   _Bool 
# 684 "./src/main/cms/cms.c"
        drawPolled = 
# 684 "./src/main/cms/cms.c" 3 4
                     0
# 684 "./src/main/cms/cms.c"
    ...
    if (currentTimeUs > lastPolledUs + 100000) {
        drawPolled = 
# 688 "./src/main/cms/cms.c" 3 4
                    1
# 688 "./src/main/cms/cms.c"
                        ;
    ...
    if (displayWasCleared) {
        for (p = pageTop, i= 0; (p <= pageTop + pageMaxRow); p++, i++) {
            do { (runtimeEntryFlags[i]) |= 0x02; } while (0);
            do { (runtimeEntryFlags[i]) |= 0x01; } while (0);
        }
    } else if (drawPolled) {
        for (p = pageTop, i = 0; (p <= pageTop + pageMaxRow); p++, i++) {
            if (((p)->flags & 0x04))
    ...
    for (i = 0, p = pageTop; (p <= pageTop + pageMaxRow); i++, p++) {
        ...
        if (((runtimeEntryFlags[i]) & 0x01) || ((runtimeEntryFlags[i]) & 0x20)) {
            
# 760 "./src/main/cms/cms.c" 3 4
           _Bool 
# 760 "./src/main/cms/cms.c"
...
const void *cmsMenuChange(displayPort_t *pDisplay, const void *ptr)
{
    ...
    if (!pMenu) {
        return 
# 790 "./src/main/cms/cms.c" 3 4
              ((void *)0)
# 790 "./src/main/cms/cms.c"
                  ;
    }
# 805 "./src/main/cms/cms.c"
    if (pMenu != currentCtx.menu) {
        saveMenuInhibited = 
# 806 "./src/main/cms/cms.c" 3 4
                           0
# 806 "./src/main/cms/cms.c"
                                ;
        ...
        if (currentCtx.menu) {
            ...
            if (menuStackIdx >= 10 - 1) {
                ...
                return 
# 813 "./src/main/cms/cms.c" 3 4
                      ((void *)0)
# 813 "./src/main/cms/cms.c"
                          ;
            }
...
void cmsMenuOpen(void)
{
    ...
    if (!cmsInMenu) {
        ...
        cmsInMenu = 
# 856 "./src/main/cms/cms.c" 3 4
                   1
# 856 "./src/main/cms/cms.c"
                       ;
        currentCtx = (cmsCtx_t){ 
# 857 "./src/main/cms/cms.c" 3 4
                                ((void *)0)
# 857 "./src/main/cms/cms.c"
                                    , 0, 0 };
    ...
    if ( pCurrentDisplay->cols < 18) {
      smallScreen = 
# 888 "./src/main/cms/cms.c" 3 4
                         1
# 888 "./src/main/cms/cms.c"
                             ;
      linesPerMenuItem = 2;
      leftMenuColumn = 0;
...
# 936 "./src/main/cms/cms.c" 3 4
                                                          ((void *)0)
# 936 "./src/main/cms/cms.c"
                                                              );
        }
...
# 943 "./src/main/cms/cms.c" 3 4
                                                                    ((void *)0)
# 943 "./src/main/cms/cms.c"
                                                                        );
                }
            }
        }
    ...
    cmsInMenu = 
# 955 "./src/main/cms/cms.c" 3 4
               0
# 955 "./src/main/cms/cms.c"
                    ;
    ...
    currentCtx.menu = 
# 960 "./src/main/cms/cms.c" 3 4
                     ((void *)0)
# 960 "./src/main/cms/cms.c"
                         ;
    ...
    return 
# 978 "./src/main/cms/cms.c" 3 4
          ((void *)0)
# 978 "./src/main/cms/cms.c"
              ;
}
# 990 "./src/main/cms/cms.c"
static uint16_t cmsHandleKey(displayPort_t *pDisplay, cms_key_e key)
{
    ...
    if (key == CMS_KEY_ESC) {
        if (osdElementEditing) {
            osdElementEditing = 
# 1006 "./src/main/cms/cms.c" 3 4
                               0
# 1006 "./src/main/cms/cms.c"
                                    ;
        } else {
            cmsMenuBack(pDisplay);
        }
    ...
    if (key == CMS_KEY_SAVEMENU && !saveMenuInhibited) {
        osdElementEditing = 
# 1014 "./src/main/cms/cms.c" 3 4
                           0
# 1014 "./src/main/cms/cms.c"
                                ;
    ...
    switch (p->type) {
        ...
        case OME_Back:
            ...
            res = 500;
            osdElementEditing = 
# 1081 "./src/main/cms/cms.c" 3 4
                               0
# 1081 "./src/main/cms/cms.c"
                                    ;
            break;
        ...
        case OME_Bool:
            if (p->data) {
                ...
                *val = (key == CMS_KEY_RIGHT) ? 1 : 0;
                do { (runtimeEntryFlags[currentCtx.cursorRow]) |= 0x01; } while (0);
                if ((p->flags & 0x10) && (*val != previousValue)) {
                    setRebootRequired();
                }
                if (p->func) {
                    p->func(pDisplay, p->data);
        ...
        case OME_VISIBLE:
            if (p->data) {
                ...
                if ((key == CMS_KEY_RIGHT) && (!osdElementEditing)) {
                    osdElementEditing = 
# 1105 "./src/main/cms/cms.c" 3 4
                                       1
# 1105 "./src/main/cms/cms.c"
                                           ;
                    osdProfileCursor = 1;
        ...
        case OME_FLOAT:
            if (p->data) {
                ...
                do { (runtimeEntryFlags[currentCtx.cursorRow]) |= 0x01; } while (0);
                if ((p->flags & 0x10) && (*ptr->val != previousValue)) {
                    setRebootRequired();
                }
                if (p->func) {
                    p->func(pDisplay, p);
...
{
    saveMenuInhibited = 
# 1467 "./src/main/cms/cms.c" 3 4
                       1
# 1467 "./src/main/cms/cms.c"
                           ;
}
