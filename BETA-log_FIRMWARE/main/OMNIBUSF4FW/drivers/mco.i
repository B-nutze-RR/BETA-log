...
void mcoConfigure(MCODevice_e device, const mcoConfig_t *config)
{
    ...
    case MCODEV_2:
        ...
        RCC_MCO2Config(((uint32_t)0x40000000), ((uint32_t)0x30000000));
        IOConfigGPIOAF(io, ((GPIO_Mode_AF) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), ((uint8_t)0x00));
