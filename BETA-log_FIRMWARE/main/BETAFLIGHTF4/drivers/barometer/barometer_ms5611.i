...
# 58 "./src/main/drivers/barometer/barometer_ms5611.c"
...
{
# 79 "./src/main/drivers/barometer/barometer_ms5611.c"
    (void)(busdev);
...
{
    busRawWriteRegister(busdev, 0x1E, 1);
...
static uint16_t ms5611Prom(busDevice_t *busdev, int8_t coef_num)
{
    ...
    busRawReadRegisterBuffer(busdev, 0xA0 + coef_num * 2, rxbuf, 2);

    return rxbuf[0] << 8 | rxbuf[1];
}

static int8_t ms5611CRC(uint16_t *prom)
{
    int32_t i, j;
    uint32_t res = 0;
...
# 117 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
   _Bool 
# 117 "./src/main/drivers/barometer/barometer_ms5611.c"
        blankEeprom = 
# 117 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                      1
# 117 "./src/main/drivers/barometer/barometer_ms5611.c"
    ...
    for (i = 0; i < 16; i++) {
        if (prom[i >> 1]) {
            blankEeprom = 
# 121 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                         0
# 121 "./src/main/drivers/barometer/barometer_ms5611.c"
                              ;
        }
        if (i & 1)
            res ^= ((prom[i >> 1]) & 0x00FF);
...
{
    busRawReadRegisterBufferStart(busdev, 0x00, sensor_data, 3);
}

static void ms5611StartUT(baroDev_t *baro)
{
    busRawWriteRegisterStart(&baro->busdev, 0x40 + 0x10 + ms5611_osr, 1);
}

static 
# 150 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
      _Bool 
# 150 "./src/main/drivers/barometer/barometer_ms5611.c"
           ms5611ReadUT(baroDev_t *baro)
{
    if (busBusy(&baro->busdev, 
# 152 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                              ((void *)0)
# 152 "./src/main/drivers/barometer/barometer_ms5611.c"
                                  )) {
        return 
# 153 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
              0
# 153 "./src/main/drivers/barometer/barometer_ms5611.c"
                   ;
    }
    ...
    return 
# 158 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
          1
# 158 "./src/main/drivers/barometer/barometer_ms5611.c"
              ;
}

static 
# 161 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
      _Bool 
# 161 "./src/main/drivers/barometer/barometer_ms5611.c"
           ms5611GetUT(baroDev_t *baro)
{
    if (busBusy(&baro->busdev, 
# 163 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                              ((void *)0)
# 163 "./src/main/drivers/barometer/barometer_ms5611.c"
                                  )) {
        return 
# 164 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
              0
# 164 "./src/main/drivers/barometer/barometer_ms5611.c"
                   ;
    }
...
{
    busRawWriteRegisterStart(&baro->busdev, 0x40 + 0x00 + ms5611_osr, 1);
}

static 
# 177 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
      _Bool 
# 177 "./src/main/drivers/barometer/barometer_ms5611.c"
           ms5611ReadUP(baroDev_t *baro)
{
    if (busBusy(&baro->busdev, 
# 179 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                              ((void *)0)
# 179 "./src/main/drivers/barometer/barometer_ms5611.c"
                                  )) {
        return 
# 180 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
              0
# 180 "./src/main/drivers/barometer/barometer_ms5611.c"
                   ;
    }
    ...
    return 
# 185 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
          1
# 185 "./src/main/drivers/barometer/barometer_ms5611.c"
              ;
}

static 
# 188 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
      _Bool 
# 188 "./src/main/drivers/barometer/barometer_ms5611.c"
           ms5611GetUP(baroDev_t *baro)
{
    if (busBusy(&baro->busdev, 
# 190 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                              ((void *)0)
# 190 "./src/main/drivers/barometer/barometer_ms5611.c"
                                  )) {
        return 
# 191 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
              0
# 191 "./src/main/drivers/barometer/barometer_ms5611.c"
                   ;
    }
    ...
    return 
# 196 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
          1
# 196 "./src/main/drivers/barometer/barometer_ms5611.c"
              ;
}

static void ms5611Calculate(int32_t *pressure, int32_t *temperature)
{
    uint32_t press;
    int64_t temp;
    int64_t delt;
...
# 231 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
_Bool 
# 231 "./src/main/drivers/barometer/barometer_ms5611.c"
    ms5611Detect(baroDev_t *baro)
{
    uint8_t sig;
    int i;
    
# 235 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
   _Bool 
# 235 "./src/main/drivers/barometer/barometer_ms5611.c"
...
# 235 "./src/main/drivers/barometer/barometer_ms5611.c"
    ...
    if ((busdev->bustype == BUSTYPE_I2C) && (busdev->busdev_u.i2c.address == 0)) {
        ...
        defaultAddressApplied = 
# 246 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                               1
# 246 "./src/main/drivers/barometer/barometer_ms5611.c"
                                   ;
    }

    if (!busRawReadRegisterBuffer(busdev, 0xA0, &sig, 1) || sig == 0xFF) {
        goto fail;
    }
    ...
    return 
# 277 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
          1
# 277 "./src/main/drivers/barometer/barometer_ms5611.c"
              ;
...
fail:;
    ...
    return 
# 286 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
          0
# 286 "./src/main/drivers/barometer/barometer_ms5611.c"
               ;
}
