...
# 32 "./src/main/drivers/dshot_bitbang.c" 2
...
# 87 "./src/main/drivers/dshot_bitbang_impl.h"
typedef struct dmaRegCache_s {
    ...
    uint32_t PAR;
    uint32_t M0AR;
# 102 "./src/main/drivers/dshot_bitbang_impl.h"
} dmaRegCache_t;
...
# 168 "./src/main/drivers/dshot_bitbang_impl.h" 3 4
   _Bool 
# 168 "./src/main/drivers/dshot_bitbang_impl.h"
        inputActive;
...
# 188 "./src/main/drivers/dshot_bitbang_impl.h" 3 4
   _Bool 
# 188 "./src/main/drivers/dshot_bitbang_impl.h"
        configured;
...
extern uint32_t bbOutputBuffer[((16 / 1) * 3) * 4];
# 232 "./src/main/drivers/dshot_bitbang_impl.h"
...
# 38 "./src/main/drivers/dshot_bitbang.c" 2
...
# 41 "./src/main/drivers/dshot_bitbang.c" 2
...
# 57 "./src/main/drivers/dshot_bitbang.c"
...
# 91 "./src/main/drivers/dshot_bitbang.c"
 uint32_t bbOutputBuffer[((16 / 1) * 3) * 4];
 uint16_t bbInputBuffer[140 * 4];
...
const timerHardware_t bbTimerHardware[] = {
    ...
    { ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), 0, ((uint16_t)0x0000), TIM_USE_NONE, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x03) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x040)), ((uint32_t)0x0E000000) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028)), ((uint32_t)0x0E000000), DMA2_ST1_HANDLER },
    { ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), 0, ((uint16_t)0x0004), TIM_USE_NONE, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x03) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x058)), ((uint32_t)0x0E000000) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028)), ((uint32_t)0x0E000000), DMA2_ST1_HANDLER },
    { ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), 0, ((uint16_t)0x0008), TIM_USE_NONE, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x03) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x070)), ((uint32_t)0x0E000000) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028)), ((uint32_t)0x0E000000), DMA2_ST1_HANDLER },
    { ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), 0, ((uint16_t)0x000C), TIM_USE_NONE, (TIMER_OUTPUT_NONE | 0), ((uint8_t)0x03) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x0B8)), ((uint32_t)0x0E000000) , (dmaResource_t *)((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028)), ((uint32_t)0x0E000000), DMA2_ST1_HANDLER },
...
# 133 "./src/main/drivers/dshot_bitbang.c"
};
...
# 142 "./src/main/drivers/dshot_bitbang.c" 3 4
                                                                 _Bool 
# 142 "./src/main/drivers/dshot_bitbang.c"
                                                                      inverted)
{
    uint32_t resetMask;
    uint32_t setMask;
...
# 164 "./src/main/drivers/dshot_bitbang.c" 3 4
                                                                            _Bool 
# 164 "./src/main/drivers/dshot_bitbang.c"
                                                                                 inverted)
{
    uint32_t middleBit;
...
static bbPacer_t *bbFindMotorPacer(TIM_TypeDef *tim)
{
    for (int i = 0; i < 4; i++) {
        ...
        if (bbPacer->tim == 
# 198 "./src/main/drivers/dshot_bitbang.c" 3 4
                           ((void *)0)
# 198 "./src/main/drivers/dshot_bitbang.c"
                               ) {
            bbPacer->tim = tim;
            ++usedMotorPacers;
            return bbPacer;
    ...
    return 
# 209 "./src/main/drivers/dshot_bitbang.c" 3 4
          ((void *)0)
# 209 "./src/main/drivers/dshot_bitbang.c"
              ;
}
...
static bbPort_t *bbFindMotorPort(int portIndex)
{
    ...
    return 
# 221 "./src/main/drivers/dshot_bitbang.c" 3 4
          ((void *)0)
# 221 "./src/main/drivers/dshot_bitbang.c"
              ;
}
...
# 228 "./src/main/drivers/dshot_bitbang.c"
    ...
    if (!bbPort->timhw) {
        ...
        return 
# 236 "./src/main/drivers/dshot_bitbang.c" 3 4
              ((void *)0)
# 236 "./src/main/drivers/dshot_bitbang.c"
                  ;
    }
...
static void bbAllocDma(bbPort_t *bbPort)
{
    ...
    dmaSetHandler(dmaIdentifier, bbDMAIrqHandler, (((((2)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), (uint32_t)bbPort);
...
# 352 "./src/main/drivers/dshot_bitbang.c" 3 4
           _Bool 
# 352 "./src/main/drivers/dshot_bitbang.c"
                timerConflict = 
# 352 "./src/main/drivers/dshot_bitbang.c" 3 4
                                0
# 352 "./src/main/drivers/dshot_bitbang.c"
            ...
            for (int channel = 0; channel < 4; channel++) {
                const resourceOwner_e timerOwner = timerGetOwner(timNumber, ((uint16_t)(channel) << 2))->owner;
                if (timerOwner != OWNER_FREE && timerOwner != OWNER_DSHOT_BITBANG) {
                    timerConflict = 
# 356 "./src/main/drivers/dshot_bitbang.c" 3 4
                                   1
# 356 "./src/main/drivers/dshot_bitbang.c"
                                       ;
                    break;
                }
            }
...
static 
# 408 "./src/main/drivers/dshot_bitbang.c" 3 4
      _Bool 
# 408 "./src/main/drivers/dshot_bitbang.c"
           bbMotorConfig(IO_t io, uint8_t motorIndex, motorPwmProtocolTypes_e pwmProtocolType, uint8_t output)
{
    ...
    if (!bbPort) {
        ...
        if (!bbPort) {
            ...
            return 
# 425 "./src/main/drivers/dshot_bitbang.c" 3 4
                  0
# 425 "./src/main/drivers/dshot_bitbang.c"
                       ;
        }

        bbPort->gpio = IO_GPIO(io);

        bbPort->portOutputCount = ((16 / 1) * 3);
        bbPort->portOutputBuffer = &bbOutputBuffer[(bbPort - bbPorts) * ((16 / 1) * 3)];
...
# 460 "./src/main/drivers/dshot_bitbang.c" 3 4
                                                                   1
# 460 "./src/main/drivers/dshot_bitbang.c"
                                                                                         );
    } else

    {
        bbOutputDataInit(bbPort->portOutputBuffer, (1 << pinIndex), 
# 464 "./src/main/drivers/dshot_bitbang.c" 3 4
                                                                   0
# 464 "./src/main/drivers/dshot_bitbang.c"
                                                                                            );
    }
...
# 469 "./src/main/drivers/dshot_bitbang.c" 3 4
                                     1
# 469 "./src/main/drivers/dshot_bitbang.c"
                                         ;

    return 
# 471 "./src/main/drivers/dshot_bitbang.c" 3 4
          1
# 471 "./src/main/drivers/dshot_bitbang.c"
              ;
}

static 
# 474 "./src/main/drivers/dshot_bitbang.c" 3 4
      _Bool 
# 474 "./src/main/drivers/dshot_bitbang.c"
           bbUpdateStart(void)
{
    ...
    if (useDshotTelemetry) {
        ...
        if (cmpTimeUs(currentUs, lastSendUs) < (timeDelta_t)(40 + 2 * dshotFrameUs)) {
            return 
# 484 "./src/main/drivers/dshot_bitbang.c" 3 4
                  0
# 484 "./src/main/drivers/dshot_bitbang.c"
                       ;
        }

        for (int motorIndex = 0; motorIndex < 8 && motorIndex < motorCount; motorIndex++) {
# 503 "./src/main/drivers/dshot_bitbang.c"
...
# 520 "./src/main/drivers/dshot_bitbang.c" 3 4
                                                                            1
# 520 "./src/main/drivers/dshot_bitbang.c"
                                                                                ;
                if (motorIndex < 4) {
                    {if (debugMode == (DEBUG_DSHOT_RPM_TELEMETRY)) {debug[(motorIndex)] = (value);}};
                }
            } else {
    ...
    return 
# 538 "./src/main/drivers/dshot_bitbang.c" 3 4
          1
# 538 "./src/main/drivers/dshot_bitbang.c"
              ;
}
...
# 552 "./src/main/drivers/dshot_bitbang.c" 3 4
                                             0
# 552 "./src/main/drivers/dshot_bitbang.c"
                                                  ;
...
# 558 "./src/main/drivers/dshot_bitbang.c" 3 4
                                                       1
# 558 "./src/main/drivers/dshot_bitbang.c"
                                                           ;
        }
    }
...
# 570 "./src/main/drivers/dshot_bitbang.c" 3 4
                                                                            1
# 570 "./src/main/drivers/dshot_bitbang.c"
                                                                                                  );
    } else
...
# 609 "./src/main/drivers/dshot_bitbang.c"
    for (int i = 0; i < usedMotorPorts; i++) {
        ...
        if (useDshotTelemetry) {
            if (bbPort->direction == 1) {
                bbPort->inputActive = 
# 614 "./src/main/drivers/dshot_bitbang.c" 3 4
                                     0
# 614 "./src/main/drivers/dshot_bitbang.c"
                                          ;
                bbSwitchToOutput(bbPort);
            }
...
static 
# 631 "./src/main/drivers/dshot_bitbang.c" 3 4
      _Bool 
# 631 "./src/main/drivers/dshot_bitbang.c"
           bbEnableMotors(void)
{
    ...
    return 
# 638 "./src/main/drivers/dshot_bitbang.c" 3 4
          1
# 638 "./src/main/drivers/dshot_bitbang.c"
              ;
}
...
static 
# 651 "./src/main/drivers/dshot_bitbang.c" 3 4
      _Bool 
# 651 "./src/main/drivers/dshot_bitbang.c"
...
static void bbPostInit()
{
    ...
    for (int motorIndex = 0; motorIndex < 8 && motorIndex < motorCount; motorIndex++) {
        ...
        if (!bbMotorConfig(bbMotors[motorIndex].io, motorIndex, motorPwmProtocol, bbMotors[motorIndex].output)) {
            return 
# 663 "./src/main/drivers/dshot_bitbang.c" 3 4
                  ((void *)0)
# 663 "./src/main/drivers/dshot_bitbang.c"
                      ;
        }


        bbMotors[motorIndex].enabled = 
# 667 "./src/main/drivers/dshot_bitbang.c" 3 4
                                      1
# 667 "./src/main/drivers/dshot_bitbang.c"
                                          ;



        motors[motorIndex].enabled = 
# 671 "./src/main/drivers/dshot_bitbang.c" 3 4
                                    1
# 671 "./src/main/drivers/dshot_bitbang.c"
                                        ;
    }
}
...
motorDevice_t *dshotBitbangDevInit(const motorDevConfig_t *motorConfig, uint8_t count)
{
    ...
    for (int motorIndex = 0; motorIndex < 8 && motorIndex < motorCount; motorIndex++) {
        ...
        if (!IOIsFreeOrPreinit(io)) {
            ...
            return 
# 731 "./src/main/drivers/dshot_bitbang.c" 3 4
                  ((void *)0)
# 731 "./src/main/drivers/dshot_bitbang.c"
                      ;
        }
        ...
        bbMotors[motorIndex].iocfg = ((GPIO_Mode_OUT) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((bbPuPdMode) << 5));
