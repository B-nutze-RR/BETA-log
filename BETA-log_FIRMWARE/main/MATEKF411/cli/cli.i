...
extern timerUpConfig_t timerUpConfig_SystemArray[10]; extern timerUpConfig_t timerUpConfig_CopyArray[10]; static inline const timerUpConfig_t* timerUpConfig(int _index) { return &timerUpConfig_SystemArray[_index]; } static inline timerUpConfig_t* timerUpConfigMutable(int _index) { return &timerUpConfig_SystemArray[_index]; } static inline timerUpConfig_t (* timerUpConfig_array(void))[10] { return &timerUpConfig_SystemArray; } struct _dummy;
...
typedef enum {
    ...
    TASK_BEEPER,
# 94 "./src/main/scheduler/scheduler.h"
    TASK_BARO,
