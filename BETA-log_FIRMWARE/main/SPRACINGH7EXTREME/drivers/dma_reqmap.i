...
# 212 "./src/main/drivers/dma_reqmap.c"
static const dmaPeripheralMapping_t dmaPeripheralMapping[] = {

    { DMA_PERIPH_SPI_TX, SPIDEV_1, 38U },
    { DMA_PERIPH_SPI_RX, SPIDEV_1, 37U },
    { DMA_PERIPH_SPI_TX, SPIDEV_2, 40U },
    { DMA_PERIPH_SPI_RX, SPIDEV_2, 39U },
    { DMA_PERIPH_SPI_TX, SPIDEV_3, 62U },
    { DMA_PERIPH_SPI_RX, SPIDEV_3, 61U },
    { DMA_PERIPH_SPI_TX, SPIDEV_4, 84U },
    { DMA_PERIPH_SPI_RX, SPIDEV_4, 83U },
    { DMA_PERIPH_SPI_TX, SPIDEV_5, 86U },
    { DMA_PERIPH_SPI_TX, SPIDEV_5, 86U },
    ...
    { DMA_PERIPH_ADC, ADCDEV_1, 9U },
    { DMA_PERIPH_ADC, ADCDEV_2, 10U },

    { DMA_PERIPH_ADC, ADCDEV_3, 115U },




    { DMA_PERIPH_UART_TX, UARTDEV_1, 42U },
    { DMA_PERIPH_UART_RX, UARTDEV_1, 41U },
    { DMA_PERIPH_UART_TX, UARTDEV_2, 44U },
    { DMA_PERIPH_UART_RX, UARTDEV_2, 43U },
    { DMA_PERIPH_UART_TX, UARTDEV_3, 46U },
    { DMA_PERIPH_UART_RX, UARTDEV_3, 45U },
    { DMA_PERIPH_UART_TX, UARTDEV_4, 64U },
    { DMA_PERIPH_UART_RX, UARTDEV_4, 63U },
    { DMA_PERIPH_UART_TX, UARTDEV_5, 66U },
    { DMA_PERIPH_UART_RX, UARTDEV_5, 65U },
    { DMA_PERIPH_UART_TX, UARTDEV_6, 72U },
    { DMA_PERIPH_UART_RX, UARTDEV_6, 71U },
    { DMA_PERIPH_UART_TX, UARTDEV_7, 80U },
    { DMA_PERIPH_UART_RX, UARTDEV_7, 79U },
    { DMA_PERIPH_UART_TX, UARTDEV_8, 82U },
    { DMA_PERIPH_UART_RX, UARTDEV_8, 81U },




    { DMA_PERIPH_TIMUP, 1 - 1, 15U },
    { DMA_PERIPH_TIMUP, 2 - 1, 22U },
    { DMA_PERIPH_TIMUP, 3 - 1, 27U },
    { DMA_PERIPH_TIMUP, 4 - 1, 32U },
    { DMA_PERIPH_TIMUP, 5 - 1, 59U },
    { DMA_PERIPH_TIMUP, 6 - 1, 69U },
    { DMA_PERIPH_TIMUP, 7 - 1, 70U },
    { DMA_PERIPH_TIMUP, 8 - 1, 51U },
    { DMA_PERIPH_TIMUP, 15 - 1, 106U },
    { DMA_PERIPH_TIMUP, 16 - 1, 110U },
    { DMA_PERIPH_TIMUP, 17 - 1, 112U },

};
# 280 "./src/main/drivers/dma_reqmap.c"
static const dmaTimerMapping_t dmaTimerMapping[] = {
    { ((TIM_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0000UL)), 0x00000000U, 11U },
    { ((TIM_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0000UL)), 0x00000004U, 12U },
    { ((TIM_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0000UL)), 0x00000008U, 13U },
    { ((TIM_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0000UL)), 0x0000000CU, 14U },
    { ((TIM_TypeDef *) ((0x40000000UL) + 0x0000UL)), 0x00000000U, 18U },
    { ((TIM_TypeDef *) ((0x40000000UL) + 0x0000UL)), 0x00000004U, 19U },
    { ((TIM_TypeDef *) ((0x40000000UL) + 0x0000UL)), 0x00000008U, 20U },
    { ((TIM_TypeDef *) ((0x40000000UL) + 0x0000UL)), 0x0000000CU, 21U },
    { ((TIM_TypeDef *) ((0x40000000UL) + 0x0400UL)), 0x00000000U, 23U },
    { ((TIM_TypeDef *) ((0x40000000UL) + 0x0400UL)), 0x00000004U, 24U },
    { ((TIM_TypeDef *) ((0x40000000UL) + 0x0400UL)), 0x00000008U, 25U },
    { ((TIM_TypeDef *) ((0x40000000UL) + 0x0400UL)), 0x0000000CU, 26U },
    { ((TIM_TypeDef *) ((0x40000000UL) + 0x0800UL)), 0x00000000U, 29U },
    { ((TIM_TypeDef *) ((0x40000000UL) + 0x0800UL)), 0x00000004U, 30U },
    { ((TIM_TypeDef *) ((0x40000000UL) + 0x0800UL)), 0x00000008U, 31U },
    { ((TIM_TypeDef *) ((0x40000000UL) + 0x0C00UL)), 0x00000000U, 55U },
    { ((TIM_TypeDef *) ((0x40000000UL) + 0x0C00UL)), 0x00000004U, 56U },
    { ((TIM_TypeDef *) ((0x40000000UL) + 0x0C00UL)), 0x00000008U, 57U },
    { ((TIM_TypeDef *) ((0x40000000UL) + 0x0C00UL)), 0x0000000CU, 58U },
    { ((TIM_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL)), 0x00000000U, 47U },
    { ((TIM_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL)), 0x00000004U, 48U },
    { ((TIM_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL)), 0x00000008U, 49U },
    { ((TIM_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL)), 0x0000000CU, 50U },
    { ((TIM_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x4000UL)), 0x00000000U, 105U },
    { ((TIM_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x4400UL)), 0x00000000U, 109U },
    { ((TIM_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x4800UL)), 0x00000000U, 111U },
};
...
static dmaChannelSpec_t dmaChannelSpec[16] = {
    { ((1 << 12)|(0 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x010UL)), 0 },
    { ((1 << 12)|(1 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x028UL)), 0 },
    { ((1 << 12)|(2 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x040UL)), 0 },
    { ((1 << 12)|(3 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x058UL)), 0 },
    { ((1 << 12)|(4 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x070UL)), 0 },
    { ((1 << 12)|(5 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x088UL)), 0 },
    { ((1 << 12)|(6 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x0A0UL)), 0 },
    { ((1 << 12)|(7 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0000UL) + 0x0B8UL)), 0 },
    { ((2 << 12)|(0 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x010UL)), 0 },
    { ((2 << 12)|(1 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x028UL)), 0 },
    { ((2 << 12)|(2 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x040UL)), 0 },
    { ((2 << 12)|(3 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x058UL)), 0 },
    { ((2 << 12)|(4 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x070UL)), 0 },
    { ((2 << 12)|(5 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x088UL)), 0 },
    { ((2 << 12)|(6 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0A0UL)), 0 },
    { ((2 << 12)|(7 << 8)|(0 << 0)), (dmaResource_t *)((DMA_Stream_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0B8UL)), 0 },
};
# 520 "./src/main/drivers/dma_reqmap.c"
static void dmaSetupRequest(dmaChannelSpec_t *dmaSpec, uint8_t request)
{
    ...
    dmaSpec->code = ((((code >> 12) & 0xf) << 12)|(((code >> 8) & 0xf) << 8)|(dmaSpec->channel << 0));
}
...
const dmaChannelSpec_t *dmaGetChannelSpecByPeripheral(dmaPeripheral_e device, uint8_t index, int8_t opt)
{
    if (opt < 0 || opt >= 16) {
        return 
# 534 "./src/main/drivers/dma_reqmap.c" 3 4
              ((void *)0)
# 534 "./src/main/drivers/dma_reqmap.c"
                  ;
    }
    ...
    return 
# 552 "./src/main/drivers/dma_reqmap.c" 3 4
          ((void *)0)
# 552 "./src/main/drivers/dma_reqmap.c"
              ;
}
...
const dmaChannelSpec_t *dmaGetChannelSpecByTimer(const timerHardware_t *timer)
{
    if (!timer) {
        return 
# 597 "./src/main/drivers/dma_reqmap.c" 3 4
              ((void *)0)
# 597 "./src/main/drivers/dma_reqmap.c"
                  ;
    }
...
dmaoptValue_t dmaGetOptionByTimer(const timerHardware_t *timer)
{
    ...
    for (unsigned opt = 0; opt < (sizeof(dmaChannelSpec) / sizeof((dmaChannelSpec)[0])); opt++) {
        if (timer->dmaRefConfigured == dmaChannelSpec[opt].ref) {
                return (dmaoptValue_t)opt;
        }
    }
# 632 "./src/main/drivers/dma_reqmap.c"
    return (-1);
}
