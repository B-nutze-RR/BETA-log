...
# 368 "./src/main/rx/rx.c" 3 4
_Bool 
# 368 "./src/main/rx/rx.c"
    rxIsReceivingSignal(void)
{
...
# 373 "./src/main/rx/rx.c" 3 4
_Bool 
# 373 "./src/main/rx/rx.c"
    rxAreFlightChannelsValid(void)
{
...
# 459 "./src/main/rx/rx.c" 3 4
   _Bool 
# 459 "./src/main/rx/rx.c"
        signalReceived = 
# 459 "./src/main/rx/rx.c" 3 4
                         0
# 459 "./src/main/rx/rx.c"
...
# 460 "./src/main/rx/rx.c" 3 4
   _Bool 
# 460 "./src/main/rx/rx.c"
...
# 460 "./src/main/rx/rx.c"
    ...
    case RX_PROVIDER_PPM:
        if (isPPMDataBeingReceived()) {
            signalReceived = 
# 469 "./src/main/rx/rx.c" 3 4
                            1
# 469 "./src/main/rx/rx.c"
                                ;
            rxIsInFailsafeMode = 
# 470 "./src/main/rx/rx.c" 3 4
                                0
# 470 "./src/main/rx/rx.c"
                                     ;
    ...
    case RX_PROVIDER_PARALLEL_PWM:
        if (isPWMDataBeingReceived()) {
            signalReceived = 
# 478 "./src/main/rx/rx.c" 3 4
                            1
# 478 "./src/main/rx/rx.c"
                                ;
            rxIsInFailsafeMode = 
...
# 493 "./src/main/rx/rx.c"
            ...
            if (frameStatus & RX_FRAME_PROCESSING_REQUIRED) {
                auxiliaryProcessingRequired = 
# 503 "./src/main/rx/rx.c" 3 4
                                             1
# 503 "./src/main/rx/rx.c"
                                                 ;
            }
        }
...
# 513 "./src/main/rx/rx.c"
    ...
    if ((signalReceived && useDataDrivenProcessing) || cmpTimeUs(currentTimeUs, rxNextUpdateAtUs) > 0) {
        rxDataProcessingRequired = 
# 517 "./src/main/rx/rx.c" 3 4
                                  1
# 517 "./src/main/rx/rx.c"
                                      ;
    }
...
# 528 "./src/main/rx/rx.c"
    ...
    if (!rxSamplesCollected) {
        ...
        rxSamplesCollected = 
# 540 "./src/main/rx/rx.c" 3 4
                            1
# 540 "./src/main/rx/rx.c"
                                ;
    }
...
static void detectAndApplySignalLossBehaviour(void)
{
    ...
    const 
# 624 "./src/main/rx/rx.c" 3 4
         _Bool 
# 624 "./src/main/rx/rx.c"
...
# 629 "./src/main/rx/rx.c"
    ...
    for (int channel = 0; channel < rxChannelCount; channel++) {
        ...
        const 
# 633 "./src/main/rx/rx.c" 3 4
             _Bool 
# 633 "./src/main/rx/rx.c"
...
# 643 "./src/main/rx/rx.c"
    ...
    if (rxFlightChannelsValid && !IS_RC_MODE_ACTIVE(BOXFAILSAFE)) {
        ...
        rxIsInFailsafeMode = 
# 661 "./src/main/rx/rx.c" 3 4
                            1
# 661 "./src/main/rx/rx.c"
                                ;
...
# 670 "./src/main/rx/rx.c" 3 4
_Bool 
# 670 "./src/main/rx/rx.c"
    calculateRxChannelsAndUpdateFailsafe(timeUs_t currentTimeUs)
{
    ...
    if (!rxDataProcessingRequired) {
        return 
# 677 "./src/main/rx/rx.c" 3 4
              0
# 677 "./src/main/rx/rx.c"
                   ;
    }

    rxDataProcessingRequired = 
# 680 "./src/main/rx/rx.c" 3 4
                              0
# 680 "./src/main/rx/rx.c"
                                   ;
    ...
    if (skipRxSamples || currentTimeUs <= suspendRxSignalUntil) {
        ...
        return 
# 689 "./src/main/rx/rx.c" 3 4
              1
# 689 "./src/main/rx/rx.c"
                  ;
    }
    ...
    return 
# 697 "./src/main/rx/rx.c" 3 4
          1
# 697 "./src/main/rx/rx.c"
              ;
}
...
# 883 "./src/main/rx/rx.c" 3 4
_Bool 
# 883 "./src/main/rx/rx.c"
    isRssiConfigured(void)
{
