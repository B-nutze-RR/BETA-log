...
# 33 "./src/main/pg/rx_spi.c" 2

extern void pgResetFn_rxSpiConfig(rxSpiConfig_t *); rxSpiConfig_t rxSpiConfig_System; rxSpiConfig_t rxSpiConfig_Copy; extern const pgRegistry_t rxSpiConfig_Registry; const pgRegistry_t rxSpiConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 537 | (0 << 12), .length = 1, .size = sizeof(rxSpiConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&rxSpiConfig_System, .copy = (uint8_t*)&rxSpiConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_rxSpiConfig }, };

void pgResetFn_rxSpiConfig(rxSpiConfig_t *rxSpiConfig)
{
    rxSpiConfig->rx_spi_protocol = RX_SPI_CYRF6936_DSM;


    rxSpiConfig->csnTag = ((ioTag_t)((((3) + 1) << 4) | (2)));
    rxSpiConfig->spibus = ((spiDeviceByInstance(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)))) + 1);

    rxSpiConfig->extiIoTag = ((ioTag_t)((((0) + 1) << 4) | (0)));

    rxSpiConfig->bindIoTag = 0;
    rxSpiConfig->ledIoTag = 0;



    rxSpiConfig->ledInversion = 
# 51 "./src/main/pg/rx_spi.c" 3 4
                               0
# 51 "./src/main/pg/rx_spi.c"
                                    ;
