...
static 
# 87 "./src/main/io/dashboard.c" 3 4
      _Bool 
# 87 "./src/main/io/dashboard.c"
           dashboardPresent = 
# 87 "./src/main/io/dashboard.c" 3 4
                              0
# 87 "./src/main/io/dashboard.c"
...
# 120 "./src/main/io/dashboard.c" 3 4
   _Bool 
# 120 "./src/main/io/dashboard.c"
        pageChanging;
...
{
    for (int channelIndex = 0; channelIndex < rxRuntimeState.channelCount && channelIndex < 14; channelIndex += 2) {
...
static void showWelcomePage(void)
{
    ...
    tfp_sprintf(lineBuffer, "v%s (%s)", "4" "." "3" "." "0", shortGitRevision);
...
static const pageEntry_t pages[PAGE_COUNT] = {
    ...
    { PAGE_RPROF, "RATE PROFILE", showRateProfilePage,0 },
    ...
    { PAGE_BB, "BLACK BOX", showBBPage, 0 },
...
void dashboardUpdate(timeUs_t currentTimeUs)
{
    ...
    const 
# 660 "./src/main/io/dashboard.c" 3 4
         _Bool 
# 660 "./src/main/io/dashboard.c"
...
# 667 "./src/main/io/dashboard.c" 3 4
   _Bool 
# 667 "./src/main/io/dashboard.c"
...
# 668 "./src/main/io/dashboard.c" 3 4
   _Bool 
# 668 "./src/main/io/dashboard.c"
...
# 676 "./src/main/io/dashboard.c" 3 4
                                1
# 676 "./src/main/io/dashboard.c"
                                    ;
    } else {
        if (armedStateChanged) {
            pageState.pageFlags |= PAGE_STATE_FLAG_FORCE_PAGE_CHANGE;
