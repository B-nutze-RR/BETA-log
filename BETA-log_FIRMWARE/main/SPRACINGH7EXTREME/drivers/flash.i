...
# 56 "./src/main/drivers/flash.c"
           flashQuadSpiInit(const flashConfig_t *flashConfig)
{
    QUADSPI_TypeDef *quadSpiInstance = quadSpiInstanceByDevice(((flashConfig->quadSpiDevice) - 1));
    quadSpiSetDivisor(quadSpiInstance, QUADSPI_CLOCK_INITIALISATION);

    uint8_t readIdResponse[4];
    
# 62 "./src/main/drivers/flash.c" 3 4
   _Bool 
# 62 "./src/main/drivers/flash.c"
        status = quadSpiReceive1LINE(quadSpiInstance, 0x9F, 8, readIdResponse, sizeof(readIdResponse));
    if (!status) {
        return 
# 64 "./src/main/drivers/flash.c" 3 4
              0
# 64 "./src/main/drivers/flash.c"
                   ;
    }
    ...
    if (w25n01g_detect(&flashDevice, chipID)) {
        return 
# 78 "./src/main/drivers/flash.c" 3 4
              1
# 78 "./src/main/drivers/flash.c"
                  ;
    }
# 90 "./src/main/drivers/flash.c"
    return 
# 90 "./src/main/drivers/flash.c" 3 4
          0
# 90 "./src/main/drivers/flash.c"
               ;
}
...
void flashPreInit(const flashConfig_t *flashConfig)
{
    spiPreinitRegister(flashConfig->csTag, (((0x00000000U)) | (((0x00000000U)) << 2) | (((0x00000001U)) << 5)), 1);
}

static 
# 101 "./src/main/drivers/flash.c" 3 4
      _Bool 
# 101 "./src/main/drivers/flash.c"
           flashSpiInit(const flashConfig_t *flashConfig)
{
    ...
    if (flashConfig->csTag) {
        ...
        return 
# 110 "./src/main/drivers/flash.c" 3 4
              0
# 110 "./src/main/drivers/flash.c"
                   ;
    }

    if (!IOIsFreeOrPreinit(busdev->busdev_u.spi.csnPin)) {
        return 
# 114 "./src/main/drivers/flash.c" 3 4
              0
# 114 "./src/main/drivers/flash.c"
                   ;
    }

    busdev->bustype = BUSTYPE_SPI;

    SPI_TypeDef *instance = spiInstanceByDevice(((flashConfig->spiDevice) - 1));
    if (!instance) {
        return 
# 121 "./src/main/drivers/flash.c" 3 4
              0
# 121 "./src/main/drivers/flash.c"
                   ;
    }
    ...
    IOConfigGPIO(busdev->busdev_u.spi.csnPin, (((0x00000001U)) | (((0x00000003U)) << 2) | (((0x00000000U)) << 5)));
    ...
    spiSetDivisor(busdev->busdev_u.spi.instance, spiCalculateDivider(5000000));
    ...
    const uint8_t out[] = { 0x9F, 0, 0, 0, 0 };
...
# 175 "./src/main/drivers/flash.c"
    chipID = (readIdResponse[2] << 16) | (readIdResponse[3] << 8) | (readIdResponse[4]);


    if (w25n01g_detect(&flashDevice, chipID)) {
        return 
# 179 "./src/main/drivers/flash.c" 3 4
              1
# 179 "./src/main/drivers/flash.c"
                  ;
    }
# 189 "./src/main/drivers/flash.c"
    spiPreinitByTag(flashConfig->csTag);

    return 
# 191 "./src/main/drivers/flash.c" 3 4
          0
# 191 "./src/main/drivers/flash.c"
               ;
}



# 195 "./src/main/drivers/flash.c" 3 4
_Bool 
# 195 "./src/main/drivers/flash.c"
    flashDeviceInit(const flashConfig_t *flashConfig)
{

    
# 198 "./src/main/drivers/flash.c" 3 4
   _Bool 
# 198 "./src/main/drivers/flash.c"
...
# 206 "./src/main/drivers/flash.c" 3 4
   _Bool 
# 206 "./src/main/drivers/flash.c"
        useQuadSpi = (((flashConfig->quadSpiDevice) - 1) != QUADSPIINVALID);
    if (useQuadSpi) {
    ...
    return 
# 212 "./src/main/drivers/flash.c" 3 4
          0
# 212 "./src/main/drivers/flash.c"
               ;
}


# 215 "./src/main/drivers/flash.c" 3 4
_Bool 
# 215 "./src/main/drivers/flash.c"
    flashIsReady(void)
{
...
# 220 "./src/main/drivers/flash.c" 3 4
_Bool 
# 220 "./src/main/drivers/flash.c"
    flashWaitForReady(void)
{
...
static void flashConfigurePartitions(void)
{
    ...
    const uint32_t firmwareSize = (448 * 1024);
    ...
    startSector = (endSector + 1) - firmwareSectors;
    ...
    const uint32_t configSize = 4096;
    ...
    startSector = (endSector + 1) - configSectors;
...
flashPartition_t *flashPartitionFindByType(uint8_t type)
{
    ...
    return 
# 355 "./src/main/drivers/flash.c" 3 4
          ((void *)0)
# 355 "./src/main/drivers/flash.c"
              ;
}
...
const flashPartition_t *flashPartitionFindByIndex(uint8_t index)
{
    if (index >= flashPartitions) {
        return 
# 361 "./src/main/drivers/flash.c" 3 4
              ((void *)0)
# 361 "./src/main/drivers/flash.c"
                  ;
    }
...
const char *flashPartitionGetTypeName(flashPartitionType_e type)
{
    ...
    return 
# 399 "./src/main/drivers/flash.c" 3 4
          ((void *)0)
# 399 "./src/main/drivers/flash.c"
              ;
}


# 402 "./src/main/drivers/flash.c" 3 4
_Bool 
# 402 "./src/main/drivers/flash.c"
    flashInit(const flashConfig_t *flashConfig)
{
...
# 407 "./src/main/drivers/flash.c" 3 4
   _Bool 
# 407 "./src/main/drivers/flash.c"
