# 1 "./src/main/target/OMNIBUSF4FW/config.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/target/OMNIBUSF4FW/config.c"
# 21 "./src/main/target/OMNIBUSF4FW/config.c"
# 1 "e:\\dev\\9 2020-q2-update\\lib\\gcc\\arm-none-eabi\\9.3.1\\include\\stdbool.h" 1 3 4
# 22 "./src/main/target/OMNIBUSF4FW/config.c" 2
...
# 23 "./src/main/target/OMNIBUSF4FW/config.c" 2
...
# 153 "./src/main/platform.h" 2
# 25 "./src/main/target/OMNIBUSF4FW/config.c" 2
...
# 29 "./src/main/target/OMNIBUSF4FW/config.c" 2
...
# 30 "./src/main/target/OMNIBUSF4FW/config.c" 2
...
# 31 "./src/main/target/OMNIBUSF4FW/config.c" 2
...
# 33 "./src/main/target/OMNIBUSF4FW/config.c" 2
...
{
    targetSerialPortFunctionConfig(targetSerialPortFunction, (sizeof(targetSerialPortFunction) / sizeof((targetSerialPortFunction)[0])));
}
