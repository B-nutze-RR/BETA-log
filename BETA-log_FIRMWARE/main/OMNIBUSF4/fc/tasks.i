...
# 38 "./src/main/drivers/serial_usb_vcp.h"
typedef struct {
    serialPort_t port;
...
# 495 "./src/main/fc/tasks.c" 3 4
                        ((void *)0)
# 495 "./src/main/fc/tasks.c"
                        , .checkFunc = 
# 495 "./src/main/fc/tasks.c" 3 4
                        ((void *)0)
# 495 "./src/main/fc/tasks.c"
                        , .taskFunc = taskUpdateRangefinder, .desiredPeriodUs = (1000000 / (10)), .staticPriority = TASK_PRIORITY_IDLE },
