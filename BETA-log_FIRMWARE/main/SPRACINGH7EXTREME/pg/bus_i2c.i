...
static const i2cDefaultConfig_t i2cDefaultConfig[] = {
    ...
    { I2CDEV_1, ((ioTag_t)((((1) + 1) << 4) | (8))), ((ioTag_t)((((1) + 1) << 4) | (9))), 
# 51 "./src/main/pg/bus_i2c.c" 3 4
                                                   1
# 51 "./src/main/pg/bus_i2c.c"
                                                                 , 
# 51 "./src/main/pg/bus_i2c.c" 3 4
                                                                   0 
# 51 "./src/main/pg/bus_i2c.c"
                                                                               },
# 62 "./src/main/pg/bus_i2c.c"
};
...
extern void pgResetFn_i2cConfig(i2cConfig_t *); i2cConfig_t i2cConfig_SystemArray[4]; i2cConfig_t i2cConfig_CopyArray[4]; extern const pgRegistry_t i2cConfig_Registry; const pgRegistry_t i2cConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 518 | (0 << 12), .length = 4, .size = (sizeof(i2cConfig_t) * 4) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&i2cConfig_SystemArray, .copy = (uint8_t*)&i2cConfig_CopyArray, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_i2cConfig}, };
