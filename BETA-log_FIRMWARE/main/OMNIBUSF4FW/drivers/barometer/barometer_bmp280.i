...
void bmp280BusInit(busDevice_t *busdev)
{
    ...
    if (busdev->bustype == BUSTYPE_SPI) {
        ...
        spiBusTransactionInit(busdev, SPI_MODE0_POL_LOW_EDGE_1ST, spiCalculateDivider(10000000));
...
# 152 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
_Bool 
# 152 "./src/main/drivers/barometer/barometer_bmp280.c"
    bmp280Detect(baroDev_t *baro)
{
    delay(20);
...
# 157 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
   _Bool 
# 157 "./src/main/drivers/barometer/barometer_bmp280.c"
...
# 157 "./src/main/drivers/barometer/barometer_bmp280.c"
    ...
    if ((busdev->bustype == BUSTYPE_I2C) && (busdev->busdev_u.i2c.address == 0)) {
        ...
        defaultAddressApplied = 
# 164 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
                               1
# 164 "./src/main/drivers/barometer/barometer_bmp280.c"
                                   ;
    }
...
# 174 "./src/main/drivers/barometer/barometer_bmp280.c"
    ...
    busReadRegisterBuffer(busdev, (0x88), (uint8_t *)&bmp280_cal, sizeof(bmp280_calib_param_t));
    ...
    baro->combined_read = 
# 186 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
                         1
# 186 "./src/main/drivers/barometer/barometer_bmp280.c"
                             ;
    baro->ut_delay = 0;
    ...
    return 
# 198 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          1
# 198 "./src/main/drivers/barometer/barometer_bmp280.c"
              ;
}
           ...
           bmp280ReadUT(baroDev_t *baro)
{
    ...
    return 
# 211 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          1
# 211 "./src/main/drivers/barometer/barometer_bmp280.c"
              ;
}
           ...
           bmp280GetUT(baroDev_t *baro)
{
    ...
    return 
# 218 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          1
# 218 "./src/main/drivers/barometer/barometer_bmp280.c"
              ;
}
...
static void bmp280StartUP(baroDev_t *baro)
{
    ...
    busWriteRegisterStart(&baro->busdev, (0xF4), (((0x04)) << 2 | ((0x01)) << 5 | (0x01)));
}

static 
# 228 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
      _Bool 
# 228 "./src/main/drivers/barometer/barometer_bmp280.c"
           bmp280ReadUP(baroDev_t *baro)
{
    if (busBusy(&baro->busdev, 
# 230 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
                              ((void *)0)
# 230 "./src/main/drivers/barometer/barometer_bmp280.c"
                                  )) {
        return 
# 231 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
              0
# 231 "./src/main/drivers/barometer/barometer_bmp280.c"
                   ;
    }


    busReadRegisterBufferStart(&baro->busdev, (0xF7), sensor_data, (6));

    return 
# 237 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          1
# 237 "./src/main/drivers/barometer/barometer_bmp280.c"
              ;
}

static 
# 240 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
      _Bool 
# 240 "./src/main/drivers/barometer/barometer_bmp280.c"
           bmp280GetUP(baroDev_t *baro)
{
    if (busBusy(&baro->busdev, 
# 242 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
                              ((void *)0)
# 242 "./src/main/drivers/barometer/barometer_bmp280.c"
                                  )) {
        return 
# 243 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
              0
# 243 "./src/main/drivers/barometer/barometer_bmp280.c"
                   ;
    }
    ...
    return 
# 249 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          1
# 249 "./src/main/drivers/barometer/barometer_bmp280.c"
              ;
}
