...
# 56 "./src/main/drivers/serial_softserial.c"
typedef enum {
    TIMER_MODE_SINGLE,
    TIMER_MODE_DUAL,
} timerMode_e;
...
# 149 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 149 "./src/main/drivers/serial_softserial.c"
                                            ;
...
static 
# 195 "./src/main/drivers/serial_softserial.c" 3 4
      _Bool 
# 195 "./src/main/drivers/serial_softserial.c"
...
serialPort_t *openSoftSerial(softSerialPortIndex_e portIndex, serialReceiveCallbackPtr rxCallback, void *rxCallbackData, uint32_t baud, portMode_e mode, portOptions_e options)
{
    ...
    const timerHardware_t *timerTx = timerAllocate(tagTx, OWNER_SERIAL_TX, (portIndex + 10 + 1));
    const timerHardware_t *timerRx = (tagTx == tagRx) ? timerTx : timerAllocate(tagRx, OWNER_SERIAL_RX, (portIndex + 10 + 1));
    ...
    if (options & SERIAL_BIDIR) {
        ...
        if (!timerTx || (timerTx->output & TIMER_OUTPUT_N_CHANNEL)) {
            return 
# 254 "./src/main/drivers/serial_softserial.c" 3 4
                  ((void *)0)
# 254 "./src/main/drivers/serial_softserial.c"
                      ;
        }
