...
{
    adcConfig->device = ((adcDeviceByInstance(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)))) + 1);
    adcConfig->dmaopt[ADCDEV_1] = 0;
...
# 57 "./src/main/pg/adc.c"
                                 ;
    adcConfig->vbat.ioTag = ((ioTag_t)((((1) + 1) << 4) | (0)));
