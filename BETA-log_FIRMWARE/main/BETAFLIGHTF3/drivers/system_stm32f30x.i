...
# 1 "<command-line>"
# 1 "./src/main/drivers/system_stm32f30x.c"
# 21 "./src/main/drivers/system_stm32f30x.c"
...
# 28 "./src/main/drivers/system_stm32f30x.c" 2
# 38 "./src/main/drivers/system_stm32f30x.c"
void SetSysClock();
...
# 62 "./src/main/drivers/system_stm32f30x.c" 3 4
_Bool 
# 62 "./src/main/drivers/system_stm32f30x.c"
    isMPUSoftReset(void)
{
    if (cachedRccCsrValue & ((uint32_t)0x10000000))
        return 
# 65 "./src/main/drivers/system_stm32f30x.c" 3 4
              1
# 65 "./src/main/drivers/system_stm32f30x.c"
                  ;
    else
        return 
# 67 "./src/main/drivers/system_stm32f30x.c" 3 4
              0
# 67 "./src/main/drivers/system_stm32f30x.c"
                   ;
}
