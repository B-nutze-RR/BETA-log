...
extern void pgResetFn_gyroDeviceConfig(gyroDeviceConfig_t *); gyroDeviceConfig_t gyroDeviceConfig_SystemArray[1]; gyroDeviceConfig_t gyroDeviceConfig_CopyArray[1]; extern const pgRegistry_t gyroDeviceConfig_Registry; const pgRegistry_t gyroDeviceConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 540 | (0 << 12), .length = 1, .size = (sizeof(gyroDeviceConfig_t) * 1) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&gyroDeviceConfig_SystemArray, .copy = (uint8_t*)&gyroDeviceConfig_CopyArray, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_gyroDeviceConfig}, };
...
void pgResetFn_gyroDeviceConfig(gyroDeviceConfig_t *devconf)
{
    ...
    buildAlignmentFromStandardAlignment(&customAlignment1, CW180_DEG);




    gyroResetSpiDeviceConfig(&devconf[0], ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), ((ioTag_t)((((0) + 1) << 4) | (15))), ((ioTag_t)((((2) + 1) << 4) | (13))), CW180_DEG, customAlignment1);
