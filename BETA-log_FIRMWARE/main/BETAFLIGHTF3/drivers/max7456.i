...
# 59 "./src/main/drivers/max7456.h" 3 4
_Bool 
# 59 "./src/main/drivers/max7456.h"
...
# 192 "./src/main/drivers/max7456.c"
...
static 
# 202 "./src/main/drivers/max7456.c" 3 4
      _Bool 
# 202 "./src/main/drivers/max7456.c"
...
static 
# 229 "./src/main/drivers/max7456.c" 3 4
      _Bool 
# 229 "./src/main/drivers/max7456.c"
           fontIsLoading = 
# 229 "./src/main/drivers/max7456.c" 3 4
                                 0
# 229 "./src/main/drivers/max7456.c"
...
# 374 "./src/main/drivers/max7456.c"
...
void max7456ReInit(void)
{
    uint8_t srdata = 0;
    static 
# 420 "./src/main/drivers/max7456.c" 3 4
          _Bool 
# 420 "./src/main/drivers/max7456.c"
               firstInit = 
# 420 "./src/main/drivers/max7456.c" 3 4
                           1
# 420 "./src/main/drivers/max7456.c"
    ...
    {spiBusSetDivisor(busdev, max7456SpiClock);IOLo((busdev)->busdev_u.spi.csnPin);};
    ...
    {IOHi((busdev)->busdev_u.spi.csnPin);spiSetDivisor((busdev)->busdev_u.spi.instance, spiCalculateDivider(1000000));};
    ...
    if (firstInit) {
        ...
        firstInit = 
# 472 "./src/main/drivers/max7456.c" 3 4
                   0
# 472 "./src/main/drivers/max7456.c"
                        ;
    }
}
...
{
    spiPreinitRegister(max7456Config->csTag, max7456Config->preInitOPU ? ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)) : ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_UP) << 5)), 1);
}
...
# 484 "./src/main/drivers/max7456.c"
                                                                                                           cpuOverclock)
{
    max7456SpiClock = spiCalculateDivider(10000000);
    max7456DeviceDetected = 
# 487 "./src/main/drivers/max7456.c" 3 4
                           0
# 487 "./src/main/drivers/max7456.c"
                                ;
    ...
    IOConfigGPIO(busdev->busdev_u.spi.csnPin, ((GPIO_Mode_OUT) | ((GPIO_Speed_Level_3) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
    ...
    spiSetDivisor(busdev->busdev_u.spi.instance, spiCalculateDivider(10000000) * 2);

    {spiBusSetDivisor(busdev, max7456SpiClock);IOLo((busdev)->busdev_u.spi.csnPin);};

    uint8_t osdm = max7456Send(0x0c|0x80, 0xff);
    ...
    max7456DeviceDetected = 
# 532 "./src/main/drivers/max7456.c" 3 4
                           1
# 532 "./src/main/drivers/max7456.c"
                               ;
    IOInit(busdev->busdev_u.spi.csnPin, OWNER_OSD_CS, 0);
    ...
    {IOHi((busdev)->busdev_u.spi.csnPin);spiSetDivisor((busdev)->busdev_u.spi.instance, spiCalculateDivider(1000000));};
# 571 "./src/main/drivers/max7456.c"
    (void)(max7456Config);
    (void)(cpuOverclock);
...
void max7456Invert(
# 602 "./src/main/drivers/max7456.c" 3 4
                  _Bool 
# 602 "./src/main/drivers/max7456.c"
                       invert)
{
    if (invert) {
...
# 664 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 664 "./src/main/drivers/max7456.c"
    max7456LayerSupported(displayPortLayer_e layer)
{
...
# 667 "./src/main/drivers/max7456.c"
        ...
        return 
# 669 "./src/main/drivers/max7456.c" 3 4
              0
# 669 "./src/main/drivers/max7456.c"
                   ;
    }
}


# 673 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 673 "./src/main/drivers/max7456.c"
    max7456LayerSelect(displayPortLayer_e layer)
{
    if (max7456LayerSupported(layer)) {
        activeLayer = layer;
        return 
# 677 "./src/main/drivers/max7456.c" 3 4
              1
# 677 "./src/main/drivers/max7456.c"
                  ;
    } else {
        return 
...
# 683 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 683 "./src/main/drivers/max7456.c"
    max7456LayerCopy(displayPortLayer_e destLayer, displayPortLayer_e sourceLayer)
{
    if ((sourceLayer != destLayer) && max7456LayerSupported(sourceLayer) && max7456LayerSupported(destLayer)) {
        ...
        return 
# 687 "./src/main/drivers/max7456.c" 3 4
              1
# 687 "./src/main/drivers/max7456.c"
                  ;
    } else {
        return 
# 689 "./src/main/drivers/max7456.c" 3 4
              0
# 689 "./src/main/drivers/max7456.c"
                   ;
    }
}


# 693 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 693 "./src/main/drivers/max7456.c"
    max7456DmaInProgress(void)
{
    ...
    return 
# 698 "./src/main/drivers/max7456.c" 3 4
          0
# 698 "./src/main/drivers/max7456.c"
               ;

}


# 702 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 702 "./src/main/drivers/max7456.c"
    max7456BuffersSynced(void)
{
    for (int i = 0; i < maxScreenSize; i++) {
        if (displayLayers[DISPLAYPORT_LAYER_FOREGROUND].buffer[i] != shadowBuffer[i]) {
            return 
# 706 "./src/main/drivers/max7456.c" 3 4
                  0
# 706 "./src/main/drivers/max7456.c"
                       ;
        }
    }
    return 
# 709 "./src/main/drivers/max7456.c" 3 4
          1
# 709 "./src/main/drivers/max7456.c"
              ;
}

void max7456ReInitIfRequired(
...
# 721 "./src/main/drivers/max7456.c" 3 4
   _Bool 
# 721 "./src/main/drivers/max7456.c"
        stalled = 
# 721 "./src/main/drivers/max7456.c" 3 4
                  0
# 721 "./src/main/drivers/max7456.c"
    ...
    if (forceStallCheck || (lastStallCheckMs + 1000 < nowMs)) {
        ...
        {spiBusSetDivisor(busdev, max7456SpiClock);IOLo((busdev)->busdev_u.spi.csnPin);};
        stalled = (max7456Send(0x00|0x80, 0x00) != videoSignalReg);
        {IOHi((busdev)->busdev_u.spi.csnPin);spiSetDivisor((busdev)->busdev_u.spi.instance, spiCalculateDivider(1000000));};
    }
...
# 775 "./src/main/drivers/max7456.c" 3 4
                               0
# 775 "./src/main/drivers/max7456.c"
                                    );
...
# 802 "./src/main/drivers/max7456.c" 3 4
                                                               ((void *)0)
# 802 "./src/main/drivers/max7456.c"
                                                                   , buff_len);
            {IOHi((busdev)->busdev_u.spi.csnPin);spiSetDivisor((busdev)->busdev_u.spi.instance, spiCalculateDivider(1000000));};
...
# 811 "./src/main/drivers/max7456.c" 3 4
   _Bool 
# 811 "./src/main/drivers/max7456.c"
        escapeCharFound = 
# 811 "./src/main/drivers/max7456.c" 3 4
                          0
# 811 "./src/main/drivers/max7456.c"
    ...
    for (int xx = 0; xx < maxScreenSize; xx++) {
        if (buffer[xx] == 0xff) {
            escapeCharFound = 
# 824 "./src/main/drivers/max7456.c" 3 4
                             1
# 824 "./src/main/drivers/max7456.c"
                                 ;
            max7456Send(0x07, ' ');
        } else {
            max7456Send(0x07, buffer[xx]);
        }
...
void max7456RefreshAll(void)
{
    ...
    max7456ReInitIfRequired(
# 858 "./src/main/drivers/max7456.c" 3 4
                           1
# 858 "./src/main/drivers/max7456.c"
                               );
    max7456DrawScreenSlow();
}


# 862 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 862 "./src/main/drivers/max7456.c"
    max7456WriteNvm(uint8_t char_address, const uint8_t *font_data)
{
    if (!max7456DeviceDetected) {
        return 
# 865 "./src/main/drivers/max7456.c" 3 4
              0
# 865 "./src/main/drivers/max7456.c"
                   ;
    }
    ...
    fontIsLoading = 
# 873 "./src/main/drivers/max7456.c" 3 4
                   1
# 873 "./src/main/drivers/max7456.c"
                       ;
    max7456Send(0x00, 0);
    ...
    {IOHi((busdev)->busdev_u.spi.csnPin);spiSetDivisor((busdev)->busdev_u.spi.instance, spiCalculateDivider(1000000));};
    return 
# 897 "./src/main/drivers/max7456.c" 3 4
          1
# 897 "./src/main/drivers/max7456.c"
              ;
}
...
void max7456HardwareReset(void)
{
# 919 "./src/main/drivers/max7456.c"
}


# 921 "./src/main/drivers/max7456.c" 3 4
_Bool 
# 921 "./src/main/drivers/max7456.c"
    max7456IsDeviceDetected(void)
{
