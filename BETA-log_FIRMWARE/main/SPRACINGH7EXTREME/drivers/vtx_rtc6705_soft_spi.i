# 1 "./src/main/drivers/vtx_rtc6705_soft_spi.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/vtx_rtc6705_soft_spi.c"
# 21 "./src/main/drivers/vtx_rtc6705_soft_spi.c"
# 1 "c:\\dev\\9 2020-q2-update\\lib\\gcc\\arm-none-eabi\\9.3.1\\include\\stdbool.h" 1 3 4
# 22 "./src/main/drivers/vtx_rtc6705_soft_spi.c" 2
...
# 23 "./src/main/drivers/vtx_rtc6705_soft_spi.c" 2
...
# 153 "./src/main/platform.h" 2
# 25 "./src/main/drivers/vtx_rtc6705_soft_spi.c" 2
...
# 29 "./src/main/drivers/vtx_rtc6705_soft_spi.c" 2
...
# 30 "./src/main/drivers/vtx_rtc6705_soft_spi.c" 2
...
# 67 "./src/main/drivers/light_led.h"
                         state);
# 31 "./src/main/drivers/vtx_rtc6705_soft_spi.c" 2
...
# 32 "./src/main/drivers/vtx_rtc6705_soft_spi.c" 2
...
# 33 "./src/main/drivers/vtx_rtc6705_soft_spi.c" 2
# 53 "./src/main/drivers/vtx_rtc6705_soft_spi.c"
static IO_t rtc6705DataPin = ((IO_t)0);
static IO_t rtc6705CsnPin = ((IO_t)0);
static IO_t rtc6705ClkPin = ((IO_t)0);



# 58 "./src/main/drivers/vtx_rtc6705_soft_spi.c" 3 4
_Bool 
# 58 "./src/main/drivers/vtx_rtc6705_soft_spi.c"
    rtc6705SoftSpiIOInit(const vtxIOConfig_t *vtxIOConfig, const IO_t csnPin)
{
    ...
    if (!(rtc6705DataPin && rtc6705ClkPin)) {
        return 
# 66 "./src/main/drivers/vtx_rtc6705_soft_spi.c" 3 4
              0
# 66 "./src/main/drivers/vtx_rtc6705_soft_spi.c"
                   ;
    }

    IOInit(rtc6705DataPin, OWNER_VTX_DATA, 10);
    IOConfigGPIO(rtc6705DataPin, (((0x00000001U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)));

    IOInit(rtc6705ClkPin, OWNER_VTX_CLK, 10);
    IOConfigGPIO(rtc6705ClkPin, (((0x00000001U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)));



    IOHi(rtc6705CsnPin);
    IOInit(rtc6705CsnPin, OWNER_VTX_CS, 10);
    IOConfigGPIO(rtc6705CsnPin, (((0x00000001U)) | (((0x00000000U)) << 2) | (((0x00000000U)) << 5)));

    return 
# 81 "./src/main/drivers/vtx_rtc6705_soft_spi.c" 3 4
          1
# 81 "./src/main/drivers/vtx_rtc6705_soft_spi.c"
              ;
}
...
{
    rtc6705_write_register(7, (rf_power > 1 ? 0x4FBD : (0x4FBD | 0x0040) & (~(0x0180 | 0x0E00))));
}
