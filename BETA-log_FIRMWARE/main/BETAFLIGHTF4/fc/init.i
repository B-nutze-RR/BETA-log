...
# 29 "./src/main/msc/usbd_storage.h" 2
...
# 30 "./src/main/msc/usbd_storage.h" 2
# 46 "./src/main/msc/usbd_storage.h"
extern USBD_STORAGE_cb_TypeDef *USBD_STORAGE_fops;
...
# 286 "./src/main/fc/init.c"
}
# 296 "./src/main/fc/init.c"
static void swdPinsInit(void)
{
    IO_t io = IOGetByTag(0);
...
# 435 "./src/main/fc/init.c"
    ...
    if (!readSuccess || !isEEPROMVersionValid() || strncasecmp(systemConfig()->boardIdentifier, "BFF4", sizeof("BFF4"))) {
        resetEEPROM(
