...
const i2cHardware_t i2cHardware[3] = {
    ...
    {
        .device = I2CDEV_1,
        .reg = ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)),
        .sclPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (6))), ((uint8_t)0x04) },
            { ((ioTag_t)((((1) + 1) << 4) | (8))), ((uint8_t)0x04) },
        },
        .sdaPins = {
            { ((ioTag_t)((((1) + 1) << 4) | (7))), ((uint8_t)0x04) },
            { ((ioTag_t)((((1) + 1) << 4) | (9))), ((uint8_t)0x04) },
        },
...
# 128 "./src/main/drivers/bus_i2c_stm32f10x.c"
};
...
static 
# 160 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
      _Bool 
# 160 "./src/main/drivers/bus_i2c_stm32f10x.c"
           i2cHandleHardwareFailure(I2CDevice device)
{
    ...
    i2cInit(device);
    return 
# 165 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
          0
# 165 "./src/main/drivers/bus_i2c_stm32f10x.c"
               ;
}


# 168 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 168 "./src/main/drivers/bus_i2c_stm32f10x.c"
    i2cWriteBuffer(I2CDevice device, uint8_t addr_, uint8_t reg_, uint8_t len_, uint8_t *data)
{
    if (device == I2CINVALID || device > 3) {
        return 
# 171 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 171 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
    ...
    if (!I2Cx) {
        return 
# 177 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 177 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
    ...
    if (state->busy) {
        return 
# 182 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 182 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
...
# 210 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 210 "./src/main/drivers/bus_i2c_stm32f10x.c"
    i2cBusy(I2CDevice device, 
# 210 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
                              _Bool 
# 210 "./src/main/drivers/bus_i2c_stm32f10x.c"
...
# 220 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 220 "./src/main/drivers/bus_i2c_stm32f10x.c"
    i2cWait(I2CDevice device)
{
    i2cState_t *state = &i2cDevice[device].state;
    uint32_t timeout = ((uint32_t)0x1000);
...
# 232 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 232 "./src/main/drivers/bus_i2c_stm32f10x.c"
...
# 237 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 237 "./src/main/drivers/bus_i2c_stm32f10x.c"
    i2cReadBuffer(I2CDevice device, uint8_t addr_, uint8_t reg_, uint8_t len, uint8_t* buf)
{
    if (device == I2CINVALID || device > 3) {
        return 
# 240 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 240 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
    ...
    if (!I2Cx) {
        return 
# 245 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 245 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
    ...
    if (state->busy) {
        return 
# 250 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 250 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
    ...
    state->busy = 1;
    state->error = 
# 263 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
                  0
# 263 "./src/main/drivers/bus_i2c_stm32f10x.c"
                       ;
    ...
    return 
# 275 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
          1
# 275 "./src/main/drivers/bus_i2c_stm32f10x.c"
              ;
}


# 278 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 278 "./src/main/drivers/bus_i2c_stm32f10x.c"
...
static void i2c_er_handler(I2CDevice device) {
    ...
    if (SR1Register & (((uint16_t)0x0100) | ((uint16_t)0x0200) | ((uint16_t)0x0400) | ((uint16_t)0x0800)))
        state->error = 
# 293 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
                      1
# 293 "./src/main/drivers/bus_i2c_stm32f10x.c"
                          ;
