...
{
    for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((0)<<(4-(7-(((uint32_t)0x00000005)))))|((1)&(0x0f>>(7-(((uint32_t)0x00000005))))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        sysTickUptime++;
