...
# 30 "./src/main/drivers/buttons.c" 2
...
# 26 "./src/main/drivers/buttons.h"
    buttonBPressed(void);
# 32 "./src/main/drivers/buttons.c" 2


static IO_t buttonAPin = ((IO_t)0);



static IO_t buttonBPin = ((IO_t)0);
# 53 "./src/main/drivers/buttons.c"
void buttonsInit(void)
{

    buttonAPin = IOGetByTag(((ioTag_t)((((4) + 1) << 4) | (4))));
    IOInit(buttonAPin, OWNER_SYSTEM, 0);
    IOConfigGPIO(buttonAPin, (((0x00000000U)) | (((0x00000000U)) << 2) | (((0x00000002U)) << 5)));



    buttonBPin = IOGetByTag(((ioTag_t)((((4) + 1) << 4) | (4))));
    IOInit(buttonBPin, OWNER_SYSTEM, 0);
    IOConfigGPIO(buttonBPin, (((0x00000000U)) | (((0x00000000U)) << 2) | (((0x00000002U)) << 5)));

}



# 69 "./src/main/drivers/buttons.c" 3 4
_Bool 
# 69 "./src/main/drivers/buttons.c"
    buttonAPressed(void)
{
...
# 80 "./src/main/drivers/buttons.c" 3 4
_Bool 
# 80 "./src/main/drivers/buttons.c"
    buttonBPressed(void)
{
