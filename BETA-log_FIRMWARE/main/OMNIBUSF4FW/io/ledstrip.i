...
# 79 "./src/main/io/ledstrip.c" 2



static 
# 82 "./src/main/io/ledstrip.c" 3 4
      _Bool 
# 82 "./src/main/io/ledstrip.c"
           ledStripEnabled = 
# 82 "./src/main/io/ledstrip.c" 3 4
                             0
# 82 "./src/main/io/ledstrip.c"
...
# 130 "./src/main/io/ledstrip.c" 3 4
                                                0
# 130 "./src/main/io/ledstrip.c"
                                                     ;
...
extern void pgResetFn_ledStripStatusModeConfig(ledStripStatusModeConfig_t *); ledStripStatusModeConfig_t ledStripStatusModeConfig_System; ledStripStatusModeConfig_t ledStripStatusModeConfig_Copy; extern const pgRegistry_t ledStripStatusModeConfig_Registry; const pgRegistry_t ledStripStatusModeConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 545 | (0 << 12), .length = 1, .size = sizeof(ledStripStatusModeConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&ledStripStatusModeConfig_System, .copy = (uint8_t*)&ledStripStatusModeConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_ledStripStatusModeConfig }, };
...
# 294 "./src/main/io/ledstrip.c" 3 4
_Bool 
# 294 "./src/main/io/ledstrip.c"
    parseLedStripConfig(int ledIndex, const char *config)
{
    if (ledIndex >= 32)
        return 
    ...
    for (enum parseState_e parseState = 0; parseState < PARSE_STATE_COUNT; parseState++) {
        char chunk[11];
        {
            ...
            if (*config != chunkSeparator) {
                return 
# 327 "./src/main/io/ledstrip.c" 3 4
                      0
# 327 "./src/main/io/ledstrip.c"
                           ;
            }
            config++;
        }
    ...
    *ledConfig = (((((((x) & 0x0F) << 4) | (((y) & 0x0F) << 0))) << 0) | ((color) << 18) | ((direction_flags) << 22) | ((baseFunction) << 8) | ((overlay_flags) << 12) | ((0) << 28));
    ...
    return 
# 378 "./src/main/io/ledstrip.c" 3 4
          1
# 378 "./src/main/io/ledstrip.c"
              ;
}
...
static const hsvColor_t* getDirectionalModeColor(const int ledIndex, const modeColorIndexes_t *modeColors)
{
    ...
    return 
# 449 "./src/main/io/ledstrip.c" 3 4
          ((void *)0)
# 449 "./src/main/io/ledstrip.c"
              ;
}
...
# 745 "./src/main/io/ledstrip.c" 3 4
                             _Bool 
# 745 "./src/main/io/ledstrip.c"
                                  updateNow, timeUs_t *timer)
{
    static 
# 747 "./src/main/io/ledstrip.c" 3 4
          _Bool 
# 747 "./src/main/io/ledstrip.c"
               flash = 
# 747 "./src/main/io/ledstrip.c" 3 4
                       0
# 747 "./src/main/io/ledstrip.c"
    ...
    if (updateNow) {
        ...
        if (state > 50) {
            flash = 
# 755 "./src/main/io/ledstrip.c" 3 4
                   1
# 755 "./src/main/io/ledstrip.c"
                       ;
...
{
    static 
# 816 "./src/main/io/ledstrip.c" 3 4
          _Bool 
# 816 "./src/main/io/ledstrip.c"
               flash = 0;
...
# 873 "./src/main/io/ledstrip.c" 3 4
           _Bool 
# 873 "./src/main/io/ledstrip.c"
                applyColor;
...
# 928 "./src/main/io/ledstrip.c" 3 4
                                   _Bool 
# 928 "./src/main/io/ledstrip.c"
                                        updateNow, timeUs_t *timer)
{
...
# 953 "./src/main/io/ledstrip.c" 3 4
                              _Bool 
# 953 "./src/main/io/ledstrip.c"
                                   updateNow, timeUs_t *timer)
{
...
# 966 "./src/main/io/ledstrip.c" 3 4
   _Bool 
# 966 "./src/main/io/ledstrip.c"
        ledOn = (blinkMask & 1);
    if (!ledOn) {
...
# 1006 "./src/main/io/ledstrip.c" 3 4
                               _Bool 
# 1006 "./src/main/io/ledstrip.c"
                                    updateNow, timeUs_t *timer);
...
# 1072 "./src/main/io/ledstrip.c" 3 4
       _Bool 
# 1072 "./src/main/io/ledstrip.c"
...
# 1084 "./src/main/io/ledstrip.c"
    ...
    for (int componentIndex = 0; result && componentIndex < (HSV_VALUE + 1); componentIndex++) {
        ...
        if (val > hsv_limit[componentIndex]) {
            result = 
# 1093 "./src/main/io/ledstrip.c" 3 4
                    0
# 1093 "./src/main/io/ledstrip.c"
                         ;
            break;
        }
        ...
        if (remainingCharacters) {
            ...
            if (componentIndex < (HSV_VALUE + 1) - 1) {
                result = 
# 1112 "./src/main/io/ledstrip.c" 3 4
                        0
# 1112 "./src/main/io/ledstrip.c"
                             ;
            }
        }
    }
    ...
    setModeColor(ledModeIndex_e modeIndex, int modeColorIndex, int colorIndex)
{
    ...
    if (colorIndex < 0 || colorIndex >= 16)
        return 
# 1131 "./src/main/io/ledstrip.c" 3 4
              0
# 1131 "./src/main/io/ledstrip.c"
                   ;
    if (modeIndex < 6) {
        if (modeColorIndex < 0 || modeColorIndex >= 6)
            return 
# 1134 "./src/main/io/ledstrip.c" 3 4
                  0
# 1134 "./src/main/io/ledstrip.c"
                       ;
        ...
        if (modeColorIndex < 0 || modeColorIndex >= 11)
            return 
# 1138 "./src/main/io/ledstrip.c" 3 4
                  0
# 1138 "./src/main/io/ledstrip.c"
                       ;
        ...
        if (modeColorIndex < 0 || modeColorIndex >= 1)
            return 
# 1142 "./src/main/io/ledstrip.c" 3 4
                  0
# 1142 "./src/main/io/ledstrip.c"
                       ;
        ledStripStatusModeConfigMutable()->ledstrip_aux_channel = colorIndex;
    } else {
        return 
# 1145 "./src/main/io/ledstrip.c" 3 4
              0
# 1145 "./src/main/io/ledstrip.c"
                   ;
    }
    return 
...
# 1193 "./src/main/io/ledstrip.c" 3 4
   _Bool 
# 1193 "./src/main/io/ledstrip.c"
        blinkLed = 
# 1193 "./src/main/io/ledstrip.c" 3 4
                   0
# 1193 "./src/main/io/ledstrip.c"
...
# 1194 "./src/main/io/ledstrip.c" 3 4
   _Bool 
# 1194 "./src/main/io/ledstrip.c"
...
# 1200 "./src/main/io/ledstrip.c"
                      ;
        visualBeeperOverride = 
# 1201 "./src/main/io/ledstrip.c" 3 4
                              0
# 1201 "./src/main/io/ledstrip.c"
                                   ;
        flashPeriod = 250;
        onPercent = 50;
        ...
        switch (ledStripConfig()->ledstrip_profile) {
            ...
            case LED_PROFILE_BEACON: {
                if (!ledStripConfig()->ledstrip_beacon_armed_only || (armingFlags & (ARMED))) {
                    ...
                    blinkLed = 
# 1216 "./src/main/io/ledstrip.c" 3 4
                              1
# 1216 "./src/main/io/ledstrip.c"
                                  ;
                }
                break;
            }
    ...
    if (blinkLed) {
        ...
        const 
# 1228 "./src/main/io/ledstrip.c" 3 4
             _Bool 
# 1228 "./src/main/io/ledstrip.c"
