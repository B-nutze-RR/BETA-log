...
# 35 "./src/main/pg/vtx_io.c" 2

extern void pgResetFn_vtxIOConfig(vtxIOConfig_t *); vtxIOConfig_t vtxIOConfig_System; vtxIOConfig_t vtxIOConfig_Copy; extern const pgRegistry_t vtxIOConfig_Registry; const pgRegistry_t vtxIOConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 57 | (0 << 12), .length = 1, .size = sizeof(vtxIOConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&vtxIOConfig_System, .copy = (uint8_t*)&vtxIOConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_vtxIOConfig }, };

void pgResetFn_vtxIOConfig(vtxIOConfig_t *vtxIOConfig)
{

    vtxIOConfig->csTag = ((ioTag_t)((((1) + 1) << 4) | (0)));
    vtxIOConfig->powerTag = ((ioTag_t)((((1) + 1) << 4) | (1)));


    vtxIOConfig->clockTag = ((ioTag_t)((((0) + 1) << 4) | (7)));
    vtxIOConfig->dataTag = ((ioTag_t)((((0) + 1) << 4) | (6)));


    vtxIOConfig->spiDevice = ((spiDeviceByInstance(
# 49 "./src/main/pg/vtx_io.c" 3 4
                            ((void *)0)
# 49 "./src/main/pg/vtx_io.c"
                            )) + 1);
}
