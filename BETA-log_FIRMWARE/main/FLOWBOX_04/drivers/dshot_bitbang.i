...
extern bbPacer_t bbPacers[4];
extern int usedMotorPacers;

extern bbPort_t bbPorts[4];
extern int usedMotorPorts;

extern bbMotor_t bbMotors[8];
...
# 57 "./src/main/drivers/dshot_bitbang.c"
 bbPacer_t bbPacers[4];
 int usedMotorPacers = 0;

 bbPort_t bbPorts[4];
 int usedMotorPorts;

 bbMotor_t bbMotors[8];
...
static motorDevice_t bbDevice;
static timeUs_t lastSendUs;
